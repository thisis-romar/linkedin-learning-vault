...
> <!-- lle:github-source --> [View this note on GitHub](https://github.com/thisis-romar/linkedin-learning-vault/blob/github-browse/Glossary/Concept/Programming%20Concepts.md)
...
1. [[Programming Foundations- Beyond the Fundamentals]] — 3 mentions
2. [[Programming For Non Programmers Ios 17 And Swift 5]] — 2 mentions
3. [[Swift 5- Protocol-Oriented Programming]] — 2 mentions
4. [[Learning Arduino- Interfacing with Hardware]] — 2 mentions
...
1. [[A Quick Start Guide to Programming in Python]] — 4 total mentions
2. [[A Quick Start Guide to Java Programming]] — 4 total mentions
3. [[Master Swift]] — 4 total mentions
4. [[Become a Programmer- Foundations]] — 3 total mentions
5. [[Explore a Career as a Web Developer]] — 3 total mentions
6. [[Explore a Career as a JavaScript Developer]] — 3 total mentions
7. [[Career Essentials in Software Development by Microsoft and LinkedIn]] — 3 total mentions
8. [[Become an Arduino Developer]] — 3 total mentions
9. [[Getting Started as a C- Developer]] — 3 total mentions
10. [[Elevating C- Skills- Building Robust Applications]] — 2 total mentions
