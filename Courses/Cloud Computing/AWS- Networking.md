...
next_courses:
  - '[Complete Guide to AWS Security and Compliance Management](Complete%20Guide%20to%20AWS%20Security%20and%20Compliance%20Management.md)'
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [DHCP](../../Glossary/Standard/DHCP.md) (3), [Web Servers](../../Skills/Web%20Development/Web%20Servers.md) (3)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Routing](../../Skills/Network%20and%20System%20Administration/Routing.md) (4), [Domain name system](../../Skills/Network%20and%20System%20Administration/Domain%20Name%20System%20(DNS).md) (1), [Google](../../Glossary/Service/Google.md) (1), [User experience](../../Skills/Web%20Development/User%20Experience%20(UX).md) (1)
...
>
> **[3:08](https://www.linkedin.com/learning/aws-networking-14125632/the-command-line-interface-cli-for-mac?u=76281980&t=188)** I have pre-created those files for the accounts I'm going to use. Let's take a quick look at them now. In the config file, I can see the five named profiles I've set up, each with a default region. Examining the credentials file, I see the access key and secret access key that I'm using for each profile. I'm going to copy both the config and credentials file into the .aws directory for later use. In the next video, I'll run through installing the CLI on a [Windows](../../Glossary/Service/Windows.md) machine.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [CLI](../../Skills/Network%20and%20System%20Administration/CLI.md) (14), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (3), [Windows](../../Glossary/Service/Windows.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/aws-networking-14125632/the-command-line-interface-cli-for-windows?u=76281980&t=0)** - [Instructor] Let's proceed with installing the AWS [CLI](../../Skills/Network%20and%20System%20Administration/CLI.md) for [Windows](../../Glossary/Service/Windows.md). Once again, if you already have the CLI installed, or are not a Windows user, feel free to skip to the next chapter. On my Windows machine, I have a browser open to my favorite search engine. Here, I simply search for download AWS CLI. Since I'm on a Windows machine, it makes sense in include for Windows. Selecting the first link takes me to the instruction page for how to install on Windows. I want to make this as easy as possible, so I choose the first installation link, installing with the MSI installer. Since I'm running 64 bit Windows, I select the first download install link. It's a relatively small file, and downloads rather quickly. I go ahead and open up the installer which works just like any other Windows installer. I first need to accept the license agreement. There's no need for me to change the default installation location, so I simply click next. With that done, all I need to do is click install and wait. This goes relatively quickly, taking perhaps 45 seconds to a minute. Note that the machine I'm installing on is a T2 Micro. One useful hint when installing software, even if the end state is a smaller [EC2](../../Skills/DevOps/Amazon%20EC2.md) instance is to create a larger instance when doing the install. Then when it's configured appropriately, you can simply size it down. After receiving the message
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Windows](../../Glossary/Service/Windows.md) (9), [CLI](../../Skills/Network%20and%20System%20Administration/CLI.md) (6), [Ec2](../../Skills/DevOps/Amazon%20EC2.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [DHCP](../../Glossary/Standard/DHCP.md) (2), [Routing](../../Skills/Network%20and%20System%20Administration/Routing.md) (1), [Ec2](../../Skills/DevOps/Amazon%20EC2.md) (1), [Virtual Machines](../../Skills/Cloud%20Computing/Virtual%20Machines.md) (1), [Databases](../../Skills/Software%20Development/Databases.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Web Servers](../../Skills/Web%20Development/Web%20Servers.md) (4), [Ec2](../../Skills/DevOps/Amazon%20EC2.md) (2), [DHCP](../../Glossary/Standard/DHCP.md) (2), [Hardware](../../Topics/Hardware.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Ec2](../../Skills/DevOps/Amazon%20EC2.md) (3), [CLI](../../Skills/Network%20and%20System%20Administration/CLI.md) (2), [Windows](../../Glossary/Service/Windows.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Routing](../../Skills/Network%20and%20System%20Administration/Routing.md) (3), [Ec2](../../Skills/DevOps/Amazon%20EC2.md) (3), [CLI](../../Skills/Network%20and%20System%20Administration/CLI.md) (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [CLI](../../Skills/Network%20and%20System%20Administration/CLI.md) (5), [Ec2](../../Skills/DevOps/Amazon%20EC2.md) (4), [Scalability](../../Skills/Artificial%20Intelligence%20(AI)/Scalability.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Hardware](../../Topics/Hardware.md) (3), [Web Servers](../../Skills/Web%20Development/Web%20Servers.md) (2), [Ec2](../../Skills/DevOps/Amazon%20EC2.md) (2), [Word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) (1), [Scalability](../../Skills/Artificial%20Intelligence%20(AI)/Scalability.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Ec2](../../Skills/DevOps/Amazon%20EC2.md) (7), [Web Servers](../../Skills/Web%20Development/Web%20Servers.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Windows](../../Glossary/Service/Windows.md) (2), [Ec2](../../Skills/DevOps/Amazon%20EC2.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/aws-networking-14125632/understanding-network-acls?u=76281980&t=0)** - [Instructor] Network access control lists, or NACLs, are a tool for controlling how traffic flows into and out of subnets within a VPC. If you have used firewalls in the past, NACLs will feel very familiar to you. Let's go over a few important things to know about how NACLs work in AWS. First off, NACLs exist within the confines of a single VPC and do not span VPCs. If you want the same NACL rule set to exist in multiple VPCs, you'll have to configure the NACL in each VPC. Within a VPC, NACLs can be associated with one or more subnets. However, each subnet can only be associated with one and only one NACL. Where security groups are granular to the [EC2](../../Skills/DevOps/Amazon%20EC2.md) instance, NACLs affect entire subnets. NACLs are applied in a stateless fashion. As such, rules to allow network traffic must be explicitly defined. NACLs differ from security groups in that both allow and deny rules can be configured. For instance, if you used a NACL instead of a security group, to allow a server to reach the internet to pull down patches, you would have to specify an allow rule for both inbound and outbound traffic. All NACLs have an implicit deny built into the rule set. Say you have a NACL with four total rules. Two allowing inbound traffic on ports 80 and 443 and two more that allow outbound traffic on those same ports. If those are the only rules specified in your NACL, all other traffic on all other ports
>
> **[1:35](https://www.linkedin.com/learning/aws-networking-14125632/understanding-network-acls?u=76281980&t=95)** will be denied implicitly. You assign a number to each rule within a NACL. NACLs are processed in numerical order with the first successful rule ending the processing logic. One thing that's very important to understand, the default NACL that gets created when you first configure a VPC has two rules in addition to the implicit deny catch-all. The two default rules allow all traffic in both directions. This allows you to not even think about NACLs and focus on controlling access to resources using security groups. Let's visualize how NACLs differ from security groups. If you take all the defaults when building a VPC, the only control you have to allow traffic to get to your EC2 instances is with a security group. Remember the security group will deny all inbound connections while allowing stateful outbound connections to originate from the EC2 instance. Modifying the security group allows you to specify where traffic comes from at the instance level. Now, suppose you want to limit traffic to this subnet to just ports 80 and 443 for web content. You could configure a NACL that specifically allows 80 and 443 while denying everything else. Suppose someone stands up a [MySQL](../../Skills/Software%20Development/MySQL.md) database server and makes an error with the security group, which would allow traffic on the default port of 3306 to come from the internet. With the NACL in place, there is a second level of protection.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Ec2](../../Skills/DevOps/Amazon%20EC2.md) (3), [MySQL](../../Skills/Software%20Development/MySQL.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Ec2](../../Skills/DevOps/Amazon%20EC2.md) (2), [Windows](../../Glossary/Service/Windows.md) (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Ec2](../../Skills/DevOps/Amazon%20EC2.md) (2), [Routing](../../Skills/Network%20and%20System%20Administration/Routing.md) (2)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/aws-networking-14125632/verify-vpc-peer-routing?u=76281980&t=0)** - [Instructor] Now, that we have a peering connection and updated route information for the VPC in Paris, we need to update the appropriate networking configurations in Canada. As a reminder, the IP space we're dealing with in Paris is in the 192.168.22 supernet. Specifically, we will be updating route information related to the private subnet in Paris. To validate this configuration, there are some [EC2](../../Skills/DevOps/Amazon%20EC2.md) instances we're going to use. In Paris, there is an instance in the public subnet with an IP of 192.168.2.122. Meanwhile, in Canada, there are a pair of instances. One is in the public subnet with a private IP of 10.0.0.109. And the other is in the private subnet with an IP of 10.0.243. In order to get from the EC2 instance in the Paris private subnet to both instances in Canada, we need to do the following things, update the route table for the private subnet for traffic bound for the Paris private subnet, make the same modification to the Canadian public subnet's route table. And, finally, change the security group configuration for the EC2 instance in Canada. Since there are a number of configuration changes to make and automation is the key to managing infrastructure at scale, let's do this now through the AWS [CLI](../../Skills/Network%20and%20System%20Administration/CLI.md). Okay, here I have three terminal [Windows](../../Glossary/Service/Windows.md) setup. Notice the two terminal windows on the left are on the same machine with the IP of 192.168.2.122. This is the machine in the Parisian private subnet.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Ec2](../../Skills/DevOps/Amazon%20EC2.md) (3), [Windows](../../Glossary/Service/Windows.md) (2), [CLI](../../Skills/Network%20and%20System%20Administration/CLI.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [CLI](../../Skills/Network%20and%20System%20Administration/CLI.md) (1), [Ec2](../../Skills/DevOps/Amazon%20EC2.md) (1)
...
>
> **[1:34](https://www.linkedin.com/learning/aws-networking-14125632/validate-transit-gateway?u=76281980&t=94)** would show up here, but that's not how it works today. Okay, let's take a quick validation check and see how we did. Here, I have three terminal [Windows](../../Glossary/Service/Windows.md). In each one, I've manifested a connection to a host in the administrative public sub-net. Note it's internal private IP of 172-16-0-76. In the terminal window on the left, I'm going to ping an instance in VPC1. In the top right I'm going to ping an instance in VPC2. And finally in the lower right, I'm going to ping an instance in VPC3. Note that no information is coming back. Let's take a quick look at the security group to see what's going on. In the AWS console, I open up the [EC2](../../Skills/DevOps/Amazon%20EC2.md) configuration screen in a new browser tab. I see I have four running instances. Drilling in, let's take a quick look at the instance running in VPC1. We can see the VPC ID at the bottom of the screen. Let's take a quick look at the inbound rules associated with the security group. That looks okay. Both Port 22 and ICMP is open from anywhere on the planet. Can you think of why we're not getting any ping responses? Let's figure it out in the next video.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Windows](../../Glossary/Service/Windows.md) (1), [Ec2](../../Skills/DevOps/Amazon%20EC2.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Windows](../../Glossary/Service/Windows.md) (1), [Ec2](../../Skills/DevOps/Amazon%20EC2.md) (1), [Routing](../../Skills/Network%20and%20System%20Administration/Routing.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [DNS Management](../../Skills/Network%20and%20System%20Administration/DNS%20Management.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [WordPress](../../Skills/Web%20Development/WordPress.md) (6), [Windows](../../Glossary/Service/Windows.md) (6), [Ec2](../../Skills/DevOps/Amazon%20EC2.md) (1), [Wordpress Development](../../Skills/Web%20Development/Wordpress%20Development.md) (1)
...
>
> **[1:34](https://www.linkedin.com/learning/aws-networking-14125632/configure-private-dns?u=76281980&t=94)** Now that we have created a private hosted zone, we need to create a record set. Let's go ahead and create an A record that points to the internal IP address of the [WordPress](../../Skills/Web%20Development/WordPress.md) instance. To get started, I click the blue create record set button. I don't need to specify a name, but I do need to specify an IP address. To get that, let's go back to the other tab. Selecting the WordPress dev instance, I slide down and copy its private IP address. Back in the Route 53 tab, I simply paste that into the value section. While there are a variety of [Routing](../../Skills/Network%20and%20System%20Administration/Routing.md) policy options, it's simple that I want. Okay, everything looks good here. So I click the blue create button. Now, let's go back to the [Windows](../../Glossary/Service/Windows.md) test box and validate that that configuration worked. Here, we have the IP address, which resolves to the blog. In the original tab, we have [sbndemo.org](https://sbndemo.org), which was resolving to our static S3 site. Let simply refresh that page. Note that that resolves to the WordPress instance, using private DNS. Meanwhile, back on my Mac, let's validate that the public has yet to be impacted. I simply pop open a new browser tab, and put in [sbndemo.org](https://sbndemo.org). As expected, using public DNS, that still resolves to my static S3 site. There you have it. Production users have not been affected, while I can fully simulate the new sites [user experience](../../Skills/Web%20Development/User%20Experience%20(UX).md)
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [WordPress](../../Skills/Web%20Development/WordPress.md) (4), [Routing](../../Skills/Network%20and%20System%20Administration/Routing.md) (1), [Windows](../../Glossary/Service/Windows.md) (1), [User experience](../../Skills/Web%20Development/User%20Experience%20(UX).md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [SDN](../../Glossary/Concept/SDN.md) (3), [Ec2](../../Skills/DevOps/Amazon%20EC2.md) (1), [Software-defined networking](../../Glossary/Concept/SDN.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/aws-networking-14125632/use-elastic-ip-and-route-53?u=76281980&t=0)** - [Instructor] Now that we understand what an Elastic IP is, let's use one in concert with Route 53 to make my [WordPress](../../Skills/Web%20Development/WordPress.md) site public. Consider [sbndemo.org](https://sbndemo.org)'s public status. Currently, Route 53 is simply pointing to an S3 bucket. I'm going to add an EIP to the mix and associate it with my WordPress instance, then I'll change [sbndemo.org](https://sbndemo.org)'s A record in Route 53 to point to the EIP. This will make my WordPress site public. Before we dive into the console, let's quickly recap what we're about to do. First, I'm going to allocate a new Elastic IP. After I have a new EIP, I'm going to associate it with my WordPress instance. With that done, I'm going to update the A record in Route 53 for [sbndemo.org](https://sbndemo.org). And finally, I'll wait for DNS to propagate this change. Here I am in the AWS console. The first thing I need to do is allocate an EIP, so I scroll down in the left-hand nav to the network and security section. Here, I click on the Elastic IP link. To allocate a new one, I simply click the allocate Elastic IP address. Note that I have an option here. I can either use one of Amazon's IPv4 addresses, or if I had my own pool, I could use one of my own. In this case, I simply want to use one of Amazon's, so I click the Allocate button. Very quickly, I get the message that the IP address has been allocated. Remember, there's an hourly charge for unassociated EIPs, so I'm going to make that association now.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [WordPress](../../Skills/Web%20Development/WordPress.md) (7)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [HTML](../../Skills/Web%20Development/HTML.md) (2), [Ec2](../../Skills/DevOps/Amazon%20EC2.md) (1), [Real-Time](../../Skills/Database%20Management/Real-Time.md) (1), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Statistics](../../Skills/Data%20Science/Statistics.md) (2), [Ec2](../../Skills/DevOps/Amazon%20EC2.md) (1), [HTML](../../Skills/Web%20Development/HTML.md) (1)
> **CLI Commands:** curl (3)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Ec2](../../Skills/DevOps/Amazon%20EC2.md) (3), [HTML](../../Skills/Web%20Development/HTML.md) (3)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Ec2](../../Skills/DevOps/Amazon%20EC2.md) (1), [User experience](../../Skills/Web%20Development/User%20Experience%20(UX).md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Ec2](../../Skills/DevOps/Amazon%20EC2.md) (6), [Routing](../../Skills/Network%20and%20System%20Administration/Routing.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/aws-networking-14125632/understand-api-gateway?u=76281980&t=0)** - [Instructor] If you have [application programming interfaces](../../Skills/Software%20Development/Application%20Programming%20Interfaces%20(API).md) that you want to make broadly accessible, you'll want to take a close look at how the AWS API Gateway can help you with everything from version management to performance. There are a variety of technologies that can be used to develop and deploy application programming interfaces. With API gateway, you can homogenize access regardless of the technology that underpins the APIs themselves. Suppose you have developers who are using the Elastic Container Service to facilitate HTTP [API Development](../../Skills/Software%20Development/API%20Development.md). You can use API gateway to route inbound requests to your ECS endpoint. That said, please note that requesters must come in over HTTPS in order to access an API gateway managed endpoint. Similarly, you can use API gateway to front [REST](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) APIs that have been developed in a serverless manner using Lambda. If you use Elastic Beanstalk to manage your infrastructure or, run your own [EC2](../../Skills/DevOps/Amazon%20EC2.md) instances to provide [WebSocket](../../Skills/Web%20Development/WebSocket.md) APIs, these deployment models are supported by API gateway. While all of these capabilities are useful, API gateway also has the ability to restrict access based on rate limits, authorization, and access controls. It can also be considered a fault tolerant component with the ability to accommodate thousands
>
> **[1:35](https://www.linkedin.com/learning/aws-networking-14125632/understand-api-gateway?u=76281980&t=95)** of concurrent requests. From a payload perspective, API gateway can support query string parameters, request headers, [JSON](../../Skills/Web%20Development/JSON.md), XML, and more. Developing, deploying, monitoring, and securing APIs is a deep and complicated set of topics. One of the things you'll want to think carefully about is authorization. Do you want consumers to use your API without any authentication? You can certainly make that choice. However, if you don't use API keys, then you'll be limited in your ability to throttle any given user in the event of a problematic client. You'll also want to consider how you route requests. For example, you may want to route a post or put request to a different API than a GET request. You can also specify a default to which all requests are routed regardless of calling method. Since APIs are simply the encapsulation of a piece of business logic, it is quite likely that they will change over time, to that end, you have the ability to specify stages in API gateway. For example, you can use stages to direct incoming requests to your development, [Quality Assurance](../../Skills/Software%20Development/Quality%20Assurance.md), or production APIs. Depending on the scale at which you operate, it may make sense to use API gateways caching feature to improve overall API performance.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (2), [Application programming interfaces](../../Skills/Software%20Development/Application%20Programming%20Interfaces%20(API).md) (1), [API Development](../../Skills/Software%20Development/API%20Development.md) (1), [Ec2](../../Skills/DevOps/Amazon%20EC2.md) (1), [WebSocket](../../Skills/Web%20Development/WebSocket.md) (1)
...
>
> **[6:19](https://www.linkedin.com/learning/aws-networking-14125632/configure-api-gateway?u=76281980&t=379)** To do so, I simply click on the log group name. This brings up the details for that log group. Note that the ARN is available in the upper right corner of the screen. I simply copy the ARN and return to my API gateway page. In the log destination, I paste in the appropriate ARN. Down below, I have the option of specifying the format in which I want access logging to occur. For this demonstration, I'll simply select [JSON](../../Skills/Web%20Development/JSON.md). To complete my login configuration, I click the Save button towards the bottom right side of the screen. Quite quickly, I get the confirmation that the logging has been enabled.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (2), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (1), [WebSocket](../../Skills/Web%20Development/WebSocket.md) (1), [Quality Assurance](../../Skills/Software%20Development/Quality%20Assurance.md) (1), [Routing](../../Skills/Network%20and%20System%20Administration/Routing.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/aws-networking-14125632/throttling-with-api-gateway?u=76281980&t=0)** - [Instructor] Now that we verified our API Gateway is working as intended, let's see how we can protect it with throttling. Here I am with two browser tabs open, on the left I have my API Gateway, on the right I have an [EC2](../../Skills/DevOps/Amazon%20EC2.md) instance connect window logged on to an EC2 instance. The first thing I'm going to do is write a quick loop that will invoke my API every second. I'm going to use the curl command to hit my API. I need to pass the URL, for my API, to the curl command. To do so, I copied the invoke URL from the left-hand browser. With that in my buffer, I paste it in after the curl command on the right. With that complete, I need to append the name of my function as well as the query string parameter. I'm also going to output the current date and time, using the Date command. Finally, I'll add a one-second pause using the Sleep command. With the loop written, I type done to complete it and return so it starts executing. Since I'm running this on a day the market is closed, I keep getting the same price for Amazon. Now suppose I want to curtail that behavior, I can do so by using throttling. In the browser, on the left side of the screen,
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Ec2](../../Skills/DevOps/Amazon%20EC2.md) (2), [Git](../../Skills/Software%20Development/Git.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Ec2](../../Skills/DevOps/Amazon%20EC2.md) (3), [Windows](../../Glossary/Service/Windows.md) (3)
...
- [Sharif Nijim](../../Instructors/Cloud%20Computing/Sharif%20Nijim.md)
...
← [Amazon EC2 Essential Training](Amazon%20EC2%20Essential%20Training.md) | **3 of 5** | [Complete Guide to AWS Security and Compliance Management](Complete%20Guide%20to%20AWS%20Security%20and%20Compliance%20Management.md) →
...
- [Aws Essential Training For Administrators](Aws%20Essential%20Training%20For%20Administrators.md) — Cloud Administration, Amazon Web Services (AWS)
