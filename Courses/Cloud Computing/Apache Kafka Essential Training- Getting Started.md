...
next_courses:
  - '[Transition from Data Science to Data Engineering](Transition%20from%20Data%20Science%20to%20Data%20Engineering.md)'
...
>
> **[0:00](https://www.linkedin.com/learning/apache-kafka-essential-training-getting-started-22398044/getting-started-with-apache-kafka?u=76281980&t=0)** - [Instructor] [Apache Kafka](../../Skills/Software%20Development/Apache%20Kafka.md) is the leading open-source technology for message queuing and distribution with widespread adoption. My name is Kumaran Ponnambalam. In this course, I will introduce Apache Kafka and show you how to build [Data Pipelines](../../Skills/Data%20Science/Data%20Pipelines.md) with it. We will start off with various concepts, benefits, and use cases of Apache Kafka. Then, we will use command-line tools to publish and consume data. We will then discuss partitioning with Kafka. Finally, we will build Apache Kafka clients using [Java](../../Skills/Software%20Development/Java.md). To get the most out of this course, you should be familiar with [Big Data](../../Skills/Data%20Science/Big%20Data.md) concepts, Java programming, and Docker. Let's now start learning about Apache Kafka.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Apache Kafka](../../Skills/Software%20Development/Apache%20Kafka.md) (5), [Java](../../Skills/Software%20Development/Java.md) (2), [Data Pipelines](../../Skills/Data%20Science/Data%20Pipelines.md) (1), [Big Data](../../Skills/Data%20Science/Big%20Data.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Apache Kafka](../../Skills/Software%20Development/Apache%20Kafka.md) (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Apache Kafka](../../Skills/Software%20Development/Apache%20Kafka.md) (2), [Big Data](../../Skills/Data%20Science/Big%20Data.md) (2)
> **CLI Commands:** apache (2)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/apache-kafka-essential-training-getting-started-22398044/benefits-of-kafka?u=76281980&t=0)** - [Instructor] What are some of the key benefits of [Apache Kafka](../../Skills/Software%20Development/Apache%20Kafka.md)? Kafka provides high throughput and can handle large quantities of data. It supports multiple concurrent producers that can push data and multiple subscribers for the same data. It can provide such high throughput with low latency of a few milliseconds. This enables a number of [Real-Time](../../Skills/Database%20Management/Real-Time.md) use cases where the latency is not noticeable end to end. Kafka provides excellent fault tolerance against failures, either within Kafka or with consumers. This ensures that messages are reliably stored and distributed in spite of issues with individual processes. Kafka decouples producers and consumers; they do not need to know about each other. This enables ease of configuration and management. It also makes [Software Development](../../Topics/Software%20Development.md) a lot simpler, as the developer of the producer or consumer program only needs to deal with Kafka and does not have to worry about other producers or consumers of the same data. One benefit of decoupling and storage capabilities is back-pressure handling. Even if the producers produce data in spikes, the consumers can catch up at their own pace, as Kafka provides the buffer in the middle, the whole data, until it is consumed. Kafka provides horizontal [Scalability](../../Skills/Artificial%20Intelligence%20(AI)/Scalability.md) within its architecture, as well as for producers and consumers.
>
> **[1:35](https://www.linkedin.com/learning/apache-kafka-essential-training-getting-started-22398044/benefits-of-kafka?u=76281980&t=95)** The system can scale with addition of nodes without significant choke points. This is essential for [Big Data](../../Skills/Data%20Science/Big%20Data.md) processing. Kafka's low latency enables stream processing, while its store and forward capability enables batch applications. The consumers need not have to consume messages immediately as Kafka acts as a buffer. Now that we have looked at Kafka's benefits, let's review the popular use cases for Kafka in the next video.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Apache Kafka](../../Skills/Software%20Development/Apache%20Kafka.md) (1), [Real-Time](../../Skills/Database%20Management/Real-Time.md) (1), [Software Development](../../Topics/Software%20Development.md) (1), [Scalability](../../Skills/Artificial%20Intelligence%20(AI)/Scalability.md) (1), [Big Data](../../Skills/Data%20Science/Big%20Data.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/apache-kafka-essential-training-getting-started-22398044/kafka-use-cases?u=76281980&t=0)** - [Narrator] What are some of the popular use cases for [Apache Kafka](../../Skills/Software%20Development/Apache%20Kafka.md)? Kafka enables a wide variety of use cases for both [Batch Processing](../../Skills/Data%20Science/Batch%20Processing.md) and [Real-Time](../../Skills/Database%20Management/Real-Time.md) streaming. To begin with, it can provide asynchronous messaging between services. Rather than use [REST](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) or RPC, a client service can send requests through Kafka and receive responses through Kafka. It provides better reliability and manages back pressure on the server side. It has low latency, enough for even browser-based real-time applications. It enables real-time stream processing. As messages are received in Kafka, consumers can consume them in real time, process them, and trigger real-time actions. Kafka queues can be used to send log messages and alerts. One consumer can archive these messages in a persistent store. Another can look for key exceptions in real time and trigger alerts. Kafka enables the event sourcing pattern where the state of an entity can be determined using the events generated about state changes for that entity. This is a popular pattern for [Big Data](../../Skills/Data%20Science/Big%20Data.md). Finally, Kafka enables real-time analytics. An [Apache Spark](../../Skills/Data%20Science/Apache%20Spark.md) or Apache Flink consumer can listen to messages in real time and generate windowed aggregations, analyze trends, and generate triggers, metrics, and actions.
>
> **[1:34](https://www.linkedin.com/learning/apache-kafka-essential-training-getting-started-22398044/kafka-use-cases?u=76281980&t=94)** This can be used to update real-time [Dashboards](../../Skills/Data%20Science/Dashboards.md). Having discussed the benefits and use cases of Kafka, let's now install the required software and get set up for the rest of the course.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Real-Time](../../Skills/Database%20Management/Real-Time.md) (6), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (2), [Apache Kafka](../../Skills/Software%20Development/Apache%20Kafka.md) (1), [Batch Processing](../../Skills/Data%20Science/Batch%20Processing.md) (1), [Big Data](../../Skills/Data%20Science/Big%20Data.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Compose](../../Glossary/Framework/Jetpack%20Compose.md) (4), [Windows](../../Glossary/Service/Windows.md) (2), [Configuration Management](../../Skills/Software%20Development/Configuration%20Management.md) (1), [Powershell](../../Skills/Network%20and%20System%20Administration/Powershell.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Web Servers](../../Skills/Web%20Development/Web%20Servers.md) (1), [Java](../../Skills/Software%20Development/Java.md) (1), [JSON](../../Skills/Web%20Development/JSON.md) (1), [Batch Processing](../../Skills/Data%20Science/Batch%20Processing.md) (1)
> **CLI Commands:** make (1)
> **Env Vars:** json (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Windows](../../Glossary/Service/Windows.md) (1), [Java](../../Skills/Software%20Development/Java.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/apache-kafka-essential-training-getting-started-22398044/extending-your-kafka-knowledge?u=76281980&t=0)** - [Kumaran] Now that you have learned about the basics of [Apache Kafka](../../Skills/Software%20Development/Apache%20Kafka.md), you can take your learning even further. First, you can learn more about building scalable Kafka applications through the next course, Apache Kafka Essentials: Building Scalable Applications. Second, you can learn more about using Kafka for building stream processing applications with Apache Kafka, Apache Flink, or Kafka Streams. Finally, you can implement Kafka in your organization for your [Big Data](../../Skills/Data%20Science/Big%20Data.md) processing use cases. Data always intrigues me. I bet it intrigues you too, so let's keep exploring it and find better ways of extracting knowledge from it.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Apache Kafka](../../Skills/Software%20Development/Apache%20Kafka.md) (3), [Big Data](../../Skills/Data%20Science/Big%20Data.md) (1)
...
← [PySpark Essential Training- Introduction to Building Data Pipelines](../Data%20Science/PySpark%20Essential%20Training-%20Introduction%20to%20Building%20Data%20Pipelines.md) | **6 of 7** | [Transition from Data Science to Data Engineering](Transition%20from%20Data%20Science%20to%20Data%20Engineering.md) →
...
- [Tuning Kafka](../Data%20Science/Tuning%20Kafka.md) — Apache Kafka
- [Troubleshooting and Debugging Kafka](../Data%20Science/Troubleshooting%20and%20Debugging%20Kafka.md) — Apache Kafka
- [Apache Kafka Essential Training Building Scalable Applications](../Data%20Science/Apache%20Kafka%20Essential%20Training%20Building%20Scalable%20Applications.md) — Apache Kafka
