...
>
> **[0:00](https://www.linkedin.com/learning/leveraging-google-cloud-developer-and-devops-tools/state-of-google-cloud-tools?u=76281980&t=0)** - [Lynn] There are so many [[Google Cloud Platform (GCP)|Google Cloud]] services.
>
...
>
> **[1:04](https://www.linkedin.com/learning/leveraging-google-cloud-developer-and-devops-tools/state-of-google-cloud-tools?u=76281980&t=64)** I'm Lynn Langit and this is [[Google Cloud Platform (GCP)|Google Cloud Platform]] Tools.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/leveraging-google-cloud-developer-and-devops-tools/who-should-watch-this-course?u=76281980&t=0)** - [Instructor] This course is designed for learners of [[Google Cloud Platform (GCP)|Google Cloud]] who work in various roles.
>
...
>
> **[0:41](https://www.linkedin.com/learning/leveraging-google-cloud-developer-and-devops-tools/google-console-for-learners?u=76281980&t=41)** In [[Google Cloud Platform (GCP)|Google Cloud]], we have the concept of a project which is a container for different objects.
>
...
>
> **[5:31](https://www.linkedin.com/learning/leveraging-google-cloud-developer-and-devops-tools/google-console-for-learners?u=76281980&t=331)** So you can search for [[Microsoft Products|products]], resources, or docs.
>
...
>
> **[0:37](https://www.linkedin.com/learning/leveraging-google-cloud-developer-and-devops-tools/user-authentication-and-authorization?u=76281980&t=37)** Now, the first time that you work with the Cloud Shell, which is a virtual machine that has the [[Google Cloud Platform (GCP)|Google Cloud]] SDK on it, you would have to authenticate.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/leveraging-google-cloud-developer-and-devops-tools/gcp-services-and-menus?u=76281980&t=0)** - [Instructor] Now once you're working in the console, as I mentioned, I typically, if I want to find something, I'll just type in the [[Microsoft Word|word]] compute for [[Virtual Machines]], storage for storage buckets.
>
...
>
> **[0:17](https://www.linkedin.com/learning/leveraging-google-cloud-developer-and-devops-tools/gcp-services-and-menus?u=76281980&t=17)** It always gives you the [[Microsoft Products|products]] or the services first, and then it gives you documentation and then resources that are specific to the project.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/leveraging-google-cloud-developer-and-devops-tools/using-google-colab-notebooks?u=76281980&t=0)** - [Instructor] In addition to the managed notebooks that are available inside of the GCP platform that are associated to your account, there's another set of cloud-based tools that actually run on the [[Google Cloud Platform (GCP)|Google Cloud]], that are in separate types of accounts.
>
...
>
> **[1:34](https://www.linkedin.com/learning/leveraging-google-cloud-developer-and-devops-tools/using-google-colab-notebooks?u=76281980&t=94)** I think this is [[Python (Programming Language)|Python]], and it's going to show you the resources that are available.
>
...
>
> **[0:48](https://www.linkedin.com/learning/leveraging-google-cloud-developer-and-devops-tools/using-google-managed-notebooks?u=76281980&t=48)** So let's just look at these [[Python (Programming Language)|Python]] docs.
>
...
>
> **[4:08](https://www.linkedin.com/learning/leveraging-google-cloud-developer-and-devops-tools/using-google-managed-notebooks?u=76281980&t=248)** So here it says, manage notebooks provide JupyterLab services and flexible computing resources and are integrated with [[Google Cloud Platform (GCP)|Google cloud]] services.
>
...
>
> **[1:20](https://www.linkedin.com/learning/leveraging-google-cloud-developer-and-devops-tools/using-google-cloud-scripts-with-cloud-shell-for-storage?u=76281980&t=80)** Now most of the tools for [[Google Cloud Platform (GCP)|Google Cloud]] are GCloud than the service, like GCloud Compute, in this case, GCloud storage, GCloud, whatever it might be.
>
...
>
> **[2:12](https://www.linkedin.com/learning/leveraging-google-cloud-developer-and-devops-tools/using-google-cloud-scripts-with-cloud-shell-for-storage?u=76281980&t=132)** So again, there's the [[Representational State Transfer (REST)|rest]] of Google Cloud Services are G Cloud, but when it comes to file storage, it's a little bit bifurcated, so I just put this in here.
>
...
>
> **[1:52](https://www.linkedin.com/learning/leveraging-google-cloud-developer-and-devops-tools/deploying-a-vm-with-google-cloud-script?u=76281980&t=112)** In addition to this capability, what I can do, I'm just going to close out of here, is I can use [[Representational State Transfer (REST)|REST]].
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/leveraging-google-cloud-developer-and-devops-tools/running-gcp-deployments?u=76281980&t=0)** - So in addition to using scripts with gcloud or [[Representational State Transfer (REST)|REST]] APIs, you can deploy sets of services using services like deployment service.
>
...
>
> **[2:17](https://www.linkedin.com/learning/leveraging-google-cloud-developer-and-devops-tools/running-gcp-deployments?u=76281980&t=137)** So using mechanisms like [[Google Cloud Platform (GCP)|Google Cloud]] deployments helps you with reproducibility.
>
...
>
> **[3:15](https://www.linkedin.com/learning/leveraging-google-cloud-developer-and-devops-tools/running-gcp-deployments?u=76281980&t=195)** One of the patterns that I see happening is the [[Kubernetes]] Resource Model or Terraform which is a third party company that has an open source set of templates that works with GCP, Amazon, [[Microsoft Azure|Azure]], and other services, and is increasingly becoming a standard around infrastructure code is supported by Google.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/leveraging-google-cloud-developer-and-devops-tools/monitoring-gcp-security-with-scc?u=76281980&t=0)** - [Instructor] When you're looking at the security tools in the [[Google Cloud Platform (GCP)|Google Cloud]], what you can see depends on who you are.
>
...
>
> **[1:14](https://www.linkedin.com/learning/leveraging-google-cloud-developer-and-devops-tools/designing-gcp-solutions-with-architecture-diagramming?u=76281980&t=74)** So you can see that this is a reference architecture for data analytics pipeline on [[Google Cloud Platform (GCP)|Google Cloud]], and yeah, it's Excalidraw.
>
...
>
> **[0:23](https://www.linkedin.com/learning/leveraging-google-cloud-developer-and-devops-tools/coding-with-the-gcp-local-google-cloud-sdk?u=76281980&t=23)** And seeing full [[Continuous Integration (CI)|continuous integration]] and continuous deployment using the Cloud Build service as our underlying service that we're implementing CI and CD.
>
...
>
> **[1:04](https://www.linkedin.com/learning/leveraging-google-cloud-developer-and-devops-tools/coding-with-the-gcp-local-google-cloud-sdk?u=76281980&t=64)** Just for being complete, I want to also mention the ability to take the [[Google Cloud Platform (GCP)|Google Cloud]] [[Software Development]] kit and install the client locally.
>
...
>
> **[0:06](https://www.linkedin.com/learning/leveraging-google-cloud-developer-and-devops-tools/storing-code-in-cloud-source-repositories?u=76281980&t=6)** These are [[Git]] repositories where your application code is stored on the [[Google Cloud Platform (GCP)|Google Cloud]].
>
> **[0:12](https://www.linkedin.com/learning/leveraging-google-cloud-developer-and-devops-tools/storing-code-in-cloud-source-repositories?u=76281980&t=12)** And this is designed for scenarios with CI/CD, or [[Continuous Integration (CI)|continuous integration]], continuous deployment.
>
...
>
> **[3:19](https://www.linkedin.com/learning/leveraging-google-cloud-developer-and-devops-tools/storing-code-in-cloud-source-repositories?u=76281980&t=199)** And then I can install the client library if I wanted to work in [[Python (Programming Language)|Python]] and then I could try my code sample.
>
...
>
> **[0:06](https://www.linkedin.com/learning/leveraging-google-cloud-developer-and-devops-tools/storing-artifacts-in-gcr-or-artifact-registry?u=76281980&t=6)** So initially, [[Google Cloud Platform (GCP)|Google Cloud]] came out with this container registry service, which I use the tutorial over here, which again, is another tip in the UI here.
>
...
>
> **[0:07](https://www.linkedin.com/learning/leveraging-google-cloud-developer-and-devops-tools/storing-secrets-in-secrets-manager?u=76281980&t=7)** And in [[Google Cloud Platform (GCP)|Google Cloud]], those are Secret Manager or KMS.
>
...
>
> **[3:15](https://www.linkedin.com/learning/leveraging-google-cloud-developer-and-devops-tools/implementing-ci-cd-with-cloud-build?u=76281980&t=195)** Whatever types of build outputs you create, these will be stored in the [[Google Cloud Platform (GCP)|Google Cloud]] Artifact Registry.
>
...
>
> **[0:18](https://www.linkedin.com/learning/leveraging-google-cloud-developer-and-devops-tools/next-steps-with-google-cloud-developer-and-devops-tools?u=76281980&t=18)** As I've been mentioning, for the [[Google Cloud Platform (GCP)|Google Cloud]] I have several courses in the [[LinkedIn]] learning library.
>
