...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/building-rapport-with-customers-21402583/build-rapport-with-your-customers-in-six-seconds-or-less?u=76281980&t=0)** One, two, three, four. That's all you get to make a first impression, about four to six seconds. The good news is, it's really easy to create a friendly connection in just a few seconds. Here are my top three tips for creating a fantastic customer experience. First, speak with enthusiasm. How would you act if you open your front door to welcome guest? You'd be energetic and friendly. From the first ring of the doorbell to the last visitor arriving, your energy would be welcoming. You can make your customers feel welcome by talking energetically and enthusiastically. Put a smile on your face and in your voice and speak to customers like you're hosting a party in your home. Second, use "ahs" and "mhmms" to tell the customer you're listening. Interject these verbal cues as they talk to show customers you're interested in what they're saying. So often, employees listen to customers silently, which can make the customer feel you aren't fully present. Engage your customers with warm "ahs" and "mhmms" and your interest will be unmistakable. You naturally do this with friends and it fosters connection. Third, practice the rule of 10-10.
>
> **[1:35](https://www.linkedin.com/learning/building-rapport-with-customers-21402583/build-rapport-with-your-customers-in-six-seconds-or-less?u=76281980&t=95)** When you serve customers face to face, I want you to greet them within 10 seconds of them entering your business. When you're working and a customer is within 10 feet, look up, smile, and say hello if they make eye contact. This is a powerful way to create instant rapport. I checked into a hotel in Denver and received the 10-10 treatment. When I entered the hotel, an employee faced me squarely, smiled, and gave me a welcome that felt like I was coming home to family. She made a fantastic first impression, which only took a few seconds. You can create instant rapport just like this. Here's my action item for you. Try one of these three tips today in at least one customer interaction.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/building-rapport-with-customers-21402583/speak-in-complete-sentences-with-your-customers?u=76281980&t=0)** Have you ever had a conversation with a customer service person that went something like this? The agent says, "Date of birth, last name, ZIP code?" A lot of customer service reps ask questions this way, but when you talk in little bites, you sound robotic and it's hard to build rapport with customers if you sound robotic. After all, rapport is a human-to-human connection. Consider the difference in placing a fast food order where the person says, "Pull forward" versus "My pleasure. We'll have your order ready at the window." Which sounds better to you? Yes, these are both full sentences, but the attitude is very different. So it makes sense that speaking in complete sentences is one of the easiest ways to make your conversations with customers more warm and friendly. Before we jump into that, let's think about why we sometimes talk in fragments. The temptation to talk in fragments is greatest when we have to ask the customer several questions before we can help them. We do it because we want to quickly get through the questions so we can solve their problem or answer their question. But remember, we're not coming across as helpful, we're coming across as mechanical and impatient. While our intentions are good, we need better execution. So when you have to ask your customer questions,
>
> **[1:35](https://www.linkedin.com/learning/building-rapport-with-customers-21402583/speak-in-complete-sentences-with-your-customers?u=76281980&t=95)** I want you to do two things. First, always ask your questions in complete sentences. Second, use please and thank you whenever possible. It will sound something like this. "Can I please have your last name?" "Do you happen to have your claim number?" "Thank you. One last question for you." Commit to asking your customers questions only in complete sentences. This will make you sound friendlier and give the conversation a casual, natural flow, giving you the best opportunity to create rapport.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/building-rapport-with-customers-21402583/practice-building-rapport-with-customers?u=76281980&t=0)** As we wrap up, I'd like you to set goals based on your learning. Grab something to write with or use the notebook feature below to type out the following. I'd like you to write down these three words: Start, stop, and continue. Now, write down one thing you will start doing due to something you've learned in this training. Maybe it's a simple act of just acknowledging and reflecting your customer's emotions, be they good or bad. Next, what's one thing you commit to stop doing? Perhaps it's committing to not asking short robotic questions while gathering customer info. Write down that one thing. Finally, what's one thing you will continue to do? There are plenty of things you're already doing that help you build rapport with your customers. What's one of those things? Reinforce what you're doing well by writing it down. The simple start, stop, continue exercise is a fantastic way to capture your biggest takeaways, and it can inspire you to apply what you've learned. If you need more help fostering rapport, visit my blog at [myragolden.com](https://myragolden.com). My website has dozens of resources, including good phrases for creating rapport and lots of
>
> **[1:37](https://www.linkedin.com/learning/building-rapport-with-customers-21402583/practice-building-rapport-with-customers?u=76281980&t=97)** inspiration to help you deliver great interactions. Thank you for taking this course with me.
