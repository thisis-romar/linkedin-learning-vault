...
next_courses:
  - '[C- Delegates, Events, and Lambdas](../Software%20Development/C-%20Delegates%2C%20Events%2C%20and%20Lambdas.md)'
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/object-oriented-programming-with-c-sharp-17331514/what-you-should-know?u=76281980&t=0)** - [Instructor] This course is intended for intermediate developers that have a basic knowledge of how C Sharp works, have experienced writing classes, and want to learn more about the concepts of [object-oriented programming](../../Skills/Software%20Development/Object-Oriented%20Programming%20(OOP).md) and practice. I'm going to assume that you've already read a little bit about the theory behind object-oriented programming or come from a language that uses it. You'll need to get .NET 6 set up on your computer but any future versions of .NET will work, since the code we'll be writing will focus on the core features of the language. If you do not have .NET set up, please go ahead and download a copy of Visual Studio for the Mac or [Windows](../../Glossary/Service/Windows.md). It'll automatically set up your dev environment and make it easier to code our game. You can also use Visual Studio Code, but you'll need to download the C Sharp plugin and manually set up the .NET SDK on the command line, which I won't be covering in this course. Once you have everything set up, you'll be ready to code along as we build our text adventure game.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Object-oriented programming](../../Skills/Software%20Development/Object-Oriented%20Programming%20(OOP).md) (2), [Windows](../../Glossary/Service/Windows.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Version Control](../../Skills/Web%20Development/Version%20Control.md) (2), [Windows](../../Glossary/Service/Windows.md) (1), [Git](../../Skills/Software%20Development/Git.md) (1), [Tokens](../../Skills/Web%20Development/Tokens.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Functional Programming](../../Skills/Software%20Development/Functional%20Programming.md) (1), [Object-oriented programming](../../Skills/Software%20Development/Object-Oriented%20Programming%20(OOP).md) (1)
> **CLI Commands:** make (3)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) (15)
> **CLI Commands:** make (8)
...
>
> **[5:38](https://www.linkedin.com/learning/object-oriented-programming-with-c-sharp-17331514/creating-a-chest?u=76281980&t=338)** Two, we'll set the ChestFound property equal to a string that says "You found". and we'll use a token to list all the items inside of the Chest. Now back in our Chest class, we can pass in the list of items. In order to do this, we're going to need to use the string format on the ChestFound string and pass in a joined [word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) list of items using And.
>
...
>
> **[2:26](https://www.linkedin.com/learning/object-oriented-programming-with-c-sharp-17331514/creating-a-key-and-gold?u=76281980&t=146)** After you've created the name space and the public class, Gold, that extends item, let's go into the language and add three strings we'll need to make the gold work. Now let's go ahead and add the values for these properties to our English class. For gold, we'll create a template that has two [Tokens](../../Skills/Web%20Development/Tokens.md) with the [word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) gold in the middle. The first token will be the number of gold and the second token will be coin or coins based on whether the value is greater than one. Now we can go back to our gold class. Next, let's add a constructor for our class,
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) (3), [Tokens](../../Skills/Web%20Development/Tokens.md) (2)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/object-oriented-programming-with-c-sharp-17331514/continuing-with-c-sharp?u=76281980&t=0)** - [Jesse] At this point, you should have practical knowledge of how [object-oriented programming](../../Skills/Software%20Development/Object-Oriented%20Programming%20(OOP).md) works in C#. We've created classes, we've extended them and we've even abstracted them out by decoupling our code and using interfaces for composition. While the game is very basic in its current form, hopefully you have a better sense of the [Design Patterns](../../Skills/Software%20Development/Design%20Patterns.md) we have used to add new items and actions to the game. It should be easy to extend any of our base classes and customize the game in order to finish it. If you'd like to learn more about .NET, C# or object-oriented programming, I suggest checking out my other course on C# [Framework Design](../../Skills/Software%20Development/Framework%20Design.md). Thanks for watching the course and I hope to see you next time.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Object-oriented programming](../../Skills/Software%20Development/Object-Oriented%20Programming%20(OOP).md) (2), [Design Patterns](../../Skills/Software%20Development/Design%20Patterns.md) (1), [Framework Design](../../Skills/Software%20Development/Framework%20Design.md) (1)
> **Env Vars:** net (1)
> **Speakers:** - [jesse] (1)
...
**1 of 8** | [C- Delegates, Events, and Lambdas](../Software%20Development/C-%20Delegates%2C%20Events%2C%20and%20Lambdas.md) →
...
- [Java Object-Oriented Programming](../Data%20Science/Java%20Object-Oriented%20Programming.md) — Object-Oriented Programming (OOP)
...
- [Python Object-Oriented Programming](../Software%20Development/Python%20Object-Oriented%20Programming.md) — Object-Oriented Programming (OOP)
- [Python Practice- Object-Oriented Programming](../Software%20Development/Python%20Practice-%20Object-Oriented%20Programming.md) — Object-Oriented Programming (OOP)
