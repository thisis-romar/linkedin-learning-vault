...
> [!transcript]- Transcript
>
> **[0:01](https://www.linkedin.com/learning/learning-docker-compose/where-to-use-docker-compose?u=76281980&t=1)** - [Instructor] Docker [Compose](../../Glossary/Framework/Jetpack%20Compose.md) was designed as a tool for a single hosted server. It's well suited for local development, a staging server, or a [continuous integration](../../Skills/Software%20Development/Continuous%20Integration%20(CI).md) testing environment. It's not designed for distributed systems and has no tooling for running containers across multiple hosts. In a software system with any significant amount of user traffic, such as a production environment, Docker Compose is not the ideal tool. This is because it does not have support for independently scaling services or any kind of auto scaling. To show you what I mean, throughout this course, I'll use the case study KinetEco, a clean energy business. KinetEco has two primary online applications, a storefront for selling things like solar panels and inverters, and a scheduler for professional equipment installation. Let's say the online storefront is expecting a significant but temporary increase in web traffic due to a promotional sale. The only way to scale up to multiple instances of the storefront is to run the Docker Compose figuration on multiple hosts. This will also scale up the scheduler at the same time. That's a waste of resources, since the scheduler is not seeing any additional traffic. While you can use Docker Compose in production, it is designed specifically for non-production environments only. A dedicated orchestration tool, like Docker Swarm or [Kubernetes](../../Skills/DevOps/Kubernetes.md), are designed to solve these problems in production environments, they're much better suited to the task than Docker Compose.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Compose](../../Glossary/Framework/Jetpack%20Compose.md) (5), [Continuous integration](../../Skills/Software%20Development/Continuous%20Integration%20(CI).md) (1), [Kubernetes](../../Skills/DevOps/Kubernetes.md) (1)
> **CLI Commands:** docker (6)
> **Analogies:** such as (1)
> **Speakers:** - [instructor] (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Compose](../../Glossary/Framework/Jetpack%20Compose.md) (20), [MySQL](../../Skills/Software%20Development/MySQL.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Compose](../../Glossary/Framework/Jetpack%20Compose.md) (4), [MySQL](../../Skills/Software%20Development/MySQL.md) (3)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [SQL](../../Skills/Data%20Science/SQL.md) (8), [Compose](../../Glossary/Framework/Jetpack%20Compose.md) (5)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Compose](../../Glossary/Framework/Jetpack%20Compose.md) (8), [MySQL](../../Skills/Software%20Development/MySQL.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Compose](../../Glossary/Framework/Jetpack%20Compose.md) (4), [Metadata](../../Skills/Web%20Development/Metadata.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Compose](../../Glossary/Framework/Jetpack%20Compose.md) (8), [Integration Testing](../../Skills/Software%20Development/Integration%20Testing.md) (1), [Microservices](../../Skills/Software%20Development/Microservices.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Compose](../../Glossary/Framework/Jetpack%20Compose.md) (10)
> **CLI Commands:** docker (10)
...
> [!transcript]- Transcript
>
> **[0:01](https://www.linkedin.com/learning/learning-docker-compose/next-steps?u=76281980&t=1)** - [Nicole] Thanks for watching my course. I hope you find ways to leverage Docker [Compose](../../Glossary/Framework/Jetpack%20Compose.md) within your organization to make local developments simpler and developers more efficient. The Docker Docs have a dedicated section on Compose that details all of the features I've covered and more. It will be an incredibly useful reference when you go to implement Docker Compose in your own system. Finally, if you liked this course and want to hear more about what I'm working on, you can follow me on [LinkedIn](../../Skills/Web%20Development/LinkedIn.md).

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Compose](../../Glossary/Framework/Jetpack%20Compose.md) (3), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (1)
...
- [Nicole Rifkin](../../Instructors/DevOps/Nicole%20Rifkin.md)
...
← [Docker- Your First Project](Docker-%20Your%20First%20Project.md) | **3 of 3**
