...
prev_courses:
  - '[C- Interfaces and Generics](C-%20Interfaces%20and%20Generics.md)'
next_courses:
  - '[C- Design Patterns Part 2](C-%20Design%20Patterns%20Part%202.md)'
...
>
> **[0:00](https://www.linkedin.com/learning/c-sharp-design-patterns-part-1-14140825/object-oriented-design-patterns-in-c-sharp?u=76281980&t=0)** - [Instructor] [Software Design Patterns](../../Skills/Software%20Development/Software%20Design%20Patterns.md) are a major key to taking your [Software Development](../../Topics/Software%20Development.md) to the next level. I'm Rich Goforth, a senior software architect and consultant designing and developing web, mobile, and server side applications with and without dot net for approximately 13.73 years at the time of this recording. In this course, we're going to talk about why [Design Patterns](../../Skills/Software%20Development/Design%20Patterns.md) sense, what they are, and how they came to be so important. Then we'll cover an overview of all the patterns from the gang of four and how they are applied in C sharp and dot net. We will deeply discuss the iterator factory method and adapter patterns. We'll apply each pattern once, in a simple standalone scenario and again in the context of a larger enterprise like MVC web app to get multiple realistic views of the pattern inaction. This isn't just about learning specific design patterns, but learning how to learn and apply design patterns in your applications of any type. Join me on my [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) learning course through the ins and outs of design patterns in C sharp.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Design Patterns](../../Skills/Software%20Development/Design%20Patterns.md) (4), [Software Design Patterns](../../Skills/Software%20Development/Software%20Design%20Patterns.md) (1), [Software Development](../../Topics/Software%20Development.md) (1), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (1)
> **Env Vars:** mvc (1)
> **Versions:** 13.73 (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Design Patterns](../../Skills/Software%20Development/Design%20Patterns.md) (5), [Software Design](../../Skills/Software%20Development/Software%20Design.md) (2)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/c-sharp-design-patterns-part-1-14140825/using-the-exercise-files-and-installing-dot-net-sdk?u=76281980&t=0)** - [Instructor] I'm going to be using .NET Core with VS Code in this course to illustrate the use of [Design Patterns](../../Skills/Software%20Development/Design%20Patterns.md) in C Sharp. If you want to follow along the most closely, install VS Code from here. You can also use the [Windows](../../Glossary/Service/Windows.md) or Mac version of Visual Studio if you prefer. If you don't have the .NET Core 3.1 SDK, get that installed from here. We've created a [GitHub](../../Skills/Software%20Development/GitHub.md) repository for you to access the course materials. You can use [Git](../../Skills/Software%20Development/Git.md) to clone the repo or download the repo as a ZIP file. You can drop down here to select a branch. There are branches for each video. The branches ending in B correspond to the beginning state of that video. All those ending in E represent the end state for that video. During this course, I've placed the repo folder in my Home directory for simplicity, but you can place the course files wherever you like.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Design Patterns](../../Skills/Software%20Development/Design%20Patterns.md) (1), [Windows](../../Glossary/Service/Windows.md) (1), [GitHub](../../Skills/Software%20Development/GitHub.md) (1), [Git](../../Skills/Software%20Development/Git.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [JavaScript](../../Skills/Software%20Development/JavaScript.md) (2), [Design Patterns](../../Skills/Software%20Development/Design%20Patterns.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Design Patterns](../../Skills/Software%20Development/Design%20Patterns.md) (5), [Functional Programming](../../Skills/Software%20Development/Functional%20Programming.md) (3)
> **Env Vars:** oop (4)
> **CLI Commands:** make (2)
> **Definitions:** is a  (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Design Patterns](../../Skills/Software%20Development/Design%20Patterns.md) (11), [Software Design](../../Skills/Software%20Development/Software%20Design.md) (1)
> **Definitions:** is a  (3)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Design Patterns](../../Skills/Software%20Development/Design%20Patterns.md) (6), [Software Design Patterns](../../Skills/Software%20Development/Software%20Design%20Patterns.md) (3), [Software Design](../../Skills/Software%20Development/Software%20Design.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Design Patterns](../../Skills/Software%20Development/Design%20Patterns.md) (4), [Open-Source Software](../../Skills/Cybersecurity/Open-Source%20Software.md) (1), [GitHub](../../Skills/Software%20Development/GitHub.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Design Patterns](../../Skills/Software%20Development/Design%20Patterns.md) (4), [NoSQL](../../Skills/Software%20Development/NoSQL.md) (1)
> **CLI Commands:** find (1), make (1)
...
>
> **[4:43](https://www.linkedin.com/learning/c-sharp-design-patterns-part-1-14140825/overview-of-the-creational-patterns-for-c-sharp?u=76281980&t=283)** from instance to instance. In .NET, the concrete header types in [System.Net](https://System.Net).Http.Headers use the prototype pattern to allow for header sets to be easily created from an existing set, but separate objects for each call. The last creational pattern is the singleton. It's probably one of the most used, as well as one of the most dangerous of the gang of four patterns. Instead of any number of instances of an object, there is only one instance. This allows for global variables in application lifetime states. However, things like concurrent access and a lack of clarity when items in a singleton are being modified can create unstable and bug-prone applications. Singletons can be used with other patterns for things like regulating access to limited resources, managing things like database connection pools. You can create singletons from a [Dependency Injection](../../Skills/Web%20Development/Dependency%20Injection.md) framework, but the service provider itself is a singleton. All these patterns are focused on the creation and lifetime of object.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Design Patterns](../../Skills/Software%20Development/Design%20Patterns.md) (2), [Products](../../Skills/Software%20Development/Microsoft%20Products.md) (1), [Dependency Injection](../../Skills/Web%20Development/Dependency%20Injection.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Compose](../../Glossary/Framework/Jetpack%20Compose.md) (1), [ASP.NET Core](../../Skills/Web%20Development/ASP.NET%20Core.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Linq](../../Skills/Software%20Development/Language%20Integrated%20Query%20(LINQ).md) (2), [Design Patterns](../../Skills/Software%20Development/Design%20Patterns.md) (2), [Algorithms](../../Skills/Software%20Development/Algorithms.md) (2), [ASP.NET Core](../../Skills/Web%20Development/ASP.NET%20Core.md) (1), [Routing](../../Skills/Network%20and%20System%20Administration/Routing.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** cursor (1), [Software Design](../../Skills/Software%20Development/Software%20Design.md) (1)
> **CLI Commands:** make (2)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/c-sharp-design-patterns-part-1-14140825/factory-method-pattern-definition?u=76281980&t=0)** - A factory, the place where a specific type of object is produced, the definition may seem obvious, but the clarity of the term that the pattern is named after is an important part of using [Design Patterns](../../Skills/Software%20Development/Design%20Patterns.md). A factory method is constructing a concrete object of any type, that implements a specified interface from a method in another concrete type. This allows the use of an object without knowing the details of what it is, just knowing what it does. It goes on to decouple, a consumer of an interface from the implementation of that interface. This allows, the use of an object without knowing the details of what it is, just knowing what it does. It decouples a consumer of an interface from the implementation of that interface. It also makes it possible to defer the creation of that object so that the type of returned object can depend on the running applications context. The factory method is another one of the most commonly used design patterns, due to its significant value in a wide array of situations. It can also be known as VirtualConstructor rather than just using the normal constructor for an object. You're creating another version of it somewhere else that performs the same task, but has different information. Here is a simplified diagram for the factory method pattern.
>
...
>
> **[3:13](https://www.linkedin.com/learning/c-sharp-design-patterns-part-1-14140825/factory-method-pattern-definition?u=76281980&t=193)** without a type, but we can also return the generically typed Enumerable that gives the consumer code type checking based on the type we requested the enumerator for. All these things come together to allow for [Dependency Injection](../../Skills/Web%20Development/Dependency%20Injection.md). The service provider is a singleton that has factory methods to return the types we request when constructing a class. Specifically in dot net core, we can use the built-in dependency injection classes. DI enables inversion of control. One of the solid design principles. It provides things like better [Unit Testing](../../Skills/Software%20Development/Unit%20Testing.md) and can reduce the number of changes required when code that is depended on changes. There are some choices and some flexibility in how you implement the factory method pattern. First, the creator can be abstract or concrete. If it's abstract, it must be some class to be instantiated, but the consumer only needs to know about the abstract type and not the concrete type. You can also make choices on the kinds of parameters that are provided to the factory method, the return type can depend on these parameters. And like we just saw, the generic type in the factory method in IEnumerable allows us to return specific types
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Design Patterns](../../Skills/Software%20Development/Design%20Patterns.md) (2), [Dependency Injection](../../Skills/Web%20Development/Dependency%20Injection.md) (2), [Unit Testing](../../Skills/Software%20Development/Unit%20Testing.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Dependency Injection](../../Skills/Web%20Development/Dependency%20Injection.md) (5), [Microsoft](../../Instructors/Artificial%20Intelligence%20(AI)/Microsoft.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Microsoft](../../Instructors/Artificial%20Intelligence%20(AI)/Microsoft.md) (5)
> **Definitions:** is a  (2), is an  (1)
> **Tools:** terminal (2)
...
>
> **[3:11](https://www.linkedin.com/learning/c-sharp-design-patterns-part-1-14140825/solution-class-adapter-vs-object-adapter?u=76281980&t=191)** and even whether an adapter pattern is the best choice for view model mapping. Thinking about [Software Architecture](../../Skills/Web%20Development/Software%20Architecture.md) in this way and creating a POC to illustrate it is a great way to find out what will and won't work as you expand your application.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Software Architecture](../../Skills/Web%20Development/Software%20Architecture.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/c-sharp-design-patterns-part-1-14140825/next-steps?u=76281980&t=0)** - [Richard] Congratulations, you've made it to the end. I understand that you may have been promised cake. Please see your manager in that regard. In this course we learn what [Design Patterns](../../Skills/Software%20Development/Design%20Patterns.md) are, how they're used in C#, why they're useful and how we can use them in C# to make our architectures better. But where should you go from here? Consider reading the original "Gang of Four Patterns" book to get really deep details. The examples in C++ may not be the easiest to read and some of the issues mentioned are not the problem that they used to be due to improvements in language design, but overall, the book has held up amazingly well over the years, which is one of the reasons this course even exists. Another great read on design patterns can be found here by Martin Fowler. He talks about what a pattern is and some of the [Forms](../../Skills/Web%20Development/Forms.md) of patterns in a lot of detail. Another book I recommend is his "Patterns of Enterprise Application Architecture" which can be found here. Next, consider keeping up with the changes to the C# language and look at the .net source code, which can be found here. You can investigate the code to see how patterns are being used throughout .net and C#. To get a different view of applying patterns with a larger focus on architecture,
>
...
← [C- Interfaces and Generics](C-%20Interfaces%20and%20Generics.md) | **7 of 9** | [C- Design Patterns Part 2](C-%20Design%20Patterns%20Part%202.md) →
...
- [C- Design Patterns Part 2](C-%20Design%20Patterns%20Part%202.md) — C#, Software Design Patterns
