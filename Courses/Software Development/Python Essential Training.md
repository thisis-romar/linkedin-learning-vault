...
>
> **[0:02](https://www.linkedin.com/learning/python-essential-training-18764650/getting-started-with-python?u=76281980&t=2)** - Oh, hello. I didn't see you come in. I hear you're looking to learn [[Python (Programming Language)|Python]]. Well, you are in for a real treat. Now, sometimes introductory means oversimplified, but that's not the case with Python or this course. So if you're serious about learning Python but don't know where to start, congratulations. You've found the right place. Hi, I'm Ryan Mitchell. I've been writing Python for over a decade and I'll be your guide every step of the way to show you what's going on behind the scenes. You'll learn about data types and [[Control Flow]], classes, and [[Object-Oriented Programming (OOP)|object-oriented programming]], parallel computing modules, packages, and everything else you need to get coding. Yes, this is a crash course in Python and computer science but I won't let you crash and burn. Come on, let's get learning.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/python-essential-training-18764650/variables-and-scope?u=76281980&t=0)** - Welcome class. Today we're covering global and local variable scope interaction in [[Python (Programming Language)|Python]].
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/python-essential-training-18764650/inheritance?u=76281980&t=0)** - My child, one day, all of this will be yours. Your inheritance. (ethereal music) So you see, in computer science and in [[Python (Programming Language)|Python]], a class can extend another class. The original class is called the parent class, and the class extending it is the child class. And the child class inherits all of the parent classes' methods and attributes. But this inheritance happens automatically when the child class is created. Let's go to the code. - Yeah.
>
