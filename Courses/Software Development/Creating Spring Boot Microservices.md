...
prev_courses:
  - '[Learning Spring 6 With Spring Boot](Learning%20Spring%206%20With%20Spring%20Boot.md)'
next_courses:
  - '[Spring Data 2](Spring%20Data%202.md)'
...
>
> **[0:00](https://www.linkedin.com/learning/creating-spring-boot-microservices/build-a-restful-spring-boot-microservices?u=76281980&t=0)** - Would you like to venture into the world of [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) [Microservices](../../Skills/Software%20Development/Microservices.md), but don't know where to start? Boiling down the vast number of spring projects can be truly daunting, but it's easier than you think. Together we will build Spring Boot Microservices by leveraging [Spring Data](../../Skills/Web%20Development/Spring%20Data.md) and spring web modules. Then we'll create a Spring Cloud API gateway with [Spring Security](../../Skills/Web%20Development/Spring%20Security.md). And finally, we'll deploy them as Dockerized containers. Now every solution needs a problem and every problem has a stakeholder. Our stakeholder is an imaginary tour operator, called Explore California. They need a new backend with restful APIs to expose their library of tours. Hi, I'm Mary Ellen Bowman. I'm a senior [Java](../../Skills/Software%20Development/Java.md) developer, and I will take you through this learning journey. We've got plenty to do, so let's get to work.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) (2), [Microservices](../../Skills/Software%20Development/Microservices.md) (2), [Spring Data](../../Skills/Web%20Development/Spring%20Data.md) (1), [Spring Security](../../Skills/Web%20Development/Spring%20Security.md) (1), [Java](../../Skills/Software%20Development/Java.md) (1)
> **Env Vars:** api (1)
> **Definitions:** is an  (1)
> **Speakers:** - would (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/creating-spring-boot-microservices/what-you-should-know?u=76281980&t=0)** - Our work on this course is going to model a real-world project. I am the architect and you will shadow me as a [Java](../../Skills/Software%20Development/Java.md) developer. Our company has been tasked to reengineer a website for our customer, Explore California. You and I will create the backend services. I will guide you through the process and give you challenges along the way. I've already met with the business analyst. We are going to create several [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) [Microservices](../../Skills/Software%20Development/Microservices.md). It's okay if you have not had any Spring experience. We'll walk through the basics of Spring [Dependency Injection](../../Skills/Web%20Development/Dependency%20Injection.md), then start creating Spring Boot microservices with [Spring Data](../../Skills/Web%20Development/Spring%20Data.md), MVC, Spring Cloud Gateway, and [Spring Security](../../Skills/Web%20Development/Spring%20Security.md). Don't worry, we are not going to get hung up on the details of every module. We are focused on delivery here. You can then parlay this experience into your next Spring Boot project. Let's get to work.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) (3), [Microservices](../../Skills/Software%20Development/Microservices.md) (2), [Java](../../Skills/Software%20Development/Java.md) (1), [Dependency Injection](../../Skills/Web%20Development/Dependency%20Injection.md) (1), [Spring Data](../../Skills/Web%20Development/Spring%20Data.md) (1)
> **Env Vars:** mvc (1)
> **Speakers:** - our (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Java](../../Skills/Software%20Development/Java.md) (6), [Dependency Injection](../../Skills/Web%20Development/Dependency%20Injection.md) (5), [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) (2), [Microservices](../../Skills/Software%20Development/Microservices.md) (2), [Spring Framework](../../Skills/Software%20Development/Spring%20Framework.md) (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Spring Framework](../../Skills/Software%20Development/Spring%20Framework.md) (2), [Dependency Injection](../../Skills/Web%20Development/Dependency%20Injection.md) (1), [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) (1)
...
> [!transcript]- Transcript
>
> **[0:05](https://www.linkedin.com/learning/creating-spring-boot-microservices/challenge?u=76281980&t=5)** - [Instructor] Okay, I have a challenge. It's your turn. Let's see if you can do this, and I'm sure you can. So I want you to invoke the TourManagementService.createTour within the application [Java](../../Skills/Software%20Development/Java.md) class. So pull the tour management service object out of the container, create a new tour, and have the tour called Zoo Tour with the price 100 and the kid friendly is true. And here in the branch, 01_04, is where you would do it and it's right after this, pulling the bean of Travel Agent Service. Let's see if you can get the Tour Management Service off of the context and then create the zoo tour.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/creating-spring-boot-microservices/introduction-to-spring-initializer?u=76281980&t=0)** - [Instructor] In this chapter, we will see how to create a [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) microservice with Spring Initializr. To build a [Java](../../Skills/Software%20Development/Java.md) application, the first step is to create a Java project. Most Java projects rely on third-party dependencies, and these dependencies usually have dependencies of their own. On top of that, each version of the dependency rely on other versions. To avoid JAR hell, we use [Dependency Management](../../Skills/Software%20Development/Dependency%20Management.md) systems like Maven or [Gradle](../../Glossary/Tool/Gradle.md), but even Maven and Gradle have versioning issues between individual JARs that can be a nuisance. Spring Boot recognizes this and creates the notion of a Spring Boot starter which bundles several dependencies into a grouping that's easier to manage. On top of that, starters make automatic configuration decisions at runtime following convention over configuration. There are a lot, and I mean a lot, of Spring Boot starter dependencies, so even cobbling together a project of your own can be difficult. This is where Spring Initializr comes to the rescue. Spring Initializr is a tool for creating Spring Boot Java projects. Initializr creates a package structure, the pom.xml for Maven or build.gradle for Gradle files, and any required Java source classes. For our first Spring Boot microservice, we will employ five Spring Boot starters.
>
> **[1:35](https://www.linkedin.com/learning/creating-spring-boot-microservices/introduction-to-spring-initializer?u=76281980&t=95)** Web, which includes Tomcat and Spring MVC, [REST](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) Repositories to expose [Spring Data](../../Skills/Web%20Development/Spring%20Data.md) repositories over REST, Spring Data JPA to form our object to relational mapping, Lombok, which is a handy library to generate our getters and setters and loggers, and H2, an in-memory database driver. We will start coding our first Spring Boot application with H2 and then later move on to a real persistent relational database. After answering all of the questions in Spring Initializr and selecting the desired dependencies, it generates the project for us.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) (8), [Java](../../Skills/Software%20Development/Java.md) (5), [Gradle](../../Glossary/Tool/Gradle.md) (4), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (2), [Spring Data](../../Skills/Web%20Development/Spring%20Data.md) (2)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/creating-spring-boot-microservices/project-setup?u=76281980&t=0)** - [Instructor] So now we're actually going to use Spring Initializr to create our project. I'm on branch O2_O2b, and I just wanted to tell you that I have removed all of the tour service projects that we worked on the last chapter. We're not going to need that anymore. So we're going to navigate to the Spring Initializr, start.[spring.io](https://spring.io). And here's the Spring Initializr UI. The language we'll select is [Java](../../Skills/Software%20Development/Java.md). [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) version is 3.2.5. And we're going to use Maven. Our group is going to stay, com.example. Our artifact ID is going to be explorecali-jpa,
>
...
>
> **[1:36](https://www.linkedin.com/learning/creating-spring-boot-microservices/build-deploy-and-launch-the-microservice?u=76281980&t=96)** of this localhost 8080 is a [JSON](../../Skills/Web%20Development/JSON.md) message. And don't worry about the meaning of this message. It's basically saying, "I'm alive." If there was any problem, we would see a response from, like a message says, site can't be reached, or something like that. I'm going back to the terminal where I started this. I'm just going to hit control C to stop that. And then this is the beauty of a microservice. It's completely self-contained with a runnable single command, and this makes it a favorite of the [DevOps](../../Topics/DevOps.md) and [Cloud Computing](../../Topics/Cloud%20Computing.md) crowds. Without implementing any explore cali solutions, we could see that the [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) project is already equipped with the basic plumbing required by most web applications.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [JSON](../../Skills/Web%20Development/JSON.md) (1), [DevOps](../../Topics/DevOps.md) (1), [Cloud Computing](../../Topics/Cloud%20Computing.md) (1), [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/creating-spring-boot-microservices/challenge-add-actuator-dependency?u=76281980&t=0)** - [Instructor] It's time for a challenge. So we're in branch 02_04 and we want to add another dependency and it's called Actuator. So how you would start to do this is go into Spring Initializr and within, now let me get back here, so within the "add dependencies," I will spell it out for you and actually is written right there, Actuator, as a suggestion. [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) Actuator. So, I want you to select that. Go to the explore in the pom.xml within the website, find the actuator dependency that it's added, and then come back and paste it into the pom.xml within one of these dependencies, within the dependency tag. Once you do that, then we'll run the application and we'll see what Actuator does for us.
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Spring Data](../../Skills/Web%20Development/Spring%20Data.md) (3)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/creating-spring-boot-microservices/invoking-the-repositories?u=76281980&t=0)** - [Instructor] Now let's invoke the repositories by launching the application. So we are in the application main class and we need to load the database with the collection of predefined tours and tour packages. The Explore California Travel Agency provided us with a .[JSON](../../Skills/Web%20Development/JSON.md) file that represents all the possible tours and it's in the main explorer of ExploreCalifornia. There it is right there. Some of the fields map directly to the fields in our tour entity like title, description, and blurb. However some fields like price, tour package, difficulty, region, those all require conversion and in ExplorecaliApplication, that's where we're going to do that. Our Explorecali web application uses an in-memory database called H2. [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) connects to H2 with the default when the dependency is provided. We need to load the data each time the application starts. So now we have services to create the tours and tour packages, but how should we invoke them before accepting web requests? Remember this ExplorecaliApplication class? In that class is the main method, the application starting point. Right there. I've already made some changes to this class. I use the @Autowired annotation to inject the tour service and tour package service Spring beans
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (5), [Spring Data](../../Skills/Web%20Development/Spring%20Data.md) (4), [JSON](../../Skills/Web%20Development/JSON.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) (2), [Codespaces](../../Skills/Software%20Development/Codespaces.md) (2), [Java](../../Skills/Software%20Development/Java.md) (1), [GitHub](../../Skills/Software%20Development/GitHub.md) (1), [HTML](../../Skills/Web%20Development/HTML.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/creating-spring-boot-microservices/challenge-modify-url-repository-keyword?u=76281980&t=0)** - [Instructor] So, I have another challenge for you. As we can see, the tourPackages endpoint, I would like to rename it from tour and then uppercase P packages to just the [word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) packages. So I'd like to challenge you to see if you could do that, and here's a previous slide from another video and words of example of how we change the endpoint of StaffRepo from "staffs" to "staff." So, see if you can make the code change, start up the application and verify it by going to the Swagger page.
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (3), [Spring Data](../../Skills/Web%20Development/Spring%20Data.md) (2), [Java](../../Skills/Software%20Development/Java.md) (1), [JSON](../../Skills/Web%20Development/JSON.md) (1)
...
>
> **[1:36](https://www.linkedin.com/learning/creating-spring-boot-microservices/declaring-a-new-restcontroller?u=76281980&t=96)** has been successfully created in the database, and I expect the API to return a 400 when a request body is not valid. I got a jumpstart on the code for these use cases. Let me show you my approach. I started looking at the nouns of the use cases, and obviously a big one that jumped out to me was tour rating. And so I have an entity tour rating that will map to a tour_rating database table. And I have a generated identifier that's of type integer. I saw that a tour rating would be associated with a particular tour, so I have a many to one annotation saying that a tour could have many tour ratings. There's a customer identifier that's an integer, a score, and a comment. Next, I have a tour rating repository in the repo folder. I do not want this repository to be exposed to [Spring Data](../../Skills/Web%20Development/Spring%20Data.md) [rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md), so I set exported equals false in the repository rest resource annotation. And then I have two methods for the tour rating repository. Find by tour ID, and that will return a list of tour ratings, and find by tour ID and customer ID, and that would return one unique tour rating if it is found. Next, I have tour rating service, whereas the business logic interacting
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (3), [Spring Data](../../Skills/Web%20Development/Spring%20Data.md) (1)
> **CLI Commands:** find (6)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (4), [Java](../../Skills/Software%20Development/Java.md) (2), [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) (2), [Spring Framework](../../Skills/Software%20Development/Spring%20Framework.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Spring Data](../../Skills/Web%20Development/Spring%20Data.md) (2), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Java](../../Skills/Software%20Development/Java.md) (2), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1), [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) (1), [GitHub](../../Skills/Software%20Development/GitHub.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [JUnit](../../Skills/Software%20Development/JUnit.md) (4), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (4), [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) (4), [Fetch](../../Skills/Web%20Development/Fetch.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/creating-spring-boot-microservices/why-docker?u=76281980&t=0)** - [Instructor] Enough of this in-memory demo database stuff. Let's use a true data store that persists data after the application ends. Our Explore Cali JPA [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) Microservice uses an H2 database as our data store, and it's good for demos or setting up a test bench, but that's not how applications are in the real world. You may be thinking, "Ugh, great. To follow along on my local machine, I need to download, install, and configure my [SQL](../../Skills/Data%20Science/SQL.md), which will clutter my PC." I could have taken this approach, but I thought I would instead incorporate a product that's a standard in [Software Development](../../Topics/Software%20Development.md) for [continuous integration](../../Skills/Software%20Development/Continuous%20Integration%20(CI).md) and delivery, and that's Docker. Docker is used to build, deploy, and run containers for software applications, and it's simply an application delivery technology. In order to follow along with this course, you do need to install Docker locally. if you are not running [Codespaces](../../Skills/Software%20Development/Codespaces.md). A simple web search of install Docker will provide all the help you need. However, our Codespace instance already has Docker installed. I assume that you are a [Java](../../Skills/Software%20Development/Java.md) developer. The goal of Java is to write once, run anywhere. You don't need to take a Java source code written on a Mac and recompile it to run on a PC. You take bytecode. It could be in the form of .class files, JAR files, WAR files, or even EAR files. But as long as the Java virtual machine is installed,
>
> **[1:34](https://www.linkedin.com/learning/creating-spring-boot-microservices/why-docker?u=76281980&t=94)** the application will run. But applications aren't normally standalone. Infrastructure, such as [Databases](../../Skills/Software%20Development/Databases.md), messaging technology, platform-specific configurations, standalone UI deployments that include node must all play together nicely before an application is truly usable. Docker is used to manage all the interdependencies of the infrastructure and gather them into one or more images, similar to a Java JAR file. And then the Docker Engine is a platform on which the image is run. A running image is known as a container. Let's make another analogy to Java. Just like a Java class file is only a declaration, it is at the runtime that one or more instances of a class become Java objects. Likewise, an image is a collection of files. Containers are running instances of an image.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Java](../../Skills/Software%20Development/Java.md) (8), [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) (1), [SQL](../../Skills/Data%20Science/SQL.md) (1), [Software Development](../../Topics/Software%20Development.md) (1), [Continuous integration](../../Skills/Software%20Development/Continuous%20Integration%20(CI).md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/creating-spring-boot-microservices/spring-boot-docker-compose?u=76281980&t=0)** - [Instructor] Docker Hub is an online repository of dockerized third party images similar to Maven Central, which is the repository of Maven dependencies. You can even create your own Docker Hub account to store your own images. I'm going to search for [MySQL](../../Skills/Software%20Development/MySQL.md). In this video, we will switch from the H2 to the MySQL database by downloading the MySQL docker image from Docker Hub. But first we need to orchestrate the interaction between the Explore Cali JP application and MySQL. Running related containers is called orchestration and this can be done manually with the Docker command line interface or through automated tools such as Docker [Compose](../../Glossary/Framework/Jetpack%20Compose.md), Docker Swarm and [Kubernetes](../../Skills/DevOps/Kubernetes.md). For local development, Docker Compose is a good choice over manual [CLI](../../Skills/Network%20and%20System%20Administration/CLI.md). Docker Compose requires a Y-A-M-L, or YAML file that defines the desired deployment relationships. The command docker-compose up begins the orchestration. Detached mode runs it in the background. Docker-compose down tears down everything. Hitting Control + C does the same thing when it's not running in the background. And isn't it just like [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) to have a tool to make this easier? The tool is Spring Boot Docker Compose. All we do is go to start.[spring.io](https://spring.io),
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/creating-spring-boot-microservices/use-cases-for-a-image-microservice?u=76281980&t=0)** - So Explore California requires an image server. We have three use cases. The first use case is, as a company photographer, I would like to upload photos to a server. The second is, as a front end developer, I would like to see a list of all images. I would like to get a list of images by file name and the unique identifier. And the third use case is to [Fetch](../../Skills/Web%20Development/Fetch.md) an image by ID. As a front end developer, I would like our website to download photos by referencing the unique ID. Let's get back to the code and design for these use cases.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/creating-spring-boot-microservices/challenge-create-the-spring-boot-mongodb-project?u=76281980&t=0)** - [Instructor] So even though I already have a design for this solution, I'd like you to set up the project. I'd like you to navigate to start.[spring.io](https://spring.io) in Spring Initializr, and the following settings, which should be used. Make sure it's a Maven project using [Java](../../Skills/Software%20Development/Java.md) 21, the name of the project should be explorecali-images, the [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) version should be the latest non-M3 version or snapshot, the package name should be com.example.explorecaliimages, without any hyphens. So the required dependencies you should add are Spring Web, [Spring Data](../../Skills/Web%20Development/Spring%20Data.md) [MongoDB](../../Skills/Software%20Development/MongoDB.md), the nonreactive one, Spring Boot Actuator, Lombok, and Docker [Compose](../../Glossary/Framework/Jetpack%20Compose.md) Support, and then change the default version in the POM, once it's downloaded, to 3.0.0. And then, I would like you to grab the OpenAPI dependency for the Swagger UI from our explorecali-jpa pom.xml.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) (2), [Java](../../Skills/Software%20Development/Java.md) (1), [Spring Data](../../Skills/Web%20Development/Spring%20Data.md) (1), [MongoDB](../../Skills/Software%20Development/MongoDB.md) (1), [Compose](../../Glossary/Framework/Jetpack%20Compose.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/creating-spring-boot-microservices/solution-create-the-spring-boot-mongodb-project?u=76281980&t=0)** - [Narrator] Were you able to figure it out? In the Branch > 08_03 that I have here, I have the results of how I did it myself. And so I have a explorecali-images folder, which is a sibling to explorecali-jpa. And here's the POM.xml with the name and the version>21. There's actuator, [MongoDB](../../Skills/Software%20Development/MongoDB.md), web, docker-[compose](../../Glossary/Framework/Jetpack%20Compose.md), lombok, our openapi, and then starter-test always comes along. There's the maven-plugin and then it also generated the ExplorecaliImagesApplication class. And finally it also generated this compose.yaml file. And these are settings specifically for mongodb. So now that we have all that in place, we should be able to run, compile and run everything and see that Docker Compose kicks in to connect to a real MongoDB image. So that will build it, and then spring-boot:run. We'll start off the Docker Compose and launch the application. See the Docker [CLI](../../Skills/Network%20and%20System%20Administration/CLI.md) is starting and Tomcat has started up.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/creating-spring-boot-microservices/spring-data-mongodb-documents-and-repositories?u=76281980&t=0)** - [Instructor] Now we're going to create our [MongoDB](../../Skills/Software%20Development/MongoDB.md) repositories. So I'm going to create a new folder called repo and a new file called image repository dot [Java](../../Skills/Software%20Development/Java.md).
>
> **[0:22](https://www.linkedin.com/learning/creating-spring-boot-microservices/spring-data-mongodb-documents-and-repositories?u=76281980&t=22)** And this will be an interface. So here's where we apply the [Spring Data](../../Skills/Web%20Development/Spring%20Data.md) MongoDB. This will extend from Mongo repository. And our two options are image, and then the type of the ID is string. Import the image. Did we import the right image? Didn't work. Let's try it again. Import image from model. Very good. Now I'm going to do a source action here so we can see what methods come from spring data MongoDB. We have the find all, the insert, the delete, the save, more find all and more counts by this, using query by example. That's what those examples there are. And finding one by query by example. So those are just some of the default methods we get. And so let's inject, remove that constructor,
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/creating-spring-boot-microservices/use-cases-for-an-api-gateway-microservice?u=76281980&t=0)** - [Instructor] So this is just our first iteration with this customer of security. I think as it goes on, we'll maybe have some more strict authorization, but for now, all that we need to do is pass in a secured way, that token to the people that have to have authorization to add packages and add tours and delete them, modify them, as well as uploading images. Use case one is to protect our tour data. As a tour publisher, I should have the ability to create, update, or delete tours, tour packages, or ratings in the [MySQL](../../Skills/Software%20Development/MySQL.md) database. Use case two, protect images. As a tour publisher, I only should have the ability to upload images to the [MongoDB](../../Skills/Software%20Development/MongoDB.md) database. Use case three, permit fetching tour data. As a front end developer, I should be able to freely reference tours, tour packages and ratings stored in the MySQL database for presentation on the Explore California website. Use case four, permit fetching images. As a front end developer, I should be able to freely download images saved to the Mongo database for presentation on the Explore California website. And then we have some non-functional requirements. For this iteration of the solution, we are not managing user accounts or logins. For endpoints that require authentication,
>
> **[1:36](https://www.linkedin.com/learning/creating-spring-boot-microservices/use-cases-for-an-api-gateway-microservice?u=76281980&t=96)** we will simply use basic auth, which is a special token on the HTTP header request. Open endpoints will not require the special token and the authentication will employ [Spring Security](../../Skills/Web%20Development/Spring%20Security.md). So we have a couple options. The first is to add Spring Security to both of our [Microservices](../../Skills/Software%20Development/Microservices.md) and expose them to the internet. The second is to create a secure API gateway. There are several API gateway [products](../../Skills/Software%20Development/Microsoft%20Products.md) out there. Ours will leverage the Spring Cloud API gateway module. Our gateway will route requests to our domain microservices. This will allow us to address cross-cutting concerns, such as security, monitoring, metrics, and resilience. Artifacts of the Spring Cloud API gateway, are predicates and filters for pre and post-processing of HTTP requests and responses. Path rewriting will modify the path of a rerouted URL. Circuit breakers handle outages gracefully, and request rate limiting will protect the system from being overwhelmed. So in Spring Initializer, I have created a project, which is called ExploreCali-Gateway. We're using [Java](../../Skills/Software%20Development/Java.md) and Maven, [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) 325, and for dependencies,
>
> **[3:11](https://www.linkedin.com/learning/creating-spring-boot-microservices/use-cases-for-an-api-gateway-microservice?u=76281980&t=191)** I've chosen the reactive gateway out of Spring Cloud [Routing](../../Skills/Network%20and%20System%20Administration/Routing.md), and we're using packaging as a jar, and it's Java 21. And I've put it already in the project in the branch of 0901. And so here's the project, ExploreCali-gateway, and our palm file, Explore-Cali-gateway. And it has Spring Cloud starter gateway, and it also includes, as part of independency management, it chooses the correct Spring Cloud version. And of course, it creates our Spring boot application.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [MySQL](../../Skills/Software%20Development/MySQL.md) (2), [Spring Security](../../Skills/Web%20Development/Spring%20Security.md) (2), [Microservices](../../Skills/Software%20Development/Microservices.md) (2), [Java](../../Skills/Software%20Development/Java.md) (2), [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Microservices](../../Skills/Software%20Development/Microservices.md) (2), [Java](../../Skills/Software%20Development/Java.md) (1), [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) (1), [JSON](../../Skills/Web%20Development/JSON.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Routing](../../Skills/Network%20and%20System%20Administration/Routing.md) (2), [Microsoft](../../Instructors/Artificial%20Intelligence%20(AI)/Microsoft.md) (1), [MongoDB](../../Skills/Software%20Development/MongoDB.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/creating-spring-boot-microservices/add-spring-security-to-the-gateway?u=76281980&t=0)** - [Instructor] So now we are going to add [Spring Security](../../Skills/Web%20Development/Spring%20Security.md) to our API gateway. The first step is to add the spring security dependency to our palm. So here is the dependency, it's [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) starter security, and I just want to show you the behavior of just adding this dependency to our gateway. So I'm building the Explore Cali Gateway, and while that's building, we need to start our Explore Cali JPA microservice and then start our Explore Cali Images microservice that is running on 8081. The JPA is running on 8082. So now that the gateway has been built, let's run it. So that is now running, go away, and I have a curl command. I'm going to invoke the 8080 slash packages endpoint to give me the packages. And I got a denied. It says 401 unauthorized. And just to show you, if I would try to invoke any endpoint on the gateway, what happens? I get a prompt for a sign in and username and password.
>
> **[1:33](https://www.linkedin.com/learning/creating-spring-boot-microservices/add-spring-security-to-the-gateway?u=76281980&t=93)** So what happens is, just from including the spring security dependency, all my endpoints are blocked and require authorization. That simply won't do. So what we are going to do is stop that and we need to configure our gateway. So I'm going to add a security configuration in a config folder, security config [Java](../../Skills/Software%20Development/Java.md). And I'm working in the branch 0904B. Over on [GitHub](../../Skills/Software%20Development/GitHub.md), here it is on branch 0904E, the class, security, config. I'm just going to copy and paste that in. So what does this do? So this class is annotated with ant configuration and then we're going to create a beam. And we are also annotating this with enable web [Flux](../../Glossary/Tool/Flux.md) security. And we're going to create a spring security, filter chain object. And we're just invoking this pattern. A HTTP security object is passed in, and then we're going to take this and using the builder pattern, add some more authorization information on it. And so I created authorized exchange
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Spring Security](../../Skills/Web%20Development/Spring%20Security.md) (6), [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) (1), [Java](../../Skills/Software%20Development/Java.md) (1), [GitHub](../../Skills/Software%20Development/GitHub.md) (1), [Flux](../../Glossary/Tool/Flux.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/creating-spring-boot-microservices/orchestrate-with-docker-compose?u=76281980&t=0)** - [Instructor] There are many ways to deploy these three [Microservices](../../Skills/Software%20Development/Microservices.md) into a production environment which will hide the domain microservices behind an API gateway. We are going to simulate a production deployment locally with the Docker [Compose](../../Glossary/Framework/Jetpack%20Compose.md) engine. So it's not important for you to know how to create your own deployment with Docker Compose. I just wanted to show you how microservices play well in a containerized environment. So the goal of this is to build and deploy on one command line. So what do we want to do? You want to compile all your microservices, create Docker images for all three of your microservices with Jib, download the [MongoDB](../../Skills/Software%20Development/MongoDB.md) image, launch and configure it, download the [MySQL](../../Skills/Software%20Development/MySQL.md) image, launch and configure it, launch and configure the explorecali-images, hiding port 8081, launch and configure the explorecali-jpa image and hiding port 8082, and launch and configure the gateway, exposing port 8080. And believe it or not, we can do it all on that one line with mvn clean compile jib:dockerBuild and then the command docker-compose up. Now what did I do to make that happen? First I created a pom.xml in our base folder and declared our three modules within it, the explorecali-gateway, images, and jpa,
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Compose](../../Glossary/Framework/Jetpack%20Compose.md) (1), [MySQL](../../Skills/Software%20Development/MySQL.md) (1), [Databases](../../Skills/Software%20Development/Databases.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/creating-spring-boot-microservices/next-steps?u=76281980&t=0)** - Thanks for joining me on this journey of creating [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) [Microservices](../../Skills/Software%20Development/Microservices.md). So what's next? We barely scratched the surface of [Spring Data](../../Skills/Web%20Development/Spring%20Data.md)'s capabilities, so for more details, check out my course, Spring Data. And if you want to learn more about Docker, I have an [Introduction to Docker for Java Developers](../Data%20Science/Introduction%20to%20Docker%20for%20Java%20Developers.md) course. I hope you enjoyed shadowing me, and I hope this helps you in your spring [Application Development](../../Skills/Software%20Development/Application%20Development.md).

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Spring Data](../../Skills/Web%20Development/Spring%20Data.md) (2), [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) (1), [Microservices](../../Skills/Software%20Development/Microservices.md) (1), [Java](../../Skills/Software%20Development/Java.md) (1), [Application Development](../../Skills/Software%20Development/Application%20Development.md) (1)
...
← [Learning Spring 6 With Spring Boot](Learning%20Spring%206%20With%20Spring%20Boot.md) | **2 of 5** | [Spring Data 2](Spring%20Data%202.md) →
...
- [Advanced Spring- Spring Boot Actuator](../Cloud%20Computing/Advanced%20Spring-%20Spring%20Boot%20Actuator.md) — Spring Boot
- [Spring Boot Observability- Deep Dive into Logging, Metrics, and Tracing](../Cloud%20Computing/Spring%20Boot%20Observability-%20Deep%20Dive%20into%20Logging%2C%20Metrics%2C%20and%20Tracing.md) — Spring Boot
- [Spring On Kubernetes Deploying And Managing Cloud Native Applications](../Cloud%20Computing/Spring%20On%20Kubernetes%20Deploying%20And%20Managing%20Cloud%20Native%20Applications.md) — Spring Boot
- [Advanced Spring- Effective Integration Testing with Spring Boot](Advanced%20Spring-%20Effective%20Integration%20Testing%20with%20Spring%20Boot.md) — Spring Boot
