...
prev_courses:
  - '[React- Creating and Hosting a Full-Stack Site](React-%20Creating%20and%20Hosting%20a%20Full-Stack%20Site.md)'
next_courses:
  - '[React- Accessibility](React-%20Accessibility.md)'
...
>
> **[0:00](https://www.linkedin.com/learning/react-hooks/understanding-modern-react-25372915?u=76281980&t=0)** - [Eve] [React Hooks](../../Skills/Web%20Development/React%20Hooks.md) are functions that we can use to manage state, [Fetch](../../Skills/Web%20Development/Fetch.md) data, and interact with browser APIs. In this course we'll explore why you might use hooks and how they can make development more scalable. I'm Eve Porcello and I'm a developer and an educator. Let's explore some more ways we can modernize our [React](../../Skills/Web%20Development/React.js.md) code with hooks.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [React Hooks](../../Skills/Web%20Development/React%20Hooks.md) (1), [Fetch](../../Skills/Web%20Development/Fetch.md) (1), [React](../../Skills/Web%20Development/React.js.md) (1)
> **CLI Commands:** make (1)
> **Speakers:** - [eve] (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [React](../../Skills/Web%20Development/React.js.md) (15), [npm](../../Skills/Web%20Development/npm.md) (5), [GitHub](../../Skills/Software%20Development/GitHub.md) (2), [JavaScript](../../Skills/Software%20Development/JavaScript.md) (1), [Google](../../Glossary/Service/Google.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [React](../../Skills/Web%20Development/React.js.md) (2), [React Hooks](../../Skills/Web%20Development/React%20Hooks.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/react-hooks/incorporating-the-usestate-hook?u=76281980&t=0)** - [Instructor] Now that we understand array destructuring a little bit more, let's go ahead and get rid of this array. We're also going to get rid of this name in our app. And just to keep everything on the same screen, I'm also going to not import my app from that app file. I'm just going to create it right here in the index. So what we want to do in this video is we want to add state to our App component. And the way that we do this with [React Hooks](../../Skills/Web%20Development/React%20Hooks.md) is we're going to use a function. Let's first go ahead and return a div. Inside of the div, let's say the package is and I'll give that a save. And the next thing I want to do is I want to create a constant here on line six and I'll going to call this results and I'm going to call the function useState. If I want to use useState, I also need to import it from the [React](../../Skills/Web%20Development/React.js.md) library and this is a function, so we're going to import it inside of these curly braces. So what I'm really looking to do here is I'm looking to figure out what this result is. So let me open up our console and I also am going to dock this to the bottom here just so that we can read it a little better. And it looks like our useState call is returning an array. And it has two items in it. One, zero position is undefined
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [React Hooks](../../Skills/Web%20Development/React%20Hooks.md) (1), [React](../../Skills/Web%20Development/React.js.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/react-hooks/working-with-component-trees?u=76281980&t=0)** - [Instructor] More often than not, our [react](../../Skills/Web%20Development/React.js.md) applications are not a single component. So working with state in a component tree is really an important concept to know about. So what we're going to build in this lesson is a star rating component, so that we can rate anything: books, movies, restaurants. We can use it all over, all different types of applications. Now the app component is going to be responsible for just rendering another component. So the app component here, let's go ahead and say, return &lt;StarRating /&gt;; We actually want to create it using a smaller component called a Star. So the Star component is going to be what makes up all of these StarRating components. And the star that we want to use is actually from a separate library called react icons. So let me go ahead and import it first, and then we're going to install it using [npm](../../Skills/Web%20Development/npm.md). So over here in my terminal window, I need to run npm install react-icons. And we'll just let that install over here, kind of in the background. Let's go back to our component. And now the Star is going to return FaStar. So FaStar is just one of the many icons that react-icon supplies,
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [React](../../Skills/Web%20Development/React.js.md) (5), [npm](../../Skills/Web%20Development/npm.md) (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [React](../../Skills/Web%20Development/React.js.md) (2), [JavaScript](../../Skills/Software%20Development/JavaScript.md) (1), [Zoom](../../Skills/Software%20Development/Zoom.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/react-hooks/fetching-data-with-useeffect?u=76281980&t=0)** - [Instructor] Another use case for useEffect is for data fetching. So let's say we had an API like api.[github.com/users](https://github.com/users) so this is just a straight up [rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) API. It returned some [JSON](../../Skills/Web%20Development/JSON.md) data and we want to make a request for this data and then load it into our page. So the way I can do that is by using a combination of useState and useEffect. The first thing we'll do is we will update our component quite a bit and let's just start literally from scratch with this thing. So we'll still import useState and useEffect but inside of this app component now we want to create a state variable for data and setData. And then on first render we want useState the initial state just to be an empty array. So then we're going to say return a paragraph that says No Users. So now if we look at our app, it says No Users. It's going to be up to us to get the data from that API using a useEffect call, useEffect always takes in a function we're going to use [Fetch](../../Skills/Web%20Development/Fetch.md) which takes in the URL of the API. So api.[github.com/users](https://github.com/users), literally the same thing as this. once we've fetched, we need to call then
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [JSON](../../Skills/Web%20Development/JSON.md) (3), [GitHub](../../Skills/Software%20Development/GitHub.md) (2), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1), [Fetch](../../Skills/Web%20Development/Fetch.md) (1), [React](../../Skills/Web%20Development/React.js.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/react-hooks/managing-form-inputs-with-useref?u=76281980&t=0)** - [Instructor] As we move our way through all of these different hooks that the [React](../../Skills/Web%20Development/React.js.md) library provides us with, one that we can't overlook is useRef. So useRef is going to allow us to reach out to a component and determine its value. And this can be extremely useful, particularly with [Forms](../../Skills/Web%20Development/Forms.md). So the first thing I want to do with our form is I want to import useRef. I'll get rid of all of our reducer stuff from before. Then inside of the component, instead of returning this here, we're going to say form and we'll close the form.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Forms](../../Skills/Web%20Development/Forms.md) (2), [React](../../Skills/Web%20Development/React.js.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/react-hooks/reusing-form-logic-with-custom-hooks?u=76281980&t=0)** - [Instructor] In addition to the pre-built hooks that are supplied by the [React](../../Skills/Web%20Development/React.js.md) library, you can also create your own custom hooks. If there's ever a place where you're writing a lot of the same code in your components, it might be possible to extract the logic into a hook. For example, for these input elements, we're kind of doing the same thing. We're just getting and resetting the value. The field takes something in, then we grab it and send it somewhere and then reset the field's value. So we're going to do all of this, instead of in this component, in a custom hook called useInput. So the first thing we need to do is create a file called useInput. So it'll be called useInput.js, and we'll put it right here in the source folder. Now, the next thing that we'll do is we'll import useState from React. Now, we're allowed to use hooks inside of other hooks or in components, so this is a great place to use one. Now, we need to think about what we want our input to do. So the first thing is, it's a function that's going to take in an initial value. Let's [Zoom](../../Skills/Software%20Development/Zoom.md) that out a little bit. Then we're going to use value and setValue as the state variable and the function to change the state. And then the initial value is what we'll send to the useState function.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [React](../../Skills/Web%20Development/React.js.md) (2), [Zoom](../../Skills/Software%20Development/Zoom.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [React](../../Skills/Web%20Development/React.js.md) (3), [React Hooks](../../Skills/Web%20Development/React%20Hooks.md) (1)
...
> [!transcript]- Transcript
>
> **[0:01](https://www.linkedin.com/learning/react-hooks/react-hooks-history?u=76281980&t=1)** - [Instructor] If you're familiar with [React](../../Skills/Web%20Development/React.js.md)'s history, you might be aware that there have been a few different ways to create components throughout time. If we hop in a time machine to between 2013 and 2017, not that long ago I realize, that meant that we would use a function called createClass to create a component. Then the createClass function would have this render method that we could use to return some UI. Then around 2017, createClass started to fall out of favor because [JavaScript](../../Skills/Software%20Development/JavaScript.md) implemented the class syntax which lent itself really well to component creation. So that meant our components transformed to kind of look like this. We had a class, it would extend a base class called React component, and it would look pretty much the same. It was also possible around this time though to create components using a function. But anytime you added state variables, you had to refactor your function component into a class. And it was a whole thing. It took a lot of time. Then came [React Hooks](../../Skills/Web%20Development/React%20Hooks.md). So Hooks allow you to add state to function components and it also allows you to abstract logic into separate function, they're just functions. So anytime you're using a Hook from React or another library, they have to start with use. Use state, use reducer, use query, use context, whatever, they always start with use. Moving forward, it's probably a good idea to use functions instead of classes as class syntax may be removed from the React library at some point in the future.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [React](../../Skills/Web%20Development/React.js.md) (5), [JavaScript](../../Skills/Software%20Development/JavaScript.md) (1), [React Hooks](../../Skills/Web%20Development/React%20Hooks.md) (1)
...
← [React- Creating and Hosting a Full-Stack Site](React-%20Creating%20and%20Hosting%20a%20Full-Stack%20Site.md) | **4 of 8** | [React- Accessibility](React-%20Accessibility.md) →
