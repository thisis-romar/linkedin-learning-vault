...
prev_courses:
  - '[ASP.NET Core- Building a GraphQL API](ASP.NET%20Core-%20Building%20a%20GraphQL%20API.md)'
...
>
> **[0:00](https://www.linkedin.com/learning/building-web-apis-with-asp-dot-net-core-8/welcome?u=76281980&t=0)** - [Christian] These days, internet-enabled devices come in countless different form factors. They all need to connect to a server to carry out work, and typically, they are using HTTP. This is where a web API comes in, providing a uniform contract to talk to a service. In my [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) Learning Course, I will show you how to use [ASP.NET](https://ASP.NET) Core to build a powerful [rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) API that any client may use. You'll see what [ASP.NET](https://ASP.NET) Core offers and how it makes creating APIs a positive and productive experience. My name is Christian Wenz. I started creating web applications in the mid-1990s and never looked back. Let's get started.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [ASP.NET Core](../../Skills/Web%20Development/ASP.NET%20Core.md) (2), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (1), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [ASP.NET Core](../../Skills/Web%20Development/ASP.NET%20Core.md) (3), [ASP.NET](../../Skills/Web%20Development/ASP.NET.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [ASP.NET Core](../../Skills/Web%20Development/ASP.NET%20Core.md) (4)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Windows](../../Glossary/Service/Windows.md) (6), [Microsoft](../../Instructors/Artificial%20Intelligence%20(AI)/Microsoft.md) (3), [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) (2), [ASP.NET Core](../../Skills/Web%20Development/ASP.NET%20Core.md) (1), [JavaScript](../../Skills/Software%20Development/JavaScript.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [ASP.NET Core](../../Skills/Web%20Development/ASP.NET%20Core.md) (2), [JSON](../../Skills/Web%20Development/JSON.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [CLI](../../Skills/Network%20and%20System%20Administration/CLI.md) (1), [API Development](../../Skills/Software%20Development/API%20Development.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (8), [Representational state transfer](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1), [System Architecture](../../Skills/Software%20Development/System%20Architecture.md) (1), [JavaScript](../../Skills/Software%20Development/JavaScript.md) (1)
...
>
> **[1:36](https://www.linkedin.com/learning/building-web-apis-with-asp-dot-net-core-8/api-design-basics?u=76281980&t=96)** And, in the API we will be developing, we are working with that list of [products](../../Skills/Software%20Development/Microsoft%20Products.md). So we won't have a shopping cart, and we also won't have all of these different sizes. But with the list of products, we can work really, really well, and I can tell you all of the important [ASP.NET](https://ASP.NET) Core web API features through that API. But back to the API design. When we set up the URIs that represent the resources in our shop, one common aspect that many agree upon is that we should use nouns, not verbs. Verbs indicate an action, but actions in [REST](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) are usually denoted by the appropriate HTTP method, so we are using nouns. So how about this URL, or URI, to denote a list of all of the products that are available in the shop. So we have the server name, api.[hplussport.com](https://hplussport.com), and, again, that's not the real domain locally. That's just an example here. And then, /products. We are using HTTP GET, so the default HTTP method, and that also indicates that we would like to retrieve information. We don't want to add products yet. We'll talk about that later. When I would like to access an individual product
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Products](../../Skills/Software%20Development/Microsoft%20Products.md) (14), [ASP.NET Core](../../Skills/Web%20Development/ASP.NET%20Core.md) (2), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [JSON](../../Skills/Web%20Development/JSON.md) (3), [JavaScript](../../Skills/Software%20Development/JavaScript.md) (2), [Fetch](../../Skills/Web%20Development/Fetch.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [ASP.NET Core](../../Skills/Web%20Development/ASP.NET%20Core.md) (3), [CLI](../../Skills/Network%20and%20System%20Administration/CLI.md) (3), [Products](../../Skills/Software%20Development/Microsoft%20Products.md) (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Products](../../Skills/Software%20Development/Microsoft%20Products.md) (9), [Microsoft](../../Instructors/Artificial%20Intelligence%20(AI)/Microsoft.md) (5), [SQL](../../Skills/Data%20Science/SQL.md) (1), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Products](../../Skills/Software%20Development/Microsoft%20Products.md) (9), [JSON](../../Skills/Web%20Development/JSON.md) (3), [Dependency Injection](../../Skills/Web%20Development/Dependency%20Injection.md) (2), [ASP.NET Core](../../Skills/Web%20Development/ASP.NET%20Core.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Products](../../Skills/Software%20Development/Microsoft%20Products.md) (7), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1), [Routing](../../Skills/Network%20and%20System%20Administration/Routing.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Products](../../Skills/Software%20Development/Microsoft%20Products.md) (10), [ASP.NET Core](../../Skills/Web%20Development/ASP.NET%20Core.md) (1), [Dependency Injection](../../Skills/Web%20Development/Dependency%20Injection.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/building-web-apis-with-asp-dot-net-core-8/challenge-searching-items?u=76281980&t=0)** - [Narrator] Time for a quick coding challenge. Take the API as it is, but add a new endpoint and that endpoint should not return a list of all [products](../../Skills/Software%20Development/Microsoft%20Products.md), but only of those products that are in stock. So think about a good URI for that endpoint, and then implement it in a [ASP.NET](https://ASP.NET) core web API.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Products](../../Skills/Software%20Development/Microsoft%20Products.md) (2), [ASP.NET Core](../../Skills/Web%20Development/ASP.NET%20Core.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Routing](../../Skills/Network%20and%20System%20Administration/Routing.md) (2), [ASP.NET Core](../../Skills/Web%20Development/ASP.NET%20Core.md) (2)
...
>
> **[6:21](https://www.linkedin.com/learning/building-web-apis-with-asp-dot-net-core-8/adding-an-item-with-post?u=76281980&t=381)** to see the list of data I am receiving. And in the end you'll notice that we have 33 products because the last product has an id of 33. And we will be able to use that later to see whether adding data to the data store works. So now let's switch over to HTTP POST so we post to the endpoint, but when we do that, we are sending a payload and there is no entry for [JSON](../../Skills/Web%20Development/JSON.md) here. So I'll just say raw so that we can enter raw data to send. And we are sending a JSON structure with a sku. So how about ABC123, and what else is in the product? A name, how about Cool Sweater and then some price, 999, sounds like a bargain. And then of course, since we need a category, CategoryId and let's just use one. That's how our product looks like. These are the main properties of a product, right? So we are sending that as part of the HttpPost request in the request body. However, we need to tell the server which format we are using. It's obvious here that it's JSON,
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [JSON](../../Skills/Web%20Development/JSON.md) (7), [Products](../../Skills/Software%20Development/Microsoft%20Products.md) (6), [ASP.NET Core](../../Skills/Web%20Development/ASP.NET%20Core.md) (2), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [ASP.NET Core](../../Skills/Web%20Development/ASP.NET%20Core.md) (1), [Products](../../Skills/Software%20Development/Microsoft%20Products.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Dependency Injection](../../Skills/Web%20Development/Dependency%20Injection.md) (2), [Products](../../Skills/Software%20Development/Microsoft%20Products.md) (2), [Word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/building-web-apis-with-asp-dot-net-core-8/solution-deleting-several-items?u=76281980&t=0)** - [Instructor] As it is often the case, there's more than one way to reach a solution. We could of course, just change our lead product method and make it accept, say, an array of ideas, but then that would mess up our [Routing](../../Skills/Network%20and%20System%20Administration/Routing.md). So I recommend we add a new endpoint here with a pretty similar implementation. There are a few changes, though, of course the HTTP method delete sounds like a good fit, but currently we are using a delete HTTP call to /[products](../../Skills/Software%20Development/Microsoft%20Products.md) or /API/products/ID to delete that one item. We need something different for a list of products because we don't have an endpoint that represents a list of products. Therefore, I propose we can issue an HTTP post request to a specific endpoint. And that endpoint could be called delete, for instance. So let's actually try this out. I am adding a new method. I am using HttpPost, and the route is delete. So it'll be /api/products/delete. And of course you can choose whatever UI scheme you want, right? That's just my proposition. And then I'm doing an public async Task<ActionResult> and I'll call it DeleteMultiple(int[] ids).
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Products](../../Skills/Software%20Development/Microsoft%20Products.md) (16), [Routing](../../Skills/Network%20and%20System%20Administration/Routing.md) (1)
...
← [ASP.NET Core- Building a GraphQL API](ASP.NET%20Core-%20Building%20a%20GraphQL%20API.md) | **9 of 9**
...
- [ASP.NET Core- Building a GraphQL API](ASP.NET%20Core-%20Building%20a%20GraphQL%20API.md) — ASP.NET Core, API Development
...
- [Getting Started with the Google Gemini API](../Artificial%20Intelligence%20(AI)/Getting%20Started%20with%20the%20Google%20Gemini%20API.md) — API Development
- [OpenAI API- Working with Files](../Artificial%20Intelligence%20(AI)/OpenAI%20API-%20Working%20with%20Files.md) — API Development
- [Openai Api Introduction](../Artificial%20Intelligence%20(AI)/Openai%20Api%20Introduction.md) — API Development
