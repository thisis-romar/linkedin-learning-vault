...
>
> **[0:12](https://www.linkedin.com/learning/learning-rest-apis/welcome?u=76281980&t=12)** They're pulling information from the internet using [[Representational State Transfer (REST)|REST]] APIs.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/learning-rest-apis/the-restful-librarian?u=76281980&t=0)** - To make sense of what a [[Representational State Transfer (REST)|REST]] API is and how it works, imagine a library with books, a librarian, and people who want to borrow, add, update, or remove those books.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/learning-rest-apis/what-is-a-rest-api?u=76281980&t=0)** - [[Representational State Transfer (REST)|REST]] and API are acronyms for [[Representational State Transfer (REST)|Representational State Transfer]] and Application Programming Interface.
>
...
>
> **[2:22](https://www.linkedin.com/learning/learning-rest-apis/sidebar-url-vs-uri?u=76281980&t=142)** When we talk about [[Representational State Transfer (REST)|REST]] APIs, we typically use the generic term URI to refer to how we access resources because within our code, we can use either URLs or URNs or a combination and URIs cover all options.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/learning-rest-apis/the-six-constraints-of-rest?u=76281980&t=0)** - [Instructor] [[Representational State Transfer (REST)|Representational state transfer]], or [[Representational State Transfer (REST)|REST]], refers to a group of [[Software Architecture]] design constraints that bring about efficient, reliable, and scalable systems.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/learning-rest-apis/how-rest-relates-to-http?u=76281980&t=0)** - Working with [[Representational State Transfer (REST)|REST]] APIs, you'll most likely send your requests through HTTP.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/learning-rest-apis/who-or-what-interacts-with-rest-apis?u=76281980&t=0)** - When explaining how [[Representational State Transfer (REST)|REST]] APIs work, you'll often hear people refer to clients who consume the REST API.
>
...
>
> **[2:30](https://www.linkedin.com/learning/learning-rest-apis/who-or-what-interacts-with-rest-apis?u=76281980&t=150)** A website, an app, even an [[IoT|internet of things]] device.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [[Representational State Transfer (REST)|Rest]] (20), [[WordPress]] (1), [[IoT|Internet of things]] (1)
...
>
> **[0:01](https://www.linkedin.com/learning/learning-rest-apis/tools-to-see-rest-api-in-action?u=76281980&t=1)** Let's take a look at a [[Representational State Transfer (REST)|REST]]-API in action.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/learning-rest-apis/anatomy-of-a-rest-request?u=76281980&t=0)** - In this chapter, we'll look at [[Representational State Transfer (REST)|REST]] requests in detail, how they're put together, what the different pieces are, and how to use them.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/learning-rest-apis/discovery?u=76281980&t=0)** - A key step in working with a [[Representational State Transfer (REST)|REST]] API is discovery, figuring out what resources and methods are available and what you can do with them.
>
...
>
> **[0:09](https://www.linkedin.com/learning/learning-rest-apis/resource?u=76281980&t=9)** The concept of [[Representational State Transfer (REST)|REST]] was defined by Roy Fielding in a doctoral dissertation in 2000 called Architectural Styles and the Design of Network Based Software Architectures.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/learning-rest-apis/methods-verbs?u=76281980&t=0)** - A [[Representational State Transfer (REST)|REST]] resource enables access to data, but doesn't in itself do anything with that data.
>
...
>
> **[1:53](https://www.linkedin.com/learning/learning-rest-apis/methods-verbs?u=76281980&t=113)** If for example you have a collection of [[Microsoft Products|products]] and you want to add a new product, you send a post request along with the data for the new product in [[JSON]] format, and the REST API creates a new resource under the product's resource and gives it a new ID and resource URI.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/learning-rest-apis/response-header?u=76281980&t=0)** - [Instructor] Any time you send a request to a [[Representational State Transfer (REST)|REST]] API, the API returns some form of response to tell you what happened on its end.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/learning-rest-apis/http-status-messages?u=76281980&t=0)** - [Instructor] The HTTP response status codes at the top of the [[Representational State Transfer (REST)|REST]] response header gives the client an immediate notification about the status of the request-response pair.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/learning-rest-apis/rest-and-authorization-authentication?u=76281980&t=0)** - The response you get from a [[Representational State Transfer (REST)|REST]] API depends on the authorization level you have when you make the request.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/learning-rest-apis/request-response-pairs?u=76281980&t=0)** - [Instructor] All this theory is well and good; but to really get [[Representational State Transfer (REST)|REST]] APIs, you have to see one in action.
>
...
>
> **[0:22](https://www.linkedin.com/learning/learning-rest-apis/get?u=76281980&t=22)** When I send this request, the [[Representational State Transfer (REST)|rest]] API returns to me a list of the 10 most recent posts on the site.
>
...
>
> **[0:54](https://www.linkedin.com/learning/learning-rest-apis/get?u=76281980&t=54)** That's because in the case of [[Microsoft Word|Word]] Press we get the full data for each of the posts even in the posts resource.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/learning-rest-apis/post?u=76281980&t=0)** - Given the necessary authorization, a [[Representational State Transfer (REST)|REST]] API can be used to create new resources.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/learning-rest-apis/put-patch?u=76281980&t=0)** - [Narrator] Now that I've created a new resource through the [[Representational State Transfer (REST)|REST]] API, I want to make a change to it.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/learning-rest-apis/next-steps?u=76281980&t=0)** - [Morten] By watching this course you now have a foundational understanding of what [[Representational State Transfer (REST)|REST]] APIs are and how they function.
>
