...
>
> **[0:00](https://www.linkedin.com/learning/node-js-essential-training-14888164/learning-the-node-js-basics?u=76281980&t=0)** - [Eve] If you've worked with [JavaScript](../../Skills/Software%20Development/JavaScript.md) before, you might think of it just as a front-end technology, a way to add interactivity to web applications, to add features like button clicks and drop-downs. But that's not all JavaScript can do. With [Node.js](../../Skills/Web%20Development/Node.js.md), you can use your JavaScript skills for more. Everything from building command line tools, to creating servers, to interacting with the file system. Since Node was released in 2009, companies like PayPal, Netflix, and [Microsoft](../../Instructors/Artificial%20Intelligence%20(AI)/Microsoft.md) have used it as a way to build scalable event-driven applications. In this course, we'll cover the basic features of Node core, including standard input and standard output, the module system, and the file system, with consumable yet real-world examples. I'm Eve Porcello. I've been teaching Node to engineers for almost a decade, and I use it nearly every day in my own projects. These days, Node.js is everywhere, and it's a really great time to get acquainted with the basics. Now's the time to become a full-stack JavaScript developer with Node. Let's go.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [JavaScript](../../Skills/Software%20Development/JavaScript.md) (4), [Node.js](../../Skills/Web%20Development/Node.js.md) (2), [Microsoft](../../Instructors/Artificial%20Intelligence%20(AI)/Microsoft.md) (1)
> **CLI Commands:** node (6)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/node-js-essential-training-14888164/what-you-should-know?u=76281980&t=0)** - [Instructor] [Node.js](../../Skills/Web%20Development/Node.js.md) Essential Training will provide you with an in-depth introduction to Node.js, but there are a couple things that you may want to be familiar with before you get started. First of all, Node.js is [JavaScript](../../Skills/Software%20Development/JavaScript.md), so you'll need to know a bit of JavaScript in order to work with Node.js successfully. If you'd like to learn more about JavaScript, check out the excellent [JavaScript Essential Training](../Software%20Development/JavaScript%20Essential%20Training.md) with Morton Rand-Hendrikson. Also because we're dealing with the latest and greatest JavaScript syntax, a bit of ES6, ESNext, the latest JavaScript syntax would be great to know. You can check out my course Learning [ECMAScript](../../Skills/Web%20Development/ECMAScript.md) 6 or [JavaScript Essential Training](../Software%20Development/JavaScript%20Essential%20Training.md) will use some of the syntax, as well. So if you feel comfortable with the JavaScript language, you are ready to become a full stack JavaScript developer with Node.js.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [JavaScript](../../Skills/Software%20Development/JavaScript.md) (9), [Node.js](../../Skills/Web%20Development/Node.js.md) (5), [ECMAScript](../../Skills/Web%20Development/ECMAScript.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/node-js-essential-training-14888164/node-js-history?u=76281980&t=0)** - [Instructor] [Node.js](../../Skills/Web%20Development/Node.js.md) can feel like a brand new technology, but really, it's been around for about a decade and it's one of the most popular [JavaScript](../../Skills/Software%20Development/JavaScript.md) tools available. Node.js was created by Ryan Doll in 2009 as a JavaScript runtime based on Chrome's VA engine. In 2011, [npm](../../Skills/Web%20Development/npm.md), the node package manager, released version 1.0, which allowed for the sharing of open source node libraries. This marked a huge shift in the way that code was shared and maintained and started to cement node as a huge player in the ecosystem. After some infighting in the community about implementation and project management, the Node.js Foundation was formed in 2015. The Foundation is made up of several large companies, including IBM, [Microsoft](../../Instructors/Artificial%20Intelligence%20(AI)/Microsoft.md), PayPal and many, many others. And it's a collaborative project at the [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) Foundation. What this means is that these companies can shepherd the growth and the evolution of the library for many, many years to come. Today, the Node.js community is thriving with numerous conferences and events internationally and wide uses across various industries.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Node.js](../../Skills/Web%20Development/Node.js.md) (4), [JavaScript](../../Skills/Software%20Development/JavaScript.md) (2), [npm](../../Skills/Web%20Development/npm.md) (1), [Microsoft](../../Instructors/Artificial%20Intelligence%20(AI)/Microsoft.md) (1), [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) (1)
...
>
> **[1:34](https://www.linkedin.com/learning/node-js-essential-training-14888164/handling-argument-variables-with-process-argv?u=76281980&t=94)** with the same two things at the beginning, but each additional array value represents the [rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) of what we typed into the console after the global module. So we see our user flag and our name, and we see our greeting flag and the greeting. So let's try to create the little function that's going to help us process some of these values. We're going to create a function called grab, and here we're going to grab this flag. We will say let indexAfterFlag equal process.argv.index of flag, plus one.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Node.js](../../Skills/Web%20Development/Node.js.md) (2), [JavaScript](../../Skills/Software%20Development/JavaScript.md) (1)
...
>
> **[3:06](https://www.linkedin.com/learning/node-js-essential-training-14888164/exporting-custom-modules?u=76281980&t=186)** can be consumed by a different file. Modules make our code reusable and consumable because we can publish our modules to [npm](../../Skills/Web%20Development/npm.md) and share them with the [rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) of the community.
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (2), [Node.js](../../Skills/Web%20Development/Node.js.md) (1)
> **CLI Commands:** node (4)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [JavaScript](../../Skills/Software%20Development/JavaScript.md) (3), [Node.js](../../Skills/Web%20Development/Node.js.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/node-js-essential-training-14888164/more-training?u=76281980&t=0)** - [Instructor] Well, we made it. We made it all the way through our [Node.js](../../Skills/Web%20Development/Node.js.md) Essential Training course. You may be wondering, "What's next for me as I continue my learning journey with Node.js?" Well, what I'd recommend to you is that first, you take a look at Node.js Essential Training Part 2. This will take you through how to work with [Web Servers](../../Skills/Web%20Development/Web%20Servers.md) in Node.js, how to deploy your Node.js applications, and much, much more. I'd also encourage you to check out [Express.js](../../Skills/Web%20Development/Express.js.md). Express is a wonderful framework, one of the most popular for building web applications using Node. If you're looking to get into testing, I would recommend the Jest testing library. And when you're ready to deploy, I would check out Vercel or Netlify as great options. And, of course, stay on top of the Node.js documentation. This is where you'll learn the latest about what's up and coming in the language. I'm so glad that you took the time to learn Node.js with me today. I hope that this is a useful foundation for whatever you build with Node.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Node.js](../../Skills/Web%20Development/Node.js.md) (7), [Web Servers](../../Skills/Web%20Development/Web%20Servers.md) (1), [Express.js](../../Skills/Web%20Development/Express.js.md) (1)
> **CLI Commands:** node (9)
...
**1 of 11** | [Learning npm- A Package Manager](Learning%20npm-%20A%20Package%20Manager.md) →
...
← [React Essential Training](React%20Essential%20Training.md) | **8 of 12** | [SQL Essential Training](../Data%20Science/SQL%20Essential%20Training.md) →
...
← [React- Authentication](React-%20Authentication.md) | **3 of 13** | [Learning npm- A Package Manager](Learning%20npm-%20A%20Package%20Manager.md) →
...
- [Node.js- Debugging and Performance Tuning](Node.js-%20Debugging%20and%20Performance%20Tuning.md) — Node.js
