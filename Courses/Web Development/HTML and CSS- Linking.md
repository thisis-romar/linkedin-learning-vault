...
prev_courses:
  - '[Crafting Meaningful HTML](Crafting%20Meaningful%20HTML.md)'
next_courses:
...
>
> **[0:00](https://www.linkedin.com/learning/html-and-css-linking/hyperlinks-the-glue-connecting-the-world-wide-web-23410801?u=76281980&t=0)** - Links are the heart of the web. If there were no links, would the web even exist? In this course we'll look in detail at the humble link. We'll use [HTML](../../Skills/Web%20Development/HTML.md) to link within a page, between pages, to different websites, email, phone numbers, and to documents like PDFs. We'll also make our links pretty with CSS, and look at link maintenance to make sure that they're up to date with the changing web. I'm Jen Kramer, an educator and web developer, and I think I've coded at least half of the links on the web in my 23-year career. So if you're ready, let's get started with HTML and CSS linking.
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [HTML](../../Skills/Web%20Development/HTML.md) (7), [Windows](../../Glossary/Service/Windows.md) (1), [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (9), [HTML](../../Skills/Web%20Development/HTML.md) (2), [Google](../../Glossary/Service/Google.md) (1), [Security Risk](../../Skills/Cybersecurity/Security%20Risk.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Microsoft Word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) (5), [Word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) (4), [HTML](../../Skills/Web%20Development/HTML.md) (2), [Microsoft Office](../../Skills/Web%20Development/Microsoft%20Office.md) (1), [User experience](../../Skills/Web%20Development/User%20Experience%20(UX).md) (1)
...
>
> **[1:45](https://www.linkedin.com/learning/html-and-css-linking/linking-to-email-addresses-and-email-messages?u=76281980&t=105)** So now you'll see here that I have "Or send me an email." Click that link, and this is going to pull open your default email. In my case, I used Gmail, and you can see here that this has started for me a new message going to info at two trees olive oil, and I can fill in the [rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) of the message from there. But that's not all there is to making an email link. There's more information that you can specify. So let's go back to VS Code, and to this mailto address we can start to add a number of additional parameters to make this email more specific. One of the most helpful ones is subject. So simply put a question mark after the email address and then put in subject equals olive oil quote, for example.
>
> **[2:41](https://www.linkedin.com/learning/html-and-css-linking/linking-to-email-addresses-and-email-messages?u=76281980&t=161)** And if you save that one more time, go back to your web browser, refresh, click the email link again, this will open up, again, another tab in [Google](../../Glossary/Service/Google.md), and another message. This time you see now it's going to info at two trees olive oil dot com, and the words olive oil quote are already pre-configured. There's a few other things you can pre-configure in this email as well. Let's say I want to add to this a CC on this message. So it's going to go to info at two trees olive oil, but it's going to CC me in my account. So here I would put in an ampersand CC equals, and my next email address, Jen at two trees olive oil dot com. Let me wrap that for you so you can see what's going on. So see how this is all like one giant [word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) with very few spaces, only spaces in the subject here. We've got question marks. We've got ampersands joining these things together. And you can even add to this some initial text inside of the body of the message. So we can put in another ampersand here and say body equals... I can even write in the body of the email message... Just like that. So that giant long thing there is going to construct an email for me.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Google](../../Glossary/Service/Google.md) (2), [JavaScript](../../Skills/Software%20Development/JavaScript.md) (1), [HTML](../../Skills/Web%20Development/HTML.md) (1), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1), [Word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [HTML](../../Skills/Web%20Development/HTML.md) (3), [Windows](../../Glossary/Service/Windows.md) (1), [Word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) (1), cursor (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [HTML](../../Skills/Web%20Development/HTML.md) (1), [Metadata](../../Skills/Web%20Development/Metadata.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [CodePen](../../Glossary/Tool/CodePen.md) (3), [HTML](../../Skills/Web%20Development/HTML.md) (2), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (2)
> **Env Vars:** html (2), css (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (1), [HTML](../../Skills/Web%20Development/HTML.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/html-and-css-linking/styling-a-text-link-to-look-like-a-button?u=76281980&t=0)** - [Instructor] Buttons have a very semantic meaning associated with them. And by default, buttons are programmed essentially to work inside of [Forms](../../Skills/Web%20Development/Forms.md). You have a form tag, there's a button inside of it. It's a submit button. It's a reset button. That's what buttons are historically true for doing. With HTML5, we got a button tag itself as opposed to an input, which is what buttons were before. And buttons are now able to live outside of an [HTML](../../Skills/Web%20Development/HTML.md) form tag, just like this button does right here. But this button does absolutely nothing. We can click this button all day long. It will do absolutely nothing. We have to associate [JavaScript](../../Skills/Software%20Development/JavaScript.md) with this button in order to make it do something whatever that something happens to be. Now, often people want the look of a button but they want the functionality of a link. They just want to be able to click on a button and it's going to take them to wherever it is they need to go rather than having to mess with JavaScript and using a semantic HTML button. The better way to deal with this is to code your regular old HTML link and leverage CSS to make it look like a button. That's a far better approach for doing this kind of work. So that's what I'd like to do now. I'm going to take this subscribe to [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) Learning and let us make it look like a button. So I'm going to start by setting this up with the a tag and I'm using generic styles here
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [HTML](../../Skills/Web%20Development/HTML.md) (3), [JavaScript](../../Skills/Software%20Development/JavaScript.md) (2), [Forms](../../Skills/Web%20Development/Forms.md) (1), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/html-and-css-linking/understanding-proper-navigation-markup?u=76281980&t=0)** - [Instructor] I've really been shocked looking at [HTML](../../Skills/Web%20Development/HTML.md) for navbars around the web these days. If you're interested in semantic HTML mark up, the navbar is the easiest thing in the world because every navbar you will ever make from now on is going to have exactly the same mark up. It's an unordered list. All this is is a list of links. And despite what marketing has to say they don't actually have to go in any particular order. So an unordered list is the best way to mark up our navigation bar. The only question you might have is whether the nav tag should be wrapped around the whole thing or not. And if it's a major navbar on the page like the one that goes at the top of your webpage. It should have a nav tag around it. So let's walk through exactly what the proper mark up for every navbar that you will ever write for the [rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) of your life looks like in detail. So here I am in my code pan. I've started you off with five links here. And let's start by writing some mark up that goes around this. So first of all this is going to be the major navigation for our website. So we start with the nav tag to indicate that this is navigation. Nav/nav. That goes around the whole entire thing. And it it indicates that we have navigation. Then after that we're going to make this an unordered list. It starts with ul it end with a /ul. Awesome.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/html-and-css-linking/creating-a-simple-vertical-navigation-bar?u=76281980&t=0)** - [Instructor] Vertical nav bars don't seem to be much in style these days; however, they're still a useful way of displaying a bunch of links, particularly when you aren't sure how many there will be. They're really useful on blogs and on other content-heavy sites, and that might be where you see them. I'm going to walk you through one possible way of creating a vertical navigation bar. Obviously, there are approximately 500 bajillion different ways to do this. I do have a course coming out, in not too long, that will be on how to create nav bars horizontally and vertically, and show you a bunch of different styling options. But, for now, in this course, I'm going to keep it brief, let's do just one vertical and one horizontal, that'll be the next video. So, let's start, remembering that every [HTML](../../Skills/Web%20Development/HTML.md) element is a box that you can leverage in creating a nav bar, and remembering exactly which box you're at and how large those boxes are and how much area they take up are really key to styling a good nav bar. So, let's just start by saying our body for this web page is going to have a margin of zero and a padding of zero, and the reason we do this is, this is going to get rid of that little white margin that goes around the edge of your web page. It's there by default from your web browser. Then, we can go on to say, for our nav element, let's say our background-color is efac2f,
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [HTML](../../Skills/Web%20Development/HTML.md) (3), [Word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) (1)
> **Env Vars:** html (3)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (2), [Facebook](../../Glossary/Service/Facebook.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (5), [HTML](../../Skills/Web%20Development/HTML.md) (3), [Metadata](../../Skills/Web%20Development/Metadata.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Google](../../Glossary/Service/Google.md) (2), [PHP](../../Skills/Software%20Development/PHP.md) (2), [Server Configuration](../../Skills/Network%20and%20System%20Administration/Server%20Configuration.md) (1), [Content Management](../../Skills/Web%20Development/Content%20Management.md) (1), [WordPress](../../Skills/Web%20Development/WordPress.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/html-and-css-linking/next-steps?u=76281980&t=0)** - [Jen] Hey everybody. It's Jen Kramer. Thank you so much for watching my course on [HTML](../../Skills/Web%20Development/HTML.md) and CSS and Links. I hope you learned something new along the way. If you're interested in learning more with me, there's a bunch of other courses here in the library that might be of interest to you. First of all, [HTML- Metadata in the Head](HTML-%20Metadata%20in%20the%20Head.md) talks a great deal about the meta refresh tag that I discussed in the course as well as some of the Link tags that I talked about as well. And you can learn more details here. The course, [Crafting Meaningful HTML](Crafting%20Meaningful%20HTML.md) is all about how you can create HTML that is indeed meaningful in its markup and conveys that meaning to the user of the website, not just a whole bunch of HTML that means nothing at all. And so this is a great course that is a great way to get an insight into that type of work. And then there's also CSS Selectors. This will talk a great deal about the various kinds of CSS selectors that are out there and the various types of Link states that are available, which we covered somewhat in this course. And there's more to know from the selectors course. Finally, keep an eye out for my new course on nav bars which should be coming to the library sometime soon which will cover all of the details that are needed for creating horizontal and vertical nav bars. Thanks again so much for watching and I hope to see you soon.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [HTML](../../Skills/Web%20Development/HTML.md) (5), [Metadata](../../Skills/Web%20Development/Metadata.md) (1)
...
← [Crafting Meaningful HTML](Crafting%20Meaningful%20HTML.md) | **3 of 11** | [HTML- Images and Figures](HTML-%20Images%20and%20Figures.md) →
