...
prev_courses:
  - '[Django Essential Training](Django%20Essential%20Training.md)'
next_courses:
...
> [!transcript]- Transcript
>
> **[0:01](https://www.linkedin.com/learning/django-forms/what-you-should-know?u=76281980&t=1)** - [Narrator] So before we start this course, let's go quickly over what it is that you should know before you begin. You should have a basic grasp of [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) 3. We're going to be using Python 3.7, but if you've used any of the recent versions of Python 3, you'll be more than fine. You should be familiar with pip to install packages via Python. Also you should be able to build a decent basic [Django](../../Skills/Web%20Development/Django.md) project. If you have any questions about that, please check out my course, [Building a Personal Portfolio with Django](Building%20a%20Personal%20Portfolio%20with%20Django.md). It's a great refresher or to teach you for the very first time how to build a Django project. We really go into depth about all the different tools that you can use. Next, you should have a basic knowledge of the terminal, be able to run your server, collect static things like that, move between directories, also, make sure that you have a text editor where you can write some code. I'm going to be using Adam, but feel free to use whatever you'd like. Also, you should have some basic [HTML](../../Skills/Web%20Development/HTML.md) and [JavaScript](../../Skills/Software%20Development/JavaScript.md) knowledge for this course. Basically, be able to work with web technology.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (4), [Django](../../Skills/Web%20Development/Django.md) (3), [HTML](../../Skills/Web%20Development/HTML.md) (1), [JavaScript](../../Skills/Software%20Development/JavaScript.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Forms](../../Skills/Web%20Development/Forms.md) (3), [Django](../../Skills/Web%20Development/Django.md) (2)
> **CLI Commands:** make (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [HTML](../../Skills/Web%20Development/HTML.md) (6), [Django](../../Skills/Web%20Development/Django.md) (1), [Word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) (1), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Forms](../../Skills/Web%20Development/Forms.md) (2), [HTML](../../Skills/Web%20Development/HTML.md) (2), [Django](../../Skills/Web%20Development/Django.md) (1)
> **CLI Commands:** make (5)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Forms](../../Skills/Web%20Development/Forms.md) (9), [Django](../../Skills/Web%20Development/Django.md) (4), [HTML](../../Skills/Web%20Development/HTML.md) (3), [Word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) (1), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (4), [Forms](../../Skills/Web%20Development/Forms.md) (3)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Forms](../../Skills/Web%20Development/Forms.md) (4), [Django](../../Skills/Web%20Development/Django.md) (3)
> **CLI Commands:** make (3)
> **Cross-References:** go back to (1)
> **UI Navigation:** go to (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Forms](../../Skills/Web%20Development/Forms.md) (6)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Forms](../../Skills/Web%20Development/Forms.md) (5)
> **CLI Commands:** make (4)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Forms](../../Skills/Web%20Development/Forms.md) (5), [HTML](../../Skills/Web%20Development/HTML.md) (3)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Forms](../../Skills/Web%20Development/Forms.md) (5), [HTML](../../Skills/Web%20Development/HTML.md) (1)
...
> [!transcript]- Transcript
>
> **[0:01](https://www.linkedin.com/learning/django-forms/controlling-the-number-of-formsets?u=76281980&t=1)** - [Nick] So we have the correct code to handle a post request, but we have nothing for a get request. So, let's go ahead and provide an else statement here for it's not a post request, we'll assume that it's a get. And in this situation, we need to return a render just like above, and it'll be all the same, except for we won't be providing the notes. So we'll go ahead and remove the note that we have there. But we'll still be providing the formset 'cause we want people to be able to order a pizza. Now, with that in place, we've got to go create a new template. So under here, I'm going to create a new pizzas.[HTML](../../Skills/Web%20Development/HTML.md). And inside of our pizzas.html, we want a few pieces of information, so let's make like a h1 tag. This is going to tell the user that they can order pizzas, so we'll say Order Pizzas, OK? If there is a note, we'll want to know about that as well. We'll make this a little bit less as an h2 tag, but this is simply going to hold our note, information. Excellent, now it's time for us to create our form, and this is not any ordinary form. This is going to be the formset form, so it's essentially a bunch of [Forms](../../Skills/Web%20Development/Forms.md) all combined into one. Now, at the end of the day, it's actually just one form, but there's a lot of fields that's going to be handled here. So, the first thing that we need to do is provide an action for this form, and that's just going to be the URL that we are currently at,
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [HTML](../../Skills/Web%20Development/HTML.md) (2), [Forms](../../Skills/Web%20Development/Forms.md) (1)
> **CLI Commands:** make (5)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [HTML](../../Skills/Web%20Development/HTML.md) (3), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1), [Django](../../Skills/Web%20Development/Django.md) (1), [Forms](../../Skills/Web%20Development/Forms.md) (1)
> **CLI Commands:** make (5)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Forms](../../Skills/Web%20Development/Forms.md) (5), [Google](../../Glossary/Service/Google.md) (2), [Django](../../Skills/Web%20Development/Django.md) (1), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1), [HTML](../../Skills/Web%20Development/HTML.md) (1)
> **Env Vars:** url (6)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Django](../../Skills/Web%20Development/Django.md) (3), [Forms](../../Skills/Web%20Development/Forms.md) (2), [HTML](../../Skills/Web%20Development/HTML.md) (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Forms](../../Skills/Web%20Development/Forms.md) (5), [HTML](../../Skills/Web%20Development/HTML.md) (3), [Django](../../Skills/Web%20Development/Django.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Forms](../../Skills/Web%20Development/Forms.md) (3), [HTML](../../Skills/Web%20Development/HTML.md) (3), [Django](../../Skills/Web%20Development/Django.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [HTML](../../Skills/Web%20Development/HTML.md) (13)
...
> [!transcript]- Transcript
>
> **[0:01](https://www.linkedin.com/learning/django-forms/next-steps?u=76281980&t=1)** - [Nick] Thanks for coming along and learning about [Django](../../Skills/Web%20Development/Django.md) [Forms](../../Skills/Web%20Development/Forms.md) with me. Hopefully, you've realized how excellent they are and you'll be using them in your projects going forward. Now, as far as next steps goes, if you'd like to dive deeper into how forms work, I'd recommend a course called [HTML & CSS- Creating Forms](HTML%20%26%20CSS-%20Creating%20Forms.md). This isn't Django-specific, but it really gets behind the nuts and bolts about how forms work on the web. Now if you'd like to dive deeper into Django, I have several courses that I think you'd be interested. The first one is how to deploy your Django apps. So in this course we're going to have one project and deploy it to four different places. We're going to be working with DigitalOcean, AWS Beanstalk, Heroku, and even [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md). You'll get to see the differences between each platform and decide which one is right for you. If you want to share your project with the world, this is the course. I also have a course on [Test-Driven Development](../../Skills/Software%20Development/Test-Driven%20Development.md) in Django. This will help ensure that you'll have confidence every time you ship your code. I also have a course on how to build a paid membership site with Django. If you've ever wanted to be able to accept payments and have a site that earns money month after month, this is a really fun course. And I'd love it if you connected with me. You can either connect with me on [LinkedIn](../../Skills/Web%20Development/LinkedIn.md), or on Twitter.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Django](../../Skills/Web%20Development/Django.md) (6), [Forms](../../Skills/Web%20Development/Forms.md) (4), [HTML](../../Skills/Web%20Development/HTML.md) (1), [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) (1), [Test-Driven Development](../../Skills/Software%20Development/Test-Driven%20Development.md) (1)
...
← [Django Essential Training](Django%20Essential%20Training.md) | **2 of 4** | [Deploying Django Apps- Make Your Site Go Live](Deploying%20Django%20Apps-%20Make%20Your%20Site%20Go%20Live.md) →
