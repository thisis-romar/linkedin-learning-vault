...
>
> **[0:00](https://www.linkedin.com/learning/html-metadata-in-the-head/setting-expectations-for-your-document-23202364?u=76281980&t=0)** - When teaching [HTML](../../Skills/Web%20Development/HTML.md), we're so eager for students to get something on the screen that we tend to skip over the HTML head of the document. This course aims to end all of that. We'll explore the tags read by robots and search engines that provide all kinds of information about your website. You'll also learn why you should add these tags, and what it will do to your page's accessibility to search engines and to other automated systems. I'm Jen Kramer, an educator and web developer with years of experience in working with HTML and CSS. So if you're ready, let's get started with "HTML: [Metadata](../../Skills/Web%20Development/Metadata.md) in the Head".

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [HTML](../../Skills/Web%20Development/HTML.md) (4), [Metadata](../../Skills/Web%20Development/Metadata.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [HTML](../../Skills/Web%20Development/HTML.md) (7), [Windows](../../Glossary/Service/Windows.md) (3), [Microsoft](../../Instructors/Artificial%20Intelligence%20(AI)/Microsoft.md) (1), [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) (1)
> **Env Vars:** html (5)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) (3), [HTML](../../Skills/Web%20Development/HTML.md) (2), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/html-metadata-in-the-head/establishing-a-document-type-22994985?u=76281980&t=0)** - [Instructor] In 2020, for the most part, new webpages are built using HTML5. However 10 years ago, when we had webpages built in HTML5, XHTML 1.0 and HTML4, how do we know what type of markup language is being used to create a document? It's the very first line of the page, the DOCTYPE declaration. HTML4 Transitional is a common form of [HTML](../../Skills/Web%20Development/HTML.md) and this is the declaration for that type of HTML. As you can see, it's quite long and it has a lot of elements to it relative to what we see these days with HTML5. HTML 1.0 Transitional is a form of XHTML. XHTML was around for several years and incorporated aspects of XML into the HTML. For example, every tag had to have a closing tag. The other thing you'll notice here in both HTML4 Transitional and XHTML1 Transitional is the transitional. The transitional versus strict designation for HTML4 and XHTML indicated the tolerance for tags like the old font tag or using B for the bold tag. Transitional tolerated these tags while the strict version did not. When HTML5 came along, we had moved far enough away from those presentational markup tags and towards CSS enough that there was no need to have a transitional versus strict DOCTYPE with HTML5.
>
...
>
> **[1:38](https://www.linkedin.com/learning/html-metadata-in-the-head/setting-character-sets-23202363?u=76281980&t=98)** for most human languages. In the old days, in English, we used ISO8859-1. Which included the Latin alphabet, but not languages like Chinese, Japanese, Russian, and other languages that don't use the Latin alphabet. That's when you might see a bunch of question marks and boxes instead of those characters. Finally, as that article mentioned earlier, make sure that this is the very first meta tag that you include in the head of your document. So the fact that I've put it here, and I'll change it back to UTF8, and in fact [Microsoft](../../Instructors/Artificial%20Intelligence%20(AI)/Microsoft.md) puts it here by default, is a really great thing because what happens is let's say we had this later in the document obviously it's going to be in the head but if we had moved this later in the document, say here, what would happen is that your web browser would start to parse the information that's here and when it hit this character set declaration it would actually go back to the beginning and reparse all of this information again using UTF8. While that's pretty trivial for a head section of a document that's as short as this one, if you look around online you'll find heads of documents that are dozens or even hundreds of lines long. So putting this meta character set of UTF8 at the very top, the very first line inside of your head is really important because then you'll only get through a handful of lines
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Google](../../Glossary/Service/Google.md) (8), [JavaScript](../../Skills/Software%20Development/JavaScript.md) (3), [User experience](../../Skills/Web%20Development/User%20Experience%20(UX).md) (1), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Facebook](../../Glossary/Service/Facebook.md) (9), [HTML](../../Skills/Web%20Development/HTML.md) (3), [Metadata](../../Skills/Web%20Development/Metadata.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/html-metadata-in-the-head/checking-your-work-for-facebook-22994984?u=76281980&t=0)** - [Instructor] Once you've created the Open Graph tags in the head of your document, you should put the page online somewhere where it can be reached by the [Facebook](../../Glossary/Service/Facebook.md) Sharing Debugger. This means you could have added those Open Graph tags to the head of a [WordPress](../../Skills/Web%20Development/WordPress.md) site, the top of your [JavaScript](../../Skills/Software%20Development/JavaScript.md)-based application or in the head of your Static [HTML](../../Skills/Web%20Development/HTML.md) webpage, which is what I did here. That page needs to be on the internet, not solely on your local computer, so that the Debugger might index it. So go on ahead and use FTP or [GitHub](../../Skills/Software%20Development/GitHub.md) or whatever you want to use to get that page on some web hosting right now. And when you've done that, copy whatever your address happens to be to get to that webpage and then we're going to go ahead and paste that into the Facebook Sharing Debugger, which is at developers.[facebook.com/tools/debug](https://facebook.com/tools/debug). Go on ahead and hit the debug button once you've pasted that URL in and it will tell you that this URL hasn't been shared on Facebook before. Shocking, you just put it up online so, of course, it hasn't been shared. Go on ahead and click [Fetch](../../Skills/Web%20Development/Fetch.md) new information and Facebook will go out and index that particular page that you shared. And so a couple of things it's going to tell you is this, so the very first thing is that the provided og image's properties are not yet available because new images are processed asynchronously. To ensure that shares of new URLs include an image, specify the dimensions using og image width
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Facebook](../../Glossary/Service/Facebook.md) (16), [WordPress](../../Skills/Web%20Development/WordPress.md) (1), [JavaScript](../../Skills/Software%20Development/JavaScript.md) (1), [HTML](../../Skills/Web%20Development/HTML.md) (1), [GitHub](../../Skills/Software%20Development/GitHub.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/html-metadata-in-the-head/creating-identity-for-your-pages-with-icons-23204069?u=76281980&t=0)** - [Instructor] Icons are another way to brand your website within the web browser. These might take the form of a favicon or as apple-touch-icons, depending on the browser and the device that you're using. A favicon is the little picture you see in the corner of some webpages. For example, note the video player icon in the corner of the [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) Learning window. The apple-touch-icons show up on the desktop of an iPad or iPhone if someone wanted to bookmark a website to that device's desktop. Let's go through making some of these icons together. So, first of all, if you go to this website, this is [manytools.org](https://manytools.org), and within this website they have an apple-touch-icon generator. So, there's two steps to this process. Step one is to actually create the icons that you're going to need, and then step two is to integrate those into the website, and I'll walk you through both of those. So, first of all, we need to make an apple-touch-icon for our Hansel and Petal website. So, we'll go ahead and choose a file for that. And from our Exercise Files folder, Chapter three, video number two, there's this lovely image here called flower.png. Go on ahead and select that, and then click the Convert button. And what this is going to generate for us is a bunch of icons, there they are, for the various different sizes. And you'll notice that they've helpfully given us the [HTML](../../Skills/Web%20Development/HTML.md) code that we're going to need in order to make these work.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [HTML](../../Skills/Web%20Development/HTML.md) (4), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [HTML](../../Skills/Web%20Development/HTML.md) (2), [Google](../../Glossary/Service/Google.md) (1)
...
>
> **[4:42](https://www.linkedin.com/learning/html-metadata-in-the-head/connecting-scripts-22995803?u=76281980&t=282)** about whether this is good [user experience](../../Skills/Web%20Development/User%20Experience%20(UX).md), hint, it's not. But just for illustration purposes, let's say that we want to include this in our document. So now we can go ahead and drop this into the head of the document. Again, this code can go anywhere, just don't put it before the UTF-8 up here at the top in the meta character set tag. So I'm just going to drop it here after my CSS. And if we go ahead and save this web page, then we can come back to our website and hit refresh. And we'll wind up with our alert box that shows up here at the top of this web page.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [JavaScript](../../Skills/Software%20Development/JavaScript.md) (13), [HTML](../../Skills/Web%20Development/HTML.md) (3), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (2), [User experience](../../Skills/Web%20Development/User%20Experience%20(UX).md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/html-metadata-in-the-head/establishing-a-base-url-23201415?u=76281980&t=0)** - [Instructor] The [HTML](../../Skills/Web%20Development/HTML.md) base tag used to be much more popular in the days when we built websites using frames. However, it may still be useful to you depending on what kind of site you're building. And all likelihood base tag is most useful in a web application at this point, and less relevant to a content based website. So let me show you what the base tag looks like. For those of you who weren't around in the frames days. Once again, this base tag can go anywhere in the header of the document, and except before that tag at the top for your character set, so it's going to look like this. Basically, it's a base tag, and then it could be followed by an href. And I could say something like https www.[linkedin.com](https://linkedin.com).
>
> **[0:48](https://www.linkedin.com/learning/html-metadata-in-the-head/establishing-a-base-url-23201415?u=76281980&t=48)** And what this would say this particular version of the tag, would indicate that all of the links in this document, should start with www.[linkedin.com](https://linkedin.com). The second version of this tag, would look like this, it would say base target equals underscore blank, just like that. So in this particular version of the tag, this would indicate that all of the items in this web page, should open in a new window. That would include anything in your navigation, which typically you don't want to wide up opening in a new window, as well as any other links that you find inside of this document. The base tag is typically used for setting a base URL for the document. In other words, all of the links within this document should be preceded by this base, only the [Facebook](../../Glossary/Service/Facebook.md) Open Graph tags don't honor the base tags. So be sure to spell things out there. So, if I wanted these items here in my Facebook, Open Graph items up here on the top, I should absolutely continue to spell that out. I knew those go to [genkramer.org](https://genkramer.org). But they could have gone to [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) if I had been hosting here. And I should continue to spell them out, even if I am making use of the base tag because Open Graph doesn't acknowledge the base. So what would happen if you wanted to override, let's just say, for example, that I wanted to have all of the links in my document open in a new window. But for my navigation, I actually really don't want it to that
>
> **[2:20](https://www.linkedin.com/learning/html-metadata-in-the-head/establishing-a-base-url-23201415?u=76281980&t=140)** I really want it to open in the same window. Well, what you'd have to do is kind of the reverse of what you do now, probably now you go through these links the things that open in a new window, you add the target equals blank to those, but in this case, you going to do the opposite. So here in your navigation, what you would say instead is target equals underscore self. And then you would just go ahead and repeat this four of the links that are in your navigation or anywhere else in this document where you'd like things to open in the same window. So this base tag is going to be most useful in the kind of environment maybe you've got some kind of resource where you have lots, lots, lots of different websites, let's say hundreds or even thousands of links to other websites that you'd like to open a new [Windows](../../Glossary/Service/Windows.md), but a handful of links that you'd like to open in the same window. Using the base target equals underscore blank is probably going to be more useful to you. And as far as the base href goes, unless you're doing something crazy with [JavaScript](../../Skills/Software%20Development/JavaScript.md), chances are you don't really need this tag as much for [Web Development](../../Topics/Web%20Development.md) now, but it's available to you in case you do.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (3), [Facebook](../../Glossary/Service/Facebook.md) (2), [HTML](../../Skills/Web%20Development/HTML.md) (1), [Windows](../../Glossary/Service/Windows.md) (1), [JavaScript](../../Skills/Software%20Development/JavaScript.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [JavaScript](../../Skills/Software%20Development/JavaScript.md) (8)
> **Env Vars:** css (4)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [JavaScript](../../Skills/Software%20Development/JavaScript.md) (3), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/html-metadata-in-the-head/next-steps-23203329?u=76281980&t=0)** - [Jen] Hey, everybody, it's Jen Kramer. Thank you so much for watching my course about all of the exciting [HTML](../../Skills/Web%20Development/HTML.md) tags we have available to us to use in the head of our documents. If you're interested in learning more with me, I thought I'd point you to a couple of courses that I mentioned in this course, as well as some other courses that will add to your HTML skills. So first of all, one of the courses that I mentioned previously was the [CSS- Variables and Fluid Layouts](CSS-%20Variables%20and%20Fluid%20Layouts.md) course. This is an advanced course. It requires a lot of background in HTML and CSS. So if you trend toward the more advanced side of things, feel free to check this out. There's also a course here that I mentioned, Learning Foundation 6. The Topsy Turvy Cake Design website was built using that. Foundation 6 is a free to download, free to use responsive design framework that's really great to work with. So if you're interested in learning more about that, this might be a good course for you. Tables are something that are becoming increasingly useful on the web now, particularly with people wanting to publish data to go along with graphs and so forth that they're making. And in this course, I will walk you through not only the right accessible markup for tables, but how to style those tables and how to make them responsive in a couple of different ways. So this might be one you want to pay some attention to. And finally, [Crafting Meaningful HTML](Crafting%20Meaningful%20HTML.md) is a course that's going to talk about all of the exciting semantic accessible tags
>
...
← [HTML- Tables](HTML-%20Tables.md) | **6 of 11** | [HTML & CSS- Creating Forms](HTML%20%26%20CSS-%20Creating%20Forms.md) →
