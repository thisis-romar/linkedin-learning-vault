...
>
> **[0:00](https://www.linkedin.com/learning/figma-from-design-to-css-implementation/implementing-css-from-your-figma-designs?u=76281980&t=0)** - Tools like [Figma](../../Skills/Web%20Development/Figma%20(Software).md) are great for designing and [Prototyping](../../Skills/Software%20Development/Prototyping.md) user experiences, but when it comes to translating these designs into workable code and content for the web, or other platforms, things get a bit more tricky. We'll use Figma's Inspect workspace to gather the CSS properties for visual documentation purposes before creating a CSS file to establish rules based upon the gathered properties. Finally, we'll establish an [HTML](../../Skills/Web%20Development/HTML.md) file linked to the translated CSS and previously exported images, which contains markup representing our Figma design elements. With some additional refinements, we will produce a fully functional, responsive website landing page. I'm Joseph Labrecque. I invite you to join me in this [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) Learning course.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Figma](../../Skills/Web%20Development/Figma%20(Software).md) (3), [Prototyping](../../Skills/Software%20Development/Prototyping.md) (1), [HTML](../../Skills/Web%20Development/HTML.md) (1), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Figma](../../Skills/Web%20Development/Figma%20(Software).md) (3), [GitHub](../../Skills/Software%20Development/GitHub.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Figma](../../Skills/Web%20Development/Figma%20(Software).md) (1), [Google](../../Glossary/Service/Google.md) (1), [Android](../../Glossary/Sdk/Android.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/figma-from-design-to-css-implementation/documenting-the-project-css?u=76281980&t=0)** - [Instructor] Before creating the actual CSS and [HTML](../../Skills/Web%20Development/HTML.md) files for the translation from [Figma](../../Skills/Web%20Development/Figma%20(Software).md), it's good practice to document the necessary project elements, establishing identifiers in consideration of the visual elements upon which they're derived. We'll do this with our Figma design file, creating a visual design document for all steps moving forward. The first thing we need to do is create a new frame to hold all of this. So I'm going to [Zoom](../../Skills/Software%20Development/Zoom.md) out and use our frame tool to drag out a new frame right here. With that frame selected, let's go ahead and rename it to Design Document. Looking toward the design workspace, I want to make sure that the width here is wide enough. I'm going to set it at 1096. And for the height, let's choose 1280. I want to change the fill color so it's nice and dark, so I'm going to set that to a dark gray, a text code 19, 19, 19. And then I can reposition it right next to our landing page. We're going to be copying some
>
> **[1:32](https://www.linkedin.com/learning/figma-from-design-to-css-implementation/documenting-the-project-css?u=76281980&t=92)** of the text attributes from the inspect workspace and placing them within our design document and then matching them up with visuals, so I'm going to need some text. Choosing the text tool, let's go ahead and drag in a text object that's about one half the width of our design document. Once again, inside of the design workspace, we'll change our text properties. [Ubuntu](../../Skills/Web%20Development/Ubuntu.md) is fine for this text. Bold is good. 35 is a bit too much. That's very large. So we're going to change that to 17. The line height at 125% will work, and I'm going to change my paragraph spacing to 10 just to give it a little more breathing room, and we can align the text to the top. I think that'll work just fine, and to the left, of course. The text fill is going to be white, which is going to stand out very well from the dark background. Let's go ahead now and copy some of these elements, in particular, the IDs from our content on the landing page and place them inside of our design document. Now, before we move on, I'm going to put in a little X here. That's going to act as a placeholder for when we are switching between documents. That'll go away soon enough, but you must have something inside of your text element in order for it to stick around.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Figma](../../Skills/Web%20Development/Figma%20(Software).md) (2), [HTML](../../Skills/Web%20Development/HTML.md) (1), [Zoom](../../Skills/Software%20Development/Zoom.md) (1), [Ubuntu](../../Skills/Web%20Development/Ubuntu.md) (1)
...
>
> **[4:23](https://www.linkedin.com/learning/figma-from-design-to-css-implementation/defining-a-css-document?u=76281980&t=263)** And finally, our footer text. There we have it. Now that we have our actual CSS rules established in a real CSS file, these can be applied to an [HTML](../../Skills/Web%20Development/HTML.md) document.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Figma](../../Skills/Web%20Development/Figma%20(Software).md) (4), [HTML](../../Skills/Web%20Development/HTML.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [HTML](../../Skills/Web%20Development/HTML.md) (6), [Figma](../../Skills/Web%20Development/Figma%20(Software).md) (4)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Figma](../../Skills/Web%20Development/Figma%20(Software).md) (5)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/figma-from-design-to-css-implementation/what-s-next?u=76281980&t=0)** - [Joseph] With the course now concluded, you have a good idea of the workflow involved when translating a design file in [Figma](../../Skills/Web%20Development/Figma%20(Software).md) to the web via CSS and [HTML](../../Skills/Web%20Development/HTML.md). We first exported any image assets that we would need from our design documents into files. We then used the inspect workspace in Figma to gather the CSS properties from various visual design elements within our document. After visually documenting these elements and properties, we then created a proper CSS file and translated the raw properties into a set of valid CSS rules. We then established an HTML file and linked our CSS to it, along with the markup representing the various design elements. A few refinements later, and we have produced a fully functional responsive landing page based on the original Figma design document. I'm Joseph Labrecque and I hope you enjoyed working with Figma and CSS in this course. Thank you for joining me.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Figma](../../Skills/Web%20Development/Figma%20(Software).md) (4), [HTML](../../Skills/Web%20Development/HTML.md) (2)
...
← [Designing Microinteractions with Figma](Designing%20Microinteractions%20with%20Figma.md) | **6 of 6**
