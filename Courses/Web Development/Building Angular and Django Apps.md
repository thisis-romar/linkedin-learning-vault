...
prev_courses:
  - '[Building React And Django Apps](Building%20React%20And%20Django%20Apps.md)'
next_courses:
  - '[Building RESTful Web APIs with Django](Building%20RESTful%20Web%20APIs%20with%20Django.md)'
...
>
> **[0:00](https://www.linkedin.com/learning/building-angular-and-django-apps/create-a-full-stack-angular-app-with-the-django-rest-framework?u=76281980&t=0)** - [Instructor] Learning [Angular](../../Skills/Web%20Development/Angular.md) is a rewarding experience and gives you the skills to become a full stacked developer. By working with [rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) APIs through [Django](../../Skills/Web%20Development/Django.md) and [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md), you can build fully-featured front-end interfaces with Angular. You'll use Angular's built-in HTTP client to communicate between the front end and the back end server. Angular Material allows you to display data in tables, show pop ups, and use a grid layout to make the front end easy to use and awesome. Angular Animations are also covered to give some life to your front end interface. Then, we'll make our app production ready with Oauth authentication, unit tests, and end-to-end tests. Hi, I'm Rudolf. I've been optimizing developer feedback loops for the past 10 years. Join me in my [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) Learning course to create a full stack app.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Angular](../../Skills/Web%20Development/Angular.md) (5), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1), [Django](../../Skills/Web%20Development/Django.md) (1), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (1), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/building-angular-and-django-apps/what-you-should-know?u=76281980&t=0)** - [Instructor] For this course you will need to know some [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md), you can check out the book "Learn Python the Hard Way" or the [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) Learning Course Learning Python Two. There's also the LinkedIn Learning Course for learning [Django](../../Skills/Web%20Development/Django.md). And [Building RESTful Web APIs with Django](Building%20RESTful%20Web%20APIs%20with%20Django.md). And you will also need to know some [JavaScript](../../Skills/Software%20Development/JavaScript.md).

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (3), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (2), [Django](../../Skills/Web%20Development/Django.md) (2), [JavaScript](../../Skills/Software%20Development/JavaScript.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/building-angular-and-django-apps/demo-project-overview?u=76281980&t=0)** - [Instructor] We have already installed some libraries for you to use with [Django](../../Skills/Web%20Development/Django.md). Django the web framework of course, and Django [REST](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) framework for creating REST APIs. And we've also installed Django-filter for filtering querysets and models and the Django OAuth Toolkit for OAuth2 authentication. On the front-end we have installed the following modules, [Angular](../../Skills/Web%20Development/Angular.md), Angular Router and Angular Material for Material Design components, and Protractor for [End-to-end Testing](../../Skills/Software%20Development/End-to-end%20Testing.md) of Angular apps. We have already built some parts of the project for you as well. We have already built a Django model for packages and a few components in Angular for displaying those packages.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Django](../../Skills/Web%20Development/Django.md) (6), [Angular](../../Skills/Web%20Development/Angular.md) (5), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (2), [End-to-end Testing](../../Skills/Software%20Development/End-to-end%20Testing.md) (1)
> **Env Vars:** rest (2)
> **Speakers:** - [instructor] (1)
...
>
> **[0:53](https://www.linkedin.com/learning/building-angular-and-django-apps/running-the-angular-and-django-development-servers?u=76281980&t=53)** The Angular development server is configured in the proxy conf [JSON](../../Skills/Web%20Development/JSON.md) file to proxy any requests made to /api and /oauth directly to the Django web server.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Angular](../../Skills/Web%20Development/Angular.md) (5), [Django](../../Skills/Web%20Development/Django.md) (4), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (2), [Web Servers](../../Skills/Web%20Development/Web%20Servers.md) (1), [JSON](../../Skills/Web%20Development/JSON.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/building-angular-and-django-apps/compiling-angular-code?u=76281980&t=0)** - [Announcer] We can use the [Angular](../../Skills/Web%20Development/Angular.md) command-line interface to compile the code for production. All we need to do is run this command. The dash dash prod is important because it enables production mode in Angular, and turns on compiler features that will lower file sizes, remove some debugging utilities and improve performance. In the angular.[JSON](../../Skills/Web%20Development/JSON.md) configuration file, you can see certain options are turned on for production compilation, such as sourceMap is false, extractCss is true, aot, Ahead-of-Time is true, and so on. Let's see what files were produced as part of the build.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Angular](../../Skills/Web%20Development/Angular.md) (3), [JSON](../../Skills/Web%20Development/JSON.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/building-angular-and-django-apps/serving-angular-code-through-django-static-files?u=76281980&t=0)** - [Instructor] Now that we have the compiled version of our [Angular](../../Skills/Web%20Development/Angular.md) app, we need to add a setting to the [Django](../../Skills/Web%20Development/Django.md) backend called front end root which will point to the path where it can be found. In the URLs configuration of Django, we add a new regular expression URL. It will point all URLs to the front end directory that we defined in the settings file. Now we run the Django web server, and let's go to local host at port 8000 index.[HTML](../../Skills/Web%20Development/HTML.md) and we can see that the compiled angular app has loaded up.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Django](../../Skills/Web%20Development/Django.md) (3), [Angular](../../Skills/Web%20Development/Angular.md) (2), [HTML](../../Skills/Web%20Development/HTML.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Django](../../Skills/Web%20Development/Django.md) (4), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (4)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (7), [Django](../../Skills/Web%20Development/Django.md) (3), [Angular](../../Skills/Web%20Development/Angular.md) (2)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/building-angular-and-django-apps/creating-a-basic-form-as-an-angular-component?u=76281980&t=0)** - [Instructor] Let's create a form component so that users can create new tour packages. We import the form control and the form group from [Angular](../../Skills/Web%20Development/Angular.md) [Forms](../../Skills/Web%20Development/Forms.md), which provides a way to construct reactive forms that use two-way data bind. In our create tour form component, we add two instance variables, package form, which is a form group, and one input to the component, which is id, the id of an existing package. In the constructor, we're going to be depending on the tour package controller. And in the lifecycle on Angular component, this constructor is called once, to inject this dependency. In contrast, the ngOnInit method is called every time the component is initialized and injected into the DOM. So we're going to set up the default values for the package form, by creating a new form group, we set up the id, and the default is zero to indicate it's a new package. And then, we're going to set up the other fields, the category,
>
> **[1:34](https://www.linkedin.com/learning/building-angular-and-django-apps/creating-a-basic-form-as-an-angular-component?u=76281980&t=94)** which has a default value of tour, the name, it's tour package, the promo, a tour length, the price, the rating, and start. This is a [Java](../../Skills/Software%20Development/Java.md) script data object. We also have a place holder save method that will be called whenever we click the save button. Now let's update the [HTML](../../Skills/Web%20Development/HTML.md) template for the create tour form. We're going to create the form and then bind the form group to the package form. Then we create our first field using Angular material form fields. It uses an Angular material label and our input will be a text with the form control name set to name, and we are using the Angular material input style as well. And again, we're going to do this for the other fields. We have category,
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Angular](../../Skills/Web%20Development/Angular.md) (7), [Forms](../../Skills/Web%20Development/Forms.md) (2), [Java](../../Skills/Software%20Development/Java.md) (1), [HTML](../../Skills/Web%20Development/HTML.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Angular](../../Skills/Web%20Development/Angular.md) (1)
> **UI Navigation:** go to (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/building-angular-and-django-apps/setting-up-authentication-with-django-oauth-toolkit?u=76281980&t=0)** - [Instructor] Our app is designed for administrators and tour operators to use. This means we're going to need authentication. [Django](../../Skills/Web%20Development/Django.md) OAUTH Tool Kit provides an easy way to add OAUTH token based authentication. We need to update the middleware setting in our settings pi file. And we add oauth2_provider.middleware. And then we need to find the authentication backend setting. We're going to remove the no authentication backend that we've been using. And we're going to insert an oauth2_provider.backend.
>
> **[0:45](https://www.linkedin.com/learning/building-angular-and-django-apps/setting-up-authentication-with-django-oauth-toolkit?u=76281980&t=45)** We must configure the oauth2 provider, specifically the backend class because we are going to be using [JSON](../../Skills/Web%20Development/JSON.md) data payloads with this [rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) API server. And then we have to configure Django rest framework to no longer use the no authentication backend and instead to use the oauth2_provider rest framework specific oauth2 authentication.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (3), [Django](../../Skills/Web%20Development/Django.md) (2), [JSON](../../Skills/Web%20Development/JSON.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Django](../../Skills/Web%20Development/Django.md) (3), [Angular](../../Skills/Web%20Development/Angular.md) (2), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (2)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/building-angular-and-django-apps/using-oauth-headers-with-angular-and-httpclient?u=76281980&t=0)** - [Instructor] Now that we can login, we need to reuse the Oauth access token in all of our [rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) API requests. We can update the common options method in the rest API service class to populate the HTTP client headers. When the user is logged out, we can return an empty header. However, when the user is logged in, the headers will include the authorization header,
>
...
>
> **[0:50](https://www.linkedin.com/learning/building-angular-and-django-apps/using-oauth-headers-with-angular-and-httpclient?u=76281980&t=50)** Now let's run the [Django](../../Skills/Web%20Development/Django.md) dev server and [Angular](../../Skills/Web%20Development/Angular.md)'s dev server
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (2), [Django](../../Skills/Web%20Development/Django.md) (1), [Angular](../../Skills/Web%20Development/Angular.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/building-angular-and-django-apps/checking-permissions-with-django?u=76281980&t=0)** - [Instructor] To add permission checking per object, we can use the base filter back in from [Django](../../Skills/Web%20Development/Django.md) [rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) framework. We can also use our pre-existing package permission model from API models. And now we can start writing our filter. That's a sub class of base filter backend. And we are overwriting the filter query set method. And the query set will be filtered through the check permission method.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Django](../../Skills/Web%20Development/Django.md) (1), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1), [Angular](../../Skills/Web%20Development/Angular.md) (1)
> **Env Vars:** api (1)
> **UI Navigation:** go to (1)
> **Speakers:** - [instructor] (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (3), [Angular](../../Skills/Web%20Development/Angular.md) (1), [Django](../../Skills/Web%20Development/Django.md) (1)
> **Env Vars:** api (3)
> **UI Navigation:** go to (2)
> **CLI Commands:** make (1)
> **Speakers:** - [instructor] (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (3), [Angular](../../Skills/Web%20Development/Angular.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Angular](../../Skills/Web%20Development/Angular.md) (2), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [JSON](../../Skills/Web%20Development/JSON.md) (2), [Django](../../Skills/Web%20Development/Django.md) (1), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Angular](../../Skills/Web%20Development/Angular.md) (3)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (4), [Angular](../../Skills/Web%20Development/Angular.md) (3), [Unit Testing](../../Skills/Software%20Development/Unit%20Testing.md) (1), [Fetch](../../Skills/Web%20Development/Fetch.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/building-angular-and-django-apps/unit-testing-a-service?u=76281980&t=0)** - [Instructor] Now we're going to be testing on [Angular](../../Skills/Web%20Development/Angular.md) service, the [rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) API service. We begin by creating it here, and before every test, we're going to be initializing that service. Going to call test bed and get rest API service.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (7), [Angular](../../Skills/Web%20Development/Angular.md) (2), [Django](../../Skills/Web%20Development/Django.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1), [Angular](../../Skills/Web%20Development/Angular.md) (1)
> **Env Vars:** api (3), http (1)
> **Definitions:** is a  (2)
> **CLI Commands:** make (1)
> **Tools:** command line (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/building-angular-and-django-apps/next-steps?u=76281980&t=0)** - [Rudolf] Thanks for watching this course. The next steps you can take are to watch another [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) Learning course, "[Angular](../../Skills/Web%20Development/Angular.md): Material Design," or you can check out how to make cool animations with Angular in "Angular: Animations." Or, become a [Django](../../Skills/Web%20Development/Django.md) developer with the learning path "Become a Django Developer." Thanks again for watching.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Angular](../../Skills/Web%20Development/Angular.md) (3), [Django](../../Skills/Web%20Development/Django.md) (2), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (1)
> **CLI Commands:** make (1)
> **Speakers:** - [rudolf] (1)
...
← [Building React And Django Apps](Building%20React%20And%20Django%20Apps.md) | **2 of 6** | [Building RESTful Web APIs with Django](Building%20RESTful%20Web%20APIs%20with%20Django.md) →
