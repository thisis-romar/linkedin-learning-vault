...
>
> **[0:00](https://www.linkedin.com/learning/protopie-for-ux-design/what-to-expect-from-this-course?u=76281980&t=0)** - [Ronnie] Hello, my name is Ronnie McBride and I'll be your instructor for this [ProtoPie](../../Skills/Web%20Development/ProtoPie.md) essential course. I'll begin this course with an overview of the ProtoPie interface, then we'll go through the core concepts and processes for [Prototyping](../../Skills/Software%20Development/Prototyping.md). Next, I'll demonstrate various methods for importing assets. I'll cover interactions like paging and scrolling. And we'll talk about organizing your layers, creating components and defining variables and formulas. There is much to cover, but after completing this course, I hope you feel confident and proficient at navigating and applying what you learned here in your own personal work.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [ProtoPie](../../Skills/Web%20Development/ProtoPie.md) (2), [Prototyping](../../Skills/Software%20Development/Prototyping.md) (1)
> **Speakers:** - [ronnie] (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [ProtoPie](../../Skills/Web%20Development/ProtoPie.md) (17), [Windows](../../Glossary/Service/Windows.md) (2), [Android](../../Glossary/Sdk/Android.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/protopie-for-ux-design/interface-overview?u=76281980&t=0)** - [Instructor] In this video, I'd like to walk you through the [ProtoPie](../../Skills/Web%20Development/ProtoPie.md) interface. If you've worked in other design applications, you'll find that the commonalities between ProtoPie's interface and those other applications should feel familiar. What I wanted to do, was make sure that designers that were designing within this application could easily pick it up and so they've made sure that the environment they were working in had those kind of similarities that would make them feel comfortable. So if you look over here on the left-hand side, we'll start at the top of the toolbar of the interface. And if you click Import, you'll see that you can import [Figma](../../Skills/Web%20Development/Figma%20(Software).md) files, Adobe, XD files, and sketch files. These three programs all have plugins that allow you to import from those applications or from within Figma itself. So those are the most popular ones. If you're using another application, you'll be able to export from that application and import it a different way. That way would be here. If you click on Media, you can import those individual assets right into your application, and then start [Prototyping](../../Skills/Software%20Development/Prototyping.md). The next tool is the Shape tool. There's some basic shapes in here for you to use, ProtoPie is not a design application, it's a prototyping application. And so you would do all your design work in those other applications, but then you would use the tools in ProtoPie to create the interactivity to build out your prototype. If you click on Text, you'll be able to create static text or input text. If you click on Container, you'll be able to import three different types of containers
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [ProtoPie](../../Skills/Web%20Development/ProtoPie.md) (7), [Figma](../../Skills/Web%20Development/Figma%20(Software).md) (2), [Prototyping](../../Skills/Software%20Development/Prototyping.md) (2), [Android](../../Glossary/Sdk/Android.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [ProtoPie](../../Skills/Web%20Development/ProtoPie.md) (6), [Figma](../../Skills/Web%20Development/Figma%20(Software).md) (1)
> **CLI Commands:** make (2)
> **UI Navigation:** click on (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [ProtoPie](../../Skills/Web%20Development/ProtoPie.md) (11), [Adobe XD](../../Skills/Web%20Development/Adobe%20XD.md) (2), [Figma](../../Skills/Web%20Development/Figma%20(Software).md) (1), [Prototyping](../../Skills/Software%20Development/Prototyping.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [ProtoPie](../../Skills/Web%20Development/ProtoPie.md) (2)
> **CLI Commands:** make (7)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [ProtoPie](../../Skills/Web%20Development/ProtoPie.md) (7), [Figma](../../Skills/Web%20Development/Figma%20(Software).md) (1), [Adobe XD](../../Skills/Web%20Development/Adobe%20XD.md) (1), [Products](../../Skills/Software%20Development/Microsoft%20Products.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [ProtoPie](../../Skills/Web%20Development/ProtoPie.md) (3)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [ProtoPie](../../Skills/Web%20Development/ProtoPie.md) (4), [Android](../../Glossary/Sdk/Android.md) (1)
> **UI Navigation:** click on (4)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [ProtoPie](../../Skills/Web%20Development/ProtoPie.md) (4), cursor (1)
...
- [Ronnie McBride](../../Instructors/Web%20Development/Ronnie%20McBride.md)
...
← [Lo-Fi to Hi-Fi- Prototyping in Figma](Lo-Fi%20to%20Hi-Fi-%20Prototyping%20in%20Figma.md) | **4 of 6** | [Sketching For Ux Designers](Sketching%20For%20Ux%20Designers.md) →
