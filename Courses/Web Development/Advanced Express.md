...
prev_courses:
  ...
  - '[Node.js- Debugging and Performance Tuning](Node.js-%20Debugging%20and%20Performance%20Tuning.md)'
next_courses:
  - '[Node.js- Web Servers, Tests, and Deployment](Node.js-%20Web%20Servers%2C%20Tests%2C%20and%20Deployment.md)'
  - '[Node.js- Microservices](Node.js-%20Microservices.md)'
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/advanced-express/what-you-should-know?u=76281980&t=0)** - [Instructor] This course is not a beginner's course. If you're just getting started with Express, I recommend you my course Building a Website with [Node.js](../../Skills/Web%20Development/Node.js.md) and Express from the library. This course here builds on what we've learned there. To get the most out of this course, you should have knowledge in [JavaScript](../../Skills/Software%20Development/JavaScript.md), of course, and there you should know variables, functions, and callbacks, at the very least. You should also know and understand ES6 syntax. This means you should know classes, you should understand arrow functions, the spread syntax, and object destructuring because I'm using it throughout the videos. And, of course, you should also understand promises and async/await. You should, at least, have basic Node.js knowledge. You should know how to install Node.js, how to use [npm](../../Skills/Web%20Development/npm.md), and how to run an application. You should have intermediate knowledge in Express. This means you should know how HTTP works, how to set up an Express project, how the request lifecycle works, and how [Routing](../../Skills/Network%20and%20System%20Administration/Routing.md) and middlewares work. As I said, this is all covered in the course Building a Website with Node.js and Express.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Node.js](../../Skills/Web%20Development/Node.js.md) (4), [JavaScript](../../Skills/Software%20Development/JavaScript.md) (1), [npm](../../Skills/Web%20Development/npm.md) (1), [Routing](../../Skills/Network%20and%20System%20Administration/Routing.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/advanced-express/get-your-tools-ready?u=76281980&t=0)** - [Instructor] Before we really get started, let's make sure that you have all the tools needed on your machine. First, let's install an editor. In this course, I will use Visual Studio Code. It's free and it comes with great [Node.js](../../Skills/Web%20Development/Node.js.md) support out of the box. I highly recommend that you use it as well, at least for this course. After installing it, you can open it right away and it will present you with a welcome screen. Visual Studio Code comes with an integrated terminal that lets you run shell commands. Let's open it by selecting View, Terminal. And there, now let's check if we have the right version of Node.js installed. You see that I'm having 10.14.1 installed, which is the currently long-term supported version of Node.js. If you haven't Node.js installed yet, just head over to the Node.js website and install the currently long-term supported version there. Let's also check the version of [npm](../../Skills/Web%20Development/npm.md). We see that we have 6.4.1 installed right now, and we can use NPM to update itself, so let's make sure that we have the latest version of NPM in place, and for that, I run sudo because I'm on a Mac and I need elevated privileges. NPM install -g for globally, npm@latest. Okay, we see that we already have the latest version of NPM installed. The sampler project we will be working on
>
> **[1:35](https://www.linkedin.com/learning/advanced-express/get-your-tools-ready?u=76281980&t=95)** comes with a configuration for [ESLint](../../Skills/Software%20Development/ESLint.md). There is a Visual Studio Code extension for ESLint. You can install it by clicking on the extensions icon on the left menu bar and then looking for ESLint. And simply installing it. Now you have all the tools needed in place and we can proceed with the [rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) of the course.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [npm](../../Skills/Web%20Development/npm.md) (6), [Node.js](../../Skills/Web%20Development/Node.js.md) (5), [ESLint](../../Skills/Software%20Development/ESLint.md) (3), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [HTML](../../Skills/Web%20Development/HTML.md) (7), [npm](../../Skills/Web%20Development/npm.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [MongoDB](../../Skills/Software%20Development/MongoDB.md) (7), [Databases](../../Skills/Software%20Development/Databases.md) (2), [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) (1), [Windows](../../Glossary/Service/Windows.md) (1)
...
>
> **[3:10](https://www.linkedin.com/learning/advanced-express/connecting-to-mongodb?u=76281980&t=190)** all tests are passing, which means that we can connect to [MongoDB](../../Skills/Software%20Development/MongoDB.md) at-list properly. Again, if your IP address tends to change frequently, please make sure that you have white listed your current IP address if the connect suddenly fails.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Databases](../../Skills/Software%20Development/Databases.md) (2), [Version Control](../../Skills/Web%20Development/Version%20Control.md) (2), [MongoDB](../../Skills/Software%20Development/MongoDB.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/advanced-express/adding-mongodb-and-mongoose-to-an-express-project?u=76281980&t=0)** - [Instructor] With all the credentials in place, we will now make [MongoDB](../../Skills/Software%20Development/MongoDB.md) available to Express. For that, we will use Mongoose. Mongoose is an object [Data Modeling](../../Skills/Data%20Science/Data%20Modeling.md) laboratory for MongoDB. It's very commonly used, lets us create schemas and makes working with Mongoose from NodeJS generally easier. On the flip side it comes with some performance overhead. So if your applications are heavy on database reads and writes and you run into performance issues, Mongoose might be an optimization target. Let's install Mongoose now, for that, I type, [npm](../../Skills/Web%20Development/npm.md) install --save and my project wrote.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [MongoDB](../../Skills/Software%20Development/MongoDB.md) (5), [npm](../../Skills/Web%20Development/npm.md) (2), [Data Modeling](../../Skills/Data%20Science/Data%20Modeling.md) (1)
...
>
> **[0:50](https://www.linkedin.com/learning/advanced-express/creating-a-user-schema-for-mongoose?u=76281980&t=50)** and we also want to add some functionality to validate the data and validate the email address is a solved problem so we will install a module for that. So in the terminal I run [npm](../../Skills/Web%20Development/npm.md) install --save
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/advanced-express/testing-the-form-and-reviewing-the-data-in-mongodb?u=76281980&t=0)** - [Instructor] With the route in place, now let's try this form out for real. So I fill it out, my name, my email address. You should remember the email address and the password you're using here because we will need it a little bit later. And I submit it, and I get the thank you for your registration message back. As we are using [MongoDB](../../Skills/Software%20Development/MongoDB.md) Atlas, we can now easily head over to their UI to see how the data actually looks in the database. So, in the Atlas dashboard, I click on my Cluster0 here, and go into Collections, and when I then look into development users, you see the newly created user with a ObjectId that is automatically provided by MongoDB, the username, the email address, the hash password using bcrypt, and also the createdAt and updatedAt time stamps, and this __v, that is a field that is internal to Mongo. Of course this is not a full-blown [User Management](../../Skills/Web%20Development/User%20Management.md) system. For that, you'd also want to add functionality for users to update their data, or maybe you even want to send out confirmation emails. In our case though, it's enough if we can create users, and in the next chapter we will use Passport to authenticate users against a database.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [MongoDB](../../Skills/Software%20Development/MongoDB.md) (2), [User Management](../../Skills/Web%20Development/User%20Management.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Fetch](../../Skills/Web%20Development/Fetch.md) (2), [HTML](../../Skills/Web%20Development/HTML.md) (1), [JavaScript](../../Skills/Software%20Development/JavaScript.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/advanced-express/adding-cookies-and-sessions-to-express?u=76281980&t=0)** - [Instructor] As shown in the previous video we will need cookie parser to read cookies from the raw request header. So I'm installing that now in [npm](../../Skills/Web%20Development/npm.md) install --save cookie-parser and we need to recall it in our app.js file. So somewhere on top of the file add, const cookieParser = require('cookie-parser').
>
> **[0:33](https://www.linkedin.com/learning/advanced-express/adding-cookies-and-sessions-to-express?u=76281980&t=33)** CookieParser is a middleware. This means we also have to add it to the chain of middlewares via app.use. And for that I'm going down to line 24, right after the bodyParser. I will now add app.use(cookieParser). And we're calling it as a function So we have to add parentheses here in the end. From now on Express will give us cookies in request.cookies. Next, let's plug in the session management. For that install express session into install-- save express-session and to store the sessions in [MongoDB](../../Skills/Software%20Development/MongoDB.md) I will install connect-mongo and now on top of app.js again
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [npm](../../Skills/Web%20Development/npm.md) (1), [MongoDB](../../Skills/Software%20Development/MongoDB.md) (1), [ESLint](../../Skills/Software%20Development/ESLint.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Node.js](../../Skills/Web%20Development/Node.js.md) (1), [Facebook](../../Glossary/Service/Facebook.md) (1)
...
>
> **[2:23](https://www.linkedin.com/learning/advanced-express/adding-passport-to-express?u=76281980&t=143)** In my templates, I want to show different navigation options depending on if the user is logged in or not. So, let's create another middleware that sets the user on res.locals which is globally available in all templates. See my course Building a Website with [Express.js](../../Skills/Web%20Development/Express.js.md) if this is unfamiliar to you. So, I will now head over back to auth.js and there I add a new exported property setUser
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [npm](../../Skills/Web%20Development/npm.md) (2), [Express.js](../../Skills/Web%20Development/Express.js.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/advanced-express/setting-up-an-authentication-strategy-for-passport?u=76281980&t=0)** - [Narrator] Eventually we want to authenticate users against our [MongoDB](../../Skills/Software%20Development/MongoDB.md) Database. For that, we already created a user model. Now we want to implement all flows and methods related to authentication. Let's open the auth.js. And as we know, passport gives us a set of different authentication strategies. To authenticate against the local database we need the local strategy. It's not bundled with passport. So we need to install the respective model. For that I'll run [npm](../../Skills/Web%20Development/npm.md) install, dash dash save, passport dash local. And now in auth.js I can add const, local strategy,
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [MongoDB](../../Skills/Software%20Development/MongoDB.md) (1), [npm](../../Skills/Web%20Development/npm.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/advanced-express/serializing-and-deserializing-users?u=76281980&t=0)** - [Instructor] When it comes to serialization, deserialization of users, it's up to us to decide what to store in the session. We could store the whole user object, but this would also mean that when a user is deleted or data is changed, the stored user object in the session would still be the same. It's better to just store the user ID and use this ID to retrieve the user from the database for every time the session is loaded. So, let's implement this serialization and deserialization now. I will add here, after line 19, passport.serializeUser and this function gets the actual user as first argument and the done callback. And all we do here now is we return done with null error, but a user._id. And we see that [ESLint](../../Skills/Software%20Development/ESLint.md) is now complaining a bit here. Here on line 21, it's telling us that the block statement could be optimized. So, let's let eslint just fix that. So, I'm clicking into this line, and do you see now this light bulb showing up? And there I select Fix this arrow-body style problem. And eslint will then optimize that to a more shortcut syntax. We also see that eslint
>
...
>
> **[4:03](https://www.linkedin.com/learning/advanced-express/handling-multipart-form-data-with-multer?u=76281980&t=243)** and there I have to scroll down a little bit and we see that we have the request body now again with the regular form fields and further down we now also have a file object that contains a buffer with binary data along with some [Metadata](../../Skills/Web%20Development/Metadata.md) to tell us more about the actually uploaded file. So far so good. In the next video, we will work on resizing and storing this file.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [npm](../../Skills/Web%20Development/npm.md) (1), [Metadata](../../Skills/Web%20Development/Metadata.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Routing](../../Skills/Network%20and%20System%20Administration/Routing.md) (1), [Fetch](../../Skills/Web%20Development/Fetch.md) (1), [Metadata](../../Skills/Web%20Development/Metadata.md) (1)
...
>
> **[5:33](https://www.linkedin.com/learning/advanced-express/serving-images?u=76281980&t=333)** and add a second argument binary. And Express will take care of the [rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md). And we also have to make this function Async. Let's reload the application. And on the website, let's reload. And now, we also have an avatar picture as thumbnail for the user menu. This is now, also, a good occasion to run all tests that come with the project. So, I will now simply run, [npm](../../Skills/Web%20Development/npm.md) run. And this will recursively run all tests in the test directory. And let's see what it gives us. It can take a little bit because it's still plenty of tests. It looks good so far. It's always an exciting moment in a project. And we see that all 32 tests are passing. This means that we have now flashed out all application logic needed.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1), [npm](../../Skills/Web%20Development/npm.md) (1)
> **Analogies:** picture (5)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [npm](../../Skills/Web%20Development/npm.md) (2), [User experience](../../Skills/Web%20Development/User%20Experience%20(UX).md) (1), [Express.js](../../Skills/Web%20Development/Express.js.md) (1), [HTML](../../Skills/Web%20Development/HTML.md) (1)
> **CLI Commands:** make (2), npm (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Node.js](../../Skills/Web%20Development/Node.js.md) (4)
> **CLI Commands:** node (6)
> **File Paths:** node.js (4)
...
>
> **[2:14](https://www.linkedin.com/learning/advanced-express/securing-an-express-application?u=76281980&t=134)** And back on the browser, let's open from developer tools. Let's reload the page and when we click on the request for localhost we see that helmet set a few headers here that deal with different kinds of attacks. Later as mentioned we will add an additional level of security by serving requests not directly from [Node.js](../../Skills/Web%20Development/Node.js.md) but via Ngenix as reverse proxy.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [npm](../../Skills/Web%20Development/npm.md) (4), [Node.js](../../Skills/Web%20Development/Node.js.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/advanced-express/deployment-and-operation-with-pm2?u=76281980&t=0)** - [Instructor] In this video, I will deploy our application to a server using PM2. PM2 is a very powerful process manager that also comes with a feature that lets us deploy a project. This is a good option for smaller projects. In larger projects you might have a whole deployment pipeline that takes care of that. As server, I'm using an [EC2](../../Skills/DevOps/Amazon%20EC2.md) instance, but any host on the internet will do. On this host, I installed [Node.js](../../Skills/Web%20Development/Node.js.md) and PM2 and I created the user Node.js and a directory on Node.js deploy. I also added the public SSH key of my development machine to the list of authorized keys. PM2 tool relies on [Git](../../Skills/Software%20Development/Git.md) to deploy project from. For that I pushed it to a [GitHub](../../Skills/Software%20Development/GitHub.md) repository. Additionally, I copied my .env file into the deploy directory because it's not published to GitHub for obvious security reasons. On [MongoDB](../../Skills/Software%20Development/MongoDB.md) Atlas, I also white listed the IP of my server so that it can then connect to the MongoDB cluster. To setup the deployment on all development machine, we first have to install PM2. I want to install it globally, so I run sudo [npm](../../Skills/Web%20Development/npm.md) install -g pm2. This asks me for my user password, and then it will install PM2 globally on my development machine. As mentioned, PM2 can handle deployments for us. For that, it needs
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Node.js](../../Skills/Web%20Development/Node.js.md) (3), [Ec2](../../Skills/DevOps/Amazon%20EC2.md) (2), [Git](../../Skills/Software%20Development/Git.md) (2), [GitHub](../../Skills/Software%20Development/GitHub.md) (2), [MongoDB](../../Skills/Software%20Development/MongoDB.md) (2)
...
>
> **[3:35](https://www.linkedin.com/learning/advanced-express/running-behind-a-web-server?u=76281980&t=215)** Now let's commit it to my [Version Control](../../Skills/Web%20Development/Version%20Control.md), updated for proxies, and let's upload from here.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Node.js](../../Skills/Web%20Development/Node.js.md) (1), [Ec2](../../Skills/DevOps/Amazon%20EC2.md) (1), [Version Control](../../Skills/Web%20Development/Version%20Control.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/advanced-express/next-steps?u=76281980&t=0)** - [Daniel] Thank you for taking this course. I hope you liked it. During this course, you've learned how to build an advanced website with Express. Please check out our library for other advanced courses that show you how to build on this knowledge. Why not extend your knowledge by watching a course on how to use different [Databases](../../Skills/Software%20Development/Databases.md) with [Node.js](../../Skills/Web%20Development/Node.js.md). Or learn how to use Express to create a [REST](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) API. Also, knowing how to run your application on cloud providers like AWS and broadening your [DevOps](../../Topics/DevOps.md) knowledge is a good investment. I post a lot of Node.js information on Twitter, and I'd be happy if you follow me there. And if you ever happen to see me at the conference, feel free to hit me up anytime. So, see you soon. I'm Daniel Khan.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Node.js](../../Skills/Web%20Development/Node.js.md) (2), [Databases](../../Skills/Software%20Development/Databases.md) (1), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1), [DevOps](../../Topics/DevOps.md) (1)
...
← [Express Essentials- Build Powerful Web Apps with Node.js](Express%20Essentials-%20Build%20Powerful%20Web%20Apps%20with%20Node.js.md) | **6 of 11** | [Node.js- Web Servers, Tests, and Deployment](Node.js-%20Web%20Servers%2C%20Tests%2C%20and%20Deployment.md) →

### In [Advance your Node.js Skills](../../Paths/Web%20Development/Learning%20Paths/Advance%20your%20Node.js%20Skills.md)
← [Node.js- Debugging and Performance Tuning](Node.js-%20Debugging%20and%20Performance%20Tuning.md) | **5 of 8** | [Node.js- Microservices](Node.js-%20Microservices.md) →
...
- [Building a Website with Node.js and Express.js](../Database%20Management/Building%20a%20Website%20with%20Node.js%20and%20Express.js.md) — Express.js
- [Building RESTful APIs with Node.js and Express](Building%20RESTful%20APIs%20with%20Node.js%20and%20Express.md) — Express.js
- [Express Essentials- Build Powerful Web Apps with Node.js](Express%20Essentials-%20Build%20Powerful%20Web%20Apps%20with%20Node.js.md) — Express.js
