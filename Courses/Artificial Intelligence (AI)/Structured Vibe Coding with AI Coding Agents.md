...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/structured-vibe-coding-with-ai-coding-agents/what-is-vibe-coding?u=76281980&t=0)** - [Instructor] Imagine if you could simply tell an AI what you want your code to do in English. It is defined as the practice of rapidly building software by issuing comments to AI coding agents and accepting the changes that they propose. That is the essence of [Vibe Coding](../../Skills/Software%20Development/Vibe%20Coding.md). It is about moving quickly, then let AI do the heavy lifting of generating code. The term vibe coding was coined by the ex co-founder of OpenAI and ex CTO of Tesla, Andrej Karpathy, in a tweet. Here, he described that you fully give into the vibes, embrace the exponentials, and forget the code even exist. All he did was just talked to Cursor Composer, barely touch the keyboard, accept all always, and pasting air back until it is resolved. This captured a new, powerful, and unconventional idea about how we could work with AI. Vibe coding didn't appear overnight. It is the result of gradual evolution of AI-assisted coding tools. We started with simple tap completions where IDE could suggest the next [word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) in the 1990s called IntelliJ. Then in 2021, [GitHub Copilot](../../Skills/Software%20Development/GitHub%20Copilot.md), powered by OpenAI's codex, took things further with advanced code completion,
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Vibe Coding](../../Skills/Software%20Development/Vibe%20Coding.md) (6), [Word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) (2), cursor (1), [GitHub Copilot](../../Skills/Software%20Development/GitHub%20Copilot.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [CLI](../../Skills/Network%20and%20System%20Administration/CLI.md) (5), [Large language models](../../Skills/Artificial%20Intelligence%20(AI)/Large%20Language%20Models%20(LLM).md) (3), [Vibe Coding](../../Skills/Software%20Development/Vibe%20Coding.md) (2), cursor (2), [GitHub Copilot](../../Skills/Software%20Development/GitHub%20Copilot.md) (2)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/structured-vibe-coding-with-ai-coding-agents/equipping-agents-essential-tools-and-mcps?u=76281980&t=0)** - [Instructor] In the previous video, we talk about tooling for coding agents. In this section that's focused on [large language models](../../Skills/Artificial%20Intelligence%20(AI)/Large%20Language%20Models%20(LLM).md). It is a critical component of any coding agents. Ever since the release of [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md), there has been an explosion of language models available for coding task. New models appear on a weekly basis, which makes it very hard to decide what to use. To help cut through the noise, we will refer to a commonly used benchmark as the artificial analysis coding index. This benchmark evaluates coding performances across popular language models like Claude4 Sonnet, open AI's [GPT4](../../Skills/Artificial%20Intelligence%20(AI)/GPT-4.md) mini, Gemini2.5, DeepSeek R1, and many, many others. However, while benchmarking can help, they don't always reflect the full picture as some models could cost more or be less available versus the others. In reality, [Vibe Coding](../../Skills/Software%20Development/Vibe%20Coding.md) where agents operate interactively in coding environments only became truly feasible after Anthropic's Claude3.5 Sonnet model. For the purpose of this course, we will standardize on Claude4 Sonnet from Anthropic, using Claude Code for the following reasons. First, it has very strong performance in coding task. Second, it has built in planning and reasoning capabilities.
>
> **[1:36](https://www.linkedin.com/learning/structured-vibe-coding-with-ai-coding-agents/equipping-agents-essential-tools-and-mcps?u=76281980&t=96)** Third, it offers very good integration with command line interface and all of the IDE tools. Other models like [Gemini](../../Skills/Software%20Development/Gemini.md) 2.5 and [GPT-4](../../Skills/Artificial%20Intelligence%20(AI)/GPT-4.md) series are also viable. But for simplicity and cost effectiveness, Claude Sonnet is our default. Keep in mind that this space evolves very rapidly. For now, Claude Sonnet offers the best balance of performance and integration for our use case. To confirm which model your agent is using, let's go back to VS Code terminal and look at Claude code. Claude code offers a wide variety of building slash command. We can do a slash status to see what model we are using. At the bottom of the screen, you see default use Opus4 or Sonnet4 based on max usage limits. This confirms our setup is complete and we are ready to start using our coding agents with the right tools and models. In the next video, we will walk through how to provide tools to large language models, including [GitHub](../../Skills/Software%20Development/GitHub.md) and [Git](../../Skills/Software%20Development/Git.md), so we can connect our agent to do a full development cycle.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Large language models](../../Skills/Artificial%20Intelligence%20(AI)/Large%20Language%20Models%20(LLM).md) (2), [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md) (1), [Gpt4](../../Skills/Artificial%20Intelligence%20(AI)/GPT-4.md) (1), [Vibe Coding](../../Skills/Software%20Development/Vibe%20Coding.md) (1), [Gemini](../../Skills/Software%20Development/Gemini.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [GitHub](../../Skills/Software%20Development/GitHub.md) (5), [Git](../../Skills/Software%20Development/Git.md) (4), [CLI](../../Skills/Network%20and%20System%20Administration/CLI.md) (3), [Version Control](../../Skills/Web%20Development/Version%20Control.md) (2), [Jira](../../Skills/DevOps/Jira.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Jira](../../Skills/DevOps/Jira.md) (1), [Vibe Coding](../../Skills/Software%20Development/Vibe%20Coding.md) (1)
> **CLI Commands:** make (1)
> **Env Vars:** rfc (1)
> **Cross-References:** in the next (1)
> **Documentation:** rfc (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Next.js](../../Skills/Web%20Development/Next.js.md) (4), [Git](../../Skills/Software%20Development/Git.md) (1), [Tokens](../../Skills/Web%20Development/Tokens.md) (1), [npm](../../Skills/Web%20Development/npm.md) (1)
...
>
> **[5:23](https://www.linkedin.com/learning/structured-vibe-coding-with-ai-coding-agents/execute-test-driven-development-with-your-ai-agent?u=76281980&t=323)** and accept only valid emails. Awesome. We just implemented our email validation component using test driven development using the ping pong method. First we define the test, which is the ping, and we have the agent implement and iterate the code on the pong side, which is the ping pong, and the agents looped until all of the test passes. This is a very powerful way to collaborate with AI coding agents when building production grade features. In the next video, we will demonstrate using playwright to automate [End-to-end Testing](../../Skills/Software%20Development/End-to-end%20Testing.md) of our web application.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Test-Driven Development](../../Skills/Software%20Development/Test-Driven%20Development.md) (1), [End-to-end Testing](../../Skills/Software%20Development/End-to-end%20Testing.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Helm](../../Glossary/Tool/Helm.md) (1), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (1), [Diagramming](../../Skills/Software%20Development/Diagramming.md) (1), [System Architecture](../../Skills/Software%20Development/System%20Architecture.md) (1), [Control Flow](../../Skills/Software%20Development/Control%20Flow.md) (1)
...
>
> **[1:34](https://www.linkedin.com/learning/structured-vibe-coding-with-ai-coding-agents/generating-diagrams-for-system-comprehension?u=76281980&t=94)** So let's go in here and view the file. And again, Command + Shift + V or Control + Shift + V if you are on [Windows](../../Glossary/Service/Windows.md) to preview the file and render them properly. Okay, so obviously this is a enterprise grade application with a huge entity relationship diagram, and all of this has been constructed out. These complex mermaid diagrams can be visualized sometimes on web application of your choice, but here, we get the gist of it. We have the primary key and all of the linkage between different tables. So with this, we can better understand the [Data Modeling](../../Skills/Data%20Science/Data%20Modeling.md) behind the whole application stack. And some of the other things we could use to better understanding the system includes a swim lane diagram, flow chart, and even draw out the diagram and flow chart for some of the workflows, including CICD or [Data Processing](../../Skills/Database%20Management/Data%20Processing.md) or even cloud architecture diagrams if there are significant set of [Terraform](../../Skills/DevOps/Terraform.md) files in there. So now we have demonstrated how to utilize coding agents for rapid code base understanding and system understanding using diagrams. There are endless possibilities of how to use coding agents to make improvements through the application,
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Windows](../../Glossary/Service/Windows.md) (1), [Data Modeling](../../Skills/Data%20Science/Data%20Modeling.md) (1), [Data Processing](../../Skills/Database%20Management/Data%20Processing.md) (1), [Terraform](../../Skills/DevOps/Terraform.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/structured-vibe-coding-with-ai-coding-agents/software-stack-selection-for-ai-agent-success?u=76281980&t=0)** - [Instructor] Now we have demonstrated structure [Vibe Coding](../../Skills/Software%20Development/Vibe%20Coding.md), a landing page with driver, navigator, and ping pong style pair programming, and explored deeper capabilities like code-based understanding and onboarding with AI. It's time to turn our attention to how we should think about our tech stack and architecture choices to improve it for coding agents. First, let's talk about selecting a software stack that works well with [AI Agents](../../Skills/Artificial%20Intelligence%20(AI)/AI%20Agents.md). Now, as anyone in engineering knows, picking a stack can stir up a lot of opinions, but when it comes to working with [large language models](../../Skills/Artificial%20Intelligence%20(AI)/Large%20Language%20Models%20(LLM).md), there is a practical guideline, stick with what's popular and well supported. If we take a look at the top programming languages on [GitHub](../../Skills/Software%20Development/GitHub.md), we can find [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md), [JavaScript](../../Skills/Software%20Development/JavaScript.md), TypeScript dominating the charts, and you can understand our suggestion of sticking with what's popular is not a coincidence. Large language models have been trained extensively on public code in these languages, and they simply are more capable when working within these ecosystems. So if you are using Python with Fast API or building front end with [React](../../Skills/Web%20Development/React.js.md) or back end with Node, you are in great shape. You will get far better performances from coding agents in this environment compared to something more exotic like Julia or Mojo,
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Large language models](../../Skills/Artificial%20Intelligence%20(AI)/Large%20Language%20Models%20(LLM).md) (2), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (2), [Vibe Coding](../../Skills/Software%20Development/Vibe%20Coding.md) (1), [AI Agents](../../Skills/Artificial%20Intelligence%20(AI)/AI%20Agents.md) (1), [GitHub](../../Skills/Software%20Development/GitHub.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/structured-vibe-coding-with-ai-coding-agents/monorepos-the-ai-coding-agent-s-best-friend?u=76281980&t=0)** - [Instructor] Now we are going to dive into co-organization choice. That is a game changer, especially in the world of AI and [large language models](../../Skills/Artificial%20Intelligence%20(AI)/Large%20Language%20Models%20(LLM).md). It's all about using a monorepo. Monorepo makes it super easy for coding agents to find, edit, and understand our code. So what exactly is a monorepo? Think of it as one joint repository that holds a bunch of different sub repositories, applications, and packages all in one place. So instead of having your front end, your backend, and share libraries in separate [GitHub](../../Skills/Software%20Development/GitHub.md) repositories, they all live in a single unified home. A perfect example is the Apache Superset repository that we have explored previously. It is a complex repository, but everything is stored in one place. As we can see here, we have the Superset backend [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) application, we have the Superset frontend application, and the embedded SDK, the test, and the build and deployment code all in one single repository. And this makes navigating the code base much, much easier for our coding agents. Now, why is this so important for AI coding agents? It all comes down to context and navigation.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Large language models](../../Skills/Artificial%20Intelligence%20(AI)/Large%20Language%20Models%20(LLM).md) (2), [GitHub](../../Skills/Software%20Development/GitHub.md) (1), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [JSON](../../Skills/Web%20Development/JSON.md) (4), [Vibe Coding](../../Skills/Software%20Development/Vibe%20Coding.md) (1)
...
> [!transcript]- Transcript
>
> **[0:01](https://www.linkedin.com/learning/structured-vibe-coding-with-ai-coding-agents/the-future-of-ai-assisted-development?u=76281980&t=1)** - Congratulations on completing the structured [Vibe Coding](../../Skills/Software%20Development/Vibe%20Coding.md) course. You have taken a significant step into the future of [Software Development](../../Topics/Software%20Development.md). Throughout this course, we have demystified vibe coding, moving from hype to practical application. You've learned how to effectively partner with AI coding agents, like Claude Code in VSCode, using a structured approach that maximizes their potential while minimizing risk. We have covered everything from setting up their environment and selecting the right tools to employing advanced techniques, like [Test-Driven Development](../../Skills/Software%20Development/Test-Driven%20Development.md), and using AI for rapid onboarding to existing codebases. Remember, the principles you have learned aren't just limited to one tool. They are applicable across the entire landscape of AI coding assistants. The key here is to think of the AI as a powerful pair programmer. You are the navigator, providing the direction and the critical oversight. So what's next? I encourage you to take these skills and apply them to your own projects. Start with something small, perhaps a personal website or a simple utility, and practice your interaction with AI. Don't be afraid to experiment, and as you grow,
>
> **[1:36](https://www.linkedin.com/learning/structured-vibe-coding-with-ai-coding-agents/the-future-of-ai-assisted-development?u=76281980&t=96)** remember the importance of verification. Always review the code and use automated testing to ensure quality and security. If you would like to continue the conversation or share your projects, please connect with me on [LinkedIn](../../Skills/Web%20Development/LinkedIn.md). Thank you for joining me here in this journey. I am incredibly excited to see what you will build. Happy coding.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Vibe Coding](../../Skills/Software%20Development/Vibe%20Coding.md) (2), [Software Development](../../Topics/Software%20Development.md) (1), [Test-Driven Development](../../Skills/Software%20Development/Test-Driven%20Development.md) (1), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (1)
> **Speakers:** - congratulations (1)


## Instructor

- [Han-chung Lee](../../Instructors/Artificial%20Intelligence%20(AI)/Han-chung%20Lee.md)
...
← [Build with AI- Beyond Pair Programming with AI](Build%20with%20AI-%20Beyond%20Pair%20Programming%20with%20AI.md) | **5 of 5**
