...
>
> **[2:17](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/introduction-to-ai?u=76281980&t=137)** In this course, we'll use these symbols to represent AI systems.
>
> **[2:22](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/introduction-to-ai?u=76281980&t=142)** The blue AI symbol is used when we focus on predictive AI topics.
>
> **[2:28](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/introduction-to-ai?u=76281980&t=148)** The green symbol is when we cover generative AI topics, and the black symbol is for when we cover AI topics in general.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-and-big-data?u=76281980&t=0)** A typical business will often need to collect, store, and process huge amounts of data in order to extract the different types of data that an AI system is looking for.
>
...
>
> **[0:36](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-and-big-data?u=76281980&t=36)** A customer record in one data set might look completely different in another data set.
>
> **[0:41](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-and-big-data?u=76281980&t=41)** We can use a big data system to combine and synthesize different data, so that we produce data suitable as input into the AI system.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-models-and-training?u=76281980&t=0)** AI systems are capable of emulating human intelligence, which means they can learn and improve and continue to learn and improve more and more over time.
>
> **[0:12](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-models-and-training?u=76281980&t=12)** The process of training an AI system to learn what you needed to do is a science in itself.
>
> **[0:19](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-models-and-training?u=76281980&t=19)** In this video, we'll just go over a few of the basics.
>
> **[0:22](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-models-and-training?u=76281980&t=22)** Let's begin with how AI systems can learn to do this.
>
> **[0:27](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-models-and-training?u=76281980&t=27)** When we want to produce a certain type of data intelligence, we begin by choosing an algorithm suitable for the type of analysis we want the system to perform.
>
...
>
> **[1:00](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-models-and-training?u=76281980&t=60)** For example, if our problem is what is the best car for us to choose?
>
> **[1:06](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-models-and-training?u=76281980&t=66)** The next thing we want to do with our AI system is shape our model the best we can, so that it will be able to effectively solve our problem.
>
> **[1:15](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-models-and-training?u=76281980&t=75)** To do this, we need to feed it input data referred to as training data.
>
...
>
> **[1:55](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-models-and-training?u=76281980&t=115)** After it's been trained enough, we can finally have it process the data to produce a result, which is the data intelligence we've been waiting for.
>
> **[2:05](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-models-and-training?u=76281980&t=125)** Even after we get our results, we can keep retraining the model so that it stays current with new input data that it receives.
>
...
>
> **[2:46](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-models-and-training?u=76281980&t=166)** Training generative AI models is usually much more demanding and time-consuming than training predictive AI models, which also means that they require more heavy-duty infrastructure to become fully trained.
>
...
>
> **[0:48](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-clouds-and-quantum-computers?u=76281980&t=48)** At a glance, we have two fundamental types of infrastructure we need to establish for this type of environment in order to keep it running.
>
> **[0:58](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-clouds-and-quantum-computers?u=76281980&t=58)** The first is storage for the large amounts of data these systems typically need.
>
...
>
> **[1:34](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-clouds-and-quantum-computers?u=76281980&t=94)** More than ever, all this data we collect is considered an important corporate asset that we need to take care of, which means storing it, maintaining it, backing it up, and keeping it secure.
>
> **[1:48](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-clouds-and-quantum-computers?u=76281980&t=108)** We can do this ourselves in-house, but there are a number of reasons businesses use clouds instead.
>
...
>
> **[2:36](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-clouds-and-quantum-computers?u=76281980&t=156)** Big data systems can demand significant processing power, depending on the quantity of data being processed and the complexity of the processing analysis being carried out.
>
> **[2:48](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-clouds-and-quantum-computers?u=76281980&t=168)** AI systems, however, can take these demands to a new level.
>
...
>
> **[3:36](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-clouds-and-quantum-computers?u=76281980&t=216)** This way, we can pay a cloud provider to provision any quantity of compute resources we may need using a pay-per-use billing model.
>
> **[3:47](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-clouds-and-quantum-computers?u=76281980&t=227)** Clouds can contain very powerful and scalable compute resources that also benefit from sophisticated native automation technology to maintain and optimize those resources, as well as monitors and scanners that can ensure they are kept healthy and safe.
>
> **[4:06](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-clouds-and-quantum-computers?u=76281980&t=246)** We'll list some of the cloud automation features most relevant to AI system requirements in the next video.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-and-cloud-automation?u=76281980&t=0)** In the previous video, we highlighted some cloud automation features for storage and compute resources.
>
> **[0:07](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-and-cloud-automation?u=76281980&t=7)** Next, we'll continue coverage of cloud automation as it pertains specifically to AI systems.
>
> **[0:15](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-and-cloud-automation?u=76281980&t=15)** So to gain an appreciation for the business value behind cloud automation, we'll be going through a list of common features relevant to AI.
>
...
>
> **[0:58](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-and-cloud-automation?u=76281980&t=58)** Part of the cloud automation infrastructure is the ability to monitor AI model performance and to issue alerts when performance falls below a threshold or when potentially bad data is detected, thereby allowing us to intervene before the model is further trained on the bad data.
>
> **[1:18](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-and-cloud-automation?u=76281980&t=78)** Cloud environments can provide versioning tools for AI models, allowing us to create new model versions and roll back to old ones when necessary.
>
> **[1:29](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-and-cloud-automation?u=76281980&t=89)** Clouds can provide tools to ensure that AI models are created and evolved in compliance with policies and ethical requirements.
>
> **[1:38](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-and-cloud-automation?u=76281980&t=98)** So what we've just listed are some of the more common cloud automation features related to AI model training and governance.
>
> **[1:46](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/ai-and-cloud-automation?u=76281980&t=106)** There are certainly many more aspects to cloud automation that can assist with our AI system and its integration within a larger enterprise environment.
...
>
> **[0:30](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-benefits-20285313?u=76281980&t=30)** Each cloud AI benefits video later in the course will highlight cloud computing benefits, typically more relevant to a specific type of AI systems.
>
> **[0:41](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-benefits-20285313?u=76281980&t=41)** However, it's important to acknowledge that the benefits associated with one type of AI can easily be applicable to other types of AI as well.
>
> **[0:51](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-benefits-20285313?u=76281980&t=51)** I therefore recommend you watch all four of the cloud AI benefits videos in this course, regardless of which type of AI you might be interested in.
>
> **[1:01](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-benefits-20285313?u=76281980&t=61)** Okay.
>
...
>
> **[1:39](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-benefits-20285313?u=76281980&t=99)** It allows us to try it out without too much of a commitment, and it can genuinely speed up the process of getting started.
>
> **[1:47](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-benefits-20285313?u=76281980&t=107)** Those same cloud marketplaces have become the primary destination for IT vendors, producing technology innovations.
>
> **[1:56](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-benefits-20285313?u=76281980&t=116)** Many vendors are now prioritizing the release of products geared toward cloud deployment instead of on-premises deployment.
>
> **[2:04](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-benefits-20285313?u=76281980&t=124)** Some vendors have even begun creating cloud-based products exclusively.
>
...
>
> **[3:07](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-benefits-20285313?u=76281980&t=187)** A key part of cloud security architecture is an army of native cloud automation controls that perform a variety of security-related functions to identify vulnerabilities and minimize threats on an ongoing basis.
>
> **[3:24](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-benefits-20285313?u=76281980&t=204)** The fact that an AI solution is in a cloud allows for it to be accessible to a broad, distributed team.
>
> **[3:32](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-benefits-20285313?u=76281980&t=212)** This enables IT staff located in different parts of the world to work together on a common project.
>
> **[3:39](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-benefits-20285313?u=76281980&t=219)** This can be an important benefit, especially when there is a talent shortage, as AI specialists may be more readily available to contribute remotely.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges-20289339?u=76281980&t=0)** Now let's discuss some of the common problems we might run into when working with AI systems in cloud environments.
>
> **[0:08](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges-20289339?u=76281980&t=8)** These can vary depending on the nature of the AI system we're using, and for how long we expect it to reside in the cloud.
>
> **[0:16](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges-20289339?u=76281980&t=16)** As with the cloud AI benefits videos, we also have four of these common cloud challenges videos in this course, and the same considerations apply in that it is best to watch all four of the videos, regardless of the type of AI system you might be using.
>
> **[0:34](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges-20289339?u=76281980&t=34)** In this video, we'll begin with a couple of well-known general challenges that are quite commonplace.
>
> **[0:41](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges-20289339?u=76281980&t=41)** Regardless of what type of AI system we may want, it won't provide any business value if it isn't producing the correct results.
>
> **[0:51](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges-20289339?u=76281980&t=51)** In fact, an AI system that produces the wrong results can end up taking a business in the wrong direction entirely.
>
> **[0:59](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges-20289339?u=76281980&t=59)** Perhaps the number one obstacle to successfully using any type of AI system is ensuring the quality of the data we use to train its model.
>
> **[1:09](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges-20289339?u=76281980&t=69)** It's as simple as garbage in, garbage out.
>
> **[1:13](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges-20289339?u=76281980&t=73)** This issue is amplified when we need to bring in different types of data from different types of external sources.
>
> **[1:22](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges-20289339?u=76281980&t=82)** This data may be incomplete, corrupted, inaccurate, or simply irrelevant to the nature of the processing that the model needs to carry out.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-humans-make-decisions?u=76281980&t=0)** The most common and well-established use for AI has been to provide data intelligence that helps us humans make better decisions.
>
> **[0:11](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-humans-make-decisions?u=76281980&t=11)** Before we look at how this happens, let's first briefly summarize how humans usually make decisions on their own.
>
> **[0:18](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-humans-make-decisions?u=76281980&t=18)** In this video, we'll introduce a car shopping scenario that will reference and elaborate on throughout the remainder of the course.
>
...
>
> **[0:15](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-helps-humans-make?u=76281980&t=15)** Let's break this down a bit more.
>
> **[0:17](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-helps-humans-make?u=76281980&t=17)** Predictive AI is a field of practice that encompasses many techniques for extracting meaningful information from data for us.
>
> **[0:27](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-helps-humans-make?u=76281980&t=27)** This doesn't just give us data, it gives us intelligent data, which is what we've been referring to as data intelligence.
>
> **[0:35](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-helps-humans-make?u=76281980&t=35)** For example, to help with our search for a new car, we could use a predictive AI system to process historical and statistical data we collected about some cars we like, and to further factor in other types of data, such as which car is most likely to require the most maintenance and repairs based on how we plan to use the car.
>
...
>
> **[2:00](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-helps-humans-make?u=76281980&t=120)** Predictive AI is all about helping us get more knowledge, insight and intelligence from data that is available to us.
>
> **[2:09](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-helps-humans-make?u=76281980&t=129)** This then helps us better understand things, make better plans, and especially make better decisions.
>
> **[2:16](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-helps-humans-make?u=76281980&t=136)** In the next video, we'll explore how this type of AI can be given the responsibility to make these decisions on its own.
...
>
> **[0:18](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-can-make-decisions-on-its-own?u=76281980&t=18)** In the business world, this opens the door to a huge amount of opportunities to improve how a business performs, how it reacts, and how it relates to its customers.
>
> **[0:29](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-can-make-decisions-on-its-own?u=76281980&t=29)** Furthermore, the same way a standard model can be retrained to improve over time, the model an AI system may use to drive its autonomous decision-making can also improve as well.
>
> **[0:44](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-can-make-decisions-on-its-own?u=76281980&t=44)** This means that the AI system can also learn from the outcome of its previous decisions, in order to continually improve how it makes those decisions.
>
> **[0:56](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-can-make-decisions-on-its-own?u=76281980&t=56)** So let's pretend that our car searching app worked so well that we decided to release it as a product for others to use.
>
> **[1:04](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-can-make-decisions-on-its-own?u=76281980&t=64)** We upgraded with an AI system that not only informs us of the right car to buy, but automatically places the order for us as well.
>
> **[1:13](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-can-make-decisions-on-its-own?u=76281980&t=73)** We're so confident the app will work that we even give our customers a seven-day money back guarantee in case they don't like the car they receive.
>
> **[1:23](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-can-make-decisions-on-its-own?u=76281980&t=83)** But in order to return a car, they have to fill out an extensive questionnaire to explain what they liked and didn't like about it.
>
> **[1:31](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-can-make-decisions-on-its-own?u=76281980&t=91)** Over time, the application gets used by lots of people and we collect a range of data, including that customer feedback.
>
...
>
> **[0:26](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-benefits?u=76281980&t=26)** This is, of course, further amplified when we have chosen to delegate some of that decision-making to the AI system itself.
>
...
>
> **[1:20](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-benefits?u=76281980&t=80)** One of the issues it raises is a lack of transparency when it comes to the logic within AI models.
>
> **[1:27](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-benefits?u=76281980&t=87)** Cloud environments can provide automated explainability generation tools that can produce improved explanations as to how the sometimes nebulous logic within AI models actually works in order to shed light on how it reaches conclusions and makes decisions.
>
> **[1:50](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-benefits?u=76281980&t=110)** This helps make predictable AI systems more accountable for the decision-making intelligence they provide us, and will also help foster trust in having those systems fulfill that role.
...
>
> **[0:25](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges-20289338?u=76281980&t=25)** This is especially a concern with predictive AI models, which can be complex to fully comprehend.
>
> **[0:33](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges-20289338?u=76281980&t=33)** Being able for us to understand the rationale behind how an AI system produces data intelligence is important in order to justify the decisions it recommends to us, and especially the decisions it might be making on its own.
>
> **[0:50](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges-20289338?u=76281980&t=50)** However, a problem with many predictive AI system models is that the decision-making logic they follow is simply not clear.
>
> **[0:59](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges-20289338?u=76281980&t=59)** This is especially the case with more complex models.
>
> **[1:04](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges-20289338?u=76281980&t=64)** AI explainability is a field dedicated to providing insights and clarity into AI models.
>
...
>
> **[1:39](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges-20289338?u=76281980&t=99)** Sometimes this type of data has regional storage requirements, meaning that it can only be stored in certain geographical regions.
>
> **[1:49](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges-20289338?u=76281980&t=109)** When we place this data in a cloud, we might lose control of where the cloud provider decides to physically store it.
>
> **[1:57](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges-20289338?u=76281980&t=117)** Therefore, when working with data that is governed by privacy or security regulations, we need to be careful so that those regulations are not inadvertently violated.
>
> **[2:10](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges-20289338?u=76281980&t=130)** Being selective with cloud providers and putting the necessary legal guarantees in place can help circumvent these issues.
>
> **[2:19](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges-20289338?u=76281980&t=139)** Other times, simply not putting this type of data in a cloud may be the best option.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/automation-without-ai?u=76281980&t=0)** - Being able to automate parts of how a business operates has been essential to organizations for decades.
>
> **[0:07](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/automation-without-ai?u=76281980&t=7)** Doing this well and doing this better than competitors has often been a critical success factor for business growth and success.
>
> **[0:17](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/automation-without-ai?u=76281980&t=17)** AI systems can be used to enhance business automation, often dramatically so.
>
> **[0:23](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/automation-without-ai?u=76281980&t=23)** But before we explore that, let's first briefly establish how business automation occurs without AI involved.
>
> **[0:32](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/automation-without-ai?u=76281980&t=32)** Business automation is typically carried out by software or an app that we buy or build to automate one or more tasks.
>
> **[0:41](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/automation-without-ai?u=76281980&t=41)** These types of business apps are generally pre-programmed to automate tasks in certain ways.
>
> **[0:48](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/automation-without-ai?u=76281980&t=48)** They can often be configured to customize certain functions, and they will generally also have conditional logic that deal with certain conditions, such as errors or invalid entries, using predefined functionality.
>
> **[1:04](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/automation-without-ai?u=76281980&t=64)** Let's take a look at some basic examples.
>
...
>
> **[1:41](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/automation-without-ai?u=76281980&t=101)** An RPA solution can be pre-programmed to carry out a variety of instructions.
>
> **[1:47](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/automation-without-ai?u=76281980&t=107)** How and when it executes those instructions is also often predetermined via an orchestration platform that establishes its workflow.
>
...
>
> **[2:41](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/automation-without-ai?u=76281980&t=161)** However, there are aspects to these applications that are limiting the logic that is pre-programmed, the customization options that are predetermined, and the conditional logic that is predefined.
>
> **[2:56](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/automation-without-ai?u=76281980&t=176)** All of this enforces a fixed set of parameters around what the application can and cannot do.
>
> **[3:04](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/automation-without-ai?u=76281980&t=184)** If we want to change those parameters, we have to either update the app with more programming or buy a different app with the new features we're looking for.
>
> **[3:14](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/automation-without-ai?u=76281980&t=194)** This video did not reveal anything new, but it is important to establish the limitations of how we've been automating business tasks in the past to better understand how AI can be utilized to improve this, which is what we'll cover in the next video.
...
> [!transcript]- Transcript
>
> **[0:01](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-can-enhance-automation-rpa-bots?u=76281980&t=1)** - As we know, an AI system can give us insights into how to make better decisions, but it can also be given the responsibility to carry out decisions on its own.
>
> **[0:13](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-can-enhance-automation-rpa-bots?u=76281980&t=13)** This opens the door to a number of ways that AI can assist with improving the way we automate business tasks.
>
...
>
> **[0:47](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-can-enhance-automation-rpa-bots?u=76281980&t=47)** The predictive AI system can reveal various insights as to how existing automation carried out by the solution can be improved, and perhaps more importantly, how the scope of the solution can be expanded to encompass more automation.
>
> **[1:05](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-can-enhance-automation-rpa-bots?u=76281980&t=65)** This is essentially us taking advantage of data intelligence produced by predictive AI to help us make better decisions when designing and programming the RPA solution.
>
> **[1:18](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-can-enhance-automation-rpa-bots?u=76281980&t=78)** Let's now take this a step further.
>
> **[1:21](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-can-enhance-automation-rpa-bots?u=76281980&t=81)** In the previous video, we talked about the fixed parameters that exist around apps we program or purchase to automate business tasks.
>
> **[1:31](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-can-enhance-automation-rpa-bots?u=76281980&t=91)** What if there was a way to incorporate AI so that we would no longer be limited to some of those fixed parameters?
>
> **[1:39](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-can-enhance-automation-rpa-bots?u=76281980&t=99)** Well, there is.
>
> **[1:40](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-can-enhance-automation-rpa-bots?u=76281980&t=100)** Instead of having our solution perform predetermined actions in predetermined sequences, we can give the responsibility of determining how the solution performs and behaves to an AI system that can make those decisions for us autonomously.
>
> **[2:00](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-can-enhance-automation-rpa-bots?u=76281980&t=120)** This means the AI system could be trained and designed to issue instructions to RPA bots so that the tasks they perform are as optimized and efficient as possible.
>
> **[2:13](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-can-enhance-automation-rpa-bots?u=76281980&t=133)** The AI systems model could then be continually retrained with the latest performance results, as well as any new requirements or conditions that may have arisen.
>
> **[2:25](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-can-enhance-automation-rpa-bots?u=76281980&t=145)** This then allows our AI driven RPA solution to continually evolve and improve.
>
> **[2:32](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-can-enhance-automation-rpa-bots?u=76281980&t=152)** This was the first of two examples we'll explore.
>
> **[2:36](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-can-enhance-automation-rpa-bots?u=76281980&t=156)** Let's move on now to the second AI-driven automation scenario in the next video.
...
>
> **[1:38](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-predictive-ai-can-enhance-automation-chatbots?u=76281980&t=98)** In this scenario, the AI system can much more effectively continuously learn from past successful and unsuccessful conversations to continually improve its ability to generate new sales.
>
...
>
> **[0:43](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-benefits-20284343?u=76281980&t=43)** This can lead to problems with performance, behavioral consistency, and runtime error conditions.
>
> **[0:51](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-benefits-20284343?u=76281980&t=51)** Clouds can provide dynamic infrastructure that will automatically scale to accommodate whatever the usage requirements turn out to be.
>
> **[0:59](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-benefits-20284343?u=76281980&t=59)** Furthermore, our AI-driven automation solution may encounter unforeseen failure conditions, perhaps resulting from flaws within the application, misconfigurations of the underlying servers, or even from cyberattacks.
>
> **[1:15](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-benefits-20284343?u=76281980&t=75)** Clouds can provide resilient infrastructure capable of automatically producing new instances of an application or part of an application when failure conditions occur.
>
> **[1:27](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-benefits-20284343?u=76281980&t=87)** This will often result in no disruption of service to the users.
...
>
> **[0:53](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges-20288345?u=76281980&t=53)** Having such a critical part of the business dependent on a third-party cloud provider can introduce risk.
>
> **[1:01](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges-20288345?u=76281980&t=61)** For example, the cloud provider may increase its prices, it could be acquired by another company, resulting in changes to its offerings, or it could fall behind in the industry while other cloud providers start offering technology innovations that it doesn't.
>
> **[1:20](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges-20288345?u=76281980&t=80)** The use of containerization technology can help an AI-driven application be more mobile, allowing it to more easily be moved to a different cloud if necessary.
>
> **[1:32](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges-20288345?u=76281980&t=92)** Following a multi-cloud approach can also help reduce unhealthy dependencies on specific cloud providers.
>
> **[1:40](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges-20288345?u=76281980&t=100)** As we discussed earlier in the course, having our AI-driven solution in the cloud allows us to avoid a lot of upfront costs, and then only commits us to leasing resources and paying for what we actually use.
>
> **[1:55](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges-20288345?u=76281980&t=115)** From a financial perspective, this is attractive at first.
>
...
>
> **[1:09](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/creating-new-content-and-ideas-without-ai?u=76281980&t=69)** Second, the quality of the new content will be limited to the human's level of expertise and authoring skill.
>
> **[1:18](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/creating-new-content-and-ideas-without-ai?u=76281980&t=78)** A human with less expertise, or one who does not research a topic thoroughly enough, or one who does not have good authoring skills, will likely produce low quality content.
>
> **[1:32](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/creating-new-content-and-ideas-without-ai?u=76281980&t=92)** Now let's think about how humans come up with new ideas.
>
> **[1:36](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/creating-new-content-and-ideas-without-ai?u=76281980&t=96)** Creativity is something all humans have to a certain extent, some more than others.
>
> **[1:43](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/creating-new-content-and-ideas-without-ai?u=76281980&t=103)** Creativity can be artistic but also business-centric, such as coming up with creative solutions to business problems.
>
> **[1:52](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/creating-new-content-and-ideas-without-ai?u=76281980&t=112)** Humans can get ideas by being inspired, by accessing knowledge and past experiences in their memory, or by various other means.
>
> **[2:02](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/creating-new-content-and-ideas-without-ai?u=76281980&t=122)** It isn't always the case, but often the quality of the ideas a human may come up with is directly related to the extent of expertise and experience the human may have in relation to the nature of those ideas.
>
> **[2:18](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/creating-new-content-and-ideas-without-ai?u=76281980&t=138)** For example, a chemist comes up with a new idea for a formula.
>
> **[2:23](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/creating-new-content-and-ideas-without-ai?u=76281980&t=143)** The quality of that formula will often relate to the extent of the chemist's past education and expertise.
>
> **[2:31](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/creating-new-content-and-ideas-without-ai?u=76281980&t=151)** Similarly, new artistic creations may be inspired by the artist's knowledge of creations from prior artists.
>
> **[2:40](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/creating-new-content-and-ideas-without-ai?u=76281980&t=160)** The limitations behind human-generated ideas are similar to those related to content creation.
>
> **[2:48](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/creating-new-content-and-ideas-without-ai?u=76281980&t=168)** It can take time to formulate and express the idea, and the quality of the idea may be limited to the extent of the human's expertise.
>
> **[2:59](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/creating-new-content-and-ideas-without-ai?u=76281980&t=179)** So why did we just spend the past few minutes not talking about AI?
>
> **[3:03](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/creating-new-content-and-ideas-without-ai?u=76281980&t=183)** It's because we need to establish how AI, generative AI, to be specific, helps us overcome common human limitations.
>
> **[3:13](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/creating-new-content-and-ideas-without-ai?u=76281980&t=193)** With this understanding, we can truly begin to see the potential that generative AI may have to offer us.
...
>
> **[0:14](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-generative-ai-can-create-new-business-content?u=76281980&t=14)** It's like having the ultimate content creator right here on your team.
>
> **[0:19](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-generative-ai-can-create-new-business-content?u=76281980&t=19)** Let's take a closer look at how this can translate into business value.
>
> **[0:25](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-generative-ai-can-create-new-business-content?u=76281980&t=25)** A generative AI model is trained on data that acts as the basis for which it creates new content.
>
...
>
> **[1:05](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-generative-ai-can-create-new-business-content?u=76281980&t=65)** This not only expedites our ability to get a new version of the solution in place, it also does so with minimal effort and labor.
>
> **[1:14](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-generative-ai-can-create-new-business-content?u=76281980&t=74)** For another example, let's revisit the automated chatbot solution in Video 3 from Chapter 4.
>
> **[1:21](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-generative-ai-can-create-new-business-content?u=76281980&t=81)** Here we use predictive AI to help us improve the dialogue scripts to be used by our chatbot programs.
>
> **[1:29](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-generative-ai-can-create-new-business-content?u=76281980&t=89)** But we can take this further by considering the involvement of generative AI systems that could create new, expanded chatbot scripts for us.
>
...
>
> **[2:19](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-generative-ai-can-create-new-business-content?u=76281980&t=139)** Of course, the generative AI systems model would still need to be trained to deliver dialogue within some boundaries, but it would have generous free rein as to how to formulate the conversation.
>
> **[2:33](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-generative-ai-can-create-new-business-content?u=76281980&t=153)** This was a pretty specific application of generative AI.
>
> **[2:37](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-generative-ai-can-create-new-business-content?u=76281980&t=157)** There are many more examples, such as creating personalized content to improve customer experiences, creating reports from research topics, creating content translated into different languages or dialects, creating marketing and website content.
>
> **[2:54](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-generative-ai-can-create-new-business-content?u=76281980&t=174)** As we mentioned before, we can even use a generative AI system to create training data that is then used to train a different AI system.
>
> **[3:04](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-generative-ai-can-create-new-business-content?u=76281980&t=184)** Generative AI systems are extremely powerful, and there are lots of ways we can use them for business purposes.
...
>
> **[0:25](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-generative-ai-can-create-new-business-ideas?u=76281980&t=25)** Let's explore this further.
>
> **[0:28](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-generative-ai-can-create-new-business-ideas?u=76281980&t=28)** Let's start with a simple example.
>
> **[0:31](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-generative-ai-can-create-new-business-ideas?u=76281980&t=31)** We could provide a whole set of marketing materials to the generative AI system as input for training purposes, also, with information about current marketing trends that our competitors are using.
>
> **[0:44](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-generative-ai-can-create-new-business-ideas?u=76281980&t=44)** We could then ask that it produce a new marketing design based on that input, or perhaps three different marketing designs for us to choose from.
>
> **[0:55](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-generative-ai-can-create-new-business-ideas?u=76281980&t=55)** Okay, now for something a bit more involved.
>
> **[0:58](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-generative-ai-can-create-new-business-ideas?u=76281980&t=58)** Let's go back to our car shopping scenario.
>
...
>
> **[2:25](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-generative-ai-can-create-new-business-ideas?u=76281980&t=145)** The generative AI system then produces a new solution design that combines both the RPA and chatbot applications into one larger cloud-based, AI driven solution.
>
...
>
> **[3:18](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-generative-ai-can-create-new-business-ideas?u=76281980&t=198)** It is something that will allow many businesses to accelerate the attainment of their goals.
>
> **[3:24](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-generative-ai-can-create-new-business-ideas?u=76281980&t=204)** But with new ideas also comes risk that needs to be assessed and judged before we act on those ideas.
>
> **[3:33](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/how-generative-ai-can-create-new-business-ideas?u=76281980&t=213)** Fortunately, risk assessment is another task AI can help us with.
...
>
> **[0:12](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-benefits-20286354?u=76281980&t=12)** However, there are other capabilities provided by cloud environments that can benefit generative AI processing.
>
> **[0:20](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-benefits-20286354?u=76281980&t=20)** Depending on the nature of the content being produced by a generative AI system, certain business policies or government regulations may need to be complied to.
>
> **[0:30](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-benefits-20286354?u=76281980&t=30)** This means that the output of the system needs to be checked for compliance before it can be used.
>
...
>
> **[0:17](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges?u=76281980&t=17)** One recurring problem with AI systems is the creation of data intelligence or content that is incorrect, but is presented as being correct.
>
> **[0:28](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges?u=76281980&t=28)** This is referred to as a hallucination.
>
...
>
> **[1:49](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges?u=76281980&t=109)** These considerations can include the ownership and copyright of the data used to train the model, as well as the ownership of the content produced by the AI system itself.
>
> **[2:01](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges?u=76281980&t=121)** There may need to be legal constraints around how generated content is utilized before it is shared and distributed.
>
> **[2:10](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges?u=76281980&t=130)** While generative AI systems can be used to add a great deal of value to some businesses, these systems can also be abused and used for various illegal and unethical purposes.
>
> **[2:23](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges?u=76281980&t=143)** As a result, governmental regulations may be imposed to restrict their usage.
>
> **[2:30](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges?u=76281980&t=150)** While these types of regulations may be targeted at preventing illegal or unethical activity, the restrictions may also impede businesses from using generative AI in ways that benefit them.
>
> **[2:44](https://www.linkedin.com/learning/generative-ai-and-predictive-ai-in-the-cloud-foundational-concepts-and-scenarios/common-cloud-ai-challenges?u=76281980&t=164)** These types of regulations may also vary across different regions and countries, which may further impact the actual location of the generative AI system implementation and the content it produces when it's hosted in clouds.
...
← [[Learning Kubernetes]] | **3 of 10** | [[MLOps Tools- MLflow and Hugging Face]] →

### In [[Foundational AI Skills for Azure Administration]]
**1 of 6** | [[Understanding Generative AI in Cloud Computing- Services and Use Cases]] →
...
- [[Understanding Generative AI in Cloud Computing- Services and Use Cases]] — Cloud Computing, Generative AI, Artificial Intelligence (AI)
