...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/threat-modeling-for-ai-ml-systems/threat-modeling-is-important-when-building-ai-systems?u=76281980&t=0)** - [Instructor] AI has transformed everything and you ain't seen nothing yet. These systems have taken the world by storm, and there are also storms of laughter and outrage as they keep making mistakes. After AI was used to create fake adult videos of a rockstar, the controversy made it to the CEOs of major tech companies and even to the White House briefing room. This course is designed to empower you to act and not get on the wrong side of Swifties or anyone else. More importantly, if that's even like possible, it's designed to empower you to anticipate a wide range of problems so you can address them effectively. Let me talk about terminology for a second, specifically, AI versus machine learning versus [large language models](../../Skills/Artificial%20Intelligence%20(AI)/Large%20Language%20Models%20(LLM).md). That list goes from very broad to more specific. [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md) is a large language model presented in a very specific interface. There are other LLMs and they can summarize, generate, translate, and more. We're talking about machine learning in this course, and machine learning is a super set of LLMs. There are machine learning tools that aren't LLMs. For example, [Computer Vision](../../Skills/Artificial%20Intelligence%20(AI)/Computer%20Vision.md) tools and [Speech Recognition](../../Skills/Software%20Development/Speech%20Recognition.md) are built on other foundations. I'll be specific as needed,
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Large language models](../../Skills/Artificial%20Intelligence%20(AI)/Large%20Language%20Models%20(LLM).md) (1), [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md) (1), [Computer Vision](../../Skills/Artificial%20Intelligence%20(AI)/Computer%20Vision.md) (1), [Speech Recognition](../../Skills/Software%20Development/Speech%20Recognition.md) (1)
> **Definitions:** is a  (2)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/threat-modeling-for-ai-ml-systems/trustworthy-ai-threat-modeling-is-better-than-principles?u=76281980&t=0)** - [Instructor] Lots of smart people have written principles for trustworthy AI. So why use threat model and principles one versus the other? And, spoiler, it's not always an either/or, sometimes it's a both/and. Principles are great. They're strategic, they're important. And everyone, from governments to big tech companies to consultancies have their own. Many cover things like fairness, transparency, [Accountability](../../Skills/Data%20Science/Accountability.md), explainability. In fact, [Google](../../Glossary/Service/Google.md)'s automated summary looks pretty good. I took this screenshot in October of 2023. But then you notice transparency and accountability are their own categories. And then there's accountability and transparency. There's explainability and explainable AI. I don't mean to pick on Google, but the things they're summarizing are often fuzzy and use slightly different words for closely-related topics. And that can be hard for an engineer used to working in binary and [Algorithms](../../Skills/Software%20Development/Algorithms.md). Similarly, fairness is great. Who's going to argue with fairness as a goal? But we get into challenges quickly. What's fair? It can be hard to say. Maybe someone wanted different gifts at a similar price. It can be hard to say, "How do I build a product recommendation feature to be fair? Am I fair to our suppliers,
>
> **[1:35](https://www.linkedin.com/learning/threat-modeling-for-ai-ml-systems/trustworthy-ai-threat-modeling-is-better-than-principles?u=76281980&t=95)** picking between them and a fair way? Fair to our customers, presenting the highest rated or lowest-priced product? Is it fair to charge a higher price for quick delivery?" And so I think we need to augment principles with something more concrete, and that more concrete practice is [Threat Modeling](../../Skills/Cybersecurity/Threat%20Modeling.md).

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Accountability](../../Skills/Data%20Science/Accountability.md) (3), [Google](../../Glossary/Service/Google.md) (2), [Algorithms](../../Skills/Software%20Development/Algorithms.md) (1), [Threat Modeling](../../Skills/Cybersecurity/Threat%20Modeling.md) (1)
> **Speakers:** - [instructor] (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/threat-modeling-for-ai-ml-systems/ml-for-business-offense-defense-and-software?u=76281980&t=0)** - [Instructor] Machine learning systems are being deployed in all sorts of ways to solve all sorts of problems. Let's distinguish between them. I like to think about three or four buckets. The first bucket is to support a business goal. For example, [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) Learning has an AI coaching module that's [AI for Business](../../Skills/Artificial%20Intelligence%20(AI)/AI%20for%20Business.md). The second and third buckets are machine learning, [Cybersecurity](../../Topics/Cybersecurity.md) goals of offense and defense. For example, I read a lot about how LLMs are going to be used to write [Phishing](../../Skills/Software%20Development/Phishing.md) emails. I've been expecting that DeepFakes will be used for spoofing, and while many of the stories in the news seem a little lacking in critical thinking, we can expect that machine learning will be used to generate attacks both at the human layer and helping write exploits and other technical attacks. So that's the second use of machine learning offense. The third use is cybersecurity defense. These are uses to detect attacks and frankly, I think they'll lag and not be as useful as you hope because the non LLM attackers are clever and grand. Now, I said three or four buckets and let me explain. The fourth bucket is LLMs for [Software Development](../../Topics/Software%20Development.md), which is a business task, but at one layer of remove. LLMs are really helpful if you want to write code in a language
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Cybersecurity](../../Topics/Cybersecurity.md) (2), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (1), [AI for Business](../../Skills/Artificial%20Intelligence%20(AI)/AI%20for%20Business.md) (1), [Phishing](../../Skills/Software%20Development/Phishing.md) (1), [Software Development](../../Topics/Software%20Development.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/threat-modeling-for-ai-ml-systems/the-stochastic-parrot?u=76281980&t=0)** - [Instructor] You may have heard the phrase "stochastic parrot," and frankly, it's a bit unfair to parrots. It refers to the fact that LLMs stochastically repeat their input without understanding it, like many people who just repeat the [word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) "stochastic" without being precisely sure how that relates to random. A stochastic process is random, but its outputs are not evenly distributed. And this matters because LLMs are statistical models of language. They take a set of input [Tokens](../../Skills/Web%20Development/Tokens.md) and use them to produce output that's statistically likely to come next in a stream of tokens. A token is something like a natural language word. And that's it. It's remarkably powerful, in part because the stochastic models are very complicated. This parrot model has a lot of important implications, including: if you teach your parrot a lot of swear words, it's more likely to swear. We'll come to other implications, like prompt injection. Creating a chatbot includes a long series of steps to create, tune, and fine-tune the model and then get it to be behave the way you want it to behave. Training a model used to be insanely expensive, allegedly on the order of tens of millions of dollars for [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md) 3, and is now just expensive on the order of tens of thousands. It used to require the wizard skills of Merlin,
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) (2), [Tokens](../../Skills/Web%20Development/Tokens.md) (2), [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md) (1)
> **CLI Commands:** make (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [OWASP](../../Skills/Cybersecurity/OWASP.md) (4), [Threat Modeling](../../Skills/Cybersecurity/Threat%20Modeling.md) (1), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1), [HTML](../../Skills/Web%20Development/HTML.md) (1), [JavaScript](../../Skills/Software%20Development/JavaScript.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/threat-modeling-for-ai-ml-systems/the-berryville-institute-exhaustive-list?u=76281980&t=0)** - [Instructor] Berryville Institute of Machine Learning is a small think tank with extensive experience in both software security and machine learning. They have two frameworks. The first is focused on machine learning and comes with a system model and a set of 87 threats grouped by where they apply and a set of system-wide risks and broad concerns. The second is specifically focused on [large language models](../../Skills/Artificial%20Intelligence%20(AI)/Large%20Language%20Models%20(LLM).md) and is LLM-specific with 81 risks, and it's similarly organized. As an aside, what they call an architectural risk analysis, I call a frat model. We've been arguing about terminology for nearly 20 years, and I think they'll see the error of their ways in no more than another 10. Their model of an LLM comes with a set of risks associated with each part of this system. This system is organized by raw data in the world, dataset assembly, which are different from the dataset risks, the learning algorithm risks, the evaluation technique risks, but data flows through to a model and there are risks to the model, risks with the inference algorithm, and risks with the output. And so in contrast to the [OWASP](../../Skills/Cybersecurity/OWASP.md) top 10, they've organized the risks by architecture. The threats are similar, but they're organized differently, which is better? Do you like apples or oranges more? Yeah, I agree.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/threat-modeling-for-ai-ml-systems/microsoft-s-frameworks-for-security-flaws?u=76281980&t=0)** - [Instructor] Over the years, [Microsoft](../../Instructors/Artificial%20Intelligence%20(AI)/Microsoft.md) has released several related documents about how to threat model LLMs. They include at least the ones shown on screen. How do they all relate? You got me, really. I've spent a lot of time trying to figure it out and I don't know. They all seem to be, here's what we're doing right now, and I want to talk about that as a warning. Microsoft as a credible company, shows up well in search engines. You, like the search engines, are going to have a hard time distinguishing authoritative guidance from work in progress or sharing of ideas. Also, Microsoft seems to be willing to push exceptionally hard to use ML to unseat [Google](../../Glossary/Service/Google.md) and sacrifice safety design to do so. Microsoft, CEO, Satya Nadella said, "To align an AI model with the world, "you have to align it in the world and not some [Simulation](../../Skills/Hardware/Simulation.md)." What that means for you is, despite the amazing contributions of Microsoft to secure development life cycles, they're not as great a resource for [Threat Modeling](../../Skills/Cybersecurity/Threat%20Modeling.md) AI systems. And you know, in a sense, they're right. These systems surprise the heck out of us. But that doesn't mean we can't anticipate many problems.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Microsoft](../../Instructors/Artificial%20Intelligence%20(AI)/Microsoft.md) (6), [Google](../../Glossary/Service/Google.md) (1), [Simulation](../../Skills/Hardware/Simulation.md) (1), [Threat Modeling](../../Skills/Cybersecurity/Threat%20Modeling.md) (1)
> **Env Vars:** ceo (1)
> **Warnings:** warning (1)
> **Speakers:** - [instructor] (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [SQL](../../Skills/Data%20Science/SQL.md) (3), [Forms](../../Skills/Web%20Development/Forms.md) (2), [OWASP](../../Skills/Cybersecurity/OWASP.md) (1), [HTML](../../Skills/Web%20Development/HTML.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [NIST](../../Skills/IT%20Help%20Desk/NIST.md) (3), [Cybersecurity](../../Topics/Cybersecurity.md) (1), [Risk management framework](../../Skills/IT%20Help%20Desk/Risk%20Management%20Framework%20(RMF).md) (1), [Privacy](../../Skills/Data%20Science/Privacy.md) (1)
> **Env Vars:** nist (3)
> **Definitions:** is a  (1)
> **Prerequisites:** set up (1)
> **Speakers:** - [instructor] (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [OWASP](../../Skills/Cybersecurity/OWASP.md) (3), [NIST](../../Skills/IT%20Help%20Desk/NIST.md) (1), [Products](../../Skills/Software%20Development/Microsoft%20Products.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/threat-modeling-for-ai-ml-systems/deploying-new-technology-isn-t-a-one-and-done?u=76281980&t=0)** - [Instructor] One of the gifts of the [Agile](../../Skills/DevOps/Agile%20Development.md) movement in software is how we now focus on an ongoing cycle of delivering value, assessing, and choosing where to invest next. With [large language models](../../Skills/Artificial%20Intelligence%20(AI)/Large%20Language%20Models%20(LLM).md), we have a complex balancing act of cost, value, and risk, and the best organizations are learning about how their choices result in customer value. Security and safety are not just predictable, as in we predict problems in the future. We know these systems have problems today. Organizations differ in how cautious they're being, from very to not at all, and how they're expressing that caution. The need to anticipate and engage thoughtfully with these dangers isn't going away, and [Threat Modeling](../../Skills/Cybersecurity/Threat%20Modeling.md) is a collection of the most important ways to productively engage and defend our systems.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Agile](../../Skills/DevOps/Agile%20Development.md) (1), [Large language models](../../Skills/Artificial%20Intelligence%20(AI)/Large%20Language%20Models%20(LLM).md) (1), [Threat Modeling](../../Skills/Cybersecurity/Threat%20Modeling.md) (1)
> **Definitions:** is a  (1)
> **Warnings:** caution (1)
> **Speakers:** - [instructor] (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/threat-modeling-for-ai-ml-systems/next-steps?u=76281980&t=0)** - [Instructor] Congratulations, you've completed the course and gained new skills. Your next step depends on your goals and on your job. You may want to use the tools from [OWASP](../../Skills/Cybersecurity/OWASP.md) or Berryville I outlined in chapter three to find threats. You may want to raise awareness about the EU or [NIST](../../Skills/IT%20Help%20Desk/NIST.md) frameworks and their efforts to push for better governance. If you want to learn more, be sure to complete my other courses here on [LinkedIn](../../Skills/Web%20Development/LinkedIn.md), including ones on [Threat Modeling](../../Skills/Cybersecurity/Threat%20Modeling.md) and one on applied creativity. Also, check out my books, "Threat Modeling: Designing for Security" and "Threats: "What Every Engineer Should Learn From Star Wars." Last but not least, you're welcome to follow me here on LinkedIn or on my blog at [shostack.org/blog](https://shostack.org/blog).

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (2), [Threat Modeling](../../Skills/Cybersecurity/Threat%20Modeling.md) (2), [OWASP](../../Skills/Cybersecurity/OWASP.md) (1), [NIST](../../Skills/IT%20Help%20Desk/NIST.md) (1)
...
← [Leveraging AI for Security Testing](Leveraging%20AI%20for%20Security%20Testing.md) | **8 of 8**
