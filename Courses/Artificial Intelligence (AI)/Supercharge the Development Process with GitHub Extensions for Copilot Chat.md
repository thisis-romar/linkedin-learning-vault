...
prev_courses:
  ...
  - '[Exploring the Future of Development with GitHub Copilot Workspace](Exploring%20the%20Future%20of%20Development%20with%20GitHub%20Copilot%20Workspace.md)'
next_courses:
  - '[Refactoring with GitHub Copilot](Refactoring%20with%20GitHub%20Copilot.md)'
  - '[Delivering and Analyzing a Software Pilot- GitHub Copilot](Delivering%20and%20Analyzing%20a%20Software%20Pilot-%20GitHub%20Copilot.md)'
...
>
> **[0:00](https://www.linkedin.com/learning/supercharge-the-development-process-with-github-extensions-for-copilot-chat/extending-github-copilot-chat?u=76281980&t=0)** - One of the standout [products](../../Skills/Software%20Development/Microsoft%20Products.md) for developers in [artificial intelligence](../../Topics/Artificial%20Intelligence%20(AI).md) has been [GitHub Copilot](../../Skills/Software%20Development/GitHub%20Copilot.md). In a recent survey, 76% of programmers reported using or planning to use AI tools in development. However, so far, [copilot](../../Skills/Cloud%20Computing/Microsoft%20Copilot.md) has been limited to functionality [GitHub](../../Skills/Software%20Development/GitHub.md) has programmed internally, but now Copilot allows third parties to expand its capabilities through an extension system. With Copilot extensions, you can build apps that take advantage of connections to other tools, models and data. It gives extensions access to your chat history, a large language model that lets you ask more [Generic Programming](../../Skills/Software%20Development/Generic%20Programming.md) questions, and also the ability to execute third party functions for added capabilities. Although it's a new product, you can already find tools from companies like Docker, LaunchDarkly, and of course you can also build your own. So if you're enjoying the productivity behind GitHub Copilot, it's time to take it to the next level with extensions. Let's do this.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Copilot](../../Skills/Cloud%20Computing/Microsoft%20Copilot.md) (3), [GitHub Copilot](../../Skills/Software%20Development/GitHub%20Copilot.md) (2), [Products](../../Skills/Software%20Development/Microsoft%20Products.md) (1), [Artificial intelligence](../../Topics/Artificial%20Intelligence%20(AI).md) (1), [GitHub](../../Skills/Software%20Development/GitHub.md) (1)
> **Tools:** github (3)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/supercharge-the-development-process-with-github-extensions-for-copilot-chat/prerequisites-for-using-github-extensions?u=76281980&t=0)** - Extensions are a part of [GitHub](../../Skills/Software%20Development/GitHub.md)'s [Copilot](../../Skills/Cloud%20Computing/Microsoft%20Copilot.md) experience, but it's not something that is freely available to all GitHub accounts, so it's important that you understand the requirements you need in order to use them. Copilot Chat, which is required to run Copilot Extensions, is available as an addition to your GitHub subscription with the Individual versions starting at $10 in the US, $19 a month for Copilot Business, and $39 a month for GitHub Enterprise clients. There are discounts for annual subscriptions and there are free options for verified students, teachers, and open source maintainers. You can start a [GitHub Copilot](../../Skills/Software%20Development/GitHub%20Copilot.md) subscription with a free trial as well. Now this goes on top of your [github.com](https://github.com) subscription, which is free for individuals and organizations. The Team subscription is at $4 per user per month, while the Team version is $4 per user per month, and the Enterprise version at $21 per user per month. Copilot and Copilot Extensions are part of the features that GitHub offers as add-ons, which includes Copilot [Codespaces](../../Skills/Software%20Development/Codespaces.md), large file storage, and advanced security. The Enterprise version does offer some additional options like the ability for Copilot to understand organizational context and the option of adding models fine tuned to a company's code. The Business and Enterprise versions also offer some extra [User Management](../../Skills/Web%20Development/User%20Management.md) and security features. Once you have the proper accounts and tools, you can use Copilot in a few different ways. You can use them with different coding editors,
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Copilot](../../Skills/Cloud%20Computing/Microsoft%20Copilot.md) (13), [GitHub](../../Skills/Software%20Development/GitHub.md) (11), [GitHub Copilot](../../Skills/Software%20Development/GitHub%20Copilot.md) (1), [Codespaces](../../Skills/Software%20Development/Codespaces.md) (1), [User Management](../../Skills/Web%20Development/User%20Management.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Copilot](../../Skills/Cloud%20Computing/Microsoft%20Copilot.md) (11), [Codespaces](../../Skills/Software%20Development/Codespaces.md) (5), [GitHub Copilot](../../Skills/Software%20Development/GitHub%20Copilot.md) (3), [JavaScript](../../Skills/Software%20Development/JavaScript.md) (2), [HTML](../../Skills/Web%20Development/HTML.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Copilot](../../Skills/Cloud%20Computing/Microsoft%20Copilot.md) (11), [GitHub](../../Skills/Software%20Development/GitHub.md) (5), [GitHub Copilot](../../Skills/Software%20Development/GitHub%20Copilot.md) (1), [JavaScript](../../Skills/Software%20Development/JavaScript.md) (1), [Gpt-4o](../../Skills/Artificial%20Intelligence%20(AI)/GPT-4.md) (1)
...
### In [Career Essentials in GitHub Copilot Professional Certificate](../../Paths/Artificial%20Intelligence%20(AI)/Professional%20Certificates/Career%20Essentials%20in%20GitHub%20Copilot%20Professional%20Certificate.md)
← [AI Pair Programming with GitHub Copilot](AI%20Pair%20Programming%20with%20GitHub%20Copilot.md) | **2 of 4** | [Refactoring with GitHub Copilot](Refactoring%20with%20GitHub%20Copilot.md) →

### In [Master GitHub Copilot](../../Paths/Artificial%20Intelligence%20(AI)/Learning%20Paths/Master%20GitHub%20Copilot.md)
← [Exploring the Future of Development with GitHub Copilot Workspace](Exploring%20the%20Future%20of%20Development%20with%20GitHub%20Copilot%20Workspace.md) | **3 of 8** | [Delivering and Analyzing a Software Pilot- GitHub Copilot](Delivering%20and%20Analyzing%20a%20Software%20Pilot-%20GitHub%20Copilot.md) →
