...
prev_courses:
  - '[Prompt Engineering with LangChain](Prompt%20Engineering%20with%20LangChain.md)'
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/building-advanced-ai-apps-with-prompt-flow/exploring-the-prompt-flow-repo-in-codespaces?u=76281980&t=0)** - [Instructor] This course focuses on the open source [Prompt Flow](../../Skills/Artificial%20Intelligence%20(AI)/Prompt%20Flow.md) project, so the logical place to start is in its official [GitHub](../../Skills/Software%20Development/GitHub.md) repository. This repository contains not only the framework itself, but also the documentation, examples, and tutorials on how to use prompt flow. So this is the place to return anytime you're trying to do something and you need to figure it out, or if you need code examples to start a new flow. What we're going to do is boot up this repository in [Codespaces](../../Skills/Software%20Development/Codespaces.md). You can do that either by clicking the Code button and going to Codespaces and click New codespace, or by scrolling down to Installation and clicking on Open in GitHub Codespace. If you can't open it in Codespace, you can also open this project locally on your computer by cloning the project into your computer. If you do so, to get it to work, you need to install a [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) environment, a Docker environment, and you need to install all the dependencies. And all of that is described down here in the README file. Once your codespace is up and running, you'll see this, two README files, the core file, and the examples file, a set of folders, and in the far left sidebar, this icon, a P. This is the prompt flow extension we'll talk about later in the course. And the reason you're seeing it in the codespace is because this codespace is pre-configured. It has all the things you need to run prompt flow examples out of the box. It has a Python environment, a Docker environment, all the extensions and all the dependencies pre-installed for you, so you can start working. What I want to draw your attention to is this folder, the examples. Here you find a comprehensive list of examples
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Prompt Flow](../../Skills/Artificial%20Intelligence%20(AI)/Prompt%20Flow.md) (12), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (6), [GitHub](../../Skills/Software%20Development/GitHub.md) (2), [Codespaces](../../Skills/Software%20Development/Codespaces.md) (2), [Microsoft](../../Instructors/Artificial%20Intelligence%20(AI)/Microsoft.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Prompt Flow](../../Skills/Artificial%20Intelligence%20(AI)/Prompt%20Flow.md) (6), [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) (3), [GitHub](../../Skills/Software%20Development/GitHub.md) (2), [CLI](../../Skills/Network%20and%20System%20Administration/CLI.md) (1), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Prompt Flow](../../Skills/Artificial%20Intelligence%20(AI)/Prompt%20Flow.md) (8), [CLI](../../Skills/Network%20and%20System%20Administration/CLI.md) (1), [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) (1), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Prompt Flow](../../Skills/Artificial%20Intelligence%20(AI)/Prompt%20Flow.md) (7), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (3), [Tokens](../../Skills/Web%20Development/Tokens.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [JSON](../../Skills/Web%20Development/JSON.md) (8), [Prompt Flow](../../Skills/Artificial%20Intelligence%20(AI)/Prompt%20Flow.md) (7)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/building-advanced-ai-apps-with-prompt-flow/going-further-with-prompt-flow?u=76281980&t=0)** - And just like that, you've reached the end of this course and the beginning of your journey with [Prompt Flow](../../Skills/Artificial%20Intelligence%20(AI)/Prompt%20Flow.md). For a deeper dive into everything prompt flow offers, go check out the official [GitHub](../../Skills/Software%20Development/GitHub.md) repository and the huge list of plug and play examples it contains. And as always, make liberal use of the official documentation for the project. Here you'll find quick start guides, tutorials, examples, and detailed breakdowns of all the advanced features of this framework I didn't have time to cover here, so you can get full use out of it. As you continue your learning journey with AI, make sure to check out our constantly expanding list of AI courses right here on [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) Learning, and follow me on LinkedIn for critical insights analysis and discussion of AI and how we build our future with it. Now, all that's left for me to say is, (instructor speaks in foreign language) go build some advanced AI apps with prompt flow, and I'll see you in the next course.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Prompt Flow](../../Skills/Artificial%20Intelligence%20(AI)/Prompt%20Flow.md) (3), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (2), [GitHub](../../Skills/Software%20Development/GitHub.md) (1)
...
← [Prompt Engineering with LangChain](Prompt%20Engineering%20with%20LangChain.md) | **6 of 6**
...
- [The AI Ecosystem for Developers- Models, Datasets, and APIs](The%20AI%20Ecosystem%20for%20Developers-%20Models%2C%20Datasets%2C%20and%20APIs.md) — Generative AI, Artificial Intelligence (AI), AI Software Development
- [RAG and Fine-Tuning Explained](RAG%20and%20Fine-Tuning%20Explained.md) — Generative AI, Artificial Intelligence (AI), AI Software Development
- [Agentic AI for Developers- Concepts and Application for Enterprises](Agentic%20AI%20for%20Developers-%20Concepts%20and%20Application%20for%20Enterprises.md) — Generative AI, Artificial Intelligence (AI), AI Software Development
