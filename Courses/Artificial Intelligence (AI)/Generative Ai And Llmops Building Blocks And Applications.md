...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/generative-ai-and-llmops-building-blocks-and-applications/understanding-llms-and-their-evolution?u=76281980&t=0)** - [Instructor] Hello, everyone. Welcome to our exploration into the world of [large language models](../../Skills/Artificial%20Intelligence%20(AI)/Large%20Language%20Models%20(LLM).md) and their incredible evolution that has reshaped the [natural language processing](../../Skills/Artificial%20Intelligence%20(AI)/Natural%20Language%20Processing%20(NLP).md) landscape. Before we dive deep into the technicalities, let's kick things off on a lighter note. Here's a comic strip to give you a glimpse of the exciting journey ahead. Meet our friendly guides who will accompany us throughout the world of LLMs making this learning experience both educational and entertaining. Before 2017, recurrent [Neural Networks](../../Skills/Artificial%20Intelligence%20(AI)/Neural%20Networks.md) or RNNs and convolution neural networks or CNNs were the front runners for handling sequence data. RRNs useful for context-based tasks. On the other hand, CNNs [excel](../../Skills/Data%20Science/Microsoft%20Excel.md) in parallel input [Data Processing](../../Skills/Database%20Management/Data%20Processing.md). RNNs often struggle with maintaining long sequence context due to vanishing gradient problem. On the other hand, CNNs excelled in parallel input data processing, but needed to catch up in capturing temporal dependencies. Enter tokenization. RNNs and CNNs required considerable data pre-processing and tokenization was essential step. Think of it as chopping a sentence into bite-sized pieces or [Tokens](../../Skills/Web%20Development/Tokens.md) for the model to analyze sequentially. Understanding tokenization is a key
>
> **[1:37](https://www.linkedin.com/learning/generative-ai-and-llmops-building-blocks-and-applications/understanding-llms-and-their-evolution?u=76281980&t=97)** to grasping how large language models process language. In 2017, the game changer arrived, the transformer model. Like CNNs, it processes all tokens in parallel and maintains sequences like RNNs. The spotlight feature is the attention mechanism that weighs each token's relevance in the context, giving the model a new level of nuance in understanding language context. In 2018, OpenAI introduced the first generative pre-trained transformer or GPT. Trained unsupervised on a large corpus of text, GPT's primary goal was to predict the next [word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) in a sentence. The new ability allowed GPT to generate coherent and contextually relevant sentences. The progression of GPT was rapid and transformative. In 2019, GPT-2 was introduced, an enhanced model, bigger and equipped with more parameters. It was initially not released due to fears of misuse, but eventually found its place in real-world application like [Content Creation](../../Skills/Software%20Development/Content%20Creation.md) and gaming. 2020 saw the advent of GPT-3, a state-of-the-art model significantly larger and more powerful.
>
> **[3:13](https://www.linkedin.com/learning/generative-ai-and-llmops-building-blocks-and-applications/understanding-llms-and-their-evolution?u=76281980&t=193)** The introduction of API allowed developers to create a diverse array of application. With features like few-shot learning and stronger contextual awareness, GPT-3 not only expanded the horizon of text generation, but also raised essential discussions on [Ethics](../../Skills/Artificial%20Intelligence%20(AI)/Ethics.md) and biases in LLMs. As we conclude, it is evident that LLMs have revolutionized the NLP field in a short span. With each model iteration, new doors open for innovation, but it also brought forth challenges, addressing bias, ensuring ethical use, and improving real-world relevance. The road ahead is promising with the potential for even more personalized and context aware systems. We are not just looking at advancements in text, but potential integration with other domains of large language model. Thank you for embarking on this enlightening odyssey with me. Together, a collective curiosity and insights will fuel the next chapter in the exciting saga of LLMs.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Large language models](../../Skills/Artificial%20Intelligence%20(AI)/Large%20Language%20Models%20(LLM).md) (2), [Neural Networks](../../Skills/Artificial%20Intelligence%20(AI)/Neural%20Networks.md) (2), [Data Processing](../../Skills/Database%20Management/Data%20Processing.md) (2), [Tokens](../../Skills/Web%20Development/Tokens.md) (2), [Natural language processing](../../Skills/Artificial%20Intelligence%20(AI)/Natural%20Language%20Processing%20(NLP).md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/generative-ai-and-llmops-building-blocks-and-applications/overview-of-llm-architectures?u=76281980&t=0)** - [Instructor] Welcome to a thrilling exploration of building applications with [large language models](../../Skills/Artificial%20Intelligence%20(AI)/Large%20Language%20Models%20(LLM).md) or LLMs. Unlike traditional [Software Development](../../Topics/Software%20Development.md) where we turn code into binary to execute commands, working with LLM involves navigating data sets, embeddings, and parameter reads. The outputs are probabilistic, adding a layer of complexity and excitement to our task. This is our first look into chapter two, Introduction to LLMs and Their Applications. Our journey begins with a critical step, pinpointing a single problem to solve. It's like finding a needle in a haystack, but the right one can sew the fabric of innovation. We start small to iterate rapidly, yet the problem must be substantial enough to make users' jaw drop. Imagine zeroing in on a coding hiccup with the vast development lifecycle, much like the [GitHub Copilot](../../Skills/Software%20Development/GitHub%20Copilot.md) team once did. Next up, selecting the right LLM is picking a trustee sidekick. Costs are cut by using a pre-trained model, but the decision is nuanced. We consider factors such as licensing for commercial use and the model size. While the larger model boasts extensive parameters, which might make them smarter, smaller models challenge this notion by being even quicker and more cost effective.
>
> **[1:35](https://www.linkedin.com/learning/generative-ai-and-llmops-building-blocks-and-applications/overview-of-llm-architectures?u=76281980&t=95)** Now we tailor the LLM for our specific needs. Customization is key. In-context learning is akin to giving your LLM a last-minute briefing, ensuring it generates output that's relevant to the situation at hand. [Reinforcement Learning](../../Skills/Artificial%20Intelligence%20(AI)/Reinforcement%20Learning.md) from human feedback is like training a pet with treats. It helps the model learn from the user interactions. Fine-tuning is a meticulous process where we compare the LLM's output to our expected results and make the precise adjustments. With our model picked and primed, we architect the application. This setup includes user input tools like a UI for interactions and the LLM's hosting environment. We incorporate input, enrichment, and prompt construction tools to refine the data before it reaches the LLM, ensuring responses are accurate and efficient. And we don't forget about the tooling. An LLM cache for speedy replies, a content classifier for appropriateness, and a telemetry service to monitor it all. Finally, we put our LLM to the test in the real world. Online evaluations help us measure the LLM's live performance. We monitor how users interact with the app using acceptance and retention rates to gauge success. This feedback informs iterative improvements,
>
> **[3:09](https://www.linkedin.com/learning/generative-ai-and-llmops-building-blocks-and-applications/overview-of-llm-architectures?u=76281980&t=189)** enhancing [user experience](../../Skills/Web%20Development/User%20Experience%20(UX).md), and refining the LLM's predictive powers.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Large language models](../../Skills/Artificial%20Intelligence%20(AI)/Large%20Language%20Models%20(LLM).md) (1), [Software Development](../../Topics/Software%20Development.md) (1), [GitHub Copilot](../../Skills/Software%20Development/GitHub%20Copilot.md) (1), [Reinforcement Learning](../../Skills/Artificial%20Intelligence%20(AI)/Reinforcement%20Learning.md) (1), [User experience](../../Skills/Web%20Development/User%20Experience%20(UX).md) (1)
> **Env Vars:** llm (11)
> **CLI Commands:** make (3)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/generative-ai-and-llmops-building-blocks-and-applications/how-llms-process-and-generate-text?u=76281980&t=0)** - [Instructor] Welcome. Today we are going to delve deep into the intricate workings of [large language models](../../Skills/Artificial%20Intelligence%20(AI)/Large%20Language%20Models%20(LLM).md), or LLMs, and explore how they process and generate text. As you can see, our friendly guides are back and they're just as curious as we are. They are pondering the differences between the human brain and LLMs. While they both process and generate text, the mechanism behind their processes are distinct and fascinating. Language models and human brains, though similar, operate quite differently. LLMs like GPT, predict the next [word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) in a sentence based solely on patterns they have been trained on. Unlike humans, they don't understand text in the way we do, nor do they have emotion or consciousness. Now, consider this question, the population of India is ___ times the US? How would a human solve it? We would [Google](../../Glossary/Service/Google.md) the population, do the math, and then do a sanity check to see if it sounds right. A LLM on the other hand, uses [Tokens](../../Skills/Web%20Development/Tokens.md) and a knowledge base to estimate the answer. Unlike humans, LLMs lack an internal monologue and won't do a sanity check or reflect the question. Let's break it down. Step one, tokenization. LLMs start by breaking down into text
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) (4), [Tokens](../../Skills/Web%20Development/Tokens.md) (4), [Large language models](../../Skills/Artificial%20Intelligence%20(AI)/Large%20Language%20Models%20(LLM).md) (1), [Google](../../Glossary/Service/Google.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Hugging Face](../../Glossary/Service/Hugging%20Face.md) (7), [Fetch](../../Skills/Web%20Development/Fetch.md) (1), [Tokens](../../Skills/Web%20Development/Tokens.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Customer Support](../../Skills/IT%20Help%20Desk/Customer%20Support.md) (1), [Hugging Face](../../Glossary/Service/Hugging%20Face.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/generative-ai-and-llmops-building-blocks-and-applications/solution-llm-for-sentiment-analysis?u=76281980&t=0)** - [Instructor] As part of this challenge, you are required to utilize a pre-trained language model to perform sentiment analysis task. Now let's see what it looks like in code. First, we install the packages we need. In this case, we need to install transformers, which is a package by [Hugging Face](../../Glossary/Service/Hugging%20Face.md). Then we need to import the tokenizer and auto model classes from the transformer. We can use these classes to download the model and its corresponding tokenizer. The model I have selected has been fine tuned to perform sentiment analysis on financial news data. However, you can choose a different model. Now we can tokenize our input text. Finally, we can query our model. Since sentiment analysis is a classification task, we need to find the max of the output, logits, to get the sentiment. Now you know how to download and use an LLM model. In the next lesson, we will see how you can fine tune your own LLM to perform sentiment analysis or any other task.
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Fine Tuning](../../Skills/Software%20Development/Fine%20Tuning.md) (7), [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (1), [Cryptocurrency](../../Skills/Data%20Science/Cryptocurrency.md) (1), [Data Processing](../../Skills/Database%20Management/Data%20Processing.md) (1)
...
>
> **[1:31](https://www.linkedin.com/learning/generative-ai-and-llmops-building-blocks-and-applications/challenge-fine-tune-a-pre-trained-llm?u=76281980&t=91)** So the first step you need to do is to [Fetch](../../Skills/Web%20Development/Fetch.md) the model and its tokenizer from [Hugging Face](../../Glossary/Service/Hugging%20Face.md). After that, you pre-process the provided sentiment analysis data and fine-tune the model using that data. Once that is complete, query the fine-tune model and check if the results are better. To take this project to the next level, try out different fine-tuning methods or try fine-tuning different LLM models and compare their performance.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Fetch](../../Skills/Web%20Development/Fetch.md) (1), [Hugging Face](../../Glossary/Service/Hugging%20Face.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/generative-ai-and-llmops-building-blocks-and-applications/why-compress-llms?u=76281980&t=0)** - [Instructor] Let's dive into compressing these [large language models](../../Skills/Artificial%20Intelligence%20(AI)/Large%20Language%20Models%20(LLM).md). Let's explore why compressing LLM is a topic of interest. Firstly, LLMs are computationally intensive. This means they require a lot of computational power to run smoothly. Consequently, they can also have long execution times, which is problematic for [Real-Time](../../Skills/Database%20Management/Real-Time.md) application. And for efficient operation, multiple GPUs are often needed, which can be costly and resource-intensive. The sheer size of LLMs with their billions of parameters can lead to execution times that aren't always optimal. These large language models require powerful [Hardware](../../Topics/Hardware.md). Compressing these models addresses this issue, allowing us to deploy LLMs even on devices with lesser computational capabilities. Think of it as having a supercomputer's power right in your mobile phone. But compression doesn't just benefit us in terms of size. Let's talk money. Deploying LLM on less powerful machines can lead to significant cost reductions. With compressed models, memory requirements decrease, meaning reduced expense on hardware upgrades. These models are also energy efficient, consuming less power, and leading to savings on electricity bill. Maintenance costs, too, are minimized due to simplicity of this compressed model. This makes it feasible
>
> **[1:34](https://www.linkedin.com/learning/generative-ai-and-llmops-building-blocks-and-applications/why-compress-llms?u=76281980&t=94)** for even small to medium enterprises and startups to benefit from LLMs. Timeliness is key to today's fast-paced world. When an LLM takes too long to respond, it can disrupt the user's experience, especially in real-time application. Every millisecond counts when it comes to generating results. Latency can translate to lost opportunity, and in some cases, financial losses. This is where compression shines again. It offers a solution to reduce execution time and improve [user experience](../../Skills/Web%20Development/User%20Experience%20(UX).md). One major challenge with LLM is the communication bottleneck when serving the model across multiple GPUs. Large models can easily overwhelm a system's memory capacity, leading to slower processing speeds. Compression, however, reduces the memory footprint, ensuring smoother operation. It elevates the need for extensive data transfer between GPU and facilitates the deployment of LLMs, even in environments where memory is at its premium. To conclude, compressing LLMs is not just about size reduction. It's about optimizing the entire ecosystem around LLMs and without compromising on their capabilities.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Large language models](../../Skills/Artificial%20Intelligence%20(AI)/Large%20Language%20Models%20(LLM).md) (2), [Real-Time](../../Skills/Database%20Management/Real-Time.md) (2), [Hardware](../../Topics/Hardware.md) (2), [User experience](../../Skills/Web%20Development/User%20Experience%20(UX).md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/generative-ai-and-llmops-building-blocks-and-applications/introduction-to-quantization-and-pruning?u=76281980&t=0)** - [Instructor] Good day everyone. Today we'll be delving deep into the fascinating world of model optimization. Specifically, we'll be focusing on two vital techniques, quantization and pruning. These techniques are instrumental in striking a balance between the model's performance and efficiency. So let's embark on this journey together and discover the essence behind these powerful tools. As we start, imagine a scenario. You are a tech enthusiast and every piece of information is like fitting an elephant into a Mini Cooper. Just like in our illustration here, that's essentially what we are doing with [large language models](../../Skills/Artificial%20Intelligence%20(AI)/Large%20Language%20Models%20(LLM).md). We are packing tons of knowledge into a small space. Our goal today is to make this process smoother and more efficient. Let's kick things off with quantization. At its core, quantization is all about reducing the precision of the parameters in our models. Think of it in this way, by default, large language models use 32-bit floating point numbers for the parameters. However, in many scenarios, such high precision isn't always necessary. By embracing quantization, we can represent these parameters using fewer bits, sometimes as low as eight, four, or even three bits without compromising much in performance.
>
...
>
> **[4:44](https://www.linkedin.com/learning/generative-ai-and-llmops-building-blocks-and-applications/introduction-to-quantization-and-pruning?u=76281980&t=284)** More sophisticated methods go to the overall impact of each parameter on the model's performance. The journey is about striking a balance and ensuring the model remains robust. Let's break down the type of pruning. First, we have magnitude-based pruning, targeting the parameters with the smallest value. It's much like shedding the least heavy weights from a balloon to make it rise faster. Then there is structured pruning, a more intricate approach that eliminates the entire neurons or layers based on this output contribution. Imagine not just removing branches, but sometimes entire limbs of tree, ensuring the tree remains healthy and vital. A shining example in the real world is AlexNet. With effective pruning, it achieves impressive 90% sparsity with minimal performance loss. However, all techniques, pruning isn't without its challenges, especially when it comes to computational aspects and efficient parameter identification. But innovation doesn't sleep. We are continually exploring automated pruning [Algorithms](../../Skills/Software%20Development/Algorithms.md) to make the process even more efficient. As we approach the end of our journey, it is essential to understand the balancing act between quantization and pruning. These are not isolated techniques, but complementary tool that we can use in tandem can actually help
>
> **[6:18](https://www.linkedin.com/learning/generative-ai-and-llmops-building-blocks-and-applications/introduction-to-quantization-and-pruning?u=76281980&t=378)** optimize model performance. The goal is to navigate trade-offs between performance, size, and computational demands. Let's consider the transformer model as a case study. By harnessing both techniques, these models have achieved a remarkable 50% size reduction. Looking forward, the horizon is promising. We can anticipate LLM [Hardware](../../Topics/Hardware.md), specifically tailored for compressed models, making optimizations even more potent. But theory is one thing, practice is another, and that is why understanding practical implementation is crucial, ensuring we apply compression techniques effectively in real-world scenarios.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Large language models](../../Skills/Artificial%20Intelligence%20(AI)/Large%20Language%20Models%20(LLM).md) (2), [Algorithms](../../Skills/Software%20Development/Algorithms.md) (1), [Hardware](../../Topics/Hardware.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/generative-ai-and-llmops-building-blocks-and-applications/challenge-quantize-a-llm?u=76281980&t=0)** - [Instructor] In this chapter, you have learned about LLM quantization. It is important to keep in mind that compressing LLMS can be beneficial to optimize your LLM application. We can deploy these quantize models on less powerful [Hardware](../../Topics/Hardware.md) and hardware with less memory. As a result, deployment becomes cheaper and easier and it eliminates the need to manage deployments across multiple GPUs. And the best thing is that we get these improvements with minimal drop in the performance of the model. In this challenge, you will have the opportunity to quantize your own model. For this challenge, we will quantize the OPT model with 125 million parameters. We will use the auto GPTQ library to perform quantization. The first step is to install this library. After that, we will [Fetch](../../Skills/Web%20Development/Fetch.md) the model from [Hugging Face](../../Glossary/Service/Hugging%20Face.md). Once that is done, we will create the quantization config and then quantize the model. After the quantization is done, try querying the model and see if you can find any loss in the model's output performance. To take this challenge to the next level, try quantizing a different model or try quantizing the model
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Hardware](../../Topics/Hardware.md) (2), [Fetch](../../Skills/Web%20Development/Fetch.md) (1), [Hugging Face](../../Glossary/Service/Hugging%20Face.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/generative-ai-and-llmops-building-blocks-and-applications/what-is-prompt-engineering?u=76281980&t=0)** - [Instructor] Today we are diving deep into the fascinating world of [Prompt Engineering](../../Skills/Artificial%20Intelligence%20(AI)/Prompt%20Engineering.md). If you have ever wondered how we instruct powerful models like LLMS to respond precisely to our queries, this session is for you. Imagine sending a message to an advanced LLM. You are merely not chatting, you are guiding it. This guiding mechanism is what we term prompt engineering. Every question you pose, every instruction you offer becomes a pathway guiding the LLM to your desired response. Let's simplify this. Think about training a dog. You merely don't say do something. You provide specific commands like sit or [Fetch](../../Skills/Web%20Development/Fetch.md). The dog learns from consistency, repetition and most importantly, clear commands. In the LLM universe, the way you instruct or prompt a language model determines the kind of response you receive. A vague command might lead to a vague response, much like telling a dog to do something and being unsure of what it might do next. The same principle applies here, clarity in command equals precision and performance. The LLM, like the dog, thrives on clear, concise commands and consistent feedback. Now, crafting these response or prompts isn't always a walk in the park. Language with its nuances and complexities
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Prompt Engineering](../../Skills/Artificial%20Intelligence%20(AI)/Prompt%20Engineering.md) (5), [Fetch](../../Skills/Web%20Development/Fetch.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/generative-ai-and-llmops-building-blocks-and-applications/best-practices-for-effective-prompt-engineering?u=76281980&t=0)** - [Instructor] Welcome, everyone. Today, we'll delve into the exciting realm of [Prompt Engineering](../../Skills/Artificial%20Intelligence%20(AI)/Prompt%20Engineering.md). In our rapidly evolving LLM landscape, it's crucial to know how to guide language models, like the one we are discussing today. Let's navigate through the best practices and understand how to maximize our outcome with these models. Prompt engineering is more than just feeding a question to an LLM. It's an art, a technique. Today, we'll explore the role in modern LLM from optimizing our interactions to enhancing response quality. But why should we care? As these models grow advanced, mastering this art is pivotal to unlock their potential. Let's embark on this journey and uncover the six best practices. Imagine you are an archer. You wouldn't shoot without spotting the target, right? Similarly, with prompt engineering, you have to set your goals before you proceed. Different projects might have diverse targets. While one might aim for pure [Information Retrieval](../../Skills/Data%20Science/Information%20Retrieval.md), another could lean into creative writing. Consider [E-Commerce](../../Skills/Web%20Development/E-Commerce.md). The language use needs to be precise, unique, and must resonate with the audience. Also, let's not forget the significance of SEO. By setting clear and actionable goals, we are not just aiming in the right direction,
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Prompt Engineering](../../Skills/Artificial%20Intelligence%20(AI)/Prompt%20Engineering.md) (3), [Large language models](../../Skills/Artificial%20Intelligence%20(AI)/Large%20Language%20Models%20(LLM).md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Prompt Engineering](../../Skills/Artificial%20Intelligence%20(AI)/Prompt%20Engineering.md) (2), [Probability](../../Skills/Data%20Science/Probability.md) (1)
...
**1 of 4** | [LLMOps in Practice- A Deep Dive](LLMOps%20in%20Practice-%20A%20Deep%20Dive.md) →
...
- [Advanced LLMOps- Deploying and Managing LLMs in Production](Advanced%20LLMOps-%20Deploying%20and%20Managing%20LLMs%20in%20Production.md) — Generative AI, Artificial Intelligence (AI), Large Language Model Operations (LLMOps)
...
- [Azure Ai For Developers Ai Design Foundations](Azure%20Ai%20For%20Developers%20Ai%20Design%20Foundations.md) — Artificial Intelligence (AI), Large Language Models (LLM), Large Language Model Operations (LLMOps)
