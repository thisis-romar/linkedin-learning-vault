...
next_courses:
  - '[Azure AI for Developers- Content Safety and Responsible AI](Azure%20AI%20for%20Developers-%20Content%20Safety%20and%20Responsible%20AI.md)'
...
>
> **[0:00](https://www.linkedin.com/learning/azure-for-developers-retrieval-augmented-generation-rag-with-azure-ai/intro-video-to-be-renamed?u=76281980&t=0)** - [Ziggy] Are you ready to unlock the power of Gentic AI with [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) and [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) qto transform your business data? Retrieval augmented generation, or RAG, is changing how companies deliver precise data-driven results. But building a RAG solution can feel overwhelming without the right tools. That's where this course comes in. I'm Ziggy Zulueta and I've helped professionals like you leverage Python with Azure AI Search, Cosmos DB, and OpenAI to create cutting edge RAG solutions. In this course, we'll cover RAG fundamentals, Python based implementation and performance evaluation step by step. Let's unlock your data's full potential. Ready? Let's dive in.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (3), [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) (2)
> **Env Vars:** rag (4)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/azure-for-developers-retrieval-augmented-generation-rag-with-azure-ai/course-prerequisites?u=76281980&t=0)** - [Narrator] We have the following prerequisites for this course. All the videos on this course will cover code developed in [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md), hence, an understanding of Python would be needed. In addition, you need experience in [GitHub](../../Skills/Software%20Development/GitHub.md) [Codespaces](../../Skills/Software%20Development/Codespaces.md) to be able to run the notebooks in this course. Alternatively, the notebooks can be run locally via Visual Studio Code. Finally, it is important that one has access to [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) to create the needed resources such as Azure OpenAI, Azure Cosmos DB, and Azure AI Search.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) (4), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (2), [GitHub](../../Skills/Software%20Development/GitHub.md) (1), [Codespaces](../../Skills/Software%20Development/Codespaces.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Tokens](../../Skills/Web%20Development/Tokens.md) (6), [Word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) (2), [Retrieval-augmented generation](../../Skills/Artificial%20Intelligence%20(AI)/Retrieval-Augmented%20Generation%20(RAG).md) (1), [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) (1)
> **Env Vars:** rag (11)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/azure-for-developers-retrieval-augmented-generation-rag-with-azure-ai/creating-a-rag-solution-with-azure-ai-foundry?u=76281980&t=0)** - [Instructor] This course is focused on creating a RAG solution in [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) using the [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) SDKs. However, I would like to demonstrate that you can also create one using [Azure AI Foundry](../../Skills/Artificial%20Intelligence%20(AI)/Azure%20AI%20Foundry.md). We start by going to ai.[azure.com](https://azure.com) and create a project.
>
...
>
> **[1:30](https://www.linkedin.com/learning/azure-for-developers-retrieval-augmented-generation-rag-with-azure-ai/creating-a-rag-solution-with-azure-ai-foundry?u=76281980&t=90)** The chat completion model would be [GPT-4](../../Skills/Artificial%20Intelligence%20(AI)/GPT-4.md) Omni
>
...
>
> **[3:30](https://www.linkedin.com/learning/azure-for-developers-retrieval-augmented-generation-rag-with-azure-ai/creating-a-rag-solution-with-azure-ai-foundry?u=76281980&t=210)** We can use [Prompt Flow](../../Skills/Artificial%20Intelligence%20(AI)/Prompt%20Flow.md) to customize the model even further.
>
...
>
> **[4:46](https://www.linkedin.com/learning/azure-for-developers-retrieval-augmented-generation-rag-with-azure-ai/creating-a-rag-solution-with-azure-ai-foundry?u=76281980&t=286)** Once the prompt flow is fully set up, we can deploy the model to [Virtual Machines](../../Skills/Cloud%20Computing/Virtual%20Machines.md).
>
...
>
> **[5:22](https://www.linkedin.com/learning/azure-for-developers-retrieval-augmented-generation-rag-with-azure-ai/creating-a-rag-solution-with-azure-ai-foundry?u=76281980&t=322)** We can then consume the model using its [REST](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) endpoint or use the available code samples. To further illustrate how we can consume the deployed model, I will demonstrate to you how to access the model using Postman.
>
...
>
> **[6:14](https://www.linkedin.com/learning/azure-for-developers-retrieval-augmented-generation-rag-with-azure-ai/creating-a-rag-solution-with-azure-ai-foundry?u=76281980&t=374)** We then specified the [JSON](../../Skills/Web%20Development/JSON.md) input in the body, which should contain the question and chat history. Here's another example with chat history captured. We have demonstrated in this video how you can create a RAG solution with no coding required. While this may be sufficient for a lot of companies who want a quick solution, their instances for encoding in Python is needed for more control and more customizations. We will demonstrate in the next chapters how to use Python to create these RAG solutions. If you want to know more about how to exclusively build RAG solutions with Azure AI Foundry, you may refer to this course on building RAG solutions with [Azure AI Studio](../../Skills/Artificial%20Intelligence%20(AI)/Azure%20AI%20Studio.md). [Microsoft](../../Instructors/Artificial%20Intelligence%20(AI)/Microsoft.md) recently rebranded Azure AI Studio to Azure AI Foundry, but the concepts are the same.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) (6), [Prompt Flow](../../Skills/Artificial%20Intelligence%20(AI)/Prompt%20Flow.md) (4), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (3), [Azure AI Foundry](../../Skills/Artificial%20Intelligence%20(AI)/Azure%20AI%20Foundry.md) (3), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (2)
...
>
> **[3:24](https://www.linkedin.com/learning/azure-for-developers-retrieval-augmented-generation-rag-with-azure-ai/rag-using-azure-ai-search?u=76281980&t=204)** and vector search, and uses an algorithm called Reciprocal Rank Fusion, RRF, to produce a single result set. Ranking, often called L2, reorders the L1 results based on higher quality relevant scores. Azure AI search uses semantic ranking as L2 ranker, which utilizes multilingual [Deep Learning](../../Skills/Artificial%20Intelligence%20(AI)/Deep%20Learning.md) models adapted from [Microsoft](../../Instructors/Artificial%20Intelligence%20(AI)/Microsoft.md) Bing. You can find more information about how Azure AI search performs all of these in these two blog posts. Now that we understand what Azure AI search is, let's create the needed resources in the Azure portal in the next video.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) (18), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (2), [Information Retrieval](../../Skills/Data%20Science/Information%20Retrieval.md) (1), [Deep Learning](../../Skills/Artificial%20Intelligence%20(AI)/Deep%20Learning.md) (1), [Microsoft](../../Instructors/Artificial%20Intelligence%20(AI)/Microsoft.md) (1)
...
>
> **[3:34](https://www.linkedin.com/learning/azure-for-developers-retrieval-augmented-generation-rag-with-azure-ai/preparing-your-resources-for-rag?u=76281980&t=214)** You then need to deploy a chat completion model and an embeddings model. We will be deploying a [GPT-4](../../Skills/Artificial%20Intelligence%20(AI)/GPT-4.md) Omni
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) (21), [GitHub](../../Skills/Software%20Development/GitHub.md) (3), [Codespaces](../../Skills/Software%20Development/Codespaces.md) (3), [Semantic Search](../../Skills/Data%20Science/Semantic%20Search.md) (1), [GPT-4](../../Skills/Artificial%20Intelligence%20(AI)/GPT-4.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/azure-for-developers-retrieval-augmented-generation-rag-with-azure-ai/creating-a-search-index?u=76281980&t=0)** - [Instructor] Once all our resources are ready, we start by creating a search index in [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) AI search. The search index contains your documents that are available to the search engine for indexing, full text search, vector search, and hybrid search. Mapping these concepts to more familiar database equivalents, a search index equates to a table, while documents are equivalent to rows in a table. The structure of a document is defined by an index schema. This schema would normally contain the following, an index name that is unique to the search service, a fields collection that defines your non-vector and vector fields. This collection describes your document. The non-vector fields will contain your document key, which is the unique identifier of a document, and other fields such as the title of the document, the text content, and any additional data enrichments we extract. Vector fields would contain the embeddings of selected non-vector fields. The index schema would also contain configurations, such as a vector configuration for [Algorithms](../../Skills/Software%20Development/Algorithms.md) that create and compress the embedding space, settings on vector field definitions that are used in query requests,
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) (6), [Algorithms](../../Skills/Software%20Development/Algorithms.md) (1), [Semantic Search](../../Skills/Data%20Science/Semantic%20Search.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/azure-for-developers-retrieval-augmented-generation-rag-with-azure-ai/creating-a-data-source?u=76281980&t=0)** - [Instructor] Once our index is created, we then need to create a data source connection. Recall that we initially save our documents in an [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) blob container. Here's an example of what our documents look like. We need to create a data source connection through code for Azure AI search to access this container and the documents inside. We initially provided Azure AI search access to the storage by providing its system assigned managed identity, a storage blob data reader role. We now need to define a data source connection through [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) code. First, we can briefly check if we have the proper Azure storage connection string.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) (18), [Microsoft](../../Instructors/Artificial%20Intelligence%20(AI)/Microsoft.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/azure-for-developers-retrieval-augmented-generation-rag-with-azure-ai/querying-your-data?u=76281980&t=0)** - [Instructor] Once the indexer has created the index, let us manually check the index in the [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) portal. Performing a quick search provides document results. You can see the parent_id, title, location entities extracted for each document, we can see the chunk_id and the chunk, which contains the actual text content of the document.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/azure-for-developers-retrieval-augmented-generation-rag-with-azure-ai/azure-ai-search-import-and-vectorize-data?u=76281980&t=0)** - [Instructor] We have shown in the previous video the steps to create an index and indexer using [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md). There's actually an easier way to create an index using [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) AI search using the import and vectorized data feature. You can see this option in the overview tab of Azure AI search. We specify Azure Blob storage as our data source.
>
...
>
> **[3:00](https://www.linkedin.com/learning/azure-for-developers-retrieval-augmented-generation-rag-with-azure-ai/azure-ai-search-import-and-vectorize-data?u=76281980&t=180)** We go to the [JSON](../../Skills/Web%20Development/JSON.md) setting of our original skillset and copy and paste the entity recognition skill to the new skillset.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) (5), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (3), [JSON](../../Skills/Web%20Development/JSON.md) (1)
> **CLI Commands:** python (3), make (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) (14), [JSON](../../Skills/Web%20Development/JSON.md) (5), [Software Development](../../Topics/Software%20Development.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/azure-for-developers-retrieval-augmented-generation-rag-with-azure-ai/solution-create-a-rag-solution-using-azure-ai-search?u=76281980&t=0)** - [Instructor] So here's the solution to our challenge. We first set up our [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) OpenAI, Azure AI Search, and Azure Storage accounts. No need to create an Azure AI Services multi-service account, given that we'll not perform any additional data enrichments. We then need to make sure that Azure AI Search has access to the two resources. We then go to our Storage account, create a new container named [products](../../Skills/Software%20Development/Microsoft%20Products.md), and upload our product data.
>
...
>
> **[3:24](https://www.linkedin.com/learning/azure-for-developers-retrieval-augmented-generation-rag-with-azure-ai/solution-create-a-rag-solution-using-azure-ai-search?u=76281980&t=204)** Finally, we send the query results to a language model to generate the response. Great job on finishing the challenge. As this code is built in [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md), it is open to a lot of customizations that can meet your varied business needs.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) (9), [Products](../../Skills/Software%20Development/Microsoft%20Products.md) (1), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/azure-for-developers-retrieval-augmented-generation-rag-with-azure-ai/rag-using-azure-cosmos-db?u=76281980&t=0)** - [Instructor] This chapter focuses on building a RAG solution using [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) Cosmos DB and Azure Open AI with [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md). Azure AI search is best when your data is unstructured in nature, such as contracts, product manuals, research documents, and service manuals. On the other hand, other data sources such as Azure Cosmos DB works best when your data has some structure such as product details, [Customer Support](../../Skills/IT%20Help%20Desk/Customer%20Support.md) tickets, customer profiles, [IoT](../../Glossary/Concept/IoT.md) telemetry, and many more, which are stored in [JSON](../../Skills/Web%20Development/JSON.md) documents or key value pairs. Here's a simple architecture of what we intend to accomplish. Azure Cosmos DB would hold both our documents and the embeddings and would act as a data source. Azure Open AI as the language model would generate the responses. We will then create Python code as the orchestrator to perform the following tasks. Like Azure AI search, we'll set up the Azure Cosmos DB, such as creating the database containers in appropriate settings and policies. However, unlike Azure AI Search, Azure Cosmos DB does not have a concept of an indexer and a skillset. We will programmatically compute the embeddings of the data and upload them to the Azure Cosmos database.
>
> **[1:36](https://www.linkedin.com/learning/azure-for-developers-retrieval-augmented-generation-rag-with-azure-ai/rag-using-azure-cosmos-db?u=76281980&t=96)** The Python code will also convert user queries to embeddings and will perform the search operation in the database. Finally, our code will also send augmented prompt to Azure OpenAI to generate the response. We will be using Azure Cosmos DB for [NoSQL](../../Skills/Software%20Development/NoSQL.md) as it has the most features for RAG as of this recording. It supports vector search with the following methods, a flat or K nearest neighbor's exact search sometimes called brute force, which can provide 100% retrieval recall for smaller focus vector searches, especially when combined with query filters and partition keys. A quantizedFlat index that compresses vectors using DiskANN based quantization methods for better efficiency in the KNN search. And finally, DiskANN, which is a suite of state of the art vector indexing [Algorithms](../../Skills/Software%20Development/Algorithms.md) developed by [Microsoft](../../Instructors/Artificial%20Intelligence%20(AI)/Microsoft.md) Research to power efficient, high accuracy vector search at any scale. You can get more information about this algorithm by reading this blog. In addition, it also supports three distance functions used to compute distance and similarity. Cosine, dot product, and Euclidean. Finally, it also supports full text search and hybrid search with reciprocal rank fusion.
>
> **[3:11](https://www.linkedin.com/learning/azure-for-developers-retrieval-augmented-generation-rag-with-azure-ai/rag-using-azure-cosmos-db?u=76281980&t=191)** This Microsoft Learn documentation gives examples on when Azure Cosmos DB can be used for and where it is a poor fit. You can also read further in Microsoft Learn its other features such as security, performance, [Scalability](../../Skills/Artificial%20Intelligence%20(AI)/Scalability.md), and many more.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) (14), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (3), [Microsoft](../../Instructors/Artificial%20Intelligence%20(AI)/Microsoft.md) (3), [Customer Support](../../Skills/IT%20Help%20Desk/Customer%20Support.md) (1), [IoT](../../Glossary/Concept/IoT.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/azure-for-developers-retrieval-augmented-generation-rag-with-azure-ai/creating-azure-cosmos-db-resource?u=76281980&t=0)** - [Instructor] Now let's create an [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) Cosmos database that can be used for a RAG application. We search for Azure Cosmos DB in the Azure portal.
>
> **[0:16](https://www.linkedin.com/learning/azure-for-developers-retrieval-augmented-generation-rag-with-azure-ai/creating-azure-cosmos-db-resource?u=76281980&t=16)** We then choose the Azure Cosmos DB for [NoSQL](../../Skills/Software%20Development/NoSQL.md) option.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) (4), [NoSQL](../../Skills/Software%20Development/NoSQL.md) (1)
> **Env Vars:** rag (2)
> **CLI Commands:** find (1)
> **Tools:** azure portal (1)
> **Speakers:** - [instructor] (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) (13), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (1), [JSON](../../Skills/Web%20Development/JSON.md) (1), [SQL](../../Skills/Data%20Science/SQL.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) (3), [JSON](../../Skills/Web%20Development/JSON.md) (2)
...
> [!transcript]- Transcript
>
> **[0:05](https://www.linkedin.com/learning/azure-for-developers-retrieval-augmented-generation-rag-with-azure-ai/solution-create-a-rag-solution-using-azure-cosmos-db?u=76281980&t=5)** - [Instructor] Here is the solution to our challenge. We first load our [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) configurations. To ensure that our embedding size is consistent throughout, we create a variable as well for it. We also assign a proper database and container name. We then set up our Azure Cosmos DB. We create a new database. We create a vector embedding policy and a content vector field, and we also assign the distance function to cosign. We then create a full text policy for the name and description fields, and then define our full text and vector indices. We finally create our container. We then create the embeddings for our recipes collection. We create [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) code that combines each key value pair of a recipe object into a single string. We then generate embeddings for each combined string, and then add the new field called content vector to each recipe. We then upload the data into a new file.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) (3), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (1)
> **CLI Commands:** python (1)
> **Env Vars:** rag (1)
> **Tools:** azure portal (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) (3), [Natural language processing](../../Skills/Artificial%20Intelligence%20(AI)/Natural%20Language%20Processing%20(NLP).md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) (6), [LangChain](../../Skills/Artificial%20Intelligence%20(AI)/LangChain.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/azure-for-developers-retrieval-augmented-generation-rag-with-azure-ai/evaluate-with-the-azure-ai-evaluation-sdk?u=76281980&t=0)** - [Instructor] So now that our evaluation set is properly constructed, we can now evaluate our RAG application using the [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) AI Evaluation SDK. We install our dependencies and load our Azure configuration. We try out a sample with a single row to see the results. We extract one row from our evaluation data set and call the different evaluators. Some evaluators have special settings that we will not discuss in this video. Best to read their specific documentation. Getting the results is straightforward. However, accessing the risk and safety metrics needs you to log in with your Azure account first. If you haven't installed the Azure Command-Line Interface in your [GitHub](../../Skills/Software%20Development/GitHub.md) [Codespaces](../../Skills/Software%20Development/Codespaces.md), you need to do so as well.
>
...
>
> **[2:28](https://www.linkedin.com/learning/azure-for-developers-retrieval-augmented-generation-rag-with-azure-ai/evaluate-with-the-azure-ai-evaluation-sdk?u=76281980&t=148)** Since I use a lot of evaluators, the processing will take longer. Once complete, the evaluation result would look like this file. You can also view the results using [Azure AI Foundry](../../Skills/Artificial%20Intelligence%20(AI)/Azure%20AI%20Foundry.md) to have a better experience. We need to create a project in a region that supports evaluations in Azure AI Foundry, as not all regions are currently supported.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) (7), [Azure AI Foundry](../../Skills/Artificial%20Intelligence%20(AI)/Azure%20AI%20Foundry.md) (4), [GitHub](../../Skills/Software%20Development/GitHub.md) (1), [Codespaces](../../Skills/Software%20Development/Codespaces.md) (1)
...
>
> **[0:05](https://www.linkedin.com/learning/azure-for-developers-retrieval-augmented-generation-rag-with-azure-ai/challenge-evaluating-a-rag-application?u=76281980&t=5)** - [Instructor] Here is our last challenge. You are tasked to evaluate the RAG solution you made with [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) AI Search in the first challenge. You should create an evaluation set with at least 10 rows using the product PDF files we have. You will then perform evaluations on groundedness, relevance, coherence, fluency, similarity, as well as the four risk and safety metrics. Finally, you need to display the results in [Azure AI Foundry](../../Skills/Artificial%20Intelligence%20(AI)/Azure%20AI%20Foundry.md). Do not forget to log in with your Azure account in the terminal and provide yourself the needed roles.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) (2), [Azure AI Foundry](../../Skills/Artificial%20Intelligence%20(AI)/Azure%20AI%20Foundry.md) (1)
> **Env Vars:** rag (1), pdf (1)
> **Tools:** terminal (1)
> **Speakers:** - [instructor] (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) (10), [Azure AI Foundry](../../Skills/Artificial%20Intelligence%20(AI)/Azure%20AI%20Foundry.md) (3), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (2), [Tokens](../../Skills/Web%20Development/Tokens.md) (1)
...
← [Azure AI for Developers- OpenAI Services and Generative AI Models](Azure%20AI%20for%20Developers-%20OpenAI%20Services%20and%20Generative%20AI%20Models.md) | **5 of 8** | [Azure AI for Developers- Content Safety and Responsible AI](Azure%20AI%20for%20Developers-%20Content%20Safety%20and%20Responsible%20AI.md) →
...
- [Building RAG Solutions with Azure AI Foundry (Formerly Azure AI Studio)](Building%20RAG%20Solutions%20with%20Azure%20AI%20Foundry%20(Formerly%20Azure%20AI%20Studio).md) — Artificial Intelligence (AI), Azure AI Foundry, Retrieval-Augmented Generation (RAG)
- [Microsoft Azure Ai Essentials Workloads And Machine Learning On Azure](Microsoft%20Azure%20Ai%20Essentials%20Workloads%20And%20Machine%20Learning%20On%20Azure.md) — Artificial Intelligence (AI), Azure AI Foundry, Machine Learning
