...
next_courses:
  - '[Nano Tips for Using ChatGPT for Business with Rachel Woods](Nano%20Tips%20for%20Using%20ChatGPT%20for%20Business%20with%20Rachel%20Woods.md)'
...
>
> **[0:00](https://www.linkedin.com/learning/prompt-engineering-with-chatgpt/chatgpt-the-ai-game-changer?u=76281980&t=0)** - Get more out of [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md) quickly. That's what effective [Prompt Engineering](../../Skills/Artificial%20Intelligence%20(AI)/Prompt%20Engineering.md) is about, and that's just what we'll learn in this course. We'll look at methods such as Socratic Prompting and personas in real business scenarios. We'll even have a little fun by using multimodality in order to cook a meal. Finally, we'll look at security and [Privacy](../../Skills/Data%20Science/Privacy.md) considerations that are essential to using this tool effectively in a professional environment. I'm Ronnie Sheer. I'm a software engineer with over a decade of experience working for companies that lean heavily on AI. If you want to be a ChatGPT Power User, you're in the right place. So let's get to it.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md) (2), [Prompt Engineering](../../Skills/Artificial%20Intelligence%20(AI)/Prompt%20Engineering.md) (1), [Privacy](../../Skills/Data%20Science/Privacy.md) (1)
> **Analogies:** such as (1)
> **Speakers:** - get (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) (4), [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md) (2), [Tokens](../../Skills/Web%20Development/Tokens.md) (1), [Reinforcement Learning](../../Skills/Artificial%20Intelligence%20(AI)/Reinforcement%20Learning.md) (1)
> **Analogies:** such as (2)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/prompt-engineering-with-chatgpt/providing-context-and-using-delimiters?u=76281980&t=0)** - Providing context is one of the best ways to get more out of [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md). Doing so will likely improve ChatGPT's accuracy. It will simplify the chat, cutting down on the unnecessary back and forth in the conversation with ChatGPT. And finally, you'll be much more likely to get an output that is tailored to your needs and is unique to your use case. Let's take a look at two examples. On one side, we have a rather vague prompt, "Write an apology email for a late shipment." It doesn't say a shipment of what or to whom this email is, and it leaves a lot for ChatGPT to sort of guess. Then, we have this slightly better prompt with more context. It says, "Our company Red30 Tech Imports GPUs. Our [products](../../Skills/Software%20Development/Microsoft%20Products.md) are used for on-premise AI applications. A shipment of three GPUs is two weeks late due to supply-chain issues. Write a formal apology to our client. Take full responsibility and offer a 10-percent discount. The client is Binaryville Robots." Now at a glance, it looks like the second prompt I read with more context takes a bit more work to put together, but let's look at what happens
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md) (15), [Products](../../Skills/Software%20Development/Microsoft%20Products.md) (1), [HTML](../../Skills/Web%20Development/HTML.md) (1), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (1)
...
>
> **[0:06](https://www.linkedin.com/learning/prompt-engineering-with-chatgpt/challenge-prompt-refactor?u=76281980&t=6)** - [Ronnie] It is time for a challenge where we take a simple prompt and refactor it with some of the practices that we've learned in this chapter. So take about 10 to 15 minutes to take this prompt, which is "write a post about learning [Prompt Engineering](../../Skills/Artificial%20Intelligence%20(AI)/Prompt%20Engineering.md)" and enhancing it using some of these techniques. Now, try different variations and see what produces the results that you're happy with. Once you're done, if you're happy with the results and feel like it, you can go ahead and share them on [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) using these hashtags. #learntechwithlinkedin, #ai, #[ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md). And you can also tag me in the post, and I'll try my best to go ahead and [react](../../Skills/Web%20Development/React.js.md) to some of these outputs. I'm always glad to see what learners are doing in these courses.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Prompt Engineering](../../Skills/Artificial%20Intelligence%20(AI)/Prompt%20Engineering.md) (1), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (1), [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md) (1), [React](../../Skills/Web%20Development/React.js.md) (1)
> **Speakers:** - [ronnie] (1)
...
>
> **[0:05](https://www.linkedin.com/learning/prompt-engineering-with-chatgpt/solution-prompt-refactor?u=76281980&t=5)** - [Instructor] The goal of this challenge was to refactor this prompt. Write a post about learning [Prompt Engineering](../../Skills/Artificial%20Intelligence%20(AI)/Prompt%20Engineering.md). My approach was to say, you are a software engineer and instructor specializing in AI. Write a professional post for [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) about the importance of learning prompt engineering. Use plenty of emojis. Now, even specifying which platform this post is for is going to make a difference in the output [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md) produces. Also, notice that I told ChatGPT who the persona is that they're writing this post on behalf of. We'll talk about this technique when we get to dealing with personas. So let's go ahead and take this prompt and bring it over to ChatGPT.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md) (6), [Prompt Engineering](../../Skills/Artificial%20Intelligence%20(AI)/Prompt%20Engineering.md) (2), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (1)
> **CLI Commands:** make (2)
> **Speakers:** - [instructor] (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/prompt-engineering-with-chatgpt/personas?u=76281980&t=0)** - In this one, we're going to look at personas. Asking [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md) to adopt a persona means telling ChatGPT who we want it to be before asking it to perform a task. Let's have a look at a task. We're going to ask ChatGPT to talk about Grafana, which is an open source analytics tool. And in the first example, we'll tell ChatGPT, "You are a marketing expert specializing in B2B cloud observability. Write an email to a CTO of a small startup explaining the benefits of using Grafana." In the second one, we say, "You are an IT consultant specializing in cloud observability. Write an email to a CTO of a small startup explaining the benefits of using Grafana." Just like in other [Prompt Engineering](../../Skills/Artificial%20Intelligence%20(AI)/Prompt%20Engineering.md) techniques, giving lots of context and being very detailed in your instructions is helpful. So let's go ahead and use this first prompt. I'll head over to ChatGPT, and I'll use three quotes as my delimiters. Go ahead and copy this right here, this beginning right here.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md) (8), [Prompt Engineering](../../Skills/Artificial%20Intelligence%20(AI)/Prompt%20Engineering.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/prompt-engineering-with-chatgpt/splitting-up-complex-tasks?u=76281980&t=0)** - [Instructor] In this one, we're going to talk about splitting up tasks into subtasks. Now doing this gives you greater control over how a task is performed, and it can really increase efficiency. Now, here are some ways we can split things up. We can get [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md) to plan, for example. We can ask it, how would you do this? And then we can follow up with another prompt, asking it to perform the actual task. Then we can also start a new conversation when necessary and only bring whatever it is we need into a new conversation. This way, we have less [Tokens](../../Skills/Web%20Development/Tokens.md) and we're less likely to hit the token limit. We can also ask ChatGPT to summarize something in one chat, and then bring that summary over to a new chat to be processed. And this, again, is another way of being efficient. Let me show you what I mean. Here I have an article about [Generative AI](../../Skills/Artificial%20Intelligence%20(AI)/Generative%20AI.md). It's from Wikipedia, and it's not so short. I also have this article about generative pre-trained transformers, GPT. That's the model that ChatGPT is based on. And this is also not the shortest article. Now, I'll start off by downloading these articles. So in Tools, I can go ahead and download as PDF. You can also copy and paste this if you can't upload files onto ChatGPT.
>
...
>
> **[3:54](https://www.linkedin.com/learning/prompt-engineering-with-chatgpt/splitting-up-complex-tasks?u=76281980&t=234)** Great, so I have a distilled version of this information right here. Now, I'll head over to my new tab. I'll start a new conversation, clear it up, and the first thing I'm going to do is I'm going to upload this template. It's an empty [PowerPoint](../../Skills/Cloud%20Computing/Microsoft%20PowerPoint.md) presentation. And I'll ask it, "What are the names of the layouts in this PPTX theme?
>
...
>
> **[5:26](https://www.linkedin.com/learning/prompt-engineering-with-chatgpt/splitting-up-complex-tasks?u=76281980&t=326)** about [GenAI](../../Skills/Artificial%20Intelligence%20(AI)/Generative%20AI.md) and GPT. Here is the context for the presentation,"
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md) (9), [Tokens](../../Skills/Web%20Development/Tokens.md) (2), [Generative AI](../../Skills/Artificial%20Intelligence%20(AI)/Generative%20AI.md) (1), [Powerpoint](../../Skills/Cloud%20Computing/Microsoft%20PowerPoint.md) (1), [Genai](../../Skills/Artificial%20Intelligence%20(AI)/Generative%20AI.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md) (3), [Products](../../Skills/Software%20Development/Microsoft%20Products.md) (1)
> **Env Vars:** ceo (1)
...
>
> **[3:02](https://www.linkedin.com/learning/prompt-engineering-with-chatgpt/socratic-prompting?u=76281980&t=182)** I'll say, "Extensive [Customer Support](../../Skills/IT%20Help%20Desk/Customer%20Support.md), so fast supply and extensive customer support."
>
...
>
> **[3:45](https://www.linkedin.com/learning/prompt-engineering-with-chatgpt/socratic-prompting?u=76281980&t=225)** So here it's given me a few names and it's giving me different reasons why these names may work. I'm going to say that I like [Swift](../../Skills/Mobile%20Development/Swift%20(Programming%20Language).md) Chip Solutions, so I'll say, "I like Swift Chip Solutions. Can you create a logo for it?" And if you have a paid version of ChatGPT that includes Dolly, this is an added benefit. And I have some logo ideas to start with. So as you can see, sometimes getting ChatGPT to interview you is a good way to make sure that you give ChatGPT more context to work with.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md) (8), [Customer Support](../../Skills/IT%20Help%20Desk/Customer%20Support.md) (2), [Swift](../../Skills/Mobile%20Development/Swift%20(Programming%20Language).md) (2)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/prompt-engineering-with-chatgpt/challenge-writing-copy?u=76281980&t=0)** - [Instructor] It's time to put the things we've learned to complete a challenge. And the goal of this challenge is to help come up with a slogan for this fictional [E-Commerce](../../Skills/Web%20Development/E-Commerce.md) brand. It's called Binaryville, and you can find this fictional site at [binaryville.com/shop](https://binaryville.com/shop). Now, Binaryville sells merchandise with these robots and nice little quotes about tech, and we want to go ahead and use some of the techniques we learned. You can try using personas, Socratic prompting, leverage multimodality, or anything we've learned so far, and I'll see you in the next one.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/prompt-engineering-with-chatgpt/solution-writing-copy?u=76281980&t=0)** - [Instructor] The goal of this challenge was to create a good slogan for the Binaryville Shop. And let me show you how I solve this using multimodality and personas. I'm going to go ahead and grab a screenshot of this portion right here. I'll go ahead and add this screenshot to my chat. And my first prompt will say: "Describe this [E-Commerce](../../Skills/Web%20Development/E-Commerce.md) shop.
>
> **[0:46](https://www.linkedin.com/learning/prompt-engineering-with-chatgpt/solution-writing-copy?u=76281980&t=46)** Explain what makes its [products](../../Skills/Software%20Development/Microsoft%20Products.md) valuable to customers." So this is a way of dividing things up a little bit.
>
> **[1:11](https://www.linkedin.com/learning/prompt-engineering-with-chatgpt/solution-writing-copy?u=76281980&t=71)** So now it's time to give [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md) a persona, and I'll say: "You are an e-commerce expert.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [E-Commerce](../../Skills/Web%20Development/E-Commerce.md) (4), [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md) (3), [Products](../../Skills/Software%20Development/Microsoft%20Products.md) (2)
> **Definitions:** is a  (1)
> **Speakers:** - [instructor] (1)
> **Non-Speech:** (upbeat music) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/prompt-engineering-with-chatgpt/what-is-dall-e?u=76281980&t=0)** - [DALL-E](../../Skills/Software%20Development/DALL-E.md) is OpenAI's text to image model. It used to be its own product, but is now part of [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md)'s paid offerings. Now, what we know about DALL-E is a bit limited, but we do know it's a diffusion type model. It receives a prompt, starts off with a noisy image, and then iteratively removes noise until it has a clean and crisp image. Now, DALL-E was trained with a very, very large data set of pairs of images and captions. Keeping this in mind can help us make better choices when [Prompt Engineering](../../Skills/Artificial%20Intelligence%20(AI)/Prompt%20Engineering.md) to get better results from DALL-E.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [DALL-E](../../Skills/Software%20Development/DALL-E.md) (4), [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md) (1), [Prompt Engineering](../../Skills/Artificial%20Intelligence%20(AI)/Prompt%20Engineering.md) (1)
> **Env Vars:** dall (4)
> **CLI Commands:** make (1)
> **Definitions:** is a  (1)
> **Speakers:** - dall (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/prompt-engineering-with-chatgpt/dall-e-3-best-practices?u=76281980&t=0)** - [Instructor] When we prompt [DALL-E](../../Skills/Software%20Development/DALL-E.md), we want to use as much detail as possible, and it can be difficult to describe an image with precise style and what goes into this image, but having DALL-E as part of the [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md) ecosystem can really help us with that. Let me show you what I mean. I can start by asking ChatGPT to list the details that make up an image of a tech conference booth.
>
...
>
> **[1:18](https://www.linkedin.com/learning/prompt-engineering-with-chatgpt/dall-e-3-best-practices?u=76281980&t=78)** The theme is AI [Hardware](../../Topics/Hardware.md). Use the details listed above.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md) (6), [DALL-E](../../Skills/Software%20Development/DALL-E.md) (4), [Hardware](../../Topics/Hardware.md) (1)
> **Env Vars:** dall (4)
> **CLI Commands:** make (1)
> **Definitions:** is a  (1)
> **Analogies:** for example (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/prompt-engineering-with-chatgpt/solution-enrich-a-dall-e-prompt?u=76281980&t=0)** - [Ronnie] The goal of this challenge was to use [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md) and [DALL-E](../../Skills/Software%20Development/DALL-E.md) to generate a sticker for a team of prompt engineers. Then share your creations on [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) so that hopefully we can learn from each other's work. And let's go ahead and head over to ChatGPT, and I'll start by saying, "List the details that make up an appealing sticker design for a team of professional [Prompt Engineering](../../Skills/Artificial%20Intelligence%20(AI)/Prompt%20Engineering.md) superheroes." So I'll go ahead and submit this.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md) (5), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (4), [DALL-E](../../Skills/Software%20Development/DALL-E.md) (1), [Prompt Engineering](../../Skills/Artificial%20Intelligence%20(AI)/Prompt%20Engineering.md) (1)
> **CLI Commands:** make (1)
> **Env Vars:** dall (1)
> **Speakers:** - [ronnie] (1)
> **Non-Speech:** (upbeat music) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/prompt-engineering-with-chatgpt/chatgpt-security-considerations?u=76281980&t=0)** - Before we start using [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md) in a professional environment, here are a few security considerations to keep in mind. It's always a good idea to seek stakeholder's approval when introducing new cutting edge tools to our workflow. Such stakeholders could include management, the person in charge of information security, and of course, our users and clients. It's also important to check ChatGPT's terms of use to see that they're aligned with your organization's security and [Privacy](../../Skills/Data%20Science/Privacy.md) policy. It's also important to configure your environment for optimal security and privacy. As with many tools, you should not input passwords, keys, or any sensitive data into ChatGPT.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md) (3), [Privacy](../../Skills/Data%20Science/Privacy.md) (2)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/prompt-engineering-with-chatgpt/plans-and-data-controls?u=76281980&t=0)** - [Instructor] Data controls give you a few options when it comes to information security and [Privacy](../../Skills/Data%20Science/Privacy.md) while using [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md). Before we take a look at how we can configure data controls, let's take a look at what different plans of ChatGPT mean for businesses. At the time of this recording, the free version of ChatGPT and ChatGPT+ use data for training by default. These versions of ChatGPT are also less suitable for business use, and they're definitely not intended for enterprise applications. Now, both the Teams and Enterprise plans do offer enhanced security and privacy. They allow resource sharing within an organization or a team, and they offer larger context [Windows](../../Glossary/Service/Windows.md); allowing you to have longer conversations and use more [Tokens](../../Skills/Web%20Development/Tokens.md). Most importantly, both teams and enterprise plans are built for work and are more appropriate for business use. With that in mind, let's take a look at how we can configure data controls. You'll notice that at the bottom it says the Smart Plan workspace chats aren't used to train models. ChatGPT can make mistakes. So these are the two pieces of information they're letting me know. The reason these chats are private is
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md) (10), [Privacy](../../Skills/Data%20Science/Privacy.md) (3), [Windows](../../Glossary/Service/Windows.md) (1), [Tokens](../../Skills/Web%20Development/Tokens.md) (1)
...
>
> **[0:05](https://www.linkedin.com/learning/prompt-engineering-with-chatgpt/solution-use-data-controls?u=76281980&t=5)** - [Instructor] The goal of this challenge was to head over to data controls, turn off chat history and training, and start a conversation, then to keep [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md)'s output somehow. Now, let me show you my solution and I'll also demonstrate a way you can get data from ChatGPT to spreadsheet software like [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) if you don't have access to creating files with ChatGPT. So here I am in my personal account of ChatGPT, and I'll open up the menu and navigate to Settings. And I'll head over to Data Controls and go ahead and toggle off chat history and training. Now, I'll type in this prompt, create a table with names, column, and ages column. Add Jill, age 44, Jim, age 43, [John](../../Glossary/Tool/John%20the%20Ripper.md), age 33, and Jack, age 28 to the table.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/prompt-engineering-with-chatgpt/next-steps?u=76281980&t=0)** - [Ronnie] This is Ronnie Sheer. I wanted to thank you for taking this course. Now, if you're interested in AI and all things technology, go ahead and subscribe to my YouTube channel; there I talk about the latest trends in AI and share tips that may help you leverage cutting-edge technologies. You might also want to follow me on [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) where I share my thoughts on these trends. Now, as far as courses go, here are a few neat ones I can recommend checking out from the library. If you wish to get a sense of the broad [Generative AI](../../Skills/Artificial%20Intelligence%20(AI)/Generative%20AI.md) landscape and how [Prompt Engineering](../../Skills/Artificial%20Intelligence%20(AI)/Prompt%20Engineering.md) applies to it, there's my course [Introduction To Prompt Engineering For Generative Ai](Introduction%20To%20Prompt%20Engineering%20For%20Generative%20Ai.md). If you wish to customize [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md)'s behavior, there's the course Build Your Own GPTs with Alina Zhang. Finally, if you're involved in software engineering and wish to get cutting-edge AI into your software, there's a great learning path called Develop Your Skills with the [OpenAI API](../../Skills/Artificial%20Intelligence%20(AI)/OpenAI%20API.md). Once again, thank you so much and till the next one, always be learning.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Generative AI](../../Skills/Artificial%20Intelligence%20(AI)/Generative%20AI.md) (2), [Prompt Engineering](../../Skills/Artificial%20Intelligence%20(AI)/Prompt%20Engineering.md) (2), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (1), [ChatGPT](../../Skills/Artificial%20Intelligence%20(AI)/ChatGPT.md) (1), [OpenAI API](../../Skills/Artificial%20Intelligence%20(AI)/OpenAI%20API.md) (1)
> **Env Vars:** api (1)
> **Speakers:** - [ronnie] (1)
...
← [How to Research and Write Using Generative AI Tools (2023)](How%20to%20Research%20and%20Write%20Using%20Generative%20AI%20Tools%20(2023).md) | **3 of 6** | [Nano Tips for Using ChatGPT for Business with Rachel Woods](Nano%20Tips%20for%20Using%20ChatGPT%20for%20Business%20with%20Rachel%20Woods.md) →
...
← [Introduction To Prompt Engineering For Generative Ai](Introduction%20To%20Prompt%20Engineering%20For%20Generative%20Ai.md) | **3 of 6** | [ChatGPT- Perfecting Your Output with Templates in Prompts](ChatGPT-%20Perfecting%20Your%20Output%20with%20Templates%20in%20Prompts.md) →
