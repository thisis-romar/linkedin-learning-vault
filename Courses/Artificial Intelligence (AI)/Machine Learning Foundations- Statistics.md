...
prev_courses:
  - '[Machine Learning Foundations- Probability](Machine%20Learning%20Foundations-%20Probability.md)'
  - '[Machine Learning Foundations- Probability](Machine%20Learning%20Foundations-%20Probability.md)'
next_courses:
  - '[Built-in Machine Learning in the Wolfram Language](../Data%20Science/Built-in%20Machine%20Learning%20in%20the%20Wolfram%20Language.md)'
  - null
...
>
> **[0:00](https://www.linkedin.com/learning/machine-learning-foundations-statistics/introduction?u=76281980&t=0)** - Imagine a future where you don't just run machine learning model, but understand it. You can troubleshoot issues, optimize performance and innovate, creating a new ML model that is more efficient. Here's a secret weapon, a deep understanding of [Statistics](../../Skills/Data%20Science/Statistics.md). This isn't just about crunching numbers, it's about gaining insights into the data, understanding uncertainties associated with predictions and making data-driven decisions with confidence. Hi, I'm Terezija Semenski, I'm a software developer, mathematician and a teacher with a passion for AI and machine learning. With this ML Foundation course in statistics, you'll be ready to [excel](../../Skills/Data%20Science/Microsoft%20Excel.md) in your next machine learning project.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/machine-learning-foundations-statistics/what-you-should-know?u=76281980&t=0)** - [Instructor] Before you get started with this course, there are a few things you should know. You should be familiar with the key concepts of algebra, pre-[Calculus](../../Skills/Data%20Science/Calculus.md), and [Probability](../../Skills/Data%20Science/Probability.md). If you struggle with basic probability concepts, I highly encourage you to take my Machine Learning Foundation Probability course before taking this course. You should have a basic [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) programming knowledge. We'll focus on statistic capabilities and their applications in Python Code. Our focus will be on the latest versions of Python 3. You will also want to make sure you have an account installed. We are going to be working with Jupyter Notebooks, so if you have never worked with Jupyter Notebooks before, then you can go check out the Jupyter Notebooks basics video in my course, Foundations of NumPy. Fortunately, everything you need for this course that's Python and Jupyter Notebooks can be acquired simply by installing the free Anaconda 3 distribution. And that's about it, so let's roll our sleeves and get started.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (4), [Probability](../../Skills/Data%20Science/Probability.md) (3), [Calculus](../../Skills/Data%20Science/Calculus.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Statistics](../../Skills/Data%20Science/Statistics.md) (3), [Deep Learning](../../Skills/Artificial%20Intelligence%20(AI)/Deep%20Learning.md) (2), [Image Processing](../../Skills/Artificial%20Intelligence%20(AI)/Image%20Processing.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Databases](../../Skills/Software%20Development/Databases.md) (2), [Algorithms](../../Skills/Software%20Development/Algorithms.md) (1)
...
>
> **[1:35](https://www.linkedin.com/learning/machine-learning-foundations-statistics/the-correlation-vs-causation?u=76281980&t=95)** and moving to a different [office](../../Skills/Web%20Development/Microsoft%20Office.md). However, one doesn't cause the other one. There's a third variable which is the cause, and it's the promotion. In the end, some examples and graphs clearly show that correlation does not imply causation. Global average temperatures correlate with the number of pirates. Divorce rate correlates with consumption of margarine. Even total revenue generated by arcades correlates with CS doctorates awarded in the US. Obviously, these funny examples show that correlation does not mean causation.
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Probability](../../Skills/Data%20Science/Probability.md) (9), [Statistics](../../Skills/Data%20Science/Statistics.md) (4)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Probability](../../Skills/Data%20Science/Probability.md) (7), [Statistics](../../Skills/Data%20Science/Statistics.md) (2)
...
>
> **[1:32](https://www.linkedin.com/learning/machine-learning-foundations-statistics/independent-and-dependent-variables?u=76281980&t=92)** or amount of exercise in minutes and we use it to predict the outcome. That way we can put features and outcome in ML model and examine if there's a statistically significant relationship. The way to do this is to adjust the features so we can measure the changes in the dependent variable. Now that we understand the role of independent and independent variables in machine learning, we can continue exploring their importance in [Linear Regression](../../Skills/Data%20Science/Linear%20Regression.md).
...
← [Machine Learning Foundations- Probability](Machine%20Learning%20Foundations-%20Probability.md) | **5 of 6** | [Built-in Machine Learning in the Wolfram Language](../Data%20Science/Built-in%20Machine%20Learning%20in%20the%20Wolfram%20Language.md) →
...
← [Machine Learning Foundations- Probability](Machine%20Learning%20Foundations-%20Probability.md) | **4 of 4**
