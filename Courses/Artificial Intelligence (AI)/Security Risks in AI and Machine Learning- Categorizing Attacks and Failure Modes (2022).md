...
prev_courses:
  - '[Artificial Intelligence and Application Security](Artificial%20Intelligence%20and%20Application%20Security.md)'
next_courses:
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Threat Modeling](../../Skills/Cybersecurity/Threat%20Modeling.md) (4), [Privacy](../../Skills/Data%20Science/Privacy.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Google](../../Glossary/Service/Google.md) (1), [Malware Detection](../../Skills/Cybersecurity/Malware%20Detection.md) (1)
> **CLI Commands:** make (2)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/security-risks-in-ai-and-machine-learning-categorizing-attacks-and-failure-modes-2022/model-inversion?u=76281980&t=0)** - [Narrator] Machine learning models need training data, lots of training data to learn from. It's reasonable to expect that the data used to train the model wouldn't be available to users of the model, once it's in production. Consider a person who learns a new language. When we encounter that person, we recognize that they are now able to converse in the new language, but we don't know what books or tools they use to acquire fluency. What if you could figure out which tool a person used to learn a language, just by speaking to them? That's the core of membership inference and model inversion. Access to the ML model can be used by attackers to uncover private information from the training data set. If the training data is public, access to it would not be a big concern. But many machine learning [Algorithms](../../Skills/Software%20Development/Algorithms.md) are used for [Privacy](../../Skills/Data%20Science/Privacy.md) sensitive purposes, such as facial recognition and medical diagnosis. And that often means that they've been trained with sensitive personal data. One example is a recommendation system for streaming sites. What if others could infer what you've been watching by seeing what the app recommends for you next? Model inversion can also leak secrets about how the system was trained. Like allowing a competitor to determine which accents an ML based [Speech Recognition](../../Skills/Software%20Development/Speech%20Recognition.md) app was trained on. Using facial recognition models
>
> **[1:36](https://www.linkedin.com/learning/security-risks-in-ai-and-machine-learning-categorizing-attacks-and-failure-modes-2022/model-inversion?u=76281980&t=96)** and the confidence scores output by the system, an attacker was able to recover a recognizable facial image of a test data subject, using only the person's name. Now granted, in a world where most of us frequently post selfies on social media, the idea of having our face recovered, isn't too concerning, but this technique can expose more private information too. Using model inversion, researchers were able to infer if a respondent answered yes or no, to the infidelity question, with no false positives. And that's probably not the kind of information anybody would want an adversary to know. In some cases the training data itself is not exposed, but it can be inferred by querying the model. In one study, researchers queried a model that contained hospital discharge data, from the Texas Department of State Health Services and were able to infer the patient procedures, with 70% accuracy. Attackers gain access to models by querying the APIs of popular ML as a service, machine learning as a service. Providers like [Google](../../Glossary/Service/Google.md), Google prediction API, Amazon, Amazon ML and [Microsoft Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) ML. Machine learning as a service is very popular, because it allows developers to incorporate ML into their systems without a lot of startup time, but they must be used with data protection in mind, to prevent an inadvertent exposure of private information.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Google](../../Glossary/Service/Google.md) (2), [Algorithms](../../Skills/Software%20Development/Algorithms.md) (1), [Privacy](../../Skills/Data%20Science/Privacy.md) (1), [Speech Recognition](../../Skills/Software%20Development/Speech%20Recognition.md) (1), [Microsoft Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/security-risks-in-ai-and-machine-learning-categorizing-attacks-and-failure-modes-2022/side-effects-in-reinforcement-learning?u=76281980&t=0)** - [Instructor] Have you ever heard the term as the Crow flies? People use it when they're trying to explain that the straight path is faster than the actual path. Getting from your [office](../../Skills/Web%20Development/Microsoft%20Office.md) to your house may be only four miles as the Crow flies, but it could be 10 miles of road and 30 minutes of sitting in traffic in reality. If you could eliminate the road and traffic obstacles, you could get home much faster. Without careful design practices in place, machine learning systems that use [Reinforcement Learning](../../Skills/Artificial%20Intelligence%20(AI)/Reinforcement%20Learning.md) and rewards could have unintended and unwanted side effects in operation by trying to operate as directly as the Crow flies. As the system looks for an optimal path to a solution, it may not take other factors into consideration. This can be particularly problematic in physical environments. Consider a floor cleaning robot that is rewarded for cleaning up a liquid when it's spilled on the floor. The smart bot uses [Computer Vision](../../Skills/Artificial%20Intelligence%20(AI)/Computer%20Vision.md) to monitor for spills and then is rewarded for mopping that spill up as quickly as possible. If the robotic systems begin to prioritize speed over other factors, it could begin malfunctioning in destructive ways. For example, if there are no obstacles, there's nothing for the robot to run into on its way to clean up. But if there's a large bouquet of flowers sitting in an expensive vase on top of a table
>
> **[1:34](https://www.linkedin.com/learning/security-risks-in-ai-and-machine-learning-categorizing-attacks-and-failure-modes-2022/side-effects-in-reinforcement-learning?u=76281980&t=94)** between the robot and the spill, the robot could crash into that table, shattering the vase and creating a new mess all in an attempt to get to the spill as quickly as possible. Side effect failures can occur online too. A cyberdefense response tool that is designed to stop attacks quickly must also be programmed with rules regarding acceptable response actions. Although, shutting down all the ports on a firewall and other critical services, such as email and [Web Servers](../../Skills/Web%20Development/Web%20Servers.md), may be the, quote, shortest path to stopping an attack. It would also stop [Business Operations](../../Skills/Data%20Science/Business%20Operations.md), putting the financial success of the company at risk. If AI and ML creators don't consider and design for side effects before launching systems into production, the results could cause real harm.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Office](../../Skills/Web%20Development/Microsoft%20Office.md) (1), [Reinforcement Learning](../../Skills/Artificial%20Intelligence%20(AI)/Reinforcement%20Learning.md) (1), [Computer Vision](../../Skills/Artificial%20Intelligence%20(AI)/Computer%20Vision.md) (1), [Web Servers](../../Skills/Web%20Development/Web%20Servers.md) (1), [Business Operations](../../Skills/Data%20Science/Business%20Operations.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Computer Vision](../../Skills/Artificial%20Intelligence%20(AI)/Computer%20Vision.md) (1), [Data Classification](../../Skills/Data%20Science/Data%20Classification.md) (1)
> **CLI Commands:** find (2)
> **Definitions:** is a  (2)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/security-risks-in-ai-and-machine-learning-categorizing-attacks-and-failure-modes-2022/ml-dataset-hygiene?u=76281980&t=0)** - [Instructor] If you've ever accidentally taught your autocorrect system that a typo is an actual [word](../../Skills/Cloud%20Computing/Microsoft%20Word.md), and then had to spend months correcting that typo every time your system tried to insert it, you know how frustrating it can be when machines learn the wrong thing. If the data ML and AI systems are trained on isn't good or accurate, the outcome from the model won't be good either. That's why it's incredibly important to vet datasets and implement dataset hygiene policies. Biased data leads to biased classifications and predictions. But bias isn't always obvious or intentional. Consider an automated faucet that is programed to turn on when the [Computer Vision](../../Skills/Artificial%20Intelligence%20(AI)/Computer%20Vision.md) recognizes human hands in front of the faucet. If the system is trained only with light-skinned adult hands, it may not turn on if darker-skinned or small hands are in front of the sensor. Systems need to be trained on datasets that represent the entire population of potential users. Existing datasets can be biased too. Traditionally, many technical fields, like computer programming, have been staffed predominantly by male workers. The [Statistics](../../Skills/Data%20Science/Statistics.md) are changing as more women enter technical fields but if an ML-based CV or resume analysis system is trained on the older biased data, it could learn that male candidates are desirable.
>
> **[1:36](https://www.linkedin.com/learning/security-risks-in-ai-and-machine-learning-categorizing-attacks-and-failure-modes-2022/ml-dataset-hygiene?u=76281980&t=96)** To get ahead of bias in systems, training sets and technique should be carefully vetted by a wide number of experts. Because we can rarely recognize our own bias, it helps to have different people with different skillsets and viewpoints assess the training data for bias. The more eyes and minds that vet the data for bias, the more likely that bias will be identified and corrected before the resource-intensive training phase. Intentional poisoning of data is another way to cause ML and AI to fail. A great way to protect training data or any sensitive data for that matter is by applying the principle of least privilege. Using the principle in practice means that only those that need access to something are granted access. It is often used in conjunction with [Data Classification](../../Skills/Data%20Science/Data%20Classification.md) programs, which help to identify an organization's most important and sensitive information. For organizations that have not yet started on the data protection journey, this is an opportunity to address overall [Data Security](../../Skills/Data%20Science/Data%20Security.md) while also defending and protecting AI and ML systems. Existing data classification and privilege management programs should be extended to include AI and ML training data. Not all training data is created or developed in house. Many companies use existing training datasets from public sources or partners.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Data Classification](../../Skills/Data%20Science/Data%20Classification.md) (2), [Word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) (1), [Computer Vision](../../Skills/Artificial%20Intelligence%20(AI)/Computer%20Vision.md) (1), [Statistics](../../Skills/Data%20Science/Statistics.md) (1), [Data Security](../../Skills/Data%20Science/Data%20Security.md) (1)
> **Definitions:** is an  (2)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/security-risks-in-ai-and-machine-learning-categorizing-attacks-and-failure-modes-2022/ml-access-control-to-apis?u=76281980&t=0)** - [Instructor] Many ML and [AI Solutions](../../Skills/Software%20Development/AI%20Solutions.md) are accessed to via API, [application programming interfaces](../../Skills/Software%20Development/Application%20Programming%20Interfaces%20(API).md). Chatty or verbose models that return a lot of information can result in data leakage of sensitive data. They can also expose ways the model operates making it easier for adversaries to generate effective attacks. Data leakage of sensitive information is of high concern for regulated organizations that must comply with protections for healthcare data, [Financial Data](../../Skills/Software%20Development/Financial%20Data.md) and personally identifiable data. In order to work well, most ML models need a lot of data. But when of amounts of data are aggregated it can be extremely difficult to protect access at a granular level. Traditionally, solutions like encryption, tokenization, and data masking have been used to protect sensitive data in aggregate sets. However, in AI and ML, most of those options could break the models or render them highly inaccurate. So what can companies do? They can extend API protection strategies to all ML and AI. This goes for both the ML and APIs that your organization has put out yourselves as well as for the APIs that your systems are interacting with. Get into a PoLP, or principle of least privileged mindset. Applying it to the APIs themselves using an API gateway
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [AI Solutions](../../Skills/Software%20Development/AI%20Solutions.md) (1), [Application programming interfaces](../../Skills/Software%20Development/Application%20Programming%20Interfaces%20(API).md) (1), [Financial Data](../../Skills/Software%20Development/Financial%20Data.md) (1)
...
← [Artificial Intelligence and Application Security](Artificial%20Intelligence%20and%20Application%20Security.md) | **4 of 8** | [Red Teaming for Generative AI- Building Robust and Responsible Solutions](../Cybersecurity/Red%20Teaming%20for%20Generative%20AI-%20Building%20Robust%20and%20Responsible%20Solutions.md) →
