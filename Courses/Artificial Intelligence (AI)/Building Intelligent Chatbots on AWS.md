...
>
> **[3:51](https://www.linkedin.com/learning/building-intelligent-chatbots-on-aws-22735480/user-input-prompts?u=76281980&t=231)** Yes, and since I said yes it fulfilled this because we don't actually have the [rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) of the intent done, but we're getting there. And you can see it was a little bumpy. We probably need to make a few changes in there some of the wording and how we [word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) it so that the response is also worded in the way we want but working pretty smooth for just typing in some fields. I'm pretty encouraged. I hope you are too.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/building-intelligent-chatbots-on-aws-22735480/client-creation?u=76281980&t=0)** - [Instructor] Now that my bot's ready to test in AWS, I want a local client to be able to access it and run some of the commands, some of those utterances from the client so that I can test this interaction. Now normally when I would do this in a project, I'd use Amplify or Amplify Studio. These are great tools by AWS to configure and kind of manage your project. In this case I'm just going to do it manually just to kind of cut to the chase and get to the point of connecting to this bot. But typically, I would definitely use Amplify to manage this whole thing. From the Amplify docs at docs.amplify.aws, I can see the typical "Get started for free" button. I could jump directly to a language and platform by clicking one of those logos underneath it as well. I'm just going to click on the "Get started for free". I'm going to select [JavaScript](../../Skills/Software%20Development/JavaScript.md) from the dropdown and then I'm going to go right to the Libraries tab over here. This is going to get me integrate this into a project really quickly. So I've got the prerequisites I need to have [Node.js](../../Skills/Web%20Development/Node.js.md) which we'll install [npm](../../Skills/Web%20Development/npm.md) as well. So I've already done that. I've got that installed, but you would need to do that. Don't really need to do NPM separately or [Git](../../Skills/Software%20Development/Git.md). I've already got an AWS account and I'm not going to use the Amplify [CLI](../../Skills/Network%20and%20System%20Administration/CLI.md). Again, I'm just going to straight to manually setting this up. So I really don't need these other pieces of setting up this command line interface and associating it with an account and everything by configuring it. So I'm just going to skip all these pieces.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [npm](../../Skills/Web%20Development/npm.md) (4), [JavaScript](../../Skills/Software%20Development/JavaScript.md) (1), [Node.js](../../Skills/Web%20Development/Node.js.md) (1), [Git](../../Skills/Software%20Development/Git.md) (1), [CLI](../../Skills/Network%20and%20System%20Administration/CLI.md) (1)
...
>
> **[1:36](https://www.linkedin.com/learning/building-intelligent-chatbots-on-aws-22735480/gathering-configuration-data?u=76281980&t=96)** down here under the services. I can look up Lex. In here, I can look at the developer guide. Under how it works, I can look up supported languages. And then here's English. Now that was kind of a pain to get to. You could probably get there a lot faster if you just [Google](../../Glossary/Service/Google.md) AWS supported languages or Lex V2 supported languages. I just wanted to show you this as one way to get into it and how to access it. So back in the code, I'm going to put in that language. And now I have all of my settings in here. I should be ready to test this and I'll do that in the next video.
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (1), [PHP](../../Skills/Software%20Development/PHP.md) (1), [Databases](../../Skills/Software%20Development/Databases.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1), [GitHub](../../Skills/Software%20Development/GitHub.md) (1)
...
← [Building Serverless Apps with AI Services on AWS](Building%20Serverless%20Apps%20with%20AI%20Services%20on%20AWS.md) | **6 of 6**
...
- [Building a Project with the ChatGPT API](Building%20a%20Project%20with%20the%20ChatGPT%20API.md) — Artificial Intelligence (AI), Chatbot Development
- [Hands On Ai Build Your Own Gpts](Hands%20On%20Ai%20Build%20Your%20Own%20Gpts.md) — Artificial Intelligence (AI), Chatbot Development
- [Introduction to AWS AI Services for Developers](Introduction%20to%20AWS%20AI%20Services%20for%20Developers.md) — Artificial Intelligence (AI), Amazon Web Services (AWS)
- [Hands-On AI- Build an AI Chatbot with GPT-4o and Next.js](Hands-On%20AI-%20Build%20an%20AI%20Chatbot%20with%20GPT-4o%20and%20Next.js.md) — Artificial Intelligence (AI), Chatbot Development
