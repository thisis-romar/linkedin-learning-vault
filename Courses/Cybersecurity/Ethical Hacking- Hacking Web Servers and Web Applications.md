...
>
> **[0:00](https://www.linkedin.com/learning/ethical-hacking-hacking-web-servers-and-web-applications/testing-to-make-sure-your-website-is-safe?u=76281980&t=0)** - [Malcolm] The web is an essential service providing easy access to information anywhere, anytime. Businesses communicate with their customers through the web, governments communicate with citizens through the web, and we all use the web for [E-Commerce](../../Skills/Web%20Development/E-Commerce.md) services, such as online [Banking](../../Skills/Software%20Development/Banking.md) and shopping. Web services are accessible remotely, and this puts them at high risk of cyber attack. I'm Malcolm Shore and I've spent a career helping governments and businesses protect their systems against cyber attacks. In this [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) Learning course, I'll start by explaining web protocols and the basics of [Web Design](../../Skills/Web%20Development/Web%20Design.md). And I'll look at the [OWASP](../../Skills/Cybersecurity/OWASP.md) top 10 web vulnerabilities. I'll demonstrate some of the popular tools available to do web testing, including [Burp Suite](../../Skills/Cybersecurity/Burp%20Suite.md), ZAP and WebScarab. And I'll show you how to use these to scan websites and run as web proxies. I'll also look at some websites, where you can practice your web testing. When you finish this course, you'll have a great understanding of how to test for website weaknesses. Now, let's get started learning about hacking [Web Servers](../../Skills/Web%20Development/Web%20Servers.md) and web applications.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [E-Commerce](../../Skills/Web%20Development/E-Commerce.md) (1), [Banking](../../Skills/Software%20Development/Banking.md) (1), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (1), [Web Design](../../Skills/Web%20Development/Web%20Design.md) (1), [OWASP](../../Skills/Cybersecurity/OWASP.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/ethical-hacking-hacking-web-servers-and-web-applications/what-you-should-know?u=76281980&t=0)** - [Instructor] This is a practical course, and during this course, I'll be using a virtualized environment called VirtualBox. I'll also be using a number of tools, many of which are in the [Kali Linux](../../Skills/Cybersecurity/Kali%20Linux.md) system. If you're not familiar with Kali and virtualization, you should watch my Introduction to Kali Linux course which will guide you through installing and using this testing environment. I'll be assuming that you understand the basics of networking, are familiar with [Windows](../../Glossary/Service/Windows.md) and [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md), and have a working knowledge of how websites work. It would also be useful to be able to script [HTML](../../Skills/Web%20Development/HTML.md) and [PHP](../../Skills/Software%20Development/PHP.md).

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Kali Linux](../../Skills/Cybersecurity/Kali%20Linux.md) (2), [Windows](../../Glossary/Service/Windows.md) (1), [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) (1), [HTML](../../Skills/Web%20Development/HTML.md) (1), [PHP](../../Skills/Software%20Development/PHP.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [HTML](../../Skills/Web%20Development/HTML.md) (3), [JavaScript](../../Skills/Software%20Development/JavaScript.md) (3), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (3), [SQL](../../Skills/Data%20Science/SQL.md) (1), [Forms](../../Skills/Web%20Development/Forms.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Web Servers](../../Skills/Web%20Development/Web%20Servers.md) (3), [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) (3), [Windows](../../Glossary/Service/Windows.md) (3), [HTML](../../Skills/Web%20Development/HTML.md) (2), [PHP](../../Skills/Software%20Development/PHP.md) (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Wireshark](../../Skills/Cybersecurity/Wireshark.md) (3), [HTML](../../Skills/Web%20Development/HTML.md) (3), [Metadata](../../Skills/Web%20Development/Metadata.md) (1), [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) (1), [Web Servers](../../Skills/Web%20Development/Web%20Servers.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/ethical-hacking-hacking-web-servers-and-web-applications/moving-on-to-websockets?u=76281980&t=0)** - [Instructor] With the release of [HTML](../../Skills/Web%20Development/HTML.md) 5, more sophisticated state management capabilities are available to the web developer. [WebSockets](../../Skills/Web%20Development/WebSocket.md) provide the ability to setup a full duplex communications channel between the client and the server. This required a handshake over HTTP or HTTPS. To upgrade the protocol to WS or WSS, and a WebSockets server to manage the protocol. Firstly the client initiates the connection by sending an HTTPS web socket handshake request, and the server responds with a status code of 101 switching protocols. It then switches to WebSockets, and both the web browser and the web server communicate using the WebSockets API, according to RFC 6455, the WebSockets protocol. WebsocketD is an easy to use WebSockets server written by Joe Walnize, which will run on [Ubuntu](../../Skills/Web%20Development/Ubuntu.md). We can get the ZIP file of this server from his [GitHub](../../Skills/Software%20Development/GitHub.md) page, unpack it, and it'll be ready for use. I've already loaded it on my Ubuntu system. While WebsocketD provides the ability to maintain state, it doesn't actually do anything. Hence we need to compliment it with some processing capability. The WebSockets server comes with a development console to ensure the protocol is working, and I've prepared a script as a backend program for the console. This is a simple bash script which counts to ten, and echoes the count to its output channel, in this case the web socket. Okay, let's start the server. I'll start it on port 8008, although any port that's not in use would be fine.
>
> **[1:36](https://www.linkedin.com/learning/ethical-hacking-hacking-web-servers-and-web-applications/moving-on-to-websockets?u=76281980&t=96)** I'll now use Chrome from my [Windows](../../Glossary/Service/Windows.md) 7 system to connect to the Web Socket server. I do that by connecting to HTTP on the web socket port 8088. Chrome has built in support for web sockets, so we don't need anything extra on the browser. Okay, we can see the URL is now WS. The bash script is communicating its count, and we have a running Web Socket server.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Websockets](../../Skills/Web%20Development/WebSocket.md) (7), [Ubuntu](../../Skills/Web%20Development/Ubuntu.md) (2), [HTML](../../Skills/Web%20Development/HTML.md) (1), [GitHub](../../Skills/Software%20Development/GitHub.md) (1), [Windows](../../Glossary/Service/Windows.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Google](../../Glossary/Service/Google.md) (5), [Wireshark](../../Skills/Cybersecurity/Wireshark.md) (2), [Android](../../Glossary/Sdk/Android.md) (1), [Products](../../Skills/Software%20Development/Microsoft%20Products.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Windows](../../Glossary/Service/Windows.md) (2), [PHP](../../Skills/Software%20Development/PHP.md) (2)
...
>
> **[2:31](https://www.linkedin.com/learning/ethical-hacking-hacking-web-servers-and-web-applications/web-access-apis?u=76281980&t=151)** [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) three OTP.Py.
>
> **[2:40](https://www.linkedin.com/learning/ethical-hacking-hacking-web-servers-and-web-applications/web-access-apis?u=76281980&t=160)** I've got [Microsoft](../../Instructors/Artificial%20Intelligence%20(AI)/Microsoft.md) Authenticator running on my mobile phone and I've scanned the QR code to install the demonstration account. Let's try out our endpoint, [http://192.168.1.51:8081/check](http://192.168.1.51:8081/check),
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Hydra](../../Glossary/Tool/Hydra.md) (1), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (1), [Microsoft](../../Instructors/Artificial%20Intelligence%20(AI)/Microsoft.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Burp Suite](../../Skills/Cybersecurity/Burp%20Suite.md) (8)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Burp Suite](../../Skills/Cybersecurity/Burp%20Suite.md) (1), [OWASP](../../Skills/Cybersecurity/OWASP.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Java](../../Skills/Software%20Development/Java.md) (1), [Banking](../../Skills/Software%20Development/Banking.md) (1), [HTML](../../Skills/Web%20Development/HTML.md) (1), [Fetch](../../Skills/Web%20Development/Fetch.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Web Servers](../../Skills/Web%20Development/Web%20Servers.md) (1), [Banking](../../Skills/Software%20Development/Banking.md) (1), [HTML](../../Skills/Web%20Development/HTML.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/ethical-hacking-hacking-web-servers-and-web-applications/looking-for-credentials-in-html-code?u=76281980&t=0)** - [Instructor] WebGoat provides a simple lesson in finding exposed data in the source [HTML](../../Skills/Web%20Development/HTML.md) code for a webpage. I'll start up WebGoat and connect to it on port 8080.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Burp Suite](../../Skills/Cybersecurity/Burp%20Suite.md) (7)
...
>
> **[2:06](https://www.linkedin.com/learning/ethical-hacking-hacking-web-servers-and-web-applications/hijacking-sessions-with-cookies-14032789?u=76281980&t=126)** Okay, I've got my account summary and I can do some [Banking](../../Skills/Software%20Development/Banking.md). Perhaps I'll transfer $100 to my credit card. Transfer funds to credit card, $100 part payment
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Wireshark](../../Skills/Cybersecurity/Wireshark.md) (4), [Banking](../../Skills/Software%20Development/Banking.md) (2), [Windows 10](../../Skills/Network%20and%20System%20Administration/Windows%2010.md) (1), [Wifi](../../Glossary/Standard/Wi-Fi.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [PHP](../../Skills/Software%20Development/PHP.md) (7), [HTML](../../Skills/Web%20Development/HTML.md) (5), [Data Validation](../../Skills/Software%20Development/Data%20Validation.md) (2)
...
>
> **[3:13](https://www.linkedin.com/learning/ethical-hacking-hacking-web-servers-and-web-applications/testing-for-sql-injections?u=76281980&t=193)** Okay, we've just dumped the whole database and achieved a full blown data breach. We can achieve the same result by entering "quote" or "one equals one" semi-colon, dash, dash, where the double dash forces the [rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) of the line, in this case, the original trailing apostrophe, to be commented out. WebGoat provides further exercises in SQL injection which you might wish to follow up with to hone your skills.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [SQL](../../Skills/Data%20Science/SQL.md) (7), [Forms](../../Skills/Web%20Development/Forms.md) (1), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1)
> **Env Vars:** sql (7)
> **CLI Commands:** make (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [PHP](../../Skills/Software%20Development/PHP.md) (4), [HTML](../../Skills/Web%20Development/HTML.md) (3)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/ethical-hacking-hacking-web-servers-and-web-applications/injecting-commands-through-the-url?u=76281980&t=0)** - [Instructor] I scripted up a [PHP](../../Skills/Software%20Development/PHP.md)-based webpage on Metasploitable called commandget.php. It's in the folder "/var/www". And we'll use this to demonstrate how we can inject arbitrary operating system commands into a Web server. The purpose of the PHP script is to do an nslookup of the host and display the results. The script starts with an [HTML](../../Skills/Web%20Development/HTML.md) header and webpage heading followed by a PHP script to do the lookup. Note the isset command which ensures that, if no host has been specified on the URL, the script just continues to display a form for the names of a lookup. Okay, let's run this. I'll browse to the Metasploitable page from Iceweasel.
>
> **[0:53](https://www.linkedin.com/learning/ethical-hacking-hacking-web-servers-and-web-applications/injecting-commands-through-the-url?u=76281980&t=53)** Okay, I'll submit the query with the default selection and we get the results for Amazon. I'll run it again and select [Google](../../Glossary/Service/Google.md). We can see, on the URL, the host name inserted. I'll add a semicolon to the end of the line and then append the ls command and I'll send the URL to the server. We've got back the lookup for Google followed rather entirely by the listing of the root directory for the Web server scripts. Let's be a bit tidier. I'll include a string of commands, including line breaks, to make this a more readable attack. While I'm at it, I might just dump the contents of the password file as well.
>
> **[1:50](https://www.linkedin.com/learning/ethical-hacking-hacking-web-servers-and-web-applications/injecting-commands-through-the-url?u=76281980&t=110)** And, here, we see an easier-to-read extraction of information from the system. We've injected a string of commands, gained a directory listing and the contents of the password file. A powerful tool for the attacker, and one of significant concern for the [defender](../../Skills/Network%20and%20System%20Administration/Microsoft%20Defender.md), is the Generic Web Exploitation Engine, GWEE. This will exploit a site with special code to deliver a shell. The TAR.GZ file can be downloaded from here and includes a [Windows](../../Glossary/Service/Windows.md) binary. This is generally recognized as malware and removed by antivirus programs. I have it loaded in my Windows 7 system and exempt from removal. GWEE contains its own shell and so we can just point it at the target and let it go. I'll use the G option for an attack using get, the L option to have GWEE use its own shell to accept the reverse connection, and I'll use a null-terminated host query.
>
...
>
> **[3:36](https://www.linkedin.com/learning/ethical-hacking-hacking-web-servers-and-web-applications/injecting-commands-through-the-url?u=76281980&t=216)** Command injection is a powerful technique, especially if we can pop a shell. For those Web applications that don't sanitize their input, this can lead fairly quickly to a major security breach and likely not detected. Checking the URL and prohibiting unwanted character sets is a good start, and Web developers should be familiar with, and rigorous in applying, [OWASP](../../Skills/Cybersecurity/OWASP.md) guidance.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [PHP](../../Skills/Software%20Development/PHP.md) (4), [Google](../../Glossary/Service/Google.md) (2), [Windows](../../Glossary/Service/Windows.md) (2), [HTML](../../Skills/Web%20Development/HTML.md) (1), [Defender](../../Skills/Network%20and%20System%20Administration/Microsoft%20Defender.md) (1)
...
>
> **[1:38](https://www.linkedin.com/learning/ethical-hacking-hacking-web-servers-and-web-applications/testing-with-uniscan?u=76281980&t=98)** Let's now run a scan against a more exploitable server. As expected, Uniscan starts the enumeration. This will take a while, so let's let it run, and we'll come back when it's finished. Okay, we've been running a while and we're still going. We can see the crawler has enumerated over 11 thousand URLs. And it's found a possible back door in the doc folder, all of this might be a false positive. It's found some folders where source code for the website exists. And a lot of email addresses. It's found a number of upload [Forms](../../Skills/Web%20Development/Forms.md). These are useful to know as they're ways into the websites. The external websites plug-in has identified the external URL references. And the [PHP](../../Skills/Software%20Development/PHP.md) info plug-in has identified locations where information about the PHP site is disclosed. And we can see some of that information. And there's a bunch of files in the doc folder which are accessible but aren't used by the website. After it's doing its basic enumeration, Uniscan then has loaded the relevant plug-ins and starts it's vulnerability scan with dynamic tests. Uniscan enumerates the twiki identifying missing backup files and some renamed ones. There' a series of what it thinks might be potential [SQL](../../Skills/Data%20Science/SQL.md) injection attacks. Let's look at one. This hasn't given us much but let's look at the original page.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [SQL](../../Skills/Data%20Science/SQL.md) (3), [PHP](../../Skills/Software%20Development/PHP.md) (2), [Forms](../../Skills/Web%20Development/Forms.md) (1)
...
> [!transcript]- Transcript
>
> **[0:01](https://www.linkedin.com/learning/ethical-hacking-hacking-web-servers-and-web-applications/using-the-modsecurity-waf?u=76281980&t=1)** - [Instructor] ModSecurity is an open source web application firewall which can be integrated with the Apache web server to provide protection against many [Forms](../../Skills/Web%20Development/Forms.md) of web attack. It works by inspecting incoming requests for suspicious content, and if a detection rule is triggered, blocking it. We'll not run through the installation of ModSecurity and its integration with Apache, but it's a fairly simple task to do. I've installed it in the Apache web service in [Hydra](../../Glossary/Tool/Hydra.md), so let's go take a look at it in action. Let's browse to Hydra on HTTP 192.168.1.51,
>
> **[0:45](https://www.linkedin.com/learning/ethical-hacking-hacking-web-servers-and-web-applications/using-the-modsecurity-waf?u=76281980&t=45)** slash, and we'll go to our root homepage, index.[HTML](../../Skills/Web%20Development/HTML.md).
>
...
>
> **[3:49](https://www.linkedin.com/learning/ethical-hacking-hacking-web-servers-and-web-applications/using-the-modsecurity-waf?u=76281980&t=229)** Let's now try to access the page with what might be an [SQL](../../Skills/Data%20Science/SQL.md) injection. And we'll put in blah quote or 1=1.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Hydra](../../Glossary/Tool/Hydra.md) (4), [SQL](../../Skills/Data%20Science/SQL.md) (3), [Forms](../../Skills/Web%20Development/Forms.md) (1), [HTML](../../Skills/Web%20Development/HTML.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Banking](../../Skills/Software%20Development/Banking.md) (5)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/ethical-hacking-hacking-web-servers-and-web-applications/hacking-the-cheese?u=76281980&t=0)** - [Instructor] [Google](../../Glossary/Service/Google.md) provides an online site for users to test, the Gruyere social media site. The first thing we need to do is to agree to the terms and conditions, then we can start. Okay, we're now at the home page and we can start testing. We can see some existing user accounts that have posted snippets, Cheddar Mac and Brie. However, we need to create a user ID for ourselves before we can do that. Let's sign up using the link at the top right. I'll enter thing1 for the username and thing1 for the password. I'm at my home page and I can now proceed to update my profile, upload snippets, and so on. You can experiment with the functionality of this application as you practice your testing. Let's sign out and sign up as another user. This time before we do anything, let's hover over the user ID field and right click. Browsers now have an inspection capability. And we can see the code that is going to be sent. As we scroll through it, we can see a hidden field which says name="is_author". It's fair to assume that there are other values to this field and we might want to experiment to see what works. I'll hover over the field and right click and select edit the attribute. Let's take a bit of a stab and try "is_admin".
>
...
← [Ethical Hacking- Evading IDS, Firewalls, and Honeypots](Ethical%20Hacking-%20Evading%20IDS%2C%20Firewalls%2C%20and%20Honeypots.md) | **13 of 19** | [Ethical Hacking- Wireless Networks](Ethical%20Hacking-%20Wireless%20Networks.md) →
