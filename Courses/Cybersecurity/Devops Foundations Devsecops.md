...
>
> **[0:00](https://www.linkedin.com/learning/devops-foundations-devsecops-2022/introduction-to-the-devsecops-course?u=76281980&t=0)** - [Tim Chase] [Data Security](../../Skills/Data%20Science/Data%20Security.md) is one of the most important considerations within any organization. On a nearly continuous basis, we hear of a major data breach that has lost privileged customer data and cost companies countless numbers of dollars. So how do you safeguard your company's applications to protect against these losses? Well, this is where [DevSecOps](../../Skills/DevOps/DevSecOps.md) comes in. Hi, I'm Tim Chase and I've been testing [Application Security](../../Skills/Cybersecurity/Application%20Security.md) and leading security teams for 20 years. In this course, I'll show you how to drive security in a [DevOps](../../Topics/DevOps.md) process. We'll discuss DevOps and why traditional [Security Testing](../../Skills/Cybersecurity/Security%20Testing.md) doesn't work well within it. Then we'll examine strategies to speed up the security testing process and develop a DevSecOps approach. And finally, we'll talk about tools and methods to implement security testing automation. If you want to move your security testing to the next level, this course is for you. So let's get started.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Security Testing](../../Skills/Cybersecurity/Security%20Testing.md) (4), [DevSecOps](../../Skills/DevOps/DevSecOps.md) (2), [DevOps](../../Topics/DevOps.md) (2), [Data Security](../../Skills/Data%20Science/Data%20Security.md) (1), [Application Security](../../Skills/Cybersecurity/Application%20Security.md) (1)
> **Speakers:** - [tim (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/devops-foundations-devsecops-2022/what-you-should-know?u=76281980&t=0)** - [Presenter] To get the most out of this course, you should have a basic working knowledge of the security development process and some basic knowledge of [Application Security](../../Skills/Cybersecurity/Application%20Security.md). You may also find it helpful, but not necessary, to know a bit about the different types of [Security Testing](../../Skills/Cybersecurity/Security%20Testing.md) and different [Software Development](../../Topics/Software%20Development.md) methodologies, like Waterfall and [DevOps](../../Topics/DevOps.md).

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Application Security](../../Skills/Cybersecurity/Application%20Security.md) (1), [Security Testing](../../Skills/Cybersecurity/Security%20Testing.md) (1), [Software Development](../../Topics/Software%20Development.md) (1), [DevOps](../../Topics/DevOps.md) (1)
> **CLI Commands:** find (1)
...
> [!transcript]- Transcript
>
> **[0:01](https://www.linkedin.com/learning/devops-foundations-devsecops-2022/introduction-to-devsecops?u=76281980&t=1)** - [Instructor] Now, let's talk a little bit about [DevSecOps](../../Skills/DevOps/DevSecOps.md) and how to integrate security into the [DevOps](../../Topics/DevOps.md) world. The definition of DevSecOps really is how do you take security and put it into the DevOps process? How do you merge the two together and still make sure that from a security perspective you have all the checkpoints that you need implemented? When you're developing a plan of how to do this, the goal really should be, how do we make the dev teams have more ownership of the process? It's not all about automation, but it's about ownership and [Accountability](../../Skills/Data%20Science/Accountability.md) and how we can get the dev teams to take more of it. Integrating automation into every step of the process is going to be key. As with all of DevOps, automation is key to DevSecOps. It's how you're going to be able to be quick and [agile](../../Skills/DevOps/Agile%20Development.md) and get away from all the manual processes that you had. There's a good chance that when you move over to DevSecOps, some of the tools that you've used for years with your existing process, won't work. Even if you can automate the tools the amount of false positives that come with them won't make them worthwhile in a DevOps pipeline. Everything has to happen quickly. So with static scans that used to take hours, these won't work anymore, and we really have to rethink, how do we do it? How do we automate it? And what tools can we use? The automation of security tools doesn't mean automating, pushing a button. It doesn't mean taking your dynamic scanner and automating clicking of a run scan. What automation means in the security tool world is that you put something in a script and have it run in the background
>
> **[1:34](https://www.linkedin.com/learning/devops-foundations-devsecops-2022/introduction-to-devsecops?u=76281980&t=94)** and push meaningful results to your developers. Not a PDF, not a document, but actual results to the developers. And the results should be pushed into a tool that they use, not a security tool that the security teams use, but something that's meaningful to developers like [Jira](../../Skills/DevOps/Jira.md) or Quality Center that they're in and out of all day long, that's meaningful to them and that's real time so they can act on it. And even taking it one step further, one of the best ways that you can enable the development team is to have the results in real time through ChatOps, or instead of sending them into PDFs, send them notifications via [Slack](../../Skills/Software%20Development/Slack.md) or HipChat or some immediate notification mechanism so they have to be able to act on the results quicker. And one of the more popular quotes that I've seen and that I really like is by Rod Michael. And it says, "If you automate a mess, you get an automated mess." So make sure that when you do your security automation, that you do it in a way that helps the developers and not hinders them and provides them with good results that they can act on. The second part of DevOps that I want to talk about is education. The developers need to be educated on the security basics. In the 20 years I've been doing [Application Security](../../Skills/Cybersecurity/Application%20Security.md), I've seen the same security defects over and over and over again. [SQL](../../Skills/Data%20Science/SQL.md) injection was a problem 20 years ago. SQL injection is still a problem today. So helping the teams understand the security basics will really help speed up the development process and the DevOps process by having them know upfront what they need to be coding for.
>
> **[3:07](https://www.linkedin.com/learning/devops-foundations-devsecops-2022/introduction-to-devsecops?u=76281980&t=187)** Ensure that they have the resources to be able to fix any defects that they may find. The idea here isn't that security isn't going to play a part. But the idea is that we will give them the information that they need through training, through help and conversations so that they can fix any of the defects that come to them. And just like with all of DevOps, the key to DevSecOps is really to let developers own security and be responsible for their security. The last point to be made for DevSecOps is that we need to give the empowerment to the dev team. Give them the tools, let them hold the tools and put them in their pipeline the way that they can use them. Put them in their [Jenkins](../../Skills/DevOps/Jenkins.md) build or put them in their IDE so that when they're building an application, they can see the results in real time. Ultimately they should be responsible for the security of the application, not the security team. The goal here really is to flip the security team to being an auditor and not a tester so that we make sure as a security team that testing is done but we aren't the ones actually doing the testing. That's left to the development team.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [DevOps](../../Topics/DevOps.md) (7), [DevSecOps](../../Skills/DevOps/DevSecOps.md) (6), [SQL](../../Skills/Data%20Science/SQL.md) (2), [Accountability](../../Skills/Data%20Science/Accountability.md) (1), [Agile](../../Skills/DevOps/Agile%20Development.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [DevOps](../../Topics/DevOps.md) (4), [DevSecOps](../../Skills/DevOps/DevSecOps.md) (4), [Security Testing](../../Skills/Cybersecurity/Security%20Testing.md) (1), [Java](../../Skills/Software%20Development/Java.md) (1), [Application Security](../../Skills/Cybersecurity/Application%20Security.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/devops-foundations-devsecops-2022/cloud-and-devops?u=76281980&t=0)** - [Instructor] Throughout some of the videos, we've talked about cloud. So the question becomes, how does cloud and [DevSecOps](../../Skills/DevOps/DevSecOps.md) relate? First, let's talk about some of the goals of going to the cloud. I think that the goals that many businesses have when they go to the cloud are the same. The first would be speed. You can launch machines faster, you can deploy faster, and you can patch faster. Everything in the cloud has the ability to go a lot faster. And kind of going hand in hand with that is that you can be more [agile](../../Skills/DevOps/Agile%20Development.md) in the cloud. You can respond to business decisions quicker, or you can adapt. You can spin up more servers to handle processing that may happen sporadically. You can also be a lot more agile in the cloud than you can with on-prem. And finally, cloud can be more secure. Inherently, there are some problems with going to the cloud, but the cloud makes security a lot easier than being on-prem. Some of the problems that we face when we dealt with servers on premises for years, can be dealt with very easily in the cloud. A good example of this is network segmentation. Historically, a lot of our on-premises networks have been flat. And to be able to segregate these requires a lot of manual work from the network teams, or expensive software. In the cloud they make this very easy, and you can set up different VPCs, or different network access controls in order to segregate applications, according to business need. It can be done very quickly and easily with different APIs. So [DevOps](../../Topics/DevOps.md) and cloud really are partners, you can do one without the other,
>
> **[1:31](https://www.linkedin.com/learning/devops-foundations-devsecops-2022/cloud-and-devops?u=76281980&t=91)** but you really have a disadvantage, and to truly capture the value of either, you need both. And when you step back and think about it, the advantages of DevOps and cloud are the same, which is why they partner so well together. You go to DevOps to be faster and more agile, and to be able to respond to your business needs quicker, and adapt. You also have the ability to be more secure in a DevOps model, and to do so quicker. The only effective way of going DevOps truly, is by going to the cloud. You could do DevOps without going to the cloud, but it would be very difficult. You'd lose a lot of the agility that's needed to do DevOps well, when you deal with physical servers, and on-premises [Hardware](../../Topics/Hardware.md). The location of the cloud doesn't really matter, the cloud could be internal or external, public or private, as long as it's a cloud that can be easily managed and maintained via an API, you can still get the advantages of DevOps and DevSecOps.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [DevOps](../../Topics/DevOps.md) (8), [Agile](../../Skills/DevOps/Agile%20Development.md) (3), [DevSecOps](../../Skills/DevOps/DevSecOps.md) (2), [Hardware](../../Topics/Hardware.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Security Testing](../../Skills/Cybersecurity/Security%20Testing.md) (4), [Application Security](../../Skills/Cybersecurity/Application%20Security.md) (4), [DevSecOps](../../Skills/DevOps/DevSecOps.md) (3), [DevOps](../../Topics/DevOps.md) (3), [Java](../../Skills/Software%20Development/Java.md) (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Continuous integration](../../Skills/Software%20Development/Continuous%20Integration%20(CI).md) (4), [DevOps](../../Topics/DevOps.md) (2), [Agile](../../Skills/DevOps/Agile%20Development.md) (2), [DevSecOps](../../Skills/DevOps/DevSecOps.md) (1), [Continuous delivery](../../Skills/Software%20Development/Continuous%20Delivery%20(CD).md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [DevSecOps](../../Skills/DevOps/DevSecOps.md) (3), [Security Testing](../../Skills/Cybersecurity/Security%20Testing.md) (3), [Jenkins](../../Skills/DevOps/Jenkins.md) (2), [DevOps](../../Topics/DevOps.md) (1), [Kubernetes](../../Skills/DevOps/Kubernetes.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Infrastructure as code](../../Skills/Software%20Development/Infrastructure%20as%20code%20(IaC).md) (8), [DevOps](../../Topics/DevOps.md) (5), [Terraform](../../Skills/DevOps/Terraform.md) (1), [DevSecOps](../../Skills/DevOps/DevSecOps.md) (1), [Jenkins](../../Skills/DevOps/Jenkins.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [DevOps](../../Topics/DevOps.md) (2), [DevSecOps](../../Skills/DevOps/DevSecOps.md) (1), [Threat Modeling](../../Skills/Cybersecurity/Threat%20Modeling.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [DevSecOps](../../Skills/DevOps/DevSecOps.md) (12), [Security Testing](../../Skills/Cybersecurity/Security%20Testing.md) (3), [Jira](../../Skills/DevOps/Jira.md) (3), [Jenkins](../../Skills/DevOps/Jenkins.md) (3), [Java](../../Skills/Software%20Development/Java.md) (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [DevSecOps](../../Skills/DevOps/DevSecOps.md) (5), [DevOps](../../Topics/DevOps.md) (4), [Application Security](../../Skills/Cybersecurity/Application%20Security.md) (2), [Network Security](../../Skills/Cybersecurity/Network%20Security.md) (1), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/devops-foundations-devsecops-2022/continuous-improvement-and-feedback?u=76281980&t=0)** - [Instructor] To wrap up this section on [DevSecOps](../../Skills/DevOps/DevSecOps.md), I'd like to spend a few minutes talking about one of the fundamental tenants of DevSecOps, continuous improvement and feedback. We've seen this graphic a few videos ago about the [DevOps](../../Topics/DevOps.md) process. When you really think about it, DevOps is not a waterfall methodology where you go from beginning to end and then you start planning again for the next release. DevOps is really meant to be this continuous cycle and this continuous loop, where as soon as you get done with the release and monitor, you go back to plan, code, deploy, and the whole process. One thing that you should keep in mind about this process is that each task should have a feedback loop. And what that means is that everything you do, you should have a way to feed that back to the developer right away. As an example, when you do static testing, your tool should get the results back to the developer. And not only that, the entire process should have a feedback loop. Once you get done with your DevOps process and you're getting ready to start the planning, you should really take a minute to be retrospective and understand what went right, what went wrong, and make modifications. Continuous feedback is really what makes DevSecOps work. We have to understand what went well, what didn't, and how we can improve. DevSecOps allows us to take this feedback and make changes quickly, not having to wait weeks for a new release cycle. It's meant to provide immediate feedback to the DevOps team. Having this information will allow us to improve for future sprints and releases,
>
> **[1:34](https://www.linkedin.com/learning/devops-foundations-devsecops-2022/continuous-improvement-and-feedback?u=76281980&t=94)** ensuring that we have a better product and better testing. It also makes us have a better team of making sure we always are efficient and lean, and make the security processes as seamless as possible. This diagram is an example of a feedback loop. You can see that after each part of the testing, there is feedback to the DevOps developer. After [Unit Testing](../../Skills/Software%20Development/Unit%20Testing.md), feedback happens. After the static testing has been completed, the defects are tracked and sent back. There's no waiting until the end before a DevOps member has the results needed to make fixes. This is a simple example, but it illustrates the point that DevSecOps is an iterative process.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [DevOps](../../Topics/DevOps.md) (7), [DevSecOps](../../Skills/DevOps/DevSecOps.md) (5), [Unit Testing](../../Skills/Software%20Development/Unit%20Testing.md) (1)
> **CLI Commands:** make (4)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/devops-foundations-devsecops-2022/open-source-devsecops-tools?u=76281980&t=0)** - [Instructor] There are a lot of free tools that we can use and add to our dev SecOps toolkit. One of the most common that I use is Find Sec Bugs or Find Security Bugs. It's strictly a [Java](../../Skills/Software%20Development/Java.md) static tool that is used to scan the source code of Java applications but it's pretty robust. It can integrate into your [Jenkins](../../Skills/DevOps/Jenkins.md) environment. It has really good OWAP's top 10 coverage and CVE coverage so that you can actually map any of the defects that it finds back to known vulnerabilities. And best of all, it can actually integrate with the IDE. So you have the flexibility of giving the developer this tool and having them run it when they develop their code or you can actually include it in your automation and run it automatically. Or maybe both. There's no harm to making it run twice in making sure testing is completed. Another tool that I like to use a lot is the [OWASP](../../Skills/Cybersecurity/OWASP.md) Zed Attack Proxy or ZAP. It's an open source dynamic scanner. So it's going to spider your site and basically try and hack it. It's going to look for any place where you can input data and try to manipulate the [Forms](../../Skills/Web%20Development/Forms.md) and hack its way into the application. It's been around a long time and so it's very mature and well maintained and it actually works very well for automation, better than some of the commercial tools that I've used. It even comes with the Jenkins plugins that you can implement it in your Docker container that you have for your toolkit. A third tool is [SQLmap](../../Glossary/Tool/SQLmap.md). I use this one a lot when people want proof that their application is susceptible to [SQL](../../Skills/Data%20Science/SQL.md) injection. Nothing makes them believe you more than when you hand them a copy of their own database. This tool can be run manually, or it can be included
>
> **[1:35](https://www.linkedin.com/learning/devops-foundations-devsecops-2022/open-source-devsecops-tools?u=76281980&t=95)** in your toolkit and run in an automated fashion. Switching over to the operation side OpenVAS is a vulnerability scanner. It's free and it's an alternative to some commercial tools like Qualys and Nessus. It maybe isn't quite as robust, but it does a very good job and I use it often to run routine scans on an external network. And finally, Recon-ng is not actually a security tool that you can use to find bugs, but it's more of a recon framework, meaning it's going to go out there and do a [Google](../../Glossary/Service/Google.md) search or do [GitHub](../../Skills/Software%20Development/GitHub.md) searches and look for things you don't know that are exposed. I use this app a lot to run on our known IP ranges and look for applications that I maybe don't know exist. And once I find them I do a bit more recon and feed it into some of my other tools like SQLMAP looking for SQL injection. You can also use Recon-ng to look for source code that is on GitHub that maybe developers accidentally checked into a public repository.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Java](../../Skills/Software%20Development/Java.md) (2), [Jenkins](../../Skills/DevOps/Jenkins.md) (2), [SQLmap](../../Glossary/Tool/SQLmap.md) (2), [SQL](../../Skills/Data%20Science/SQL.md) (2), [GitHub](../../Skills/Software%20Development/GitHub.md) (2)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/devops-foundations-devsecops-2022/helpful-devsecops-resources?u=76281980&t=0)** - [Instructor] Now that we know a few of my favorite tools to include in the pipeline, let's talk a little bit about some resources that we can use to help us with our process. These are three of my favorite resources that I go to often and just see the latest updates, or refresh my mind on the concepts. I think each one offers a little bit of a different perspective on [DevSecOps](../../Skills/DevOps/DevSecOps.md), and can help in different ways. The DevSecOps Checklist is a list on [GitHub](../../Skills/Software%20Development/GitHub.md) that has lots of helpful resources. It has everything from tools to talks. It would be a great resource that the community could submit updates to, but it's the perfect place for a new DevSecOps person to find starting information. The second resource is a handbook written for the DoD and unclassified for public consumption. It's called the DevSecOps Reference Design. It's a pretty long guide, describing what the standard practice for DevSecOps should be in the US Department of Defense. There are several diagrams that describe the [DevOps](../../Topics/DevOps.md) flow in different places where security fits into it. There is also a version two that specifically deals with containers and DevOps and how to create a secure container repository. The final resource I have is Awesome DevSecOps. Kind of like the name says, it's an awesome list of DevSecOps information. It includes everything from trainings, presentations, tools, and [Dashboards](../../Skills/Data%20Science/Dashboards.md), and so on. It's a great list, and in the spirit of DevOps, it changes as the community finds things work and don't work. Here's the list of resources. There is plenty of content to get started.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [DevSecOps](../../Skills/DevOps/DevSecOps.md) (7), [DevOps](../../Topics/DevOps.md) (3), [GitHub](../../Skills/Software%20Development/GitHub.md) (1), [Dashboards](../../Skills/Data%20Science/Dashboards.md) (1)
> **Definitions:** is a  (2)
> **CLI Commands:** find (1)
> **Tools:** github (1)
> **UI Navigation:** go to (1)
...
>
> **[5:48](https://www.linkedin.com/learning/devops-foundations-devsecops-2022/real-life-example?u=76281980&t=348)** So, we really won't go into setting up [Jenkins](../../Skills/DevOps/Jenkins.md) in your pipeline, but you can really see how you could take this tool, and integrate it, and be able to control whether your bill passes or fails based on certain thresholds. You can do more with this tool, but this is an example of how you can start building your tool set to integrate into your [DevSecOps](../../Skills/DevOps/DevSecOps.md) process.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [JSON](../../Skills/Web%20Development/JSON.md) (3), [GitHub](../../Skills/Software%20Development/GitHub.md) (2), [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) (1), [Jenkins](../../Skills/DevOps/Jenkins.md) (1), [DevSecOps](../../Skills/DevOps/DevSecOps.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/devops-foundations-devsecops-2022/grow-and-expand?u=76281980&t=0)** - Now that we have talked about how to make the first step into [DevSecOps](../../Skills/DevOps/DevSecOps.md). And we've seen a demo where we create our initial DevSecOps container. Let's talk about where we should go next to grow our security involvement with the [DevOps](../../Topics/DevOps.md) teams. There are lots of places where we can take our DevSecOps process. We have our initial tool set, but don't be afraid to change. You can add tools, remove tools, or change tools. Always be challenging yourself to see what works well and what doesn't. Expand the process to more teams. In the previous video, we started out with one team, the team that's seen the most eager to try new things. Now that we have a tool set and process working, let's bring more people into the mix and roll DevSecOps out to many more teams. Grow your security containers. We started easy with some standard languages, but now expand to multiple languages or give some of the newer languages like [Node.js](../../Skills/Web%20Development/Node.js.md) a try. Increase the number of automated checks that you have in place. Automate the auditing of source code with tools like Crucible. And automate the review of [Cloud Security](../../Skills/Cloud%20Computing/Cloud%20Security.md) checks for things like bad NACL policy in the cloud. And as the automation checks grow and mature, don't be afraid to automate the failing of builds. When a build has severe enough vulnerabilities, you can prevent the application from being promoted. We talk a little about integration of ChatOps in an earlier video, but this is a next great step that developers love. Work to integrate your DevSecOps tools into [Slack](../../Skills/Software%20Development/Slack.md) or HipChat. Strong CICD teams have channels set up where they push their unit test results.
>
> **[1:34](https://www.linkedin.com/learning/devops-foundations-devsecops-2022/grow-and-expand?u=76281980&t=94)** Use these same channels to send security vulnerabilities. For [Continuous Monitoring](../../Skills/Data%20Science/Continuous%20Monitoring.md), use a tool like Contrast RASP to watch real time for threats against your application. Recon-ng can also be used as a monitoring tool to look for source code on public repositories or websites that have been deployed without security approval. Manual security tests are one of the hardest items to ensure to get tested. Tools can't test for everything. Think about password complexity or the ability of client A being able to see client B's data. These are manual test cases that many times get forgotten about when we talk about automation. Work with the development teams to create the scripts to be included in the automated [Security Testing](../../Skills/Cybersecurity/Security%20Testing.md). These are just a few ideas of where to go next with DevSecOps. Different companies are at different levels of DevOps maturity. So there really is no one size fits all formula. But in the end, find what works for you and the development teams. Don't be afraid to continue to change and push security everywhere.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [DevSecOps](../../Skills/DevOps/DevSecOps.md) (6), [DevOps](../../Topics/DevOps.md) (2), [Node.js](../../Skills/Web%20Development/Node.js.md) (1), [Cloud Security](../../Skills/Cloud%20Computing/Cloud%20Security.md) (1), [Slack](../../Skills/Software%20Development/Slack.md) (1)
...
**1 of 5** | [DevSecOps- Automated Security Testing](DevSecOps-%20Automated%20Security%20Testing.md) →
