...
learning_paths:
  ...
  - '[Strategies for Managing Vulnerabilities and Mitigating Cyber Risks](../../Paths/Cybersecurity/Learning%20Paths/Strategies%20for%20Managing%20Vulnerabilities%20and%20Mitigating%20Cyber%20Risks.md)'
prev_courses:
  - '[Learning the OWASP Top 10](Learning%20the%20OWASP%20Top%2010.md)'
  - '[Vulnerability Management in Cybersecurity- The Basics](Vulnerability%20Management%20in%20Cybersecurity-%20The%20Basics.md)'
next_courses:
  - '[Dynamic Application Security Testing](Dynamic%20Application%20Security%20Testing.md)'
  - '[Vulnerability Management with Nessus](Vulnerability%20Management%20with%20Nessus.md)'
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/security-testing-essential-training-2022/what-you-should-know?u=76281980&t=0)** - [Instructor] This course is intended to be a broad introduction to [Security Testing](../../Skills/Cybersecurity/Security%20Testing.md). Will we be going into [Penetration Testing](../../Skills/Cybersecurity/Penetration%20Testing.md) in depth, learning how to write [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) exploit code from scratch? I'm afraid not. We will, however, be covering the different types of fundamental security tests that security analysts and penetration testers may be expected to perform as part of their day-to-day responsibilities. Once you have an understanding of the similarities and the differences between these types of tests, we're going to break out our toolkit, roll up our sleeves, and do some hands-on testing. If you want to get the most that you can out of this course, you'll want to follow along with the demos in your own lab environment. Personally, I prefer to do all my training and testing using a small collection of [Virtual Machines](../../Skills/Cloud%20Computing/Virtual%20Machines.md), maybe some [Cloud Services](../../Skills/Cloud%20Computing/Cloud%20Services.md), and this course is no exception. If you don't have access to a laptop or a workstation, capable of running a hypervisor, [Kali Linux](../../Skills/Cybersecurity/Kali%20Linux.md), and at least one other virtual machine, no worries. You'll still gain a lot from this course by watching it from beginning to end. I'll be using VirtualBox during this course for two reasons. One, it's free, so you don't have to worry about purchasing software if you want to do these demos at home on your own. And two, it allows you to run multiple virtual machines simultaneously.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Virtual Machines](../../Skills/Cloud%20Computing/Virtual%20Machines.md) (2), [Security Testing](../../Skills/Cybersecurity/Security%20Testing.md) (1), [Penetration Testing](../../Skills/Cybersecurity/Penetration%20Testing.md) (1), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (1), [Cloud Services](../../Skills/Cloud%20Computing/Cloud%20Services.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [NIST](../../Skills/IT%20Help%20Desk/NIST.md) (6), [Information Security Management](../../Skills/Software%20Development/Information%20Security%20Management.md) (2), [Cybersecurity](../../Topics/Cybersecurity.md) (2), [Quality Assurance](../../Skills/Software%20Development/Quality%20Assurance.md) (1), [Privacy](../../Skills/Data%20Science/Privacy.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/security-testing-essential-training-2022/vulnerability-assessments?u=76281980&t=0)** - [Instructor] The goal of a [Vulnerability Assessment](../../Skills/Cybersecurity/Vulnerability%20Assessment.md) is to validate that technical vulnerabilities are being identified and remediated on a regular basis. There are a few items that you'll focus on with this type of assessment. First and foremost, you're going to look for exploitable technical vulnerabilities within in-scope systems and applications. What do I mean by exploitable? Think of it this way; if a criminal found that same vulnerability and could use it to force the system or application to behave in some unexpected way, how bad would that be for your organization? If a server's missing a security patch that a remote attacker could use to list the directories on that server, that's not such a big deal, right? You'd likely consider that a low risk vulnerability. But what if an attacker could exploit a [SQL](../../Skills/Data%20Science/SQL.md) injection vulnerability and download every username and password from one of your applications? That's a much bigger deal. Hopefully, you'd consider that a high, maybe even a critical, vulnerability. On that note, understanding how to scope a vulnerability assessment is crucial. Don't limit yourself to only scanning servers. If it has an IP address, you should probably scan it. This includes servers, workstations, and mobile devices. The one exception here might be industrial control systems,
>
> **[1:38](https://www.linkedin.com/learning/security-testing-essential-training-2022/vulnerability-assessments?u=76281980&t=98)** but you should also be testing applications and [Databases](../../Skills/Software%20Development/Databases.md), and they may require different scanning technologies all together. In an enterprise environment, you'll likely perform vulnerability assessments on a regular schedule using automated tools. If this is the case, make sure that your scanning technology is aligned with your scope. Also, make sure you're taking full advantage of the capabilities in your scanning technology. As a consultant, I would recommend the following on a regular basis: number one, perform authenticated scans of all host systems; number two, perform unauthenticated scans of internet-facing web applications; number three, perform authenticated scans of non-production instances of those same applications; and number four, perform security configuration scans of all the in-scope systems and apps. I'll show you how to configure and use some of these vulnerability scanning tools later in the course. [NIST](../../Skills/IT%20Help%20Desk/NIST.md) provides guidance around manual vulnerability assessment activities that you can use to compliment your automated scans. I'll cover a number of these techniques in a later video as well. The end result of a vulnerability assessment should be a prioritized list of potentially exploitable vulnerabilities. That list should be accompanied by recommendations on how to remediate those vulnerabilities.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Vulnerability Assessment](../../Skills/Cybersecurity/Vulnerability%20Assessment.md) (4), [SQL](../../Skills/Data%20Science/SQL.md) (1), [Databases](../../Skills/Software%20Development/Databases.md) (1), [NIST](../../Skills/IT%20Help%20Desk/NIST.md) (1)
> **CLI Commands:** make (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Penetration Testing](../../Skills/Cybersecurity/Penetration%20Testing.md) (2)
> **CLI Commands:** make (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Wireshark](../../Skills/Cybersecurity/Wireshark.md) (7), [Kali Linux](../../Skills/Cybersecurity/Kali%20Linux.md) (1)
> **CLI Commands:** find (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) (4), [Kali Linux](../../Skills/Cybersecurity/Kali%20Linux.md) (2)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/security-testing-essential-training-2022/cis-cat-lite?u=76281980&t=0)** - [Instructor] The first time I heard of the Center for Internet Security or CIS, was in reference to the security configuration benchmarks they publish. When it comes to determining how to secure a system, the CIS benchmarks may be the most comprehensive guides available. The CIS also publishes a scanner known as the CIS-CAT or Center for Internet Security Configuration Assessment Tool, where Tenable's Nessus scans for vulnerabilities based on known signatures. CIS-CAT scans for security configuration weaknesses based on known benchmarks. Just like Tenable, the CIS offers a free tool, the CIS-CAT Lite to registered users. Once you provide your contact info, they'll send you a link where you can download the free version of the scanner. The Lite version of the CIS-CAT scanner is only capable of scanning three technologies, [Windows 10](../../Skills/Network%20and%20System%20Administration/Windows%2010.md), [Ubuntu](../../Skills/Web%20Development/Ubuntu.md), and [Google](../../Glossary/Service/Google.md) Chrome. The pro version, however, supports all of the existing CIS benchmarks. Even better, it supports the CIS workbench component which allows you to customize the benchmarks to better align with internal technical standards. The CIS-CAT Lite is a [Java](../../Skills/Software%20Development/Java.md) app though, so you'll need to have Java installed in your system in order to use the tool.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Java](../../Skills/Software%20Development/Java.md) (6), [Windows 10](../../Skills/Network%20and%20System%20Administration/Windows%2010.md) (1), [Ubuntu](../../Skills/Web%20Development/Ubuntu.md) (1), [Google](../../Glossary/Service/Google.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/security-testing-essential-training-2022/hashcat?u=76281980&t=0)** - [Instructor] There are multiple password crackers in the pen testing space. [John the Ripper](../../Glossary/Tool/John%20the%20Ripper.md) may be one of the most well-known, along with [THC-Hydra](../../Glossary/Tool/Hydra.md), L0phtCrack, and RainbowCrack. One of my favorite tools in this space, though, is [Hashcat](../../Glossary/Tool/Hashcat.md). You can read up on this tool at [hashcat.net](https://hashcat.net). Hashcat is one of if not the fastest password crackers. It's installed by default in [Kali Linux](../../Skills/Cybersecurity/Kali%20Linux.md) and it supports over 350 hash types, including popular [Algorithms](../../Skills/Software%20Development/Algorithms.md) like MD5 and NTLM. You can type hashcat -h at the command prompt in Kali Linux in order to access the help file. When you do this, you'll quickly get a sense of how powerful this tool can really be. When cracking passwords using Hashcat, the more you know about the password's source, the more likely you are to be successful. Scrolling through the help file will point you in the right direction, but I'm going to walk through a simple demo later in this course so that you can see Hashcat in action.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Hashcat](../../Glossary/Tool/Hashcat.md) (6), [Kali Linux](../../Skills/Cybersecurity/Kali%20Linux.md) (2), [John the Ripper](../../Glossary/Tool/John%20the%20Ripper.md) (1), [Thc-hydra](../../Glossary/Tool/Hydra.md) (1), [Algorithms](../../Skills/Software%20Development/Algorithms.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/security-testing-essential-training-2022/owasp-zap?u=76281980&t=0)** - [Instructor] Web application scanning can be tricky, so be careful. Host vulnerability scanners often check against known signatures. Does this condition exist on the target system? Yes or no? That binary approach to vulnerability scanning enables vulnerability management vendors to build scanners that are unlikely to impact the systems they're scanning. Web app scanners, on the other hand, tend to be a little more open-ended. What happens when I do this? These scanners often interact with the target applications like a potential malicious end user, which increases the risk of accidentally breaking the target application. With this in mind, it's important that you, the security assessor, take additional precautions when configuring your scans. It's also important you test your scanning skills against non-production web applications first so you can see the potential impacts firsthand and adjust your production scans accordingly. That's where [OWASP](../../Skills/Cybersecurity/OWASP.md) comes to the rescue. OWASP, short for the Open [Web Application Security](../../Skills/Cybersecurity/Web%20Application%20Security.md) Project, is a not-for-profit organization dedicated to improving web application security. The organization sponsors and publishes multiple open-source projects to help accomplish this goal, and we're going to take a look at two of them in this course.
>
> **[1:33](https://www.linkedin.com/learning/security-testing-essential-training-2022/owasp-zap?u=76281980&t=93)** ZAP, or Zed Attack Proxy, is a web application security scanner that can test some basic web application security vulnerabilities. In addition to the automated scanning functionality, ZAP includes some [Manual Testing](../../Skills/Software%20Development/Manual%20Testing.md) tools that can come in handy during a penetration test. OWASP also maintains a number of intentionally vulnerable web applications for the purpose of training security assessors and penetration testers. We're going to use one of those apps, Juice Shop, to walk through a basic web app security scan using ZAP.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Web Application Security](../../Skills/Cybersecurity/Web%20Application%20Security.md) (4), [OWASP](../../Skills/Cybersecurity/OWASP.md) (3), [Manual Testing](../../Skills/Software%20Development/Manual%20Testing.md) (1)
...
>
> **[2:59](https://www.linkedin.com/learning/security-testing-essential-training-2022/improving-over-time?u=76281980&t=179)** - Or is it going to be a patchwork quilt of random [Statistics](../../Skills/Data%20Science/Statistics.md) and educated guesses? [NIST](../../Skills/IT%20Help%20Desk/NIST.md) special publication 800-115, the technical guide to information security testing and assessments, recommends that your security assessment methodology be both documented and repeatable. Those two simple concepts will hope you'll avoid falling into the garbage, in garbage out trap from the scenario we just discussed.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Security Testing](../../Skills/Cybersecurity/Security%20Testing.md) (2), [Statistics](../../Skills/Data%20Science/Statistics.md) (1), [NIST](../../Skills/IT%20Help%20Desk/NIST.md) (1)
> **CLI Commands:** make (2)
> **Speakers:** - one (1), - or (1)
> **Env Vars:** nist (1)
> **Definitions:** is a  (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/security-testing-essential-training-2022/selecting-your-methodology?u=76281980&t=0)** - [Instructor] Here are a few methodologies you may want to consider depending on the nature of your assessment. When conducting a risk assessment, a great place to start is [NIST](../../Skills/IT%20Help%20Desk/NIST.md) Special Publication 800-30 Rev 1, Guide for Conducting Risk Assessments. While this tends to be more qualitative in its approach, the Fair Institute's quantitative approach may be more to your organization's liking. For security controls assessments, NIST Special Publication 800-53 Rev 5, Security and [Privacy](../../Skills/Data%20Science/Privacy.md) Controls for Federal Information Systems and Organizations, contains an extensive set of security controls, along with considerable detail regarding each individual control. Likewise, ISO 27002, the 2022 version, Code of practice for information security controls, provides a comprehensive set of security controls that you may want to consider. And when it comes to compliance assessments, the specific data set often dictates which controls must be assessed by whom, and how often. Organizations that accept, process, store, and or transmit credit card data need to refer to the [payment card industry data security standard](../../Glossary/Standard/PCI%20DSS.md). Going one level deeper,
>
> **[1:32](https://www.linkedin.com/learning/security-testing-essential-training-2022/selecting-your-methodology?u=76281980&t=92)** the specific controls which must be assessed and the determination whether an organization can self-assess their controls or whether they must engage a certified third-party depends on factors like the number of credit card transactions processed each year. Organizations in the United States that handle electronically-protected healthcare information must perform a [Security Risk](../../Skills/Cybersecurity/Security%20Risk.md) assessment that aligns with the controls required by the Health Insurance Portability and [Accountability](../../Skills/Data%20Science/Accountability.md) Act of 1996, better known as HIPAA. The frequency of these assessments will vary based on a number of deciding factors. And the unified compliance framework has mapped over 800 authority documents into their database to help organizations like yours determine which controls should be tested in efforts to comply with relevant standards and regulations.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [NIST](../../Skills/IT%20Help%20Desk/NIST.md) (2), [Privacy](../../Skills/Data%20Science/Privacy.md) (1), [Data Security](../../Skills/Data%20Science/Data%20Security.md) (1), [Security Risk](../../Skills/Cybersecurity/Security%20Risk.md) (1), [Accountability](../../Skills/Data%20Science/Accountability.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [NIST](../../Skills/IT%20Help%20Desk/NIST.md) (1), [Information Security Management](../../Skills/Software%20Development/Information%20Security%20Management.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/security-testing-essential-training-2022/advanced-assessment-tools?u=76281980&t=0)** - [Instructor] Compliance assessment tools are sometimes provided by the compliance authority. The payment card industry, for example, maintains a library of Self-Assessment Questionnaires online at [pcisecuritystandards.org](https://pcisecuritystandards.org). The [Office](../../Skills/Web%20Development/Microsoft%20Office.md) of Civil Rights, OCR, and the Office of the National Coordinator for Health Information Technology, ONC, have a HIPAA [Security Risk](../../Skills/Cybersecurity/Security%20Risk.md) Assessment Tool available to download for free from this URL at [healthit.gov](https://healthit.gov). When it comes to vulnerability assessments and penetration tests, referring to the methodology guides is your best starting point. The [Penetration Testing](../../Skills/Cybersecurity/Penetration%20Testing.md) Execution Standard, the PTES, references a number of tools in the technical guideline available at [pentes-standard.org](https://pentes-standard.org). You could compliment the information in the PTES with the Open Source [Security Testing](../../Skills/Cybersecurity/Security%20Testing.md) Methodology Manual, or OSSTMM available at [isecom.org](https://isecom.org). When testing web applications I've included a pair of [OWASP](../../Skills/Cybersecurity/OWASP.md) links here to an extensive list of [Application Security](../../Skills/Cybersecurity/Application%20Security.md) testing tools. The number of tools available for performing very specific tests against unique web app technologies continues to grow and I've yet to find a more robust, comprehensive list
>
> **[1:34](https://www.linkedin.com/learning/security-testing-essential-training-2022/advanced-assessment-tools?u=76281980&t=94)** than the ones you find on the OWASP website. You can check out those resources at these URLs. And while the website, [sectools.org](https://sectools.org) is a bit dated, many of the tools on that site have withstood the test of time. If you want to round out your knowledge of security testing tools, browse through the SecTools list of the Top 125 [Network Security](../../Skills/Cybersecurity/Network%20Security.md) Tools. You'll see a few tools there that we've already covered in this course, along with dozens of tools that could prove useful in one of your upcoming security assessments.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Office](../../Skills/Web%20Development/Microsoft%20Office.md) (2), [Security Testing](../../Skills/Cybersecurity/Security%20Testing.md) (2), [OWASP](../../Skills/Cybersecurity/OWASP.md) (2), [Security Risk](../../Skills/Cybersecurity/Security%20Risk.md) (1), [Penetration Testing](../../Skills/Cybersecurity/Penetration%20Testing.md) (1)
...
>
> **[4:43](https://www.linkedin.com/learning/security-testing-essential-training-2022/documentation-review?u=76281980&t=283)** organizations often have VISIOs or something similar that provides a graphical representation of the environment. System security plans, or SSPs. These are narratives that describe how controls will be implemented in order to protect a specific environment. Third-party contracts and agreements. Language outlining how third parties are expected to protect an organization's data can be very insightful. [Security Incident Response](../../Skills/Cybersecurity/Security%20Incident%20Response.md) plans. In the event of a security incident, does an organization have a documented tested plan that they intend to use to respond? And disaster recovery and business continuity plans, similar to security incident response plans, how does the organization intend to respond to an event that impacts their ability to operate or to deliver services to their customers?

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Security Incident Response](../../Skills/Cybersecurity/Security%20Incident%20Response.md) (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Elasticsearch](../../Skills/Software%20Development/Elasticsearch.md) (2), [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) (1), [Incident Response](../../Skills/Cybersecurity/Incident%20Response.md) (1)
> **Definitions:** is a  (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Intrusion Detection](../../Skills/Network%20and%20System%20Administration/Intrusion%20Detection.md) (1), [Nmap](../../Glossary/Tool/Nmap.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [System Configuration](../../Skills/Network%20and%20System%20Administration/System%20Configuration.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/security-testing-essential-training-2022/cis-cat-demo?u=76281980&t=0)** - [Instructor] For this CIS-CAD demo, we're going to be using a [Windows 10](../../Skills/Network%20and%20System%20Administration/Windows%2010.md) virtual machine, that you can download for free from developer dot [Microsoft](../../Instructors/Artificial%20Intelligence%20(AI)/Microsoft.md) dot com. This is a timeboxed machine. It's only going to work for 90 days, but that's plenty of time to run your tests. We're going to use the MSEdge on Win10 image for VirtualBox. And once we import that image into VirtualBox, fire it up, you'll be prompted to log in as the IEUser account. Just to make it easy, the password for that account is capital P, A-S-S-W, zero, R-D, exclamation point. From this image, you're going to want to download the CIS-CAT tool and unzip it anywhere on the machine. I've got it here on the desktop. In the assessor folder. And you can see the contents of that folder contain everything the tool needs to run on multiple platforms. It contains the [Java](../../Skills/Software%20Development/Java.md) file image, it contains the shell script for [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) boxes. We're going to use the executable design... The gooey... For the [Windows](../../Glossary/Service/Windows.md) machine. But before you run the tool, you need to go into the config folder, and edit the sessions dot properties. You can right click and open that with Notepad, as I've done here. And you'll see a commented out file, that let's the CIS-CAD tool know which system you want to scan. Everything's going to be commented out, so it won't know whether or not you're looking at the local box or a remote system.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/security-testing-essential-training-2022/network-sniffing?u=76281980&t=0)** - [Instructor] The most time consuming part of network sniffing is that the amount of data that you'll have to analyze is directly proportional to how long you leave the network sniffer running on the customer's network. If you only sniff an hours worth of network traffic, your results won't be an accurate representation of what to expect over the course of a business day. If you sniff traffic before users arrive in the [office](../../Skills/Web%20Development/Microsoft%20Office.md) or after they leave, then you won't see endpoint traffic. If you sniff network traffic during lunch however, you're more likely to see things like online shopping and social media use, than you are normal business traffic. Your network sniffing results will also be impacted by the network segment on which your sniffer is running. If the customer's implemented network segmentation between office locations or between wired and wireless networks, or even between user subnets and server subnets, then it's unlikely you're going to see everything you want or hope to see from one location. Before performing network sniffing review the customer's network diagrams to determine where the sniffer should be placed. Discuss what a normal day looks like for users or systems on that particular subnet and make a note of the sniffer's start and stop times that will collect traffic in which you're most interested. What should you look for? Active devices and identifying information such as operating systems and applications
>
> **[1:35](https://www.linkedin.com/learning/security-testing-essential-training-2022/network-sniffing?u=76281980&t=95)** as well as services and protocols in use, particularly if those services or protocols are either insecure by nature or explicitly prohibited in the customer's written policies. You should also look for unencrypted data transmissions especially of sensitive data and unencrypted credential sets traveling across the network. So where should you sniff from? At the perimeter for starters. Watch for what's coming in and what's going out. You should also place a sniffer behind firewalls to determine if they're filtering appropriately as part of your rule set review output. You should place a sniffer behind [Intrusion Detection](../../Skills/Network%20and%20System%20Administration/Intrusion%20Detection.md) systems and intrusion prevention systems to determine whether or not they're firing the appropriate rules. You should place sniffers in front of sensitive systems or applications to check for the principle of lease privilege being applied, and you should place sniffers on any network segment where encryption is required by policy to validate compliance with that policy. Let's turn to [Wireshark](../../Skills/Cybersecurity/Wireshark.md) to see what we can learn.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Office](../../Skills/Web%20Development/Microsoft%20Office.md) (2), [Intrusion Detection](../../Skills/Network%20and%20System%20Administration/Intrusion%20Detection.md) (1), [Wireshark](../../Skills/Cybersecurity/Wireshark.md) (1)
> **CLI Commands:** make (1)
> **Analogies:** such as (1)
> **Speakers:** - [instructor] (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Nmap](../../Glossary/Tool/Nmap.md) (1), [Network Security](../../Skills/Cybersecurity/Network%20Security.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Nmap](../../Glossary/Tool/Nmap.md) (20), [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) (3)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Windows](../../Glossary/Service/Windows.md) (3), [Kali Linux](../../Skills/Cybersecurity/Kali%20Linux.md) (2), [Nmap](../../Glossary/Tool/Nmap.md) (1), [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) (1), [Windows 10](../../Skills/Network%20and%20System%20Administration/Windows%2010.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/security-testing-essential-training-2022/wireless-scanning?u=76281980&t=0)** - [Presenter] Wireless networks were slowly gaining traction in the enterprise in the early two thousands, but when Apple released the first iPhone in June, 2007, that marked the true beginning of what we consider the mobile enterprise that's so prevalent today. Now, it's common to see multiple wireless networks in use in a corporate environment. We often see one for managed devices, one for personal devices. Sometimes you'll even find a dedicated wireless network for [internet of things](../../Skills/Software%20Development/Internet%20of%20Things%20(IoT).md) or [IoT](../../Glossary/Concept/IoT.md) devices. And with an increasing reliance on wireless technology comes a corresponding increase in our efforts to secure those technologies. Before embarking on a wireless network scan, step back and ask a few key questions. Which locations should have wireless enabled? Are there any environmental considerations that might interfere with your scanning? Things like protective film on the [Windows](../../Glossary/Service/Windows.md) or interference from nearby wireless networks. What security settings should be applied to the wireless networks you're assessing? This would be a great time to refer to the [Wireless Networking](../../Skills/Network%20and%20System%20Administration/Wireless%20Networking.md) security policy. What does a normal day look like to these in scope wireless networks? Your scans are only going to be useful if the endpoints are actually connected during the time you're performing your assessment. And does the customer have any wireless security technologies that might interfere with your scanner? When performing wireless network scans, security assessors
>
> **[1:38](https://www.linkedin.com/learning/security-testing-essential-training-2022/wireless-scanning?u=76281980&t=98)** often connect a second wireless antenna to their laptop. All scanning traffic is collected through this antenna to avoid mingling scanning data with regular network traffic. This is a list of possible wireless security configurations in the order of least secure to most secure. You can have open/unencrypted wireless networks. You could enable Wired Equivalent [Privacy](../../Skills/Data%20Science/Privacy.md) or WEP, which is known to be insecure. You could implement [Wi-Fi](../../Glossary/Standard/Wi-Fi.md) Protected Access or WPA, also broken, or you could implement Wi-Fi Protected Access to WPA2 or WPA3, and either the personal configuration or the enterprise configuration. From a [Penetration Testing](../../Skills/Cybersecurity/Penetration%20Testing.md) standpoint, any wireless security configuration prior to WPA2 represents a significant risk to the organization. Tools and techniques for compromising wireless networks with these weaker security protocols have been available for years and they're incredibly effective at what they do. Ideally, your customer will be using at least WPA2 enterprise or ideally WPA3, both of which combine strong encryption with certificate based authentication. An attacker targeting a WPA2 encrypted network only needs the wireless network password
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Wi-Fi](../../Glossary/Standard/Wi-Fi.md) (2), [Internet of things](../../Skills/Software%20Development/Internet%20of%20Things%20(IoT).md) (1), [IoT](../../Glossary/Concept/IoT.md) (1), [Windows](../../Glossary/Service/Windows.md) (1), [Wireless Networking](../../Skills/Network%20and%20System%20Administration/Wireless%20Networking.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/security-testing-essential-training-2022/aircrack-ng-demo?u=76281980&t=0)** - [Instructor] For the Aircrack demo, we're going to be connecting a physical wireless network adapter to your virtual [Kali Linux](../../Skills/Cybersecurity/Kali%20Linux.md) machine instance. As I mentioned in a previous video, I like to use the ALFA adapters. And for this particular demo, I'm using the AWUS036ACH model. I'm using this model because of that Realtek chip set. It's easier to get it up and running in Kali with that chip set. Although, you have a lot of options available. Depending on the adapter that you've selected, you'll want to research the directions for connecting it to Kali before continuing with this demo in your own lab. Once you get the wireless network adapter connected, you'll open a terminal window and type ifconfig. Within that list, you should now see an entry for wlan0. This is the network interface that Kali understands to be your wireless network adapter. That means that using this interface, your Kali VM can now see [Wireless Networking](../../Skills/Network%20and%20System%20Administration/Wireless%20Networking.md) traffic in the real world. We're going to clear the screen. And we're going to run one quick utility built into the Aircrack suite, airmon-ng and we're going to run it with the parameters check kill. And what this is going to do is check for running processes that might interfere with Aircrack. And if it finds them, kill them.
>
...
>
> **[3:09](https://www.linkedin.com/learning/security-testing-essential-training-2022/password-cracking?u=76281980&t=189)** have contributed to the field. In 2009, the media website [rockyou.com](https://rockyou.com) was breached and a security researcher published the list of 32 million passwords that were exposed in just that one breach. This list represented the largest collection of passwords that we knew people were actually using to log into this website. And the RockYou list has been a favorite of pen testers ever since. Variations of the RockYou wordlist have been built into [Kali Linux](../../Skills/Cybersecurity/Kali%20Linux.md) directly, and we're going to take a look at using [Hashcat](../../Glossary/Tool/Hashcat.md) with the RockYou list to crack some passwords. But as I mentioned earlier, we're just scratching the surface when it comes to password cracking.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Application Security](../../Skills/Cybersecurity/Application%20Security.md) (1), [Kali Linux](../../Skills/Cybersecurity/Kali%20Linux.md) (1), [Hashcat](../../Glossary/Tool/Hashcat.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Hashcat](../../Glossary/Tool/Hashcat.md) (16), [Word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) (11), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (4), [Kali Linux](../../Skills/Cybersecurity/Kali%20Linux.md) (2), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/security-testing-essential-training-2022/penetration-test-planning?u=76281980&t=0)** - [Instructor] In my experience, the best way to validate your information security program is through a penetration test. Practically speaking, [Penetration Testing](../../Skills/Cybersecurity/Penetration%20Testing.md) can often be summed up in two concepts: privilege escalation and lateral movement. The initial goal is often to compromise a single system or application by compromising a set of valid credentials. From there, you'll want to escalate your privileges ideally assuming or creating an administrative account. Once you migrate your activity to that administrative account, you'll want to move to another system or another application, pillaging sensitive data along the way. While the goal of many penetration tests is to compromise domain admin credentials, this isn't always the case. If performing a pen test as part of your [PCI DSS](../../Glossary/Standard/PCI%20DSS.md) compliance efforts, you should be attempting to compromise cardholder data. If you can access unencrypted credit cards via an [Application Security](../../Skills/Cybersecurity/Application%20Security.md) vulnerability, or a set of credentials authorized to access that data, then you've accomplished your goal without compromising domain admin credentials. Understanding why your customer engaged you to perform a penetration test is essential if you intend to conduct a pen test in line with the customer's expectations. [NIST](../../Skills/IT%20Help%20Desk/NIST.md) subscribes to a four-stage penetration testing methodology: planning, discovery, attack, and reporting.
>
> **[1:38](https://www.linkedin.com/learning/security-testing-essential-training-2022/penetration-test-planning?u=76281980&t=98)** The attack stage can be broken down into four distinct cyclical activities: gaining access, escalating privileges, system browsing and installing additional tools. In my own consulting experience, though, I prefer to follow the penetration testing execution standard or PTES. The PTES outlines a seven-stage methodology: pre-engagement interactions, intelligence gathering, [Threat Modeling](../../Skills/Cybersecurity/Threat%20Modeling.md), vulnerability analysis, exploitation, post exploitation, and reporting. Your first activity should always be to ensure that the scope, methodology and goals have been explicitly identified. You should also ensure that you have a written statement from an authorized party explicitly granting you permission to test the in scope systems and applications for weaknesses. What should you focus on during a penetration test? It could be any combination of the following: internet-facing systems, internet-facing applications, mobile applications, internal systems, internal applications, physical [office](../../Skills/Web%20Development/Microsoft%20Office.md) locations, company employees, through social engineering, and systems and applications hosted by a third party.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Penetration Testing](../../Skills/Cybersecurity/Penetration%20Testing.md) (3), [PCI DSS](../../Glossary/Standard/PCI%20DSS.md) (1), [Application Security](../../Skills/Cybersecurity/Application%20Security.md) (1), [NIST](../../Skills/IT%20Help%20Desk/NIST.md) (1), [Threat Modeling](../../Skills/Cybersecurity/Threat%20Modeling.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/security-testing-essential-training-2022/penetration-test-tools?u=76281980&t=0)** - [Instructor] Once your customer has identified what's in scope, and what's out of scope, you should perform your own reconnaissance. Use the tools and techniques outlined in this course. Combine them with OSINT gathering tools and techniques and then compare your findings to your customer's requested scope. They may be surprised to see that you found systems and applications that they didn't realize they still had online. One of my favorite OSINT gathering tools is the "Discover" [python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) script from Lee Baird. You can download "Discover" from Lee's [GitHub](../../Skills/Software%20Development/GitHub.md) repository using the link here. In order to get the best results from this tool, you'll need to spend a bit of time configuring the tool with API keys for the services you intend to access. The APIs that I recommend you configure are as follows: Bing, BuiltWith, Censys, both the API and the secret key, FullContact, GitHub, [Google](../../Glossary/Service/Google.md), API and CSE, Hashes, Ipinfo, [LinkedIn](../../Skills/Web%20Development/LinkedIn.md), client and secret, Shodan, and Twitter, both API and secret. Once you've configured these API keys within the tool you simply run the tool from the command line and enter the top level domains you'd like to analyze. Within seconds, you'll have an extensive set of open source intelligence on your customer.
>
> **[1:34](https://www.linkedin.com/learning/security-testing-essential-training-2022/penetration-test-tools?u=76281980&t=94)** When it comes to vulnerability analysis in a penetration test, there are multiple schools of thoughts. [NIST](../../Skills/IT%20Help%20Desk/NIST.md) encourages the use of vulnerability scanners. While you're likely to get detailed, accurate results on your targets using these tools, they'll almost certainly trigger alerts in your customer's security information event management system. They may even trigger an intrusion prevention system that automatically blocks your testing system from accessing any of the customer's IT assets. I know a number of pen-testers who forgo noisy automated scans, opting instead to focus on OSINT and user credentials. OSINT gathering rarely, if ever, touches the target network so the likelihood of OSINT gathering tripping alarms, and getting blacklisted is virtually nonexistent. Once you know which systems and applications are accessible from the internet, you'll want credentials so you can attempt to log in. OSINT gathering is certain to turn up email addresses and likely to turn up internal usernames. With just a single email address or a single username, you should be able to determine the naming convention that the customer follows. With email, is it first name dot last name? First name underscore last name? First initial, last name? The web application, Hunter, available at [hunter.io](https://hunter.io), can answer that question for you.
>
> **[3:09](https://www.linkedin.com/learning/security-testing-essential-training-2022/penetration-test-tools?u=76281980&t=189)** [Metadata](../../Skills/Web%20Development/Metadata.md) extraction tools like FOCA, and Metagoofil, can often extract internal network usernames from publicly available documents. If you find a single username, enough to determine the customer's naming convention, you could scour LinkedIn for other employees working at the same company. From there, determining other valid user names should be pretty straightforward.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [GitHub](../../Skills/Software%20Development/GitHub.md) (2), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (2), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (1), [Google](../../Glossary/Service/Google.md) (1), [NIST](../../Skills/IT%20Help%20Desk/NIST.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/security-testing-essential-training-2022/social-engineering?u=76281980&t=0)** - [Narrator] We tend to think of [Penetration Testing](../../Skills/Cybersecurity/Penetration%20Testing.md) as a technical exercise, but criminals learned long ago that it's much easier to hack a person. That's why social engineering has been and will remain a highly effective method for compromising organizations. That's also why it's important for penetration testers to include social engineering in our engagements. Social engineering often involves tricking targets into taking an action on the attacker's behalf. Examples of this are opening a malicious email attachment or visiting a malicious website, both with the intent of installing malware on the target system. This is known as [Phishing](../../Skills/Software%20Development/Phishing.md) and it's generally considered to be the most common social engineering attack method. Another common tactic in social engineering is attempting to trick users into sharing valid credentials. This could be done via a phone call where the attacker impersonates someone the user is likely to trust, maybe somebody on the help desk. This might also be done by convincing the user to visit a log on page that looks and feels like a website the user trusts, when it's really a website owned and controlled by the attacker. A fantastic tool for staging and executing social engineering attacks is the social engineer toolkit or set. Set is an open source [python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) tool, originally written by Dave Kennedy,
>
> **[1:33](https://www.linkedin.com/learning/security-testing-essential-training-2022/social-engineering?u=76281980&t=93)** one of the most active and influential members of the Information Security Community. Set is pre-installed in [Kali Linux](../../Skills/Cybersecurity/Kali%20Linux.md) and it's accessible under the social engineering tools of the applications menu. Set contains nearly a dozen different attack vectors, helping you automate social engineering attacks against websites, wireless networks, email accounts, mobile devices, and even [Arduino](../../Skills/Software%20Development/Arduino.md) devices. When it comes to website attack vectors, set includes seven unique attack methods in addition to credential harvesting. Remember that the intent of social engineering isn't to embarrass your targets. Rather, it's to help the organization determine whether or not their [Security Awareness](../../Skills/Cybersecurity/Security%20Awareness.md) efforts are having the desired effect. More importantly, the results of your social engineering tests should provide your customer with targeted guidance on how they might improve their resilience to these types of attacks. While phishing campaigns are far and away the most popular form of social engineering tests, I recommend that you consider including the following as well. Perform a physical site visit, attempt to bypass the front desk and walk around the customer's [office](../../Skills/Web%20Development/Microsoft%20Office.md) area. An attacker who can gain physical access to their facilities could likely install unauthorized [Hardware](../../Topics/Hardware.md) on their internal network. Authenticate to applications protected by two-factor authentication. Your customer may believe that sites protected
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Phishing](../../Skills/Software%20Development/Phishing.md) (2), [Penetration Testing](../../Skills/Cybersecurity/Penetration%20Testing.md) (1), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (1), [Kali Linux](../../Skills/Cybersecurity/Kali%20Linux.md) (1), [Arduino](../../Skills/Software%20Development/Arduino.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Kali Linux](../../Skills/Cybersecurity/Kali%20Linux.md) (1), [OWASP](../../Skills/Cybersecurity/OWASP.md) (1), [Web Application Security](../../Skills/Cybersecurity/Web%20Application%20Security.md) (1)
> **UI Navigation:** go to (2), click on (1), scroll down (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/security-testing-essential-training-2022/additional-resources?u=76281980&t=0)** - [Instructor] While I spend a lot of my time reading blogs and scouring [GitHub](../../Skills/Software%20Development/GitHub.md), I do have a few books that I return to time and again. If you're interested, I recommend that you consider adding these books to your own shelf: "RTFM: The Red Team Field Manual," "BTFM: The Blue Team Field Manual," "Hash Crack: The Password Cracking Manual,: and "[Penetration Testing](../../Skills/Cybersecurity/Penetration%20Testing.md): "A Hands on Introduction to Hacking." I mentioned multiple [NIST](../../Skills/IT%20Help%20Desk/NIST.md) special publications throughout the course, referencing 801-15, the Technical Guide to Information [Security Testing](../../Skills/Cybersecurity/Security%20Testing.md) and Assessment more than any of the others. NIST special publications are incredibly detailed and free to download, and I recommend that you review these three publications more closely when you have the opportunity: Special Publication 800-30 Rev 1: "Guide for Conducting Risk Assessments," Special Publication 800-53 Rev 5: "Security and [Privacy](../../Skills/Data%20Science/Privacy.md) Controls "for Federal Information Systems and Organizations," and Special Publication 800-115: "Technical Guide to Information Security "Testing and Assessment." Getting involved in professional groups is a fantastic way to connect with other information security professionals. If you live near a major metropolitan area, I recommend that you check out local chapter meetings of one or more of these organizations:
>
> **[1:33](https://www.linkedin.com/learning/security-testing-essential-training-2022/additional-resources?u=76281980&t=93)** ISSA, ISACA, ISC Squared, InfraGard, and [OWASP](../../Skills/Cybersecurity/OWASP.md). If a chapter doesn't exist yet, maybe you should start one. If you'd rather do something independent, maybe you could start your own group or join forces with one that's already underway. Don't spend all of your time in a book or behind a computer screen, though. Try to attend security conferences every now and then. [Infosec-conferences.com](https://Infosec-conferences.com) has a robust list of information security conferences all around the world. Search for a city near you and I'm sure you'll find at least one conference worth checking out. Better yet, see if you can find a security BSides within driving distance. BSides conferences are run by security professionals for security professionals. They're both accessible and very affordable and they're one of the best things to happen in the information security community in years. If you can't find a BSides near you, start one. The BSides team would love to help you do just that. You can visit them online at [securitybsides.com](https://securitybsides.com). If you can't make a conference in person, you could also visit YouTube to watch recorded talks posted after each event. Adrian Crenshaw, who goes by the online handle irongeek_adc, travels from conference to conference throughout the year, recording talks
>
> **[3:07](https://www.linkedin.com/learning/security-testing-essential-training-2022/additional-resources?u=76281980&t=187)** and uploading them to his YouTube channel. Head on over to [irongeek.com](https://irongeek.com) for a complete list of conferences that Adrian's attended and videos that he's recorded. Finally, I recommend that you keep in touch with me as you continue to move forward in your career. I'm easy enough to find here on [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) and I publish my slides to conference talks on my SlideShare account and on my LinkedIn profile. I also maintain a website in my spare time, [simplifyingcybersecurity.com](https://simplifyingcybersecurity.com). I built the site to help folks like you continue to sharpen your skills and grow your own careers. If you see something out there that helps you do what you're trying to do, excellent. If not, let me know what you're looking for and I'll see what I can do.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [NIST](../../Skills/IT%20Help%20Desk/NIST.md) (2), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (2), [GitHub](../../Skills/Software%20Development/GitHub.md) (1), [Penetration Testing](../../Skills/Cybersecurity/Penetration%20Testing.md) (1), [Privacy](../../Skills/Data%20Science/Privacy.md) (1)
...
← [Learning the OWASP Top 10](Learning%20the%20OWASP%20Top%2010.md) | **4 of 7** | [Dynamic Application Security Testing](Dynamic%20Application%20Security%20Testing.md) →

### In [Strategies for Managing Vulnerabilities and Mitigating Cyber Risks](../../Paths/Cybersecurity/Learning%20Paths/Strategies%20for%20Managing%20Vulnerabilities%20and%20Mitigating%20Cyber%20Risks.md)
← [Vulnerability Management in Cybersecurity- The Basics](Vulnerability%20Management%20in%20Cybersecurity-%20The%20Basics.md) | **2 of 6** | [Vulnerability Management with Nessus](Vulnerability%20Management%20with%20Nessus.md) →
