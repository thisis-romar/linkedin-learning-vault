...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/cybersecurity-foundations-application-security/the-most-reported-vulnerabilities-today?u=76281980&t=0)** - [Instructor] There are no prerequisites for this course but it is designed for aspiring technology professionals, ranging from students to entry-level [Cybersecurity](../../Topics/Cybersecurity.md) engineers. The course is based on the top 10 most reported vulnerabilities on bug bounty programs in the calendar year 2022. Therefore, completing this course will position an aspiring [Application Security](../../Skills/Cybersecurity/Application%20Security.md) engineer to be able to slot right into a defensive role. Similarly, the course will educate application developers on the most common mistakes in their field and how to avoid repeating them. There is also a chapter dedicated towards industry trends as relates application security and how they impact both cybersecurity engineers and developers alike. You're welcome to pick and choose the information that best fits your needs and academic goals.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Cybersecurity](../../Topics/Cybersecurity.md) (2), [Application Security](../../Skills/Cybersecurity/Application%20Security.md) (2)
> **Speakers:** - [instructor] (1)
...
>
> **[6:16](https://www.linkedin.com/learning/cybersecurity-foundations-application-security/web-application-firewall-waf?u=76281980&t=376)** to the new IP, which is the Web Application Firewall's IP, and click on Save. With the WAF now deployed, let's log back in to our sample social media application with the user Bob. Now, when Bob tries to submit the same malicious script into the database, he is met with a 403 Forbidden error by Microsoft-[Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md)-Application-Gateway/v2. The underlying code is still vulnerable, but the WAF is protecting the exploitation of common vulnerabilities on this application. Web Application Firewalls can be configured in detection or prevention mode to suit your needs. Learning how to configure and tweak a WAF so as to maintain security but limit false positives is definitely something an [Application Security](../../Skills/Cybersecurity/Application%20Security.md) engineer ought to know how to do. Whether you have one or not, continue to insist on developers writing secure code.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Routing](../../Skills/Network%20and%20System%20Administration/Routing.md) (4), [Microsoft](../../Instructors/Artificial%20Intelligence%20(AI)/Microsoft.md) (2), [SQL](../../Skills/Data%20Science/SQL.md) (1), [JavaScript](../../Skills/Software%20Development/JavaScript.md) (1), [Microsoft Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/cybersecurity-foundations-application-security/practice-platforms?u=76281980&t=0)** - [Instructor] The only way an [Application Security](../../Skills/Cybersecurity/Application%20Security.md) engineer can become really good at identifying, triaging, and resolving security incidents is by practicing. Several practice platforms exist online, such as Hack The Box, [TryHackMe](../../Glossary/Service/TryHackMe.md), and PentesterLabs. Hack The Box is one of the most popular [Ethical Hacking](../../Skills/Cybersecurity/Ethical%20Hacking.md) websites. They offer hacking labs, hacking challenges, and capture the flag competitions. Another platform for practicing is TryHackMe. This platform is somewhat similar in features to Hack The Box, but it is arguably more beginner-friendly. We also have PentesterLabs, which offers AttackDefense as their lab platform with over 2,000 practical labs at the time of this recording. These platforms are not entirely free, and so if you want to be fully in control of your learning experience, I recommend setting up labs locally. Some options of vulnerable applications that you can download and run on your local machine include Damn Vulnerable Web Application, [OWASP](../../Skills/Cybersecurity/OWASP.md) WebGoat, and OWASP Juice Shop. Setting up these downloadable platforms today is much easier. They often come packaged and pre-built as [Virtual Machines](../../Skills/Cloud%20Computing/Virtual%20Machines.md) or Docker containers, which you can run and interact with via your web browser. Once setup, you can now test various application level vulnerabilities, tweak the code to explore further,
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [TryHackMe](../../Glossary/Service/TryHackMe.md) (2), [OWASP](../../Skills/Cybersecurity/OWASP.md) (2), [Application Security](../../Skills/Cybersecurity/Application%20Security.md) (1), [Ethical Hacking](../../Skills/Cybersecurity/Ethical%20Hacking.md) (1), [Virtual Machines](../../Skills/Cloud%20Computing/Virtual%20Machines.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/cybersecurity-foundations-application-security/next-steps?u=76281980&t=0)** - [Instructor] [Application Security](../../Skills/Cybersecurity/Application%20Security.md) is increasingly cementing itself as the most important facet of [Cybersecurity](../../Topics/Cybersecurity.md). This is because the world is moving away from [infrastructure as a service](../../Glossary/Concept/IaaS.md) deployments in favor of [platform as a service](../../Glossary/Concept/PaaS.md) deployments. With this trend taking place in the cloud, the most likely way to compromise a system will no longer be at the physical or network layer, which are now professionally managed by cloud providers, but instead at the application level. Therefore, cementing your knowledge on the vulnerabilities we've covered in this course is key. And while this course focused on the most commonly reported application security vulnerabilities, there are other application security vulnerabilities that you need to be aware of as well. As you plan to grow in your cybersecurity journey, gaining knowledge in some of these other vulnerabilities across other programming languages is equally important. In this course, we also saw how improper deployment can compromise the security of an application. If you wish to learn more about how to securely deploy your applications in the cloud, then check out my [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) learning course on FinTech security essentials. The application security field is changing very fast. Keeping abreast with technological trends, programming paradigms, and defensive tools is paramount. You need to practice regularly across various platforms in order to gain enough experience. With time, you'll be able to spot an AppSec issue just by perusing a few lines of code. It is my hope that you eventually get there in your cybersecurity journey.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Application Security](../../Skills/Cybersecurity/Application%20Security.md) (4), [Cybersecurity](../../Topics/Cybersecurity.md) (3), [Infrastructure as a service](../../Glossary/Concept/IaaS.md) (1), [Platform as a service](../../Glossary/Concept/PaaS.md) (1), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (1)
> **Warnings:** be aware (1)
> **Speakers:** - [instructor] (1)
...
**1 of 7** | [Penetration Testing Essential Training](Penetration%20Testing%20Essential%20Training.md) →
