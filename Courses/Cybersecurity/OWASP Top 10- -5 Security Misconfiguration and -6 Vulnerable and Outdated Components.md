...
>
> **[2:30](https://www.linkedin.com/learning/owasp-top-10-5-security-misconfiguration-and-6-vulnerable-and-outdated-components/prevention-technique-1-repeatable-hardening?u=76281980&t=150)** Conveniently, these are recognized as secure configurations by [[PCI DSS]], the [[PCI DSS|Payment Card Industry Data Security Standard]], HIPAA, the Health Insurance Portability and [[Accountability]] Act, FISMA, the US Federal [[Information Security Management]] Act, FedRAMP, the US Federal Risk and Authorization Management Program, and [[NIST]], the US National Institute of Standards and Technology.
>
