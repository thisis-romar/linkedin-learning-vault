...
prev_courses:
  - '[Ethical Hacking- Mobile Devices and Platforms](Ethical%20Hacking-%20Mobile%20Devices%20and%20Platforms.md)'
next_courses:
  - '[Ethical Hacking- Cryptography](Ethical%20Hacking-%20Cryptography.md)'
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [IoT](../../Glossary/Concept/IoT.md) (4), [Internet of things](../../Skills/Software%20Development/Internet%20of%20Things%20(IoT).md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/ethical-hacking-hacking-iot-devices-21053658/identifying-owasp-iot-top-10?u=76281980&t=0)** - [Instructor] The Open [Web Application Security](../../Skills/Cybersecurity/Web%20Application%20Security.md) Project, or [OWASP](../../Skills/Cybersecurity/OWASP.md) provides continuous research on common vulnerabilities. In this segment, we'll learn how OWASP can help us understand the common [IoT](../../Glossary/Concept/IoT.md) vulnerabilities across multiple attacks surfaces. First, let's start by outlining the concept of an attack surface. An attack surface represents any known or unknown weakness across an entry point such as software, [Hardware](../../Topics/Hardware.md), network, and users. With the internet of everything, the attack surface will continue to grow, and all attack surfaces must be monitored. Let's step through an example. In this graphic, we see the extent of the possible attack surfaces of a single vehicle. A malicious actor might be able to launch an attack using a broad range of attack vectors, which can include the following, the anti-lock braking system, keyless entry, and telematics. Now that we understand what's at stake, let's visit the OWASP website where we can explore the many ways that the organization provides updates and continuous research on common vulnerabilities. In addition, OWASP provides a range of resources to help us learn about security and [Privacy](../../Skills/Data%20Science/Privacy.md) best practices.
>
...
>
> **[3:16](https://www.linkedin.com/learning/ethical-hacking-hacking-iot-devices-21053658/identifying-owasp-iot-top-10?u=76281980&t=196)** and systems are updated with the latest security patches and firmware updates. Implement strong authentication and authorization methods including two-factor authentication when possible, use encryption to protect data in transit and at [rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md). Properly configure the device and disable any unnecessary services and protocols, and employ physical security measures such as locking cabinets and secure mounting. Now, let's test your knowledge. Describe how OWASP can help us understand the common IOT vulnerabilities across multiple attack surfaces. You can record your answer on the challenge worksheet.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [IoT](../../Glossary/Concept/IoT.md) (10), [OWASP](../../Skills/Cybersecurity/OWASP.md) (5), [Web Application Security](../../Skills/Cybersecurity/Web%20Application%20Security.md) (1), [Hardware](../../Topics/Hardware.md) (1), [Privacy](../../Skills/Data%20Science/Privacy.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [IoT](../../Glossary/Concept/IoT.md) (14), [Cryptocurrency](../../Skills/Data%20Science/Cryptocurrency.md) (1)
> **Env Vars:** iot (14)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [IoT](../../Glossary/Concept/IoT.md) (6), [Ethical Hacking](../../Skills/Cybersecurity/Ethical%20Hacking.md) (2), [Technical Documentation](../../Skills/Software%20Development/Technical%20Documentation.md) (1), [Manual Testing](../../Skills/Software%20Development/Manual%20Testing.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [IoT](../../Glossary/Concept/IoT.md) (8), [Nmap](../../Glossary/Tool/Nmap.md) (1), [Real-Time](../../Skills/Database%20Management/Real-Time.md) (1), [Wifi](../../Glossary/Standard/Wi-Fi.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [IoT](../../Glossary/Concept/IoT.md) (12), [Nmap](../../Glossary/Tool/Nmap.md) (5), [Android](../../Glossary/Sdk/Android.md) (2), [Products](../../Skills/Software%20Development/Microsoft%20Products.md) (1), [Privacy](../../Skills/Data%20Science/Privacy.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [IoT](../../Glossary/Concept/IoT.md) (8), [Hardware](../../Topics/Hardware.md) (1)
> **Definitions:** is a  (5)
> **Analogies:** such as (4)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [IoT](../../Glossary/Concept/IoT.md) (8), [Hardware](../../Topics/Hardware.md) (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [SCADA](../../Glossary/Concept/SCADA.md) (4), [Programmable logic controller](../../Skills/Hardware/Programmable%20Logic%20Controller%20(PLC).md) (2), [Ethical Hacking](../../Skills/Cybersecurity/Ethical%20Hacking.md) (1), [Data Acquisition](../../Skills/Software%20Development/Data%20Acquisition.md) (1), [PLC](../../Glossary/Tool/PLC.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/ethical-hacking-hacking-iot-devices-21053658/ot-technologies-and-protocols?u=76281980&t=0)** - [Instructor] Operational technology encompasses a wide range of technologies and protocols that are used in industrial environments. In this segment, we'll outline key operational technology protocols and standards that include Modbus, [PROFIBUS](../../Glossary/Standard/PROFIBUS.md), Highway Addressable Remote Transducer, and OLE for Process Control. When we think about operational technology protocols, one category of communication protocols used are the fieldbus protocols. These protocols and technologies play essential roles in industrial automation and process control, facilitating communication and data exchange between various devices and systems in industrial settings. Let's talk about a few of the fieldbus protocols. Modbus is a simple, open communication protocol that allows communication between different industrial devices, such as sensors, remote terminal units, and PLCs. Modbus is known for its ease of implementation and compatibility with a wide range of devices. Modbus includes three main protocol types, Modbus RTU for serial communication, Modbus ASCII for transmitting messages using ASCII characters, and Modbus TCP for ethernet-based communication.
>
> **[1:37](https://www.linkedin.com/learning/ethical-hacking-hacking-iot-devices-21053658/ot-technologies-and-protocols?u=76281980&t=97)** PROFIBUS, or Process Field Bus, is another communication protocol that is often used for [Real-Time](../../Skills/Database%20Management/Real-Time.md) control and monitoring applications in various industries, including manufacturing, chemical processing, and water treatment. HART, or Highway Addressable Remote Transducer, is a hybrid communication protocol used in process industries for communication with field instruments, such as pressure transmitters, flow meters, and temperature sensors. HART allows for real-time measurement data to be transmitted along with device diagnostics and configuration information. OLE for Process Control, or [OPC](../../Glossary/Standard/OPC.md), is not a communication protocol, but rather a set of industry standards and specifications. OPC provides interoperability among different devices and software applications in the process control and automation field. By using a client [Server Configuration](../../Skills/Network%20and%20System%20Administration/Server%20Configuration.md), devices and systems using OPC can easily exchange data. Now let's test your knowledge. outline key operational technology protocols and standards that include Modbus, PROFIBUS, HART, and OPC. You can record your answer on the Challenge Worksheet.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [OPC](../../Glossary/Standard/OPC.md) (4), [PROFIBUS](../../Glossary/Standard/PROFIBUS.md) (3), [Real-Time](../../Skills/Database%20Management/Real-Time.md) (2), [Server Configuration](../../Skills/Network%20and%20System%20Administration/Server%20Configuration.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/ethical-hacking-hacking-iot-devices-21053658/recognizing-the-challenges-of-ot?u=76281980&t=0)** - [Instructor] Reducing risk when using operational technology can be challenging as a malicious actor can gain access to a system in one of several ways. In this segment, we'll review the challenges of securing operational technology. That includes threats, attacks, and vulnerabilities. If a system is not properly secured, this can make a system vulnerable to threats and attacks. Those include denial of service attacks, viruses and malware, social engineering, and physical attacks. [IoT](../../Glossary/Concept/IoT.md) and OT devices are notorious for their poor security and several major exploits have been seen in the wild. Let's review some of the vulnerable components that can occur in operational technology systems that can be exploited by a malicious actor to gain access to the infrastructure. Vulnerabilities can include outdated or flawed software, weak access controls, lack of security patches, and insecure network configurations that can lead to a system compromise. Another issue that can expose a system to an attack is management interface vulnerabilities. Now, when running an enterprise network, it's common to use an application such as an intelligent platform management interface.
>
> **[1:35](https://www.linkedin.com/learning/ethical-hacking-hacking-iot-devices-21053658/recognizing-the-challenges-of-ot?u=76281980&t=95)** As shown here in the graphic, this makes it easier for the administrator to monitor and control the servers via a central interface. However, if the management interface is not properly configured, it can expose the network and allow a malicious actor to have direct access to the network. In an operational technology environment, devices communicate with each other and perform specialized functions. For example, we see here in this graphic field devices such as a motor, switch, sensor, and valve in a [distributed control system](../../Glossary/Concept/DCS.md) all communicating with each other. However, the problem is in some cases, the devices come with pre-configured default settings, such as a username and password. In addition, the manufacturer may have hard coded the credentials, which makes it difficult, if not impossible to remove. In some cases, the vulnerabilities exist as a result of human error along with improper or missing configurations. For example, leaving the username and password as the default or leaving the password blank can leave your system open to an attack. In addition to default passwords. There can also be flaws in the way the system handles errors.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [IoT](../../Glossary/Concept/IoT.md) (1), [Distributed control system](../../Glossary/Concept/DCS.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Ethical Hacking](../../Skills/Cybersecurity/Ethical%20Hacking.md) (4)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Ethical Hacking](../../Skills/Cybersecurity/Ethical%20Hacking.md) (1), [Penetration Testing](../../Skills/Cybersecurity/Penetration%20Testing.md) (1), [SCADA](../../Glossary/Concept/SCADA.md) (1), [Windows](../../Glossary/Service/Windows.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [HMI](../../Glossary/Concept/HMI.md) (4), [Human machine interface](../../Glossary/Concept/HMI.md) (3), [Windows](../../Glossary/Service/Windows.md) (1), [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) (1), [IoT](../../Glossary/Concept/IoT.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [SCADA](../../Glossary/Concept/SCADA.md) (4), [IoT](../../Glossary/Concept/IoT.md) (4), [Wireshark](../../Skills/Cybersecurity/Wireshark.md) (1), [Web Servers](../../Skills/Web%20Development/Web%20Servers.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/ethical-hacking-hacking-iot-devices-21053658/targeting-ot-systems?u=76281980&t=0)** - [Instructor] Malicious actors use a variety of different methods to compromise the security of an industrial control system. In this segment, we'll review various methods used to control or disrupt operations in a critical infrastructure environment. Industrial control systems are typically used in sectors such as manufacturing, energy, transportation, and utilities. Auditing these systems is crucial for ensuring their reliability, safety, and protection against [Cybersecurity](../../Topics/Cybersecurity.md) threats. During this process, the team will examine and evaluate the security, performance, and compliance of the technology and processes used in industrial and critical infrastructure settings. The initial phase of an attack typically involves a reconnaissance exercise to learn more about the target environment and what is the best approach to launch an attack. As illustrated here in this simplified graphic of an industrial control system, there are many attack vectors and ways to gain access to the system. So let's talk about some examples of techniques that can be used. Malicious actors might attempt to hack the [Hardware](../../Topics/Hardware.md) in an industrial control system, as the widespread reliance on the technology in sectors such as energy and manufacturing makes them lucrative targets.
>
> **[1:33](https://www.linkedin.com/learning/ethical-hacking-hacking-iot-devices-21053658/targeting-ot-systems?u=76281980&t=93)** Some of the targets can include programmable logic controllers, remote terminal units, human machine interfaces, and field devices and sensors. DNP3 or distributed network protocol and Modbus are two of the most commonly used protocols in [SCADA](../../Glossary/Concept/SCADA.md) systems. These protocols serve as communication standards that enable the exchange of data between different devices and components within SCADA systems. Like many other protocols, both DNP3 and Modbus can potentially be exploited by malicious actors to gain unauthorized access to industrial control systems if they are not properly secured. For instance, a malicious actor can use [Metasploit](../../Glossary/Framework/Metasploit.md) or any other hacking tool to gain access to read and overwrite data on a Modbus server. A [programmable logic controller](../../Skills/Hardware/Programmable%20Logic%20Controller%20(PLC).md) automates and controls machinery and processes and manufacturing and industrial applications. If exploited the attack can impact the functionality and alter controls or configurations. The complexity of the attack will depend on the security of the system and the desired effect. For example, if we look at this [PLC](../../Glossary/Tool/PLC.md) code segment, we see that the system will send an alarm and shut down the system if the temperature of the machine
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [SCADA](../../Glossary/Concept/SCADA.md) (2), [Cybersecurity](../../Topics/Cybersecurity.md) (1), [Hardware](../../Topics/Hardware.md) (1), [Metasploit](../../Glossary/Framework/Metasploit.md) (1), [Programmable logic controller](../../Skills/Hardware/Programmable%20Logic%20Controller%20(PLC).md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [IoT](../../Glossary/Concept/IoT.md) (10), [Real-Time](../../Skills/Database%20Management/Real-Time.md) (2), [SCADA](../../Glossary/Concept/SCADA.md) (1), [Hardware](../../Topics/Hardware.md) (1), [Incident Response](../../Skills/Cybersecurity/Incident%20Response.md) (1)
> **Analogies:** such as (4)
> **CLI Commands:** find (1)
> **Env Vars:** scada (1)
> **Speakers:** - [instructor] (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/ethical-hacking-hacking-iot-devices-21053658/designing-a-secure-framework?u=76281980&t=0)** - [Instructor] The number of [IoT](../../Glossary/Concept/IoT.md) devices in our homes, offices and infrastructure continues to grow. In this segment, we'll discover the many resources, frameworks, and websites we can use to learn best practice methods to provide a more secure infrastructure. IoT and OT security are evolving fields, so staying updated with the latest developments is crucial. Today's networks and the [internet of things](../../Skills/Software%20Development/Internet%20of%20Things%20(IoT).md) pose unique challenges. The job of the security specialist is to stay ahead of common threats, by attending training, participating in security organizations, and checking security websites on a daily basis. I'd like to show you a sample of what's currently available. So that you have these references, I'll include all of the links in the challenge and links document found in the exercise folder. Let's start with the IoT Security Foundation, and I'll scroll down. This organization focuses on promoting security in IoT devices and infrastructure. Their website offers a wealth of information, including white papers, best practice guides, and security assessment tools. The Industrial Internet Consortium is a global organization dedicated to accelerating the growth of the industrial internet. And I'll drop this down so that you can see
>
> **[1:35](https://www.linkedin.com/learning/ethical-hacking-hacking-iot-devices-21053658/designing-a-secure-framework?u=76281980&t=95)** that they provide resources and publications that can help you secure operational technology systems. The Industrial Internet Security Framework is developed to address the security challenges associated with the industrial internet of things and industrial control systems. Now, there's a lot of information on the framework here. If you'd like to get a copy of the framework, we'll go to this page and select this link. And I opened it in a new tab. And as you can see, it's a very comprehensive document. The Center for Internet Security offers a set of controls that provide guidance on securing IoT and OT environments and are widely recognized in the [Cybersecurity](../../Topics/Cybersecurity.md) community. And here's where you can download the controls. [CISA.gov](https://CISA.gov) has a two page summary of cybersecurity best practices for industrial control systems and you can find that here at this link. [ISA.org](https://ISA.org) has a set of standards for industrial automation and control systems. And I'll scroll down so you can get a sample of all the resources that are available.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [IoT](../../Glossary/Concept/IoT.md) (5), [Cybersecurity](../../Topics/Cybersecurity.md) (3), [Internet of things](../../Skills/Software%20Development/Internet%20of%20Things%20(IoT).md) (2)
...
← [Ethical Hacking- Mobile Devices and Platforms](Ethical%20Hacking-%20Mobile%20Devices%20and%20Platforms.md) | **16 of 19** | [Ethical Hacking- Cryptography](Ethical%20Hacking-%20Cryptography.md) →
...
- [Cybersecurity Awareness- IoT Devices](../Cloud%20Computing/Cybersecurity%20Awareness-%20IoT%20Devices.md) — Internet of Things (IoT)
