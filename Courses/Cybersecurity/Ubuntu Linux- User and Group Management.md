...
>
> **[0:00](https://www.linkedin.com/learning/ubuntu-linux-user-and-group-management/welcome?u=76281980&t=0)** - [Scott] On a [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) system we make use of users and groups to manage access, and to secure information for humans and software alike. I'm Scott Simpson, and in this course I'll show you how to create and modify users and groups, and how to manage access to the superuser privileges. Then I'll show you how to manage resources for individual users, and I'll show you how to configure a folder so that a group of users can collaborate on files within it. After that, I'll introduce you to PAM, a modular authentication system that many Linux programs use. I'll give you an overview of how to connect a client machine to an LDAP server, and to a Kerberos key distribution center to allow central management of user information. As an aspiring system administrator having a good handle on [User Management](../../Skills/Web%20Development/User%20Management.md) is an important skill to have. Let's go.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) (2), [User Management](../../Skills/Web%20Development/User%20Management.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) (1), [Office](../../Skills/Web%20Development/Microsoft%20Office.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/ubuntu-linux-user-and-group-management/environment-setup?u=76281980&t=0)** - [Instructor] In this course, I'll be using an [Ubuntu](../../Skills/Web%20Development/Ubuntu.md) virtual machine in VirtualBox. If you already have a VM or a [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) machine ready to go, you should be able to use it without any trouble. The changes that we'll make in this course do require superuser access and we'll be adding and modifying users and groups. As always, be sure you're not learning on a production system where a configuration change could break something or cause a security problem. If you don't have a Linux machine handy or you don't have a VM already installed and ready to go, take some time to get that set up before you continue. We have many courses that cover the process in detail, so I won't go through the process here.
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [PHP](../../Skills/Software%20Development/PHP.md) (2), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1), [Databases](../../Skills/Software%20Development/Databases.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/ubuntu-linux-user-and-group-management/next-steps?u=76281980&t=0)** - [Scott] That's been a look at managing users and groups on [Ubuntu](../../Skills/Web%20Development/Ubuntu.md). I encourage you to continue practicing with creating users and groups in different configurations. And maybe try to anticipate some user concerns that might come in. I've forgotten my password. I can't save changes to the file, and so on. And if you're feeling extra adventurous, set up a few [Virtual Machines](../../Skills/Cloud%20Computing/Virtual%20Machines.md) and explore Kerberos and LDAP in a larger setting. With an understanding of user and group management, you're one step closer to being a well rounded system administrator. Keep learning and practicing. See you next time.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Ubuntu](../../Skills/Web%20Development/Ubuntu.md) (1), [Virtual Machines](../../Skills/Cloud%20Computing/Virtual%20Machines.md) (1)
> **Env Vars:** ldap (1)
> **Prerequisites:** set up (1)
> **Speakers:** - [scott] (1)
...
← [Ubuntu Linux- Storage Management](Ubuntu%20Linux-%20Storage%20Management.md) | **4 of 4**
