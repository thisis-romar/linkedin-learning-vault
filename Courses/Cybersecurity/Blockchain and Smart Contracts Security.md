...
prev_courses:
  - '[Foundations of Decentralized Finance (DeFi)](Foundations%20of%20Decentralized%20Finance%20(DeFi).md)'
...
>
> **[0:00](https://www.linkedin.com/learning/blockchain-and-smart-contracts-security/security-concerns-with-blockchain?u=76281980&t=0)** - Do you know what's the driving force and the technology behind cryptos, NFTs, Web 3.0 and the metaverse? It's [Blockchain](../../Skills/Data%20Science/Blockchain.md) While the adoption of blockchain has skyrocketed, so have the number of attacks compromising the security and trust in this ecosystem. [Smart Contracts](../../Skills/Data%20Science/Smart%20Contracts.md) and [decentralized applications](../../Skills/Data%20Science/Decentralized%20Applications%20(DApps).md) are paving the way to new business models and a revolutionary new autonomous incarnation of the internet. And security must be ingrained from day one. So what can you and your organization do to secure your share in the blockchain ecosystem? Well, if you are a security professional, trying to apply your knowledge and experience in security to this intriguing world of blockchain, or if you are a blockchain Smart contracts or decentralized app developer who wants to get a comprehensive view of security threats, weaknesses and mitigation practices, this course is for you. Hi, my name is Sam Seghal. I have over a decade of combined industry experience across leading software engineering projects, securing complex applications, and leading grassroots security transformation efforts. In this course, I will help you look at the blockchain Smart contracts and its ecosystem from the lens of security.
>
> **[1:34](https://www.linkedin.com/learning/blockchain-and-smart-contracts-security/security-concerns-with-blockchain?u=76281980&t=94)** Keeping inside its attack surface and potential attack vectors we will apply a four factor security model to cover security aspects of blockchain platform and its consensus protocols, Smart contracts programming, third party services, such as wallets, exchanges, and Oracles. And finally the end user. By the end of this course I hope that you will walk away with an understanding of security controls and practices you should apply to protect your blockchain ecosystem, whether you leverage it for cryptocurrencies, decentralized finance, non-fungible [Tokens](../../Skills/Web%20Development/Tokens.md), or your industry specific applications. So join me on my [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) learning course as we explore the intersection of blockchain and security.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Blockchain](../../Skills/Data%20Science/Blockchain.md) (9), [Smart Contracts](../../Skills/Data%20Science/Smart%20Contracts.md) (4), [Decentralized applications](../../Skills/Data%20Science/Decentralized%20Applications%20(DApps).md) (1), [Tokens](../../Skills/Web%20Development/Tokens.md) (1), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (1)
> **Versions:** 3.0 (1)
> **Analogies:** such as (1)
> **Speakers:** - do (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/blockchain-and-smart-contracts-security/what-you-should-know?u=76281980&t=0)** - [Instructor] This course includes an introduction to the foundations of the [Blockchain](../../Skills/Data%20Science/Blockchain.md) and [Smart Contracts](../../Skills/Data%20Science/Smart%20Contracts.md). But to get the best out of this course, you should have some information technology knowledge. Familiarity with crypto, blockchain, and smart contracts will help you get the most out of the concepts. Exposure to programming in any language will help you approach these [Secure Coding](../../Skills/Software%20Development/Secure%20Coding.md) practices that will apply to smart contracts. And finally, familiarity with the general knowledge of security concepts outside of blockchain is an excellent foundation for learning security controls specific to blockchain.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Blockchain](../../Skills/Data%20Science/Blockchain.md) (4), [Smart Contracts](../../Skills/Data%20Science/Smart%20Contracts.md) (3), [Secure Coding](../../Skills/Software%20Development/Secure%20Coding.md) (1)
> **Definitions:** is an  (1)
...
>
> **[4:48](https://www.linkedin.com/learning/blockchain-and-smart-contracts-security/what-is-blockchain?u=76281980&t=288)** blockchain protocols will ensure the blockchain network continues to remain functional and the data remains accessible at all times. Blockchain records are public, meaning anyone can see the record of transactions published on the blockchain ledger. That said, some blockchains can be set up as private but most widely adopted blockchains today, such as Bitcoin and [Ethereum](../../Skills/Data%20Science/Ethereum.md) are public. Obviously the public nature allows anyone to audit and spot any discrepancies but it can also be a [Privacy](../../Skills/Data%20Science/Privacy.md) concern. So we reviewed the unique features of blockchain but before we dig deeper into security aspects of the blockchain, let's digress and take a look at another use case for blockchain that is beyond cryptocurrencies but has profound implications if not secured.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Blockchain](../../Skills/Data%20Science/Blockchain.md) (27), [Cryptocurrency](../../Skills/Data%20Science/Cryptocurrency.md) (1), [Word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) (1), [Ethereum](../../Skills/Data%20Science/Ethereum.md) (1), [Privacy](../../Skills/Data%20Science/Privacy.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/blockchain-and-smart-contracts-security/smart-contracts-and-dapps?u=76281980&t=0)** - [Narrator] Enter [Smart Contracts](../../Skills/Data%20Science/Smart%20Contracts.md). Now don't be confused by the name. In simple words a smart contract is a computer program that is a collection of code and data that is stored and executed on the [Blockchain](../../Skills/Data%20Science/Blockchain.md). In contrast, a traditional program runs on a desktop or a virtual machine or in the cloud. But smart contracts since they are deployed on blockchain are by nature, distributed and transparent. Moreover, any user can interact with a smart contract and execute its function. This distinguishing feature of the smart contracts makes them vulnerable to attacks. Now, with regular applications, you can patch or redeploy app frequently and get rid of the coding issues. But once you have a buggy code deployed in blockchain it is extremely difficult to replace it. So what role do smart contracts play in the world of the blockchain? Well, think of smart contracts as important building blocks that other users can leverage. You average you as a user when want to create business applications that are decentralized in nature and deployed on blockchain are likely to rely on smart contracts. Smart contracts are developed in blockchain specific languages,
>
> **[1:34](https://www.linkedin.com/learning/blockchain-and-smart-contracts-security/smart-contracts-and-dapps?u=76281980&t=94)** such as [Solidity](../../Skills/Data%20Science/Solidity.md). [Decentralized applications](../../Skills/Data%20Science/Decentralized%20Applications%20(DApps).md) deployed on blockchain are a new breed of applications that take advantage of the properties of blockchain that we reviewed in the prior videos. Sometimes these are also referred to as Web 3.0 applications. Surprisingly, the most common examples of such apps are Bitcoin and [Ethereum](../../Skills/Data%20Science/Ethereum.md). And then, there are apps that allow users to trade digital ad via known fungible [Tokens](../../Skills/Web%20Development/Tokens.md) or NFTs. E-voting and identity management are specific use cases addressed by many upcoming decentralized apps. Decentralized apps are also heavily used in the world of finance today. Many industry specific applications are also emerging in the fields of legal supply chain and [internet of things](../../Skills/Software%20Development/Internet%20of%20Things%20(IoT).md).

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Blockchain](../../Skills/Data%20Science/Blockchain.md) (8), [Smart Contracts](../../Skills/Data%20Science/Smart%20Contracts.md) (7), [Solidity](../../Skills/Data%20Science/Solidity.md) (1), [Decentralized applications](../../Skills/Data%20Science/Decentralized%20Applications%20(DApps).md) (1), [Ethereum](../../Skills/Data%20Science/Ethereum.md) (1)
> **Definitions:** is a  (2)
> **Versions:** 3.0 (1)
> **Analogies:** such as (1)
> **Speakers:** - [narrator] (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/blockchain-and-smart-contracts-security/how-blockchain-works?u=76281980&t=0)** - [Instructor] You'll be able to appreciate the security properties and the weaknesses in [Blockchain](../../Skills/Data%20Science/Blockchain.md) if you know how blockchain actually works behind the scenes. So let's get to that first and see how a transaction is created, validated, and finally recorded on blockchain. You already know blockchain is a chain of blocks, but what is a block? A block is a collection of [Data Structures](../../Skills/Software%20Development/Data%20Structures.md) that includes a header and a list of transactions. Blockchain header contains multiple fields that are necessary for blockchain protocols to do their job. Some examples are timestamp, the hash of the previous block, Merkle root, and so on. We will cover the purpose of these fields in a minute. By the way, the very first block of a blockchain is known as the Genesis block. It does not contain a hash of the previous block since there is none. A block contains multiple transactions that are recorded in the blockchain. A transaction can represent any of the following: a transfer of [Cryptocurrency](../../Skills/Data%20Science/Cryptocurrency.md) value from one party to another. It can also be a smart contract program intended to perform an action that someone programmed it to be.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Blockchain](../../Skills/Data%20Science/Blockchain.md) (23), [Cryptocurrency](../../Skills/Data%20Science/Cryptocurrency.md) (2), [Data Structures](../../Skills/Software%20Development/Data%20Structures.md) (1)
> **CLI Commands:** node (9)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Blockchain](../../Skills/Data%20Science/Blockchain.md) (10), [Ethereum](../../Skills/Data%20Science/Ethereum.md) (2), [Algorithms](../../Skills/Software%20Development/Algorithms.md) (2), [Cryptography](../../Skills/Cybersecurity/Cryptography.md) (1), [Tokens](../../Skills/Web%20Development/Tokens.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/blockchain-and-smart-contracts-security/immutability?u=76281980&t=0)** - [Instructor] In [Blockchain](../../Skills/Data%20Science/Blockchain.md) terms, the immutability property means, once a block of transactions is added to the blockchain the data cannot be modified. Obviously one can continue to append new blocks but the previous blocks are immutable. This isn't quite a contrast to the enterprise database that is used in the financial and [rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) of the industries, where with the appropriate rights one can modify any table or attribute. Why does that matter from a security perspective? Maintaining [Data Integrity](../../Skills/Cybersecurity/Data%20Integrity.md) is one of the key elements of the CIA trial of security. CIA stands for confidentiality, integrity and availability. Data integrity goal requires that data must not be tampered with maliciously or by error and hence should remain trustable at all times. So how does blockchain achieve immutability? Well, if you recall from previous videos, every new block added to the blockchain contains a hash of the previous block. A hash in simple words is a mathematical function that takes an input data of variable length and returns an output of fixed length. Blockchain uses SHA-256 hashing algorithm, which means the hash is of 256 bit length
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Blockchain](../../Skills/Data%20Science/Blockchain.md) (7), [Data Integrity](../../Skills/Cybersecurity/Data%20Integrity.md) (2), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/blockchain-and-smart-contracts-security/cryptography-validation?u=76281980&t=0)** - [Instructor] We already talked about how the hashing is used for immutability in the previous video but let us clarify a few important interconnected but sometimes confused cryptographic concepts, such as hashing, Merkle root, digital signatures and encryption. Let's assume that you are the sender who is about to post a transaction on the [Blockchain](../../Skills/Data%20Science/Blockchain.md) network. When you want to give the confidence to the receiver that the transaction is not modified in the transit, include a hash of the data along with it. Upon receipt, the receiver will calculate the hash and compare it with your supplied value. An exact match confirms that data has not been altered on its way. Speaking of [Data Integrity](../../Skills/Cybersecurity/Data%20Integrity.md), the cornerstone of the blockchain is the capability to validate the transactions can still be trusted and their data integrity has not be violated. And as you saw in the previous videos, blockchain relies on the validator nodes for this. Let's revisit the blockchain block one more time. Each block has a header and list of transactions. And the header has a set of fields about the transaction. One special field called Merkle root is essential to the process of transaction verification. In the context of blockchain, the Merkle tree is a data structure
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Blockchain](../../Skills/Data%20Science/Blockchain.md) (6), [Data Integrity](../../Skills/Cybersecurity/Data%20Integrity.md) (2)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/blockchain-and-smart-contracts-security/overall-technology-architecture?u=76281980&t=0)** - [Instructor] To implement security controls for protecting your [Blockchain](../../Skills/Data%20Science/Blockchain.md) ecosystem, you first need to identify the attack surface. And that requires an understanding of the end-to-end architecture. That also requires knowledge of the role each building block plays from the underlying platform to [Smart Contracts](../../Skills/Data%20Science/Smart%20Contracts.md) to decentralized apps and finally, to the end users. To put things into perspective, when we looked at blockchain in the last few videos, we were only focused on just one but a critical piece of its ecosystem. But in order for blockchain to be valuable to real-life business applications beyond cryptocurrencies, a number of other players step in to create a rich ecosystem. Foundation of this ecosystem is the blockchain platform. The platform includes a distributed ledger that stores and processes transactions across blockchain networks. Consensus layer provides the transaction validation capability through the consensus protocols. Examples are proof of work, proof of stake, BFT or a combination of these. A number of different external services enable blockchain platform to be usable for end users and [decentralized applications](../../Skills/Data%20Science/Decentralized%20Applications%20(DApps).md). Host wallet services offer users the ability to store their private keys
>
> **[1:34](https://www.linkedin.com/learning/blockchain-and-smart-contracts-security/overall-technology-architecture?u=76281980&t=94)** and hence, their cryptocurrencies with a third-party provider. One example you may have heard of is Coinbase. Chances are if you hold crypto [Tokens](../../Skills/Web%20Development/Tokens.md), you're going to buy, sell, or exchange them in others. Obviously, you can directly contact an interested party and transfer the tokens to them or you can take the route of using an exchange. Exchange is exactly what the name says. It's a third-party service that allows users to trade their crypto tokens. Again, some of the known examples are Binance, Coinbase and Kraken, and so on. While blockchain ledgers act as source of truth for the transactions that are stored in it, it still needs access to the external data. For example, a smart contract may need access to live stock market data or wind speed data from [IoT](../../Glossary/Concept/IoT.md) sensors installed on the windmills. So blockchain needs a trustworthy source that can provide a data feed. Such third-party entities are known as oracles in the blockchain ecosystem. Timestamping service provides assurance that a certain data existed at the moment it was timestamped. For example, you can use this service to prove that you were in possession of an asset at the timestamped time. Smart contracts are the building blocks for creating decentralized apps or Dapps.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Blockchain](../../Skills/Data%20Science/Blockchain.md) (12), [Tokens](../../Skills/Web%20Development/Tokens.md) (3), [Smart Contracts](../../Skills/Data%20Science/Smart%20Contracts.md) (2), [Decentralized applications](../../Skills/Data%20Science/Decentralized%20Applications%20(DApps).md) (1), [IoT](../../Glossary/Concept/IoT.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/blockchain-and-smart-contracts-security/attack-surface-and-vectors?u=76281980&t=0)** - [Instructor] Keeping the [Blockchain](../../Skills/Data%20Science/Blockchain.md) ecosystem secure is going to be challenging, but before we can secure it we need to understand what can actually go wrong. To do so, we will look at the attack surface of the components of its ecosystem. The attack surface simply means the areas of a system that are vulnerable and can be exploited. The first, concentration of consensus power, meaning malicious minors and transaction validators can collude to manipulate the consensus protocols. Nodes on the blockchain network can become rogue, assume civil identities, and compromise the trust in the blockchain. These weaknesses can cause a ripple effect and lead to 51% attacks and double spending attacks. Vulnerability in the blockchain platform can also lead to an attack on the promise of [Privacy](../../Skills/Data%20Science/Privacy.md) that blockchain is founded upon. [Smart Contracts](../../Skills/Data%20Science/Smart%20Contracts.md) are also vulnerable to attacks such as reentrancy attack, front running attack, and denial of service attacks. Ecosystem enabler services such as wallets exchanges can also be compromised due to [Phishing](../../Skills/Software%20Development/Phishing.md) attacks, denial of service attacks, other insider threats, and conflict of interests. The end user and client running on these devices is also prone to well known attacks
>
> **[1:34](https://www.linkedin.com/learning/blockchain-and-smart-contracts-security/attack-surface-and-vectors?u=76281980&t=94)** such as malware infections, threat of private keys, and a host of attacks that are possible due to application level vulnerabilities also defined by [OWASP](../../Skills/Cybersecurity/OWASP.md) Top 10.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Blockchain](../../Skills/Data%20Science/Blockchain.md) (5), [Privacy](../../Skills/Data%20Science/Privacy.md) (1), [Smart Contracts](../../Skills/Data%20Science/Smart%20Contracts.md) (1), [Phishing](../../Skills/Software%20Development/Phishing.md) (1), [OWASP](../../Skills/Cybersecurity/OWASP.md) (1)
> **Analogies:** such as (3)
> **Env Vars:** owasp (1)
> **Speakers:** - [instructor] (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/blockchain-and-smart-contracts-security/security-model?u=76281980&t=0)** - [Narrator] So now we know that the [Blockchain](../../Skills/Data%20Science/Blockchain.md) ecosystem has an enormous attack surface and can be breached due to a variety of threats. Such threats can emerge from traditional and well-known attack vectors, or due to a new breed of attacks, unique to blockchain. We can now appreciate the complexity of efforts that will be required to keep it all protected. Therefore, we need a structured approach to security. We are going to apply a four factor security model. Each factor comprises of a set of security controls that works to protect this ecosystem. Let's take a quick look at them. The [rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) of the course will be a deep dive into each of these factors. The first factor is all about securing the foundations of the blockchain. That includes its transactions, distributed ledger and consensus protocol. The next factor focuses on security of [Smart Contracts](../../Skills/Data%20Science/Smart%20Contracts.md). This factor includes secure design principles, [Secure Coding](../../Skills/Software%20Development/Secure%20Coding.md) practices, especially targeted for smart contracts. And finally, the testing strategies to discover bugs before deploying a contract. The next factor focuses on securing the crucial ecosystem players, such as wallet, providers, exchanges, and Oracles. And the last factor is all about the end user and security controls to protect the interactions of the users with the blockchain ecosystem.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Blockchain](../../Skills/Data%20Science/Blockchain.md) (4), [Smart Contracts](../../Skills/Data%20Science/Smart%20Contracts.md) (2), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1), [Secure Coding](../../Skills/Software%20Development/Secure%20Coding.md) (1)
> **Analogies:** such as (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Blockchain](../../Skills/Data%20Science/Blockchain.md) (26), [Probability](../../Skills/Data%20Science/Probability.md) (1), [Ethereum](../../Skills/Data%20Science/Ethereum.md) (1)
...
>
> **[3:11](https://www.linkedin.com/learning/blockchain-and-smart-contracts-security/proof-of-stake-protocol-attacks?u=76281980&t=191)** Penalize miners who are found mining on multiple chains. Have the validator deposit crypto [Tokens](../../Skills/Web%20Development/Tokens.md). Tokens from the deposit will be withdrawn if multiple blocks are being generated by the same validator. When applicable, require the validators to submit their identity information without disclosing their true identity in the public.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Tokens](../../Skills/Web%20Development/Tokens.md) (2), [Blockchain](../../Skills/Data%20Science/Blockchain.md) (1)
> **Warnings:** be aware (1)
> **Speakers:** - [instructor] (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/blockchain-and-smart-contracts-security/smart-contracts-and-evm?u=76281980&t=0)** - [Instructor] While [Blockchain](../../Skills/Data%20Science/Blockchain.md) platform security vulnerabilities affect the underlying core of the ecosystem, a poorly written smart contract can still lead to a security breach, regardless of how secure the platform is. In fact, every day, new [decentralized applications](../../Skills/Data%20Science/Decentralized%20Applications%20(DApps).md) and [Smart Contracts](../../Skills/Data%20Science/Smart%20Contracts.md) are written and many of them without going through proper secure [Software Development](../../Topics/Software%20Development.md) practices. Now, the security risks associated with a traditional centralized application can still manifest in a modern Web 3.0 application but a new breed of security bugs can impact your smart contracts, making them even harder to secure. Let's take a look at the architecture of a Web 3.0 application and review its similarity and differences from Web 2.0 application. Given the popularity and suitability of [Ethereum](../../Skills/Data%20Science/Ethereum.md) for smart contracts, I will use Ethereum as the platform for explaining these concepts. A typical application today follows architecture like this. A front-end module that enables interaction with the user via a web or a mobile interface. Common languages and frameworks used for this are [HTML](../../Skills/Web%20Development/HTML.md), CSS, [JavaScript](../../Skills/Software%20Development/JavaScript.md) with [Angular](../../Skills/Web%20Development/Angular.md) or [React](../../Skills/Web%20Development/React.js.md). The backend server-side logic handles the requests and responses from front-end client. The backend also contains the business logic
>
> **[1:35](https://www.linkedin.com/learning/blockchain-and-smart-contracts-security/smart-contracts-and-evm?u=76281980&t=95)** for the application. Examples of the languages and frameworks used here are [Node.js](../../Skills/Web%20Development/Node.js.md), [Java](../../Skills/Software%20Development/Java.md), C# and [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md). It also interacts with a relational or a [NoSQL](../../Skills/Software%20Development/NoSQL.md) database where the data about the transactions is stored. Now, compare that to the architecture of a decentralized application. There is still a need for a front end that could very well use the same languages and frameworks as in Web 2.0. Now, you may recall that smart contracts are the building blocks for decentralized apps. A smart contract is a software program that contains backend logic. The most common language used for developing smart contracts is [Solidity](../../Skills/Data%20Science/Solidity.md). Front-end code interacts with the smart contract. And Ethereum virtual machine runs the compiled smart contract program, and both smart contracts and EVM are deployed on the distributed blockchain nodes. But wait, what is Ethereum virtual machine or EVM? If you recall, we have been using the term distributed ledger to describe blockchain. This model has worked well to explain [Cryptocurrency](../../Skills/Data%20Science/Cryptocurrency.md) operations, such as sending or receiving Bitcoins. While Ethereum also fully supports cryptographic primitives, it also has much richer support for smart contracts. So to explain its inner working,
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Ethereum](../../Skills/Data%20Science/Ethereum.md) (10), [Smart Contracts](../../Skills/Data%20Science/Smart%20Contracts.md) (7), [Blockchain](../../Skills/Data%20Science/Blockchain.md) (5), [Solidity](../../Skills/Data%20Science/Solidity.md) (2), [Decentralized applications](../../Skills/Data%20Science/Decentralized%20Applications%20(DApps).md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Remix](../../Glossary/Framework/Remix.md) (2), [Blockchain](../../Skills/Data%20Science/Blockchain.md) (1)
> **Env Vars:** ide (2)
> **Speakers:** - [instructor] (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Blockchain](../../Skills/Data%20Science/Blockchain.md) (3), [Smart Contracts](../../Skills/Data%20Science/Smart%20Contracts.md) (2), [Solidity](../../Skills/Data%20Science/Solidity.md) (2), [Ethereum](../../Skills/Data%20Science/Ethereum.md) (2)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/blockchain-and-smart-contracts-security/blockchain-ecosystem-threats-part-one?u=76281980&t=0)** - [Instructor] For [Smart Contracts](../../Skills/Data%20Science/Smart%20Contracts.md) and [decentralized applications](../../Skills/Data%20Science/Decentralized%20Applications%20(DApps).md) to be useful in the real world, they rely on many enabler services. You already know that [Blockchain](../../Skills/Data%20Science/Blockchain.md) platform security vulnerabilities affect the underlying core of the ecosystem. A poorly written smart contract can also lead to a security breach. Similarly, these enabler services that make up the blockchain ecosystem are also prone to security attacks. This ecosystem is complex and contains many moving parts. We will cover hosted wallets, exchanges, and oracles, which are the most critical systems of all. Regardless of the nature of the crypto [Tokens](../../Skills/Web%20Development/Tokens.md), be it native cryptocurrencies or special purpose asset ownership tokens, they all need to be secured. Wallets serve an important purpose here. They act as the custodian of the tokens and provide a unified user-friendly interface to the blockchain. Wallets fall into two categories: hosted and non-hosted wallets. You may also notice them being referred to with different names, such as custodial and non-custodial wallets. Regardless of the names, basically, the wallets where users are in full control and are responsible for their tokens are known as non-custodial or non-hosted wallets.
>
> **[1:33](https://www.linkedin.com/learning/blockchain-and-smart-contracts-security/blockchain-ecosystem-threats-part-one?u=76281980&t=93)** In the case of custodial or hosted wallets, users rely on a third-party provider for storage and management of their private keys. Recall that private keys are what associates a user's ownership rights with their crypto tokens. By the way, some hosted wallets also allow users to store their private keys in their browsers. In this case, the keys are not in the custody of the wallet provider. First of all, hosted wallets are regular applications with web and mobile entry points accessible to users. That means these applications are vulnerable to classic well-known security attacks. These are documented under [OWASP](../../Skills/Cybersecurity/OWASP.md) Top 10. To mitigate these attacks, the wallet provider must follow secure development life cycle processes. The approach and tooling to handle such attacks are well documented. These hosted wallet providers are also the single point of failure, meaning they are also vulnerable to attacks such as denial of service, [Phishing](../../Skills/Software%20Development/Phishing.md) attacks, which can further lead to more sophisticated and targeted attacks. All of these attacks are well understood by the security community and should be addressed with appropriate security controls, including network firewalls, DDoS protection, access management, and employee training.
>
> **[3:07](https://www.linkedin.com/learning/blockchain-and-smart-contracts-security/blockchain-ecosystem-threats-part-one?u=76281980&t=187)** To learn more about these security controls, check out this learning path on [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) Learning. Regardless of whether it is a hosted or non-hosted wallet setting, if the keys are stored and managed by a user, they are subject to additional attacks. Keys stored locally are prone to malicious attacks using keyloggers and other malwares. These attacks can either lead to theft of the private key or malicious intrusion during the signing of a blockchain transaction. You can mitigate this attack with a [Hardware](../../Topics/Hardware.md) wallet supplement with additional control such as [Multi-factor Authentication](../../Skills/Software%20Development/Multi-factor%20Authentication.md). Typically, an end user's computer runs software for managing keys. This software may have its own security weaknesses. It performs cryptographic operations such as encrypting and signing transactions, but the software may be built with security bugs. For example, poor [Data Management](../../Skills/Software%20Development/Data%20Management.md), secret stored in plain text, or unprotected memory access. Use known and blockchain community recommended libraries for cryptographic operations such as encryption and decryption.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Blockchain](../../Skills/Data%20Science/Blockchain.md) (5), [Tokens](../../Skills/Web%20Development/Tokens.md) (5), [Smart Contracts](../../Skills/Data%20Science/Smart%20Contracts.md) (1), [Decentralized applications](../../Skills/Data%20Science/Decentralized%20Applications%20(DApps).md) (1), [OWASP](../../Skills/Cybersecurity/OWASP.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/blockchain-and-smart-contracts-security/blockchain-ecosystem-threats-part-two?u=76281980&t=0)** - [Instructor] [Cryptocurrency](../../Skills/Data%20Science/Cryptocurrency.md) owners usually want to buy, sell or exchange their currencies. Obviously, they can do so directly with others, but it limits their ability to locate potentially interested parties. Third-party exchanges solve this problem by offering the ability to swap crypto [Tokens](../../Skills/Web%20Development/Tokens.md). There are two types of exchanges, centralized and decentralized. In the case of centralized exchanges, a third-party intermediary facilitates, monitors and secures the transactions. Users of the centralized exchanges are subject to "Know Your Customer" or KYC requirements. That means they're also required to share their identification information. Centralized exchanges also offer advantages, such as funds liquidity, stability and [Customer Support](../../Skills/IT%20Help%20Desk/Customer%20Support.md). Examples are Binance and Coinbase. Decentralized exchanges on the other hand have no third-party intermediary involved. Instead, the exchange protocol facilitates the transaction. End users continue to maintain control of their funds while relying on the [Blockchain](../../Skills/Data%20Science/Blockchain.md) for clearing the funds. The exchange protocol uses [Smart Contracts](../../Skills/Data%20Science/Smart%20Contracts.md) to execute the transaction. One of the rapidly-growing protocols that operate on [Ethereum](../../Skills/Data%20Science/Ethereum.md) is Uniswap. There is no requirement for KYC, but liquidity is low
>
> **[1:36](https://www.linkedin.com/learning/blockchain-and-smart-contracts-security/blockchain-ecosystem-threats-part-two?u=76281980&t=96)** and orders take a long time to fill. Even today, most of the order fulfillment takes place through centralized exchanges. The interest and adoption of a decentralized exchange are rapidly growing. Both of these types of exchanges are vulnerable to attacks but considering the attacks in recent years, centralized exchanges have been attacked more often as they have been more active. Centralized exchanges are similar to a hosted wallet in terms of their threat vectors. In fact, many times the same commercial company offers both of these capabilities. They are also susceptible to [OWASP](../../Skills/Cybersecurity/OWASP.md) Top 10 application-level attacks, denial of service attacks and so on. So you should implement the same security controls as described earlier in the wallet section of this video. Since decentralized exchanges are based on exchange protocols, which in turn are built on the blockchain smart contracts, they are prone to the same attacks that normal blockchain transactions are. For example, in April, 2020, attackers managed to steal $25 million worth of currency from Uniswap and Lendf.Me by leveraging the reentrancy attack. The reason this attack was possible was due to the same security bug in the Uniswap code that we reviewed earlier. Some other attacks are also possible.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Blockchain](../../Skills/Data%20Science/Blockchain.md) (3), [Smart Contracts](../../Skills/Data%20Science/Smart%20Contracts.md) (3), [Cryptocurrency](../../Skills/Data%20Science/Cryptocurrency.md) (1), [Tokens](../../Skills/Web%20Development/Tokens.md) (1), [Customer Support](../../Skills/IT%20Help%20Desk/Customer%20Support.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/blockchain-and-smart-contracts-security/blockchain-ecosystem-threats-part-three?u=76281980&t=0)** - [Instructor] [Blockchain](../../Skills/Data%20Science/Blockchain.md) networks are isolated networks, so are the smart contract and decentralized apps that are built on them. These apps need to rely on data from external [word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) and legacy Web 2.0 applications to be of meaningful use. Oracles are the off chain middleware that enables these apps to interface with [rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) of the world. Oracles handle the communication between blockchain and external data providers, business applications, [IoT](../../Glossary/Concept/IoT.md) sensors, financial markets, you name it. Note that Oracles are not embedded into the blockchain network but are rather run as their own independent Oracle networks. Oracles are important and should they be compromised, they can undermine the trustworthiness of the data they're providing. This will further lead to a ripple effect on trust in [Smart Contracts](../../Skills/Data%20Science/Smart%20Contracts.md) and decentralized apps. So, Oracles do carry the same burden of providing trust and security as rest of the blockchain networks. Just as we have previously seen in other ecosystem players, Oracles to can be centralized and decentralized. Centralized Oracles pose what's known as the Oracle problem in the industry, while blockchain is built on the principle of [Decentralization](../../Skills/Data%20Science/Decentralization.md), reliance on a central Oracle as a trusted source, brings us back to a centralized model with single point of failure.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Blockchain](../../Skills/Data%20Science/Blockchain.md) (6), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (2), [Smart Contracts](../../Skills/Data%20Science/Smart%20Contracts.md) (2), [Word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) (1), [IoT](../../Glossary/Concept/IoT.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/blockchain-and-smart-contracts-security/wallet-and-keys-security?u=76281980&t=0)** - While [Blockchain](../../Skills/Data%20Science/Blockchain.md) platforms, [Smart Contracts](../../Skills/Data%20Science/Smart%20Contracts.md), and enabler services are necessary to maintain trust in the ecosystem, that trust does not automatically flow to the end user. In fact, in a decentralized world, where there are no governance and protection laws, the burden of responsibility on the shoulders of an end user is much higher than in our traditional world. But the irony is, that given this field is so new, the expertise and knowledge of a common person does not equate to the interest that end user has. So let's review some of the necessary prevention and best practices to protect your [Cryptocurrency](../../Skills/Data%20Science/Cryptocurrency.md) and your end of the decentralized application. Malwares, trojan horses, either directly compromise your computing device or make it easy for attackers to take control of the device. So install antivirus, and keep your device updated with operating system updates, especially these security patches. Similarly, any keylogger installed on your device can read anything you type, including passwords and keys. Do not install any software that you do not trust. Hosted wallets make it easy to store your keys, but any interaction with an online wallet provider creates a new attack surface. You can always opt for cold wallets,
>
> **[1:34](https://www.linkedin.com/learning/blockchain-and-smart-contracts-security/wallet-and-keys-security?u=76281980&t=94)** such as a dedicated [Hardware](../../Topics/Hardware.md) device, or even print them on a paper wallet. Now that doesn't mean that just because they are cold, they are automatically safe. You would still need to safeguard them as if you would guard any physical assets of high value. Diversify your cryptocurrency portfolio with multiple wallets. Obviously do not share your private keys with anyone.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Cryptocurrency](../../Skills/Data%20Science/Cryptocurrency.md) (2), [Blockchain](../../Skills/Data%20Science/Blockchain.md) (1), [Smart Contracts](../../Skills/Data%20Science/Smart%20Contracts.md) (1), [Hardware](../../Topics/Hardware.md) (1)
> **CLI Commands:** make (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Phishing](../../Skills/Software%20Development/Phishing.md) (1), [Tokens](../../Skills/Web%20Development/Tokens.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/blockchain-and-smart-contracts-security/next-steps?u=76281980&t=0)** - [Instructor] The world of [Blockchain](../../Skills/Data%20Science/Blockchain.md) and [decentralized applications](../../Skills/Data%20Science/Decentralized%20Applications%20(DApps).md) is evolving rapidly. In this course, we only scratched the surface of security controls you can use to protect this ecosystem. But that shouldn't stop you from taking advantage of blockchain in your organization today. Many organizations are already seeing the benefits of blockchain in their respective industries. So I urge you to start today and take action. Make security a priority for your blockchain projects and decentralized applications. Feel free to reach out and connect with me on [LinkedIn](../../Skills/Web%20Development/LinkedIn.md). I look forward to hearing how your journey in the security of the blockchain is progressing. Thank you for watching.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Blockchain](../../Skills/Data%20Science/Blockchain.md) (5), [Decentralized applications](../../Skills/Data%20Science/Decentralized%20Applications%20(DApps).md) (2), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (1)
> **CLI Commands:** make (1)
> **Speakers:** - [instructor] (1)
...
← [Foundations of Decentralized Finance (DeFi)](Foundations%20of%20Decentralized%20Finance%20(DeFi).md) | **5 of 5**
...
- [Building an Ethereum Blockchain App- 8 Supply Chain Smart Contract dApp](../Data%20Science/Building%20an%20Ethereum%20Blockchain%20App-%208%20Supply%20Chain%20Smart%20Contract%20dApp.md) — Smart Contracts
- [Building an Ethereum Blockchain App- 7 Smart Contracts](../Data%20Science/Building%20an%20Ethereum%20Blockchain%20App-%207%20Smart%20Contracts.md) — Smart Contracts
- [Ethical Hacking- Cryptography](Ethical%20Hacking-%20Cryptography.md) — Cryptography
