...
> [!transcript]- Transcript
>
> **[0:01](https://www.linkedin.com/learning/8-things-you-must-know-in-python/next-steps?u=76281980&t=1)** - [Instructor] Well I hope you found this course helpful. Now I work primarily on machine learning and AI projects, and almost exclusively in [[Python (Programming Language)|Python]], so if you like this course, you might like some of my other courses online, including Python courses like decorators, the [[Pandas (Software)|Pandas]] library and Apache [[PySpark]], or other ones with more of an AI and machine learning-focus like [[Deep Learning]] in [[PyTorch]], [[Computer Vision]] in OpenCV, Docker, and how to introduce AI into your organization. I'd love to hear back from you and to connect via [[LinkedIn]]. Thanks again for watching and (speaking foreign language).
