...
prev_courses:
  - '[Java Advanced Concepts For High Performance Development](Java%20Advanced%20Concepts%20For%20High%20Performance%20Development.md)'
next_courses:
...
>
> **[0:00](https://www.linkedin.com/learning/introduction-to-docker-for-java-developers/zero-to-zero-to-hero?u=76281980&t=0)** - [Mary Ellen Bowman] Hey, [Java](../../Skills/Software%20Development/Java.md) developer. Do you want to go from zero to a hero in Docker? Then choose a different course. In this course, you'll become a Java hero by going from zero to zero with Docker. How is this possible, and why care about Docker containerization during Java development? Well, consider an online food order. We expect our order to arrive intact at the proper temperature. This is accomplished through careful packaging and timely delivery. The goal of software containerization is the same. Applications are packaged with the required infrastructure at the build phase, making deliveries reliable. Hi, I'm Mary Ellen Bowman. I'm a senior software developer. And in this course, we'll start from zero by reverse engineering a Dockerized Java web app, invoke the Docker [CLI](../../Skills/Network%20and%20System%20Administration/CLI.md), learn Docker file commands and containerization best practices. Then employ modern tools requiring zero Docker files, making you a hero in your Java development team. Let's go from zero to zero to hero in this Introduction to Docker for Java Developers.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Java](../../Skills/Software%20Development/Java.md) (6), [CLI](../../Skills/Network%20and%20System%20Administration/CLI.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/introduction-to-docker-for-java-developers/what-you-should-know?u=76281980&t=0)** - [Mary] To interact with the exercises in this course, I expect you to have [Java](../../Skills/Software%20Development/Java.md) 11 installed. Although, the examples are not very complex, so Java 8 should be fine. Apache Maven for automated builds and IDE for debugging. I use IntelliJ, but you do you. And that you will be able to install Docker for desktop. We'll walk through that later. I expect you to have a basic understanding of Java and how to build with Maven. This course is an introduction to Docker for developers. Your time is valuable, so I don't drag you through every detail. I expect that you, as a developer, will be able to flesh out any extras as needed. Many examples in this course are [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) microservice web applications. If this is new to you, I suggest you watch my course, Creating Your First Spring Boot Microservice, in the [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) library.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Java](../../Skills/Software%20Development/Java.md) (3), [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) (2), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Java](../../Skills/Software%20Development/Java.md) (7), [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) (4), [JSON](../../Skills/Web%20Development/JSON.md) (2), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1), [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Java](../../Skills/Software%20Development/Java.md) (4), [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Java](../../Skills/Software%20Development/Java.md) (6), [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) (2)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/introduction-to-docker-for-java-developers/challenge-modify-dockerfile-to-remove-forever-java?u=76281980&t=0)** - [Instructor] It's your turn. It's time for a challenge. So from this exercise file, this Dockerfile.build. It's now time to see if you can remove the [Java](../../Skills/Software%20Development/Java.md) file forever.java from this Docker image after it has been built. So you want to modify this, remove the forever.java file but make sure that it still builds and runs and then prove once it is running, that you can actually see that that file is not in the slash app folder. And you would use the Docker exec command to prove that. Give it a try.
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (2), [Git](../../Skills/Software%20Development/Git.md) (1), [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) (1), [Java](../../Skills/Software%20Development/Java.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) (6), [Java](../../Skills/Software%20Development/Java.md) (3)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) (3), [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/introduction-to-docker-for-java-developers/ditching-the-dockerfile?u=76281980&t=0)** - [Instructor] We've gone through some great learning about the best way to containerize your apps with Dockerfiles. And the great news is we really don't need to use Dockerfiles to containerize our [Java](../../Skills/Software%20Development/Java.md) apps anymore and I could not be more happy about that. Various organizations realize that, while powerful, Dockerfiles can be difficult to maintain and don't enforce best practices. The alternatives are opinionated, employ efficient image layering, are lightweight, overrideable by configuration, and best of all, get you back to where you really want to be, coding in Java. There are many alternative solutions to Dockerfiles. In this course, we will talk about three, Cloud Native Buildpack Pack [CLI](../../Skills/Network%20and%20System%20Administration/CLI.md), [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) Docker Build plugin and the Jib Build plugin.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Java](../../Skills/Software%20Development/Java.md) (2), [CLI](../../Skills/Network%20and%20System%20Administration/CLI.md) (1), [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Java](../../Skills/Software%20Development/Java.md) (2), [Google](../../Glossary/Service/Google.md) (1), [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) (11)
> **CLI Commands:** docker (4)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/introduction-to-docker-for-java-developers/the-google-jib-plugin?u=76281980&t=0)** - [Instructor] The last alternative we will look at is Jib by [Google](../../Glossary/Service/Google.md). Jib is a Maven/[Gradle](../../Glossary/Tool/Gradle.md) plugin where you build the [Java](../../Skills/Software%20Development/Java.md) app on your host machine then Jib creates an image with dependencies in separate layers. An added bonus is that the image can be automatically pushed to a server registry, so there's no need to have Docker Engine installed. It's also lighter and faster than [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) plugin or Pack. So I've opened IntelliJ, and here is the Jib plugin. And within this configuration tag, there's a lot of settings you can do, but I've actually set in here the image name. And because I want it to be pushed to my Docker Hub registry, I put the full path in there with the registry/, my mellenbowman is my name space, and then the actual name of the image is webapp, and then :jib is the tag. So within Maven, I'll say ./mvnw package. I want to skip the unit tests. And then the jib plugin :build. So it's trying push it, and it did not work. It was unauthorized, and that's because I haven't added credentials. So there's a couple options here. One, is within the configuration, I can actually put credentials in here or site environment variables with credentials. Another way is I do have the Docker Engine installed,
>
> **[1:34](https://www.linkedin.com/learning/introduction-to-docker-for-java-developers/the-google-jib-plugin?u=76281980&t=94)** and I could do docker login [CLI](../../Skills/Network%20and%20System%20Administration/CLI.md) locally.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) (2), [Google](../../Glossary/Service/Google.md) (1), [Gradle](../../Glossary/Tool/Gradle.md) (1), [Java](../../Skills/Software%20Development/Java.md) (1), [CLI](../../Skills/Network%20and%20System%20Administration/CLI.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/introduction-to-docker-for-java-developers/next-steps?u=76281980&t=0)** - [Mary Ellen] So after this introduction to Docker, what's next? I would say most [Java](../../Skills/Software%20Development/Java.md) development projects can be containerized just fine using the Jib or the [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) plugins. With your current understanding of Docker, you should have no trouble configuring either of them for your solutions. And once containerized, orchestration is necessary. The [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) Library is a trove of information covering [Kubernetes](../../Skills/DevOps/Kubernetes.md), cloud container platforms, such as Amazon EKS, [Google Cloud](../../Skills/Software%20Development/Google%20Cloud%20Platform%20(GCP).md) Run, or [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) Container Instances. There's also content on Docker native tools like Swarm and [Compose](../../Glossary/Framework/Jetpack%20Compose.md). If you enjoy this course, you can find all my LinkedIn Learning courses on my website MaryEllenTeaches.me and my [GitHub](../../Skills/Software%20Development/GitHub.md) organization is MaryEllenTeaches. I love learner feedback. Let me know what you think here or via LinkedIn or Twitter. Thanks for watching. I hope this course was time well spent and it contributes to your future success.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (3), [Java](../../Skills/Software%20Development/Java.md) (1), [Spring Boot](../../Skills/Software%20Development/Spring%20Boot.md) (1), [Kubernetes](../../Skills/DevOps/Kubernetes.md) (1), [Google cloud](../../Skills/Software%20Development/Google%20Cloud%20Platform%20(GCP).md) (1)
...
← [Java Advanced Concepts For High Performance Development](Java%20Advanced%20Concepts%20For%20High%20Performance%20Development.md) | **2 of 4** | [Data Science for Java Developers](Data%20Science%20for%20Java%20Developers.md) →
