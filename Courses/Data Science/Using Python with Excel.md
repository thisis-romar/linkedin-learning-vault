...
prev_courses:
  - '[Excel- Working Together with Power Query and Power Pivot](Excel-%20Working%20Together%20with%20Power%20Query%20and%20Power%20Pivot.md)'
next_courses:
...
>
> **[0:00](https://www.linkedin.com/learning/using-python-with-excel-22676328/managing-excel-with-python?u=76281980&t=0)** Despite the rise of so many [business intelligence](../../Skills/Data%20Science/Business%20Intelligence%20(BI).md) and [Data Science](../../Topics/Data%20Science.md) tools, much of the business world's reporting still lives in [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md). That won't be changing any time soon. So if you can't beat them, join them. Use [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) to create even the most complex workbooks without even opening Excel. Hi, my name is George Mount. I'm the founder of Stringfest Analytics where I specialize in teaching Python, Excel, and more to professionals like you. I'm a [Microsoft Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) MVP and the author of Advancing Into Analytics from Excel to Python and R. In this course, I'll go over tools for integrating Excel with Python, in particular [Pandas](../../Skills/Software%20Development/Pandas%20(Software).md), a [Data Manipulation](../../Skills/Data%20Science/Data%20Manipulation.md) powerhouse, and openpyxl, which lets you both read and write Excel files and Python with flair. I'm excited to get you moving on your Python and Excel journey. If you love the idea of automating anything in Excel using Python, you won't want to miss this. Let's get started.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (8), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (7), [Business intelligence](../../Skills/Data%20Science/Business%20Intelligence%20(BI).md) (1), [Data Science](../../Topics/Data%20Science.md) (1), [Microsoft Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Pandas](../../Skills/Software%20Development/Pandas%20(Software).md) (9), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (4), [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (2), [Statistics](../../Skills/Data%20Science/Statistics.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (9), [Pandas](../../Skills/Software%20Development/Pandas%20(Software).md) (5), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (2)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/using-python-with-excel-22676328/manipulating-data-with-pandas?u=76281980&t=0)** As you manage DataFrames of growing complexity, you'll need additional methods to organize, compare, and sort your data. In this lesson, you will learn some basic row and column operations using [pandas](../../Skills/Software%20Development/Pandas%20(Software).md). Open the demo file for this lesson, 01_05_demo. This demo will be using the tips sample data set from Seaborn. Now think of all the tasks you perform to analyze data in [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md). You might add or remove columns or maybe sort and filter the results, or probably both and then some more. Pandas makes these types of operations a breeze. For example, this dataset shows the tip and total bill for each transaction. But what about the tip percentage? To create this new column, type tips and then in square brackets and quotes, tip_pct. This is the notation to refer to an individual column in pandas. Then, = tips['tip'] divided by tips['total_bill'].
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Pandas](../../Skills/Software%20Development/Pandas%20(Software).md) (6), [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (3)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/using-python-with-excel-22676328/working-with-dates-and-times-in-pandas?u=76281980&t=0)** The name [pandas](../../Skills/Software%20Development/Pandas%20(Software).md) isn't just for cute animals. This library is named after working with panel data or a type of time series data. After this lesson, you'll be able to work with dates and times using pandas. Open the demo file for this lesson, 01_06_demo. This demonstration will use the seattle weather sample data set from the vega data sets package imported as seattle. If you do not have vega data sets installed, remove the hash sign and run the first cell. You'll see that this data consists of daily weather measurements, making it time series data. If you've ever worked with dates in [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md), you've probably gotten pretty frustrated. I'm happy to tell you that pandas is much better with dates and times. To give you an example, I'm going to create a date object and set it to pd.to_datetime('8th sep, 2019 11:15 AM').
>
...
>
> **[4:36](https://www.linkedin.com/learning/using-python-with-excel-22676328/working-with-dates-and-times-in-pandas?u=76281980&t=276)** for all the different time periods to resample by. Excel isn't the best at working with dates, so when you're considering what to automate with [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md), keep the datetime features of pandas in mind.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Pandas](../../Skills/Software%20Development/Pandas%20(Software).md) (6), [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (2), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (8), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (4), [Pandas](../../Skills/Software%20Development/Pandas%20(Software).md) (3)
...
>
> **[3:40](https://www.linkedin.com/learning/using-python-with-excel-22676328/working-with-large-worksheets?u=76281980&t=220)** it's time to send it out to [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) using the dataframe_to_rows function. This data should start at row 8 in the template, so I'm going to adjust for that in the for loop.
>
...
>
> **[4:10](https://www.linkedin.com/learning/using-python-with-excel-22676328/working-with-large-worksheets?u=76281980&t=250)** I'm ready to take a look. And there it is, the start of a nicely formatted Excel report. One question I get a lot from Excel users is how big of a data set can I work with in [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md)? There's really no one answer here. It all depends on how much memory your computer can afford. But by using practices covered in this video, such as using typecasting and filtering out unnecessary rows, you can easily work with hundreds of thousands of rows or more, consolidate your results, and send them over to Excel without ever opening a workbook.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Pandas](../../Skills/Software%20Development/Pandas%20(Software).md) (8), [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (4), [Big Data](../../Skills/Data%20Science/Big%20Data.md) (1), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (4), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (7), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (8), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (5)
...
- [George Mount](../../Instructors/Artificial%20Intelligence%20(AI)/George%20Mount.md)
...
← [Excel- Working Together with Power Query and Power Pivot](Excel-%20Working%20Together%20with%20Power%20Query%20and%20Power%20Pivot.md) | **4 of 7** | [From Excel to SQL](From%20Excel%20to%20SQL.md) →
