...
prev_courses:
  - '[Excel Vba Managing Files And Data](Excel%20Vba%20Managing%20Files%20And%20Data.md)'
next_courses:
...
>
> **[0:00](https://www.linkedin.com/learning/excel-vba-process-modeling-25158426/analyze-your-business-processes-using-excel-vba?u=76281980&t=0)** - [Narrator] [Microsoft Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) is a powerful and versatile tool for analyzing business processes. Mastering the skills you need to model and simulate your operations will let you work quickly and support great decision making. In this course, I'll use real world examples to demonstrate how you can apply the incredible power of [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) and Excel VBA to business process analysis. Whether you are running a neighborhood sandwich shop, or a large production line. I'm Curt Frye. Join me at [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) Learning for an introduction to the essential skills for analyzing business processes using Microsoft Excel VBA.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Microsoft Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (2), [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (2), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (1)
> **Env Vars:** vba (2)
> **Definitions:** is a  (1)
> **Speakers:** - [narrator] (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/excel-vba-process-modeling-25158426/gain-insight-into-your-business-through-simulation?u=76281980&t=0)** - [Instructor] Thanks again for your interest in this course. Before I get started, I want to share some important information that you should know. I assume that you have basic proficiency in [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) VBA. If not, you'll pick up a lot as we go along, but the more you know before you get started, the better off you'll be. Secondly, this is not the type of course where I teach a specific skill within each movie. Instead, the movies build progressively within each chapter. And that means also that not every movie ends with code that you can run. Many of them do, but some of them, especially in the later chapters do not. I make sure though that all the workbooks contain previous code from the chapter. That way you will never have to retype anything. Also, chapters two through four include a workbook With the completed code, you can complete the exercises yourself for chapters five and later, and create the code that you need. And finally, I need to cover how to manage macro security for downloaded files. As of September 20th, 2024, [Microsoft](../../Instructors/Artificial%20Intelligence%20(AI)/Microsoft.md) has changed how [Microsoft Office](../../Skills/Web%20Development/Microsoft%20Office.md) handles files that are downloaded from the internet. So I'm going to switch to the exercise files folder, and show you what you need to do to be able to run the code. I have switched over to File Explorer, and I have chapter two of the exercise files collection open. But any exercise files folder will do. Let me show you what happens when you open a file without changing its macro security settings.
>
> **[1:34](https://www.linkedin.com/learning/excel-vba-process-modeling-25158426/gain-insight-into-your-business-through-simulation?u=76281980&t=94)** So I will double-click 0205 and we won't actually do any work. I'm just using it as an example. So I have enable editing on the warning bar here. So I'll click Enable Editing. After I click Enable Editing, I receive a [Security Risk](../../Skills/Cybersecurity/Security%20Risk.md) message saying that Microsoft has blocked macros from running because the source of this file is untrusted. If I click Learn more, I'll go to an online article. So if you want to learn more, I encourage you to click that. But instead, there's a setting that you can make to the files properties that will keep this from happening because as the file is right now, none of the macros in it will run. So I will close the file. and then in File Explorer, I'll right-click the files icon, and then click properties. In the properties dialogue box on the general tab, if you look down at the bottom, almost all the way to the bottom right, there's a security note saying, "This file came from another computer, and might be blocked to help protect this computer." That's because this file was in fact downloaded from the internet. To open the file and have the macros be usable, you need to check the unblock checkbox here. So this will allow you to use macros in this file and in this file only. So it does mean that you need to repeat this process for every file. However, that's great for security. So always make sure you trust a file
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Microsoft](../../Instructors/Artificial%20Intelligence%20(AI)/Microsoft.md) (2), [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (1), [Microsoft Office](../../Skills/Web%20Development/Microsoft%20Office.md) (1), [Security Risk](../../Skills/Cybersecurity/Security%20Risk.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Simulation](../../Skills/Hardware/Simulation.md) (1), [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Object-oriented programming](../../Skills/Software%20Development/Object-Oriented%20Programming%20(OOP).md) (1), [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (1), [Simulation](../../Skills/Hardware/Simulation.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (3), [Simulation](../../Skills/Hardware/Simulation.md) (1), cursor (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Simulation](../../Skills/Hardware/Simulation.md) (3), [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Simulation](../../Skills/Hardware/Simulation.md) (1), [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (1), [Memory Management](../../Skills/Web%20Development/Memory%20Management.md) (1)
> **CLI Commands:** find (1)
> **Env Vars:** f11 (1)
> **Exercise Files:** exercise files (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Simulation](../../Skills/Hardware/Simulation.md) (5)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (2), [Statistics](../../Skills/Data%20Science/Statistics.md) (1), [Word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) (1), [Probability](../../Skills/Data%20Science/Probability.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Simulation](../../Skills/Hardware/Simulation.md) (3), [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Simulation](../../Skills/Hardware/Simulation.md) (3), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Simulation](../../Skills/Hardware/Simulation.md) (6)
> **Env Vars:** f11 (6)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Probability](../../Skills/Data%20Science/Probability.md) (6), [Simulation](../../Skills/Hardware/Simulation.md) (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Simulation](../../Skills/Hardware/Simulation.md) (3), [Probability](../../Skills/Data%20Science/Probability.md) (3), [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (2)
> **Env Vars:** f11 (4)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Simulation](../../Skills/Hardware/Simulation.md) (4), [Technical Support](../../Skills/Network%20and%20System%20Administration/Technical%20Support.md) (1), [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (1)
> **CLI Commands:** find (2)
> **Env Vars:** vba (1), f11 (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (5), [Simulation](../../Skills/Hardware/Simulation.md) (4)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/excel-vba-process-modeling-25158426/summarize-results-using-the-total-row?u=76281980&t=0)** - [Instructor] [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) tables are useful and versatile tools. It's a shame that more users aren't aware of them. One of the elements of Excel tables that I use a lot is the total row. You can display a total row in your table and use it to summarize values from a column, such as finding the sum of all processing times or the average values in a column. In this movie, I will show you how to add the total row and change it so it summarizes your table data. My sample file is chapter 07_03, and you can find it in the chapter seven folder of the exercise files collection. I've already run the [Simulation](../../Skills/Hardware/Simulation.md), so I will move to the results worksheet. And here I have an Excel table that shows my data. To display the total row at the bottom, I click any cell within the body of the Excel table and then go up to the Table Design, contextual tab on the ribbon, and then in the Table Style options group, check the Total Row box, and that displays the total row. You can define totals and that can be any calculation for each of the columns. By default, Excel creates a calculation for the bottom right. That is the right most column, 'cause that's typically where data is stored. And here I have the total of all of the percentages that customers were idle. In this case, a total, or sum, isn't the best way to summarize this data. Instead, it would be to find an average.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (5), [Simulation](../../Skills/Hardware/Simulation.md) (3)
> **CLI Commands:** find (4)
> **Env Vars:** h143 (1)
> **Versions:** 3.54 (1)
> **UI Navigation:** go to (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (3), [Simulation](../../Skills/Hardware/Simulation.md) (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Simulation](../../Skills/Hardware/Simulation.md) (2), [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (2), [Probability](../../Skills/Data%20Science/Probability.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (5), [Simulation](../../Skills/Hardware/Simulation.md) (1)
...
← [Excel Vba Managing Files And Data](Excel%20Vba%20Managing%20Files%20And%20Data.md) | **2 of 7** | [Excel- Working Together with Power Query and Power Pivot](Excel-%20Working%20Together%20with%20Power%20Query%20and%20Power%20Pivot.md) →
