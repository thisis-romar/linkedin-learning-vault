...
prev_courses:
  - '[Communication within Teams (2021)](Communication%20within%20Teams%20(2021).md)'
  - '[Executive Leadership](../../Skills/Data%20Science/Executive%20Leadership.md)'
next_courses:
  - '[Negotiation Foundations](Negotiation%20Foundations.md)'
...
>
> **[0:00](https://www.linkedin.com/learning/interpersonal-communication-22638889/build-your-interpersonal-communication-skills?u=76281980&t=0)** - We all know some people that are just excellent communicators. They really stand out. It's easy to think they were born that way or they just have some special skill that we don't, but that's a cop-out. Communication skills absolutely can be learned and honed. When you master communication, people see you differently. Everything you do becomes easier because people are more likely to support you and want to help you, and that makes a huge difference for your career. All you need is an open mind and a willingness to learn. I'm Dorie Clark. I'm the author of the Long Game in Reinventing You, as well as a former presidential campaign spokesperson, where I learned firsthand the importance of getting every [word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) right. Let's get started.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/interpersonal-communication-22638889/when-to-send-an-email-vs-have-a-call-or-meeting?u=76281980&t=0)** - Communication choices used to be simple in the old days. if someone worked in your [office](../../Skills/Web%20Development/Microsoft%20Office.md), you'd meet with them face-to-face. If they worked somewhere else, you'd call them or maybe mail them a letter or send a fax. But nowadays, the situation has gotten more complex. Do you meet face-to-face or in a video meeting? Do you call? Should you email, text, use a messaging app? There's a lot of choices. So, how do you decide? The first question to ask yourself is whether the person you're communicating with has a clear preference. If someone is in a powerful position like your boss or a valued client and they have a strong opinion about how they like to communicate, honor it. Even if it's not the optimal way for you to do business or to use that medium, just do what they like. It's a good idea to keep them happy, so adapt to their preferences. But what if the person doesn't have a particular preference or it's a colleague with equal standing that you don't need to bend over backwards for? In that case, here are a few questions to ask yourself to help you decide. First, is the situation time-sensitive? It's a really good idea for any team to clarify their procedures around urgent or time-sensitive situations. If something needs to be addressed asap, who gets contacted and how do we contact them? It doesn't really matter what you decide, as long as everyone knows about it and is on the same page because when you're in the middle of a crisis is the wrong time to figure that out. Next, is the conversation delicate? If what you're going to discuss is high stakes or emotional or is going to prompt a lot of questions, maybe
>
> **[1:36](https://www.linkedin.com/learning/interpersonal-communication-22638889/when-to-send-an-email-vs-have-a-call-or-meeting?u=76281980&t=96)** you're reassigning someone to a new role or you need to ask for leave of absence or someone's not getting a promotion then it's best to find a way to have that conversation in real time. Whether you meet in-person or through a video meeting or phone call, probably depends on geography or personal preferences, but it's a good idea to have the conversation live so that they can ask the questions that they'll almost certainly have. Having important conversations live is a form of respect for the other person, so that they're not just worrying and having to wait for clarification. Next, will the conversation have a lot of give and take? If you're discussing ideas or brainstorming or troubleshooting, a [Real-Time](../../Skills/Database%20Management/Real-Time.md) conversation is also helpful so you can get input from your colleagues. Interacting live lets you springboard off each other's suggestions and probe and test and refine your concepts fast, and is the information clear-cut? If you have a simple update to share, let's say the office holiday party is going to be Thursday at 5:00 PM or George is now going to be the point person for the recycling committee. That's perfect for asynchronous communication like email or using a messaging app. It's useful for people to know, but it's definitely not an emergency. Are time zones an issue? In a global economy, most of us have probably had to get up earlier, work late to do calls or meetings with folks across the world, but that's really hard to do all the time and to make work sustainable, it's best to use asynchronous communication like email or a messaging app as much as possible when you're working
>
> **[3:09](https://www.linkedin.com/learning/interpersonal-communication-22638889/when-to-send-an-email-vs-have-a-call-or-meeting?u=76281980&t=189)** with teams in diametrically-opposed time zones. Of course, we all need to get together live sometimes and iron out issues or just connect but it's a kindness to keep that to a minimum, if it's impinging on people's sleep. There's no magic formula for how to communicate best with your colleagues and clients. We're all figuring it out together. But with these strategies, you can make informed choices about the modalities that you're using.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Office](../../Skills/Web%20Development/Microsoft%20Office.md) (2), [Real-Time](../../Skills/Database%20Management/Real-Time.md) (1)
> **CLI Commands:** make (2), find (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/interpersonal-communication-22638889/how-to-manage-expectations?u=76281980&t=0)** - You're probably juggling multiple projects already, and if you're like most of us, your boss keeps throwing new ones at you. So how can you keep up, do a good job, and manage your supervisor's expectations? As with many things in life, the majority of problems can be avoided with a detailed conversation upstream well before any actual deadlines. The first step is making a comprehensive list of the projects you're working on and rank ordering them based on your understanding of priorities. You then want to set up a meeting with your boss where you can confer and ask if your understanding of their relative importance matches hers. The last thing you want to do is waste time pushing hard on the 10th priority when number one is languishing. You have limited time and energy, and you want to expend it on the right things. So ask. Next, for each project, come up with a time estimate. How long do you realistically think it'll take you to complete it? For instance, creating the pitch deck might take 90 minutes, writing the client report might be three hours, and pulling together your department's annual budget might take 10 hours of work. Then you talk with your boss and match up those expectations. See if he thinks those are realistic estimates. And if you're wildly off, that can surface misaligned expectations early on. You might envision the departmental budget project as taking 10 hours and being hugely laborious, but maybe he just meant you should email everyone, ask him for some numbers, and pull together a spreadsheet, which would take an hour, not 10. Knowing that enables you to triage much more effectively
>
> **[1:36](https://www.linkedin.com/learning/interpersonal-communication-22638889/how-to-manage-expectations?u=76281980&t=96)** and also push back where necessary. If you agree that writing a certain report will take three hours, but he wants you to do 30 hours worth of other projects first, he's certainly not going to get that report on his desk tomorrow. Finally, make sure you know what the deadline is for every project. We may think we know or have an implicit understanding, but it pays to be explicit and know exactly what others are envisioning. You can't prioritize effectively if you don't grasp the real urgency or lack thereof behind a given task. Understanding deadlines gives you power to shift and adjust your schedule based on what's actually most important. Expectations are tricky. They're often unstated and often unrealistic, so having detailed conversations upfront can help spare you confusion and dissatisfaction down the road because you know exactly where you stand.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/interpersonal-communication-22638889/how-to-handle-an-interruption?u=76281980&t=0)** - Let's say you're in a meeting. You get interrupted. Fine, but a little later you speak up and get interrupted again. If that keeps up, most of us are likely to go in one of 2 directions, either retreating into silence or getting mad and lashing out. The frustration is understandable, but as you can imagine, neither reaction is a great idea, so here's what to do instead. First of all, it's useful to step back and ask yourself, why are you being interrupted? Sometimes people are rude. They're not really listening to you, or they're so eager to talk, they don't care what anyone else is saying or doing. But other times, interruptions can actually be a sign of interest and engagement. If they're interrupting to ask for more details or with a clarifying question, that can actually be a good sign that they care about the topic and want to learn more. Another useful thing to look at is whether you're being interrupted by just one person or by lots of people. If it's the latter, it may just be your company culture, which isn't a great thing, but it also shouldn't be taken as a personal insult. You need to contextualize what's happening in order to know what to do about it. If it's one person interrupting you, it may be time to sit down with them and have a conversation about how you have conversations. You could go to your colleague and say, "Bob, I know we both want our meetings to be as effective as possible. I've noticed, though, that it seems like when I speak in the meetings, you're interrupting me pretty frequently. Last Tuesday, it actually happened 3 different times. That made it hard for me to get my points across. I'm sure that's not intentional,
>
> **[1:32](https://www.linkedin.com/learning/interpersonal-communication-22638889/how-to-handle-an-interruption?u=76281980&t=92)** and I wonder if there's a way we could strategize about that." Odds are, your colleague doesn't even know he's doing this, and may well be contrite. If he gets defensive, "I didn't interrupt you," then you can say, "Well, it was my perception that you did. Maybe I'm wrong. Is there a signal or a system we could use in the future in case something like that happens to come up again?" If it's actually your whole [office](../../Skills/Web%20Development/Microsoft%20Office.md) culture, if everyone's interrupting everyone all the time, then you may need to find a way to disrupt the system. You could go to your boss, note your observation that people interrupt each other frequently, and ask if she's also noticed that. If she has, you have a starting point. If not, you could suggest appointing an interruption monitor to record instances for a couple of weeks to see if it's a frequent problem or not. Once you've established that it is, you may be able to suggest modifications that can help ensure more people's ideas get heard, like doing the bulk of brainstorming individually prior to the meeting or empowering the meeting facilitator to stop interrupters and put the focus back on the previous speaker until she finishes. It's annoying when you get repeatedly interrupted, but it doesn't help anyone if you blow up or shut down. Instead, use these strategies to get at the root of the problem.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/interpersonal-communication-22638889/how-to-respond-to-critical-feedback?u=76281980&t=0)** - It's easy to get defensive when you're feeling criticized. Why wouldn't you? But it's not great for your career to be known as the person who can't take feedback. Here's how to prepare yourself in order to receive feedback calmly and professionally. First, one important thing upfront is knowing who to take feedback from. There are a lot of people out there in the world that have an opinion, whether it's about how you dress or your accent or your public speaking skills. The best way to avoid getting worked up about people's comments is to decide in advance who's worth listening to. Largely, this boils down to two categories. Your boss and people whose feedback you ask for, just about anyone else who gives unsolicited advice, no matter how well intentioned, should be ignored. I'm actually a hard liner on this because we'd never make any progress if all we did was try to adapt to please people because most people have different opinions. It should be green. No, it should be red and most people think they're far better informed than they really are. If you respect someone enough to ask for their feedback, then listen, otherwise, don't. You know your public speaking coach knows what she's talking about. The random audience member quite likely does not. Next, repeat this mantra. "Don't respond immediately." People often go into fight or flight mode when they feel threatened, and let's face it, criticism is a form of threat so they get defensive and want to go on the attack. They'll either try to smash down the feedback, I don't come into work late.
>
> **[1:34](https://www.linkedin.com/learning/interpersonal-communication-22638889/how-to-respond-to-critical-feedback?u=76281980&t=94)** That was one day and I was sick. 99% of the time I'm there early or they attack the person giving the feedback. The only reason the presentation wasn't as good as it could have been is you didn't get me the numbers on time. That's not helpful. Promise yourself that unless you had time to prepare for the feedback in advance, like a pre-planned performance review, you won't respond in the moment and maybe not even that day. Just say, "Thank you for the feedback. I'd love to respond to this, but to do it justice I want to think about it for a while." Then stop, if you know the feedback is coming and you can prepare in advance, it's often a good idea to try to map out the worst case scenario. That way you're ready if it comes your way and if it doesn't, that's good news. For instance, let's say you feel like you might be on shaky ground with your boss. Odds are you probably know why. Maybe she thinks you're late too often, or she's talked to you in the past about your presentation skills or how you've handled a particular client. Write down all the things you're worried she might say. Now, write out draft responses when you're calm so that in the heat of the moment and you're feeling flustered, you can fall back on that for what to say. For instance, it's useful to acknowledge where you agree she has a point. Maybe you were late a few times last month and let her know what you're doing or have done to change that. Maybe it's true that public speaking isn't really your forte at this point, but you've signed up for Toastmasters, showing that you've thought about these points and are taking action makes a difficult conversation go way better.
>
...
> [!transcript]- Transcript
>
> **[0:01](https://www.linkedin.com/learning/interpersonal-communication-22638889/communicating-through-tense-situations?u=76281980&t=1)** - Unfortunately, it's inevitable that at some point, you'll face a tense situation at work with a colleague, or an employee, or your manager. So how can we handle it with grace so it doesn't fracture the relationship, but instead, hopefully helps you reach a better understanding, and maybe even get to a positive place. Here are four things to keep in mind. The first is to do your best to stay calm and composed. When you're in a tense situation, or there's conflict, your body goes on high alert. It's natural to feel defensive or upset. After all, cortisol's racing through your bloodstream. And in a fight or flight situation, you might be tempted to storm off, or lash out, or behave in a way that you might regret later. But take a deep breath, which actually does help calm your nervous system. And as a starting point, try to focus on the facts rather than your immediate emotional reaction, because there's a possibility you might be reading the situation wrong, or there's more context that would be helpful. Which leads us to the second point. Work to actively listen to, and try to understand the other person's perspective. Conflicts often happen because of miscommunication, so it's really important to make sure that's not happening here. Test your assumptions and ask questions until you're sure you understand the situation and how they view it. It's possible you have diametrically opposed views or agendas, but it's also possible you're on the same side and just talking about things differently, so you want to suss that out quickly. Next, once you understand the situation, it's important to make sure you're sharing your perspective
>
> **[1:35](https://www.linkedin.com/learning/interpersonal-communication-22638889/communicating-through-tense-situations?u=76281980&t=95)** in a clear and respectful way. For instance, it's always a good idea to use I statements to talk about what you're feeling and experiencing. So instead of saying, "You're wrong," you could say, "I have a different perspective," or, "I'd like to understand your perspective better. Can you elaborate?" That helps keep the other person's defensiveness at bay, because you're not attacking them or criticizing them, you're just sharing your own views. Treating them with respect even when it's a tough conversation is a sign of professionalism that they'll remember. And finally, there's sometimes a temptation to keep talking about the conflict, and you obviously need to up to a point in order to understand the situation and how everyone views it. But there's a difference between understanding the facts and endlessly re-litigating them and arguing about them. Once the scope of the disagreement is clear, it's useful to make a conscious shift into looking for solutions. What can you actually do to solve the problem or make the situation better? There's almost always something that can be done, even if it's small or just an initial step. It'll probably involve compromise, and may not be perfectly satisfying to everyone, but it's a lot better of an option than just continuing to argue. It's never easy to communicate in stressful situations where there's conflict, but it's a skill we do have to master. And if you develop real expertise in finding a respectful path forward, even when you disagree with someone, that's one of the most valuable skills you can have, because it means you can get through almost anything.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/interpersonal-communication-22638889/investing-in-communication-skills?u=76281980&t=0)** - We communicate every day with colleagues and supervisors and clients. Unfortunately, because we're all human, that means our interactions are often ripe for misunderstanding. But if you are aware of the ways that communication can be derailed, then you can prepare in advance, mitigate potential problems, and quickly discover and fix any crossed wires. In the Internet era, [Interpersonal Communication](../../Skills/Data%20Science/Interpersonal%20Communication.md) skills matter more, not less. If you can invest just a bit of time in improving your knowledge and honing your abilities, it gives you a critical edge. With these strategies, you can become more effective at work and more likely to connect positively with your colleagues and everyone around you. Let me know how it goes, and you can access hundreds of free articles and other resources on my website at [dorieclark.com](https://dorieclark.com). Good luck.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Interpersonal Communication](../../Skills/Data%20Science/Interpersonal%20Communication.md) (1)
...
- [Dorie Clark](../../Instructors/Data%20Science/Dorie%20Clark.md)
...
← [Communication within Teams (2021)](Communication%20within%20Teams%20(2021).md) | **17 of 18** | [Negotiation Foundations](Negotiation%20Foundations.md) →
...
← [Executive Leadership](../../Skills/Data%20Science/Executive%20Leadership.md) | **2 of 10** | [The Smart Way to Grow Your Network with LinkedIn's Andrew McCaskill](The%20Smart%20Way%20to%20Grow%20Your%20Network%20with%20LinkedIn's%20Andrew%20McCaskill.md) →
...
- [Skills for Inclusive Conversations](../Cloud%20Computing/Skills%20for%20Inclusive%20Conversations.md) — Interpersonal Communication
- [Communication Foundations](../Cloud%20Computing/Communication%20Foundations.md) — Interpersonal Communication
