...
prev_courses:
  ...
  - '[Learning Docker](../DevOps/Learning%20Docker.md)'
  - null
next_courses:
  - '[Git Essential Training](../Web%20Development/Git%20Essential%20Training.md)'
  - '[Generative AI and Predictive AI in the Cloud- Foundational Concepts and Scenarios](../Artificial%20Intelligence%20(AI)/Generative%20AI%20and%20Predictive%20AI%20in%20the%20Cloud-%20Foundational%20Concepts%20and%20Scenarios.md)'
  - '[Kubernetes- Your First Project (2021)](../DevOps/Kubernetes-%20Your%20First%20Project%20(2021).md)'
...
>
> **[0:00](https://www.linkedin.com/learning/learning-kubernetes-16086900/setting-sail-on-your-kubernetes-voyage?u=76281980&t=0)** - [Kubernetes](../../Skills/DevOps/Kubernetes.md) is ubiquitous in the tech industry as the way to deploy and manage distributed software. And you can find it heralded in conference talks, job descriptions, blog posts, and all over Twitter. But if you're new to Kubernetes, it can be difficult to understand what all the hype is about and how to start learning. If that's you, you're in the right place. I created this course because when I started learning Kubernetes, I found that it was a large and very complicated system, and it took me over a year before I felt like I was finally starting to understand the basics. I want you to have a solid understanding of Kubernetes much faster than I did. By the end of this course, you'll get a sense why companies like Spotify, Wikimedia, Pinterest, and scientific organizations like CERN have adopted Kubernetes as their container orchestration platform. We'll also cover Kubernetes architecture and some best practices in security and troubleshooting issues. If you're excited to walk away with some real-world Kubernetes experience, this course is for you. I'm Kim Schlesinger, a tech educator, and Kubernetes enthusiast. So join me in this [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) Learning course as I guide you through this container orchestration platform. Let's dive in.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Kubernetes](../../Skills/DevOps/Kubernetes.md) (8), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (1)
> **CLI Commands:** find (1)
> **Env Vars:** cern (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/learning-kubernetes-16086900/what-you-should-know?u=76281980&t=0)** - Before we begin, let's review what you'll need to know and be able to do in order to complete this course. First, you'll need access to a computer running [Windows](../../Glossary/Service/Windows.md), [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md), or macOS. Second, you'll need internet access and a terminal application where you can run simple Unix commands like make directory, mkdir, and change directory, cd. Next, you need to be able to describe container technology from a 10,000-foot view. Simply knowing a tiny bit about Docker or another container technology like Podman is more than enough, so if you want to quickly read the first paragraph of the Docker Wikipedia entry that will do. If you'd like a more in-depth overview of containers, you can find several courses on Docker and [Microservices](../../Skills/Software%20Development/Microservices.md) in the [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) Learning Library. Finally, you'll need a text editor like VS Code to view and edit the [Kubernetes](../../Skills/DevOps/Kubernetes.md) manifests we'll use in this course. There's no need to be a tech expert to work through this course, so if you've got a terminal app, a text editor, a high-level understanding of Docker, and the desire to learn more about Kubernetes, you're ready, so let's go.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Kubernetes](../../Skills/DevOps/Kubernetes.md) (2), [Windows](../../Glossary/Service/Windows.md) (1), [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) (1), [Microservices](../../Skills/Software%20Development/Microservices.md) (1), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/learning-kubernetes-16086900/what-is-kubernetes?u=76281980&t=0)** - Since it was launched as an open source project in 2015, [Kubernetes](../../Skills/DevOps/Kubernetes.md) has proven to be one of the most exciting and dynamic [Software Projects](../../Skills/Software%20Development/Software%20Projects.md) of all time. Kubernetes is eating the world and surveys of software engineers, [DevOps](../../Topics/DevOps.md) professionals, and chief technology officers show us this is true. According to the official 2021 Cloud Native Computing Foundation survey, 96% of organizations are either using or evaluating Kubernetes and more than 5.6 million developers are using it today. Kubernetes' release was announced by [Google](../../Glossary/Service/Google.md) in 2014 and the system's design was influenced by Google's internal cluster management system called Borg. Instead of keeping the idea to themselves, Google worked with the [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) Foundation to form a new organization called the Cloud Native Computing Foundation and donated Kubernetes as the first open source project under the purview of the CNCF. Kubernetes, also known as "Kates" or K8s, is Greek for the [word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) pilot or helmsman of a ship. Kubernetes has this name because it's a container orchestrator. Like the captain of a ship leading their crew, Kubernetes makes decisions about where and how containerized applications are launched on a server, when to scale up and down the number of application replicas, and what to do when an application or server stops working. Kubernetes is an open source project written in the programming language Go
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Kubernetes](../../Skills/DevOps/Kubernetes.md) (10), [Virtual Machines](../../Skills/Cloud%20Computing/Virtual%20Machines.md) (1), [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) (1), [Windows](../../Glossary/Service/Windows.md) (1), [Google](../../Glossary/Service/Google.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/learning-kubernetes-16086900/what-is-cloud-native?u=76281980&t=0)** - The tech industry is full of terms that are loaded with meaning and here are a few that I often see [agile](../../Skills/DevOps/Agile%20Development.md), [DevOps](../../Topics/DevOps.md) and cloud native. I've even used some of these terms in this course. In earlier videos, I alluded to the fact that [Kubernetes](../../Skills/DevOps/Kubernetes.md) is a cloud native technology but, what does that mean?
>
> **[0:24](https://www.linkedin.com/learning/learning-kubernetes-16086900/what-is-cloud-native?u=76281980&t=24)** - [Narrator] Here's the official definition from the cloud native computing foundation. Cloud native technologies empower organizations to build and run scalable applications in modern dynamic environments such as public, private, and hybrid clouds. Containers, service meshes, [Microservices](../../Skills/Software%20Development/Microservices.md), immutable infrastructure, and declarative APIs exemplify this approach that's really, dense. So, here's my definition, cloud native technologies are open-source projects designed to let technologists use [Cloud Computing](../../Topics/Cloud%20Computing.md) services to automatically deploy and scale applications.
>
...
>
> **[1:40](https://www.linkedin.com/learning/learning-kubernetes-16086900/what-is-cloud-native?u=76281980&t=100)** - The Cloud Native Computing Foundation or CNCF is part of the [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) Foundation and the organization's goal is to make cloud native computing ubiquitous. The organization supports their community by organizing groups that write the code for cloud native software, including Kubernetes.
>
...
>
> **[3:07](https://www.linkedin.com/learning/learning-kubernetes-16086900/what-is-cloud-native?u=76281980&t=187)** - [Narrator] Kubernetes is one of many open source projects backed by the CNCF and as you move through your Kubernetes journey you'll encounter other projects like [Helm](../../Glossary/Tool/Helm.md), Prometheus and Linkerd.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Kubernetes](../../Skills/DevOps/Kubernetes.md) (9), [Agile](../../Skills/DevOps/Agile%20Development.md) (1), [DevOps](../../Topics/DevOps.md) (1), [Microservices](../../Skills/Software%20Development/Microservices.md) (1), [Cloud Computing](../../Topics/Cloud%20Computing.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/learning-kubernetes-16086900/install-docker-on-windows?u=76281980&t=0)** - [Instructor] Docker is the container engine that will help us spin up a [Kubernetes](../../Skills/DevOps/Kubernetes.md) cluster on our computer. Let's find out how to install Docker on [Windows 10](../../Skills/Network%20and%20System%20Administration/Windows%2010.md). This is the install Docker desktop on [Windows](../../Glossary/Service/Windows.md) page in the Docker Docs. I need to download Docker desktop. So let's click the download button. Looks like the installer is downloading. Let's open that file and open the installer. We're going to click yes here.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Kubernetes](../../Skills/DevOps/Kubernetes.md) (2), [Windows](../../Glossary/Service/Windows.md) (2), [Windows 10](../../Skills/Network%20and%20System%20Administration/Windows%2010.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/learning-kubernetes-16086900/install-docker-on-linux?u=76281980&t=0)** - [Instructor] Docker is the container engine that will help us spin up a [Kubernetes](../../Skills/DevOps/Kubernetes.md) cluster on our computer. Let's find out how to install Docker on [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md). First, let's find out what Linux distribution and version I'm running, with lsb_release -a. I'm running [Ubuntu](../../Skills/Web%20Development/Ubuntu.md) version 22.04. Next, let's follow along with the instructions titled "Install using the repository." First thing I have to do is set up the repository, so I'm going to copy this command, sudo apt-get update, and paste it in my terminal. This may take a while.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Kubernetes](../../Skills/DevOps/Kubernetes.md) (2), [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) (2), [Ubuntu](../../Skills/Web%20Development/Ubuntu.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/learning-kubernetes-16086900/install-docker-on-macos?u=76281980&t=0)** - [Instructor] Docker is the container engine that will help us spin up a [Kubernetes](../../Skills/DevOps/Kubernetes.md) cluster on our computer. Let's find out how to install Docker on macOS. This is the "Install Docker Desktop on Mac" page in the Docker docs. I need to download Docker Desktop, and I'm running a macOS with an Intel chip. So let's click that button. All right, it looks like it's downloading, so we'll just wait. All right, let's open that up and follow the instructions. It's asking me to drag and drop to my Applications folder, and it's going to copy Docker to that directory on my computer. All right, now that that's done, let's open the Docker app.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/learning-kubernetes-16086900/install-minikube-on-windows?u=76281980&t=0)** - Now that we have Docker desktop installed, let's download Minikube. Minikube is software that lets you run a [Kubernetes](../../Skills/DevOps/Kubernetes.md) cluster using just your computer. In order to use minikube, you need a way to run commands in your terminal and you need to install a container runtime like Docker or Podman. Minikube is a tool that can help you learn Kubernetes. It's free because you are not required to pay a cloud provider for compute resources. But minikube is not fit for production clusters because it runs locally on your computer and lacks the security and networking capabilities offered by cloud providers. All right, so we are on the minikube welcome page. Let's figure out how to install minikube on [Windows](../../Glossary/Service/Windows.md) by going to the Get started section. All right, we're going to scroll down. All right, so we scroll down to the installation and we're just selecting what's true for us. We're on a Windows machine. We're using X 86 64 architecture. We want the stable release of Minikube and we're going to download the executable file. If we scroll down it says download and run the installer for the latest release. So we're going to click on that link. And just like with Docker desktop, we're going to download it. Windows is giving us a message saying that Minikube installer isn't commonly downloaded. Make sure that you trust this installer, which we do.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Windows](../../Glossary/Service/Windows.md) (4), [Kubernetes](../../Skills/DevOps/Kubernetes.md) (2)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/learning-kubernetes-16086900/install-minikube-on-linux?u=76281980&t=0)** - [Instructor] Minikube is software that lets you run a [Kubernetes](../../Skills/DevOps/Kubernetes.md) cluster using just your computer. In order to use minikube, you need a way to run commands in your terminal and you need to install a container runtime like Docker or Podman. This video assumes you have both ready to go. Minikube is a tool that can help you learn Kubernetes. It's free because you are not required to pay a cloud provider for compute resources, but minikube is not fit for production clusters because it runs locally on your computer and lacks the security and networking capabilities offered by cloud providers. Let's click on the Get Started section to install minikube on [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md). So we're going to scroll down and here's the installation instructions. I'm using a Linux operating system, I'm using an x86-64 processor, I want to download the stable release, and I'm going to download the binary release. So what I'm going to do is copy these two commands and I'm going to paste them and hit Enter. Wow, that happened really fast. Let's make sure minikube is installed by running the command minikube. If you see that list of commands, that means we're ready to go. Great work, you've installed minikube on your computer.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Kubernetes](../../Skills/DevOps/Kubernetes.md) (2), [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) (2)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/learning-kubernetes-16086900/install-minikube-on-macos?u=76281980&t=0)** - [Instructor] minikube is software that lets you run a [Kubernetes](../../Skills/DevOps/Kubernetes.md) cluster using just your computer. In order to use minikube, you need to install a container runtime, like Docker or podman. this video assumes you have a container runtime ready to go, and just so you know, I'm using Docker as mine. minikube is a tool that can help you learn Kubernetes. It's free because you're not required to pay a cloud provider for compute resources, but minikube is not fit for production clusters, because it runs locally on your computer, and lacks the security and networking capabilities offered by cloud providers. If you are using a computer, running the Mac operating system, install minikube with Homebrew, the installation command Is brew install minikube. The installation process usually takes a few minutes. Once you have minikube installed on your machine, you can explore some of its capabilities. Start a cluster with the command minikube start. This also usually takes a few minutes. Once your cluster is ready, get some information about it, with kubectl get nodes. Nice. Now check the version of minikube you have installed, and compare it with the latest stable version
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Kubernetes](../../Skills/DevOps/Kubernetes.md) (6), [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) (1), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/learning-kubernetes-16086900/reading-and-writing-yaml?u=76281980&t=0)** - [Instructor] Once you start working with Cloud Native Tech, you'll notice the terms [Infrastructure as Code](../../Skills/Software%20Development/Infrastructure%20as%20code%20(IaC).md) and GitOps all over the place. These two approaches are often paired with [Kubernetes](../../Skills/DevOps/Kubernetes.md). In Kubernetes, setting up your infrastructure with code and preparing yourself to deploy changes through a GitOps workflow require that you can save the desired state of your cluster in a set of files that you manage with a source control system like [Git](../../Skills/Software%20Development/Git.md). In Kubernetes, the most commonly used format for these files are YAML manifests. A quick note on the terms Infrastructure as Code and GitOps. We won't go in depth on these terms in this course, but when you're ready to learn more, I recommend you check out the course called GitOps Foundations in the [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) Learning Library. YAML is a data serialization language often used for configuration files. Data serialization languages provide a standard syntax for communicating information so that devices, operating systems and programming languages can easily share data with one another. Examples of other data serialization languages are [JSON](../../Skills/Web%20Development/JSON.md) and xml. Using a data serialization language makes your data portable. Remember, we used that [word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) to talk about containers earlier in the course. Like a suitcase, YAML lets you package and pick up your data and take it to another location and unload it without requiring anything extra from the developer.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Kubernetes](../../Skills/DevOps/Kubernetes.md) (5), [Infrastructure as code](../../Skills/Software%20Development/Infrastructure%20as%20code%20(IaC).md) (3), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (2), [Git](../../Skills/Software%20Development/Git.md) (1), [JSON](../../Skills/Web%20Development/JSON.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Kubernetes](../../Skills/DevOps/Kubernetes.md) (6), [Microservices](../../Skills/Software%20Development/Microservices.md) (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Kubernetes](../../Skills/DevOps/Kubernetes.md) (6), [Microservices](../../Skills/Software%20Development/Microservices.md) (1), [Metadata](../../Skills/Web%20Development/Metadata.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/learning-kubernetes-16086900/check-that-your-application-is-working-with-busybox?u=76281980&t=0)** - [Instructor] Once you deploy something in your [Kubernetes](../../Skills/DevOps/Kubernetes.md) cluster, you want to verify that the application is working as expected. But how can you check? One way is to use a tool called BusyBox. BusyBox is known as the Swiss Army Knife of embedded [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md), and it's a binary that contains many well-known Unix tools like Awk, Date, Who am I and Wget? It's a good tool for debugging and troubleshooting issues in a Linux environment and Kubernetes runs on Linux. Let's create a pod running BusyBox. First, find and open the BusyBox dot YAML file. Like we did with our application, we're going to use a deployment to create the BusyBox pod. Unlike our other deployment, we're going to deploy this in our default namespace and run only one replica. Let's create the BusyBox pod with kubectl apply -f busybox.yaml. Let's check and see that the BusyBox Pod is up and running with the command kubectl get pods, looks good. Notice in that last command, I didn't specify a name space, which is fine because if you don't, kubectl assumes you want the objects in the default name space. We want to use BusyBox to make an HTTP get request to our application, and we need to know the IP address of our pods in order to make that request.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/learning-kubernetes-16086900/delete-your-kubernetes-objects-and-tear-down-your-cluster?u=76281980&t=0)** - [Instructor] We've arrived at the end of this chapter, and we no longer need our minikube cluster. Minikube is a resource-intensive application, so unless you want your computer to melt, it's best to clean up your cluster and stop it when you're not using it. The first thing we want to do is delete any [Kubernetes](../../Skills/DevOps/Kubernetes.md) resources we created. We'll do that using the YAML files. Here's a list of files that we used. We can delete the objects in these files by running kubectl delete -f and the name of the file. I'm going to go through and do that one by one. Kubectl delete, busybox. Kubectl delete the file deployment, Kubectl delete the file quote, Kubectl delete the file service, and finally, kubectl delete the file namespace. Make sure you delete the namespace last because it will destroy anything inside of it when it is deleted. You could also do it first if you only want to run one command. Finally, let's delete our minikube cluster. The command is simple, minikube delete. Excellent work with the hands-on portion of this course. Now that you've got experience using Kubernetes, in the next chapter,
>
...
>
> **[3:09](https://www.linkedin.com/learning/learning-kubernetes-16086900/the-kubernetes-control-plane?u=76281980&t=189)** to make sure things are running properly. For example, the controller manager checks that all worker nodes are up and running, and if it finds that something is broken, it will remove the broken node and replace it with a new worker node. The controller manager creates and checks several other things in a cluster. The final component of the Kubernetes control plane is the cloud controller manager, which lets you connect your cluster with a cloud provider's API so you can use cloud resources from AWS, GCP, [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md), or any public cloud. The Kubernetes control plane contains the components that manage a cluster and enable the [Resiliency](../../Skills/Software%20Development/Resiliency.md) and automation that make Kubernetes such a popular container orchestrator. One note, if you're using a managed Kubernetes service like AWS's EKS or [Google](../../Glossary/Service/Google.md)'s GKE, you will not be able to see your control plane nodes using kubectl, those are hidden because the cloud provider handles all the maintenance of those components for you. In our next video, we'll learn about the second part of a cluster, the worker nodes.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Kubernetes](../../Skills/DevOps/Kubernetes.md) (18), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1), [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) (1), [Resiliency](../../Skills/Software%20Development/Resiliency.md) (1), [Google](../../Glossary/Service/Google.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Kubernetes](../../Skills/DevOps/Kubernetes.md) (9)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Kubernetes](../../Skills/DevOps/Kubernetes.md) (8)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/learning-kubernetes-16086900/running-stateful-workloads?u=76281980&t=0)** - [Instructor] Earlier in the course, we deployed a sample application which was stateless and didn't communicate with the database. You might be wondering how do you handle [Data Storage](../../Skills/Data%20Science/Data%20Storage.md) in [Kubernetes](../../Skills/DevOps/Kubernetes.md)? In this video, I'll discuss two ways. The first option is to connect your application with a database that is running outside of your cluster. For example, let's assume you have an application that uses [Postgres](../../Skills/Software%20Development/PostgreSQL.md) for data persistence. You can either build and maintain a [SQL](../../Skills/Data%20Science/SQL.md) database on a server that is separate from your cluster, or you can use a managed database service like [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) SQL. Amazon RDS, or [Google Cloud](../../Skills/Software%20Development/Google%20Cloud%20Platform%20(GCP).md) SQL and configure it to communicate with Kubernetes. The second option is to use a Kubernetes Persistent Volume. Persistent volumes are a type of data storage that exists in your cluster and remain even after a pod is destroyed. You can use a Kubernetes object called a stateful set to make sure your updated application can communicate with the same volume as the previous pod. Data storage in Kubernetes is a big topic that could have its own course, but you should know that there are two main approaches to making a stateful application work in your cluster. You can set up a database independent of your cluster or you can use Kubernetes Persistent Volumes.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Kubernetes](../../Skills/DevOps/Kubernetes.md) (6), [Data Storage](../../Skills/Data%20Science/Data%20Storage.md) (3), [SQL](../../Skills/Data%20Science/SQL.md) (3), [Postgres](../../Skills/Software%20Development/PostgreSQL.md) (1), [Azure](../../Skills/Cloud%20Computing/Microsoft%20Azure.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Kubernetes](../../Skills/DevOps/Kubernetes.md) (16), [Cryptocurrency](../../Skills/Data%20Science/Cryptocurrency.md) (1), [Infrastructure as code](../../Skills/Software%20Development/Infrastructure%20as%20code%20(IaC).md) (1), [CLI](../../Skills/Network%20and%20System%20Administration/CLI.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/learning-kubernetes-16086900/next-steps-on-your-kubernetes-voyage?u=76281980&t=0)** - Thanks for embarking on your [Kubernetes](../../Skills/DevOps/Kubernetes.md) journey with me. Knowing how to set up a Kubernetes cluster, deploying applications and managing those applications with Kubernetes is an in demand skill that can help you land a job or get promoted at your current one. Because Kubernetes is an open source project, it's always under development and new versions are released frequently. To keep up with what's new, I recommend following announcements about the project from the CNCF. To dive more deeply into Kubernetes, I suggest you take a look at other [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) Learning courses, especially those in the learning path called Master Cloud-Native Infrastructure with Kubernetes. Another way to learn more about Kubernetes is to watch talks from past CubeCon conferences, which you can find on YouTube. An excellent way to practice working with a cluster is by taking one of the [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) Foundation's Kubernetes certification exams, like the Kubernetes and Cloud Native Associate exam, the Certified Kubernetes Application Developer exam or the Certified Kubernetes Administrator exam. These tests are tough, but they are worth it because studying for them will push you to learn more about how to use Kubernetes. You could also follow me on LinkedIn to see what I'm posting about in the world of Kubernetes. I hope this course has inspired you to learn more about Kubernetes or other cloud native technologies. In keeping with the nautical theme,
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Kubernetes](../../Skills/DevOps/Kubernetes.md) (14), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (2), [Linux](../../Skills/Network%20and%20System%20Administration/Linux.md) (1)
> **Definitions:** is an  (2)
> **CLI Commands:** find (1)
> **Env Vars:** cncf (1)
> **Prerequisites:** set up (1)
...
- [Kim Schlesinger](../../Instructors/DevOps/Kim%20Schlesinger.md)
...
← [JavaScript Essential Training](../Software%20Development/JavaScript%20Essential%20Training.md) | **7 of 10** | [Git Essential Training](../Web%20Development/Git%20Essential%20Training.md) →
...
← [Learning Docker](../DevOps/Learning%20Docker.md) | **2 of 10** | [Generative AI and Predictive AI in the Cloud- Foundational Concepts and Scenarios](../Artificial%20Intelligence%20(AI)/Generative%20AI%20and%20Predictive%20AI%20in%20the%20Cloud-%20Foundational%20Concepts%20and%20Scenarios.md) →

### In [Getting Started with Kubernetes](../../Paths/DevOps/Learning%20Paths/Getting%20Started%20with%20Kubernetes.md)
**1 of 6** | [Kubernetes- Your First Project (2021)](../DevOps/Kubernetes-%20Your%20First%20Project%20(2021).md) →
...
- [Securing Containers and Kubernetes Ecosystem](../DevOps/Securing%20Containers%20and%20Kubernetes%20Ecosystem.md) — Kubernetes
- [Kubernetes- Cloud Native Ecosystem](../DevOps/Kubernetes-%20Cloud%20Native%20Ecosystem.md) — Kubernetes
- [Kubernetes- Microservices](../DevOps/Kubernetes-%20Microservices.md) — Kubernetes
- [Kubernetes- Essential Tools](../DevOps/Kubernetes-%20Essential%20Tools.md) — Kubernetes
