...
>
> **[0:00](https://www.linkedin.com/learning/getting-started-with-python-for-finance/introduction?u=76281980&t=0)** - Are you ready to supercharge your [Financial Analysis](../../Skills/Data%20Science/Financial%20Analysis.md) skills and take your career to the next level? Join us for this exciting [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) for Finance course. You'll learn how to harness the power of Python and [Pandas](../../Skills/Software%20Development/Pandas%20(Software).md) to transform [Financial Data](../../Skills/Software%20Development/Financial%20Data.md) into valuable insights. We'll cover everything from loading data, manipulating data for technical analysis, and advanced visualization techniques. You'll also learn how to optimize your code for maximum performance so you can analyze even the largest data sets quickly and efficiently. I'm Matt Harrison, a corporate trainer and author. I've written multiple books on Python and [Data Science](../../Topics/Data%20Science.md) and help thousands learn them. If you're ready, let's start.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (3), [Financial Analysis](../../Skills/Data%20Science/Financial%20Analysis.md) (1), [Pandas](../../Skills/Software%20Development/Pandas%20(Software).md) (1), [Financial Data](../../Skills/Software%20Development/Financial%20Data.md) (1), [Data Science](../../Topics/Data%20Science.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/getting-started-with-python-for-finance/what-you-should-know?u=76281980&t=0)** - [Narrator] Before starting this [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) for Finance course there are a few things you should know to get the most out of the content. First, it's important to have a basic understanding of Python. You don't need to be an expert, but you should be familiar with basic [Programming Concepts](../../Skills/Software%20Development/Programming%20Concepts.md) such as variables, loops, and functions. Second, experience with Jupyter Notebooks will be helpful. Jupyter is a web-based interactive computing environment that allows you to create and share code, visualizations, and other content in a single document. Lastly, some knowledge of [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) formulas will be helpful, as many financial analysts use Excel as their primary tool. While we won't be using Excel directly in this course, understanding basic formulas like sum, average and if will help convert existing Excel functions to Python. Armed with these skills, you'll be well equipped to dive into this Python for Finance course and get the most out of the content. Let's get started.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (4), [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (4), [Programming Concepts](../../Skills/Software%20Development/Programming%20Concepts.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Pandas](../../Skills/Software%20Development/Pandas%20(Software).md) (8), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Pandas](../../Skills/Software%20Development/Pandas%20(Software).md) (12)
> **CLI Commands:** make (3)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Pandas](../../Skills/Software%20Development/Pandas%20(Software).md) (8), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Pandas](../../Skills/Software%20Development/Pandas%20(Software).md) (4), [Windows](../../Glossary/Service/Windows.md) (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Pandas](../../Skills/Software%20Development/Pandas%20(Software).md) (4), [Financial Data](../../Skills/Software%20Development/Financial%20Data.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Zoom](../../Skills/Software%20Development/Zoom.md) (4), [Pandas](../../Skills/Software%20Development/Pandas%20(Software).md) (2)
...
>
> **[4:47](https://www.linkedin.com/learning/getting-started-with-python-for-finance/solution-exponential-moving-average?u=76281980&t=287)** that we're taking a bunch of these tools. I like to view [Pandas](../../Skills/Software%20Development/Pandas%20(Software).md) as kind of a Swiss Army knife that gives you 400 different tools that you can use and then we start layering them on top of each other. Using chaining is a great way to do this because it lets us look at them each as a recipe of operations.
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Pandas](../../Skills/Software%20Development/Pandas%20(Software).md) (8), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (4), [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (1)
> **Env Vars:** obv (15)
...
>
> **[3:12](https://www.linkedin.com/learning/getting-started-with-python-for-finance/challenge-rsi?u=76281980&t=192)** Generally, how most people solve it is they'll use the apply method in [Pandas](../../Skills/Software%20Development/Pandas%20(Software).md) and write a function that will calculate the average for you using this special technique of giving the first 14 values and then taking the previous value, multiplying it by 13, adding the current value, and dividing by 14. Good luck with it. This will be a good challenge to let you practice your Pandas skills and dive into a lot of what we've talked about in this course.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Pandas](../../Skills/Software%20Development/Pandas%20(Software).md) (2), [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (1)
> **Env Vars:** rsi (4)
> **Definitions:** is a  (2)
> **Warnings:** note that (1)
> **Speakers:** - [instructor] (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (7), [Pandas](../../Skills/Software%20Development/Pandas%20(Software).md) (4), [Big Data](../../Skills/Data%20Science/Big%20Data.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/getting-started-with-python-for-finance/next-steps?u=76281980&t=0)** - [Matt] Congratulations. You've completed the [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) for Finance course. You might be thinking, what are the next steps? First, I strongly encourage you to practice the material covered in this course. As with any new skill, the more you practice, the more confident and proficient you'll become. You can use your own [Financial Data](../../Skills/Software%20Development/Financial%20Data.md) or find some sample data sets online to practice. Second, check out my book, "Effective [Pandas](../../Skills/Software%20Development/Pandas%20(Software).md)." It's a bestselling pandas book that will help you master pandas. This book includes real world code that you won't find in other books. Pandas can be a challenge, so each chapter has exercises for you to get practice writing good pandas code. Third, I invite you to follow me on [LinkedIn](../../Skills/Web%20Development/LinkedIn.md). I'm always posting code and updates on Python pandas and related topics. Finally, I encourage you to apply the concepts and techniques you've learned on your own data. This is where you can really unleash the power of pandas and make a real impact at work. Whether you're analyzing financial reports, predicting market trends, or measuring the effectiveness of investment strategies, the skills you learned in this course can be applied to a wide range of financial applications. Thank you for taking my course and I wish you all the best in your future endeavors.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Pandas](../../Skills/Software%20Development/Pandas%20(Software).md) (7), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (2), [Financial Data](../../Skills/Software%20Development/Financial%20Data.md) (1), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (1)
...
← [SQL for Finance Professionals](SQL%20for%20Finance%20Professionals.md) | **5 of 7** | [Using Data in Financial Analysis](Using%20Data%20in%20Financial%20Analysis.md) →
...
**1 of 5** | [Python in Excel for Financial Professionals](Python%20in%20Excel%20for%20Financial%20Professionals.md) →
