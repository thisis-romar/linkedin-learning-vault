...
prev_courses:
  ...
  - '[The Data Science Of Economics Banking And Finance](The%20Data%20Science%20Of%20Economics%20Banking%20And%20Finance.md)'
next_courses:
...
>
> **[0:00](https://www.linkedin.com/learning/sql-for-finance-professionals/become-the-ultimate-financial-analyst-using-sql-23442774?u=76281980&t=0)** - I'm guessing [SQL](../../Skills/Data%20Science/SQL.md) may not be the first tool that comes to mind when thinking about the day-to-day of working in finance. Almost every industry is grappling with how to handle and make sense of vast stores of information or data, and finance is no different. This makes SQL, the programming language used to query data, increasingly essential for finance professionals to know, especially as more and more data gets produced from the proliferation of modern tools and technologies. My name is Megan Lieu, a financial analyst turned data scientist. I love working with SQL to derive insights and tell stories from large volumes of [Financial Data](../../Skills/Software%20Development/Financial%20Data.md). If you want to learn about how SQL is an essential tool in your finance toolkit, join me on [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) Learning for SQL for Finance.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [SQL](../../Skills/Data%20Science/SQL.md) (5), [Financial Data](../../Skills/Software%20Development/Financial%20Data.md) (1), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (1)
> **Env Vars:** sql (5)
> **CLI Commands:** make (1)
> **Definitions:** is an  (1)
> **Speakers:** - i (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/sql-for-finance-professionals/background-and-use-cases-of-sql-23448343?u=76281980&t=0)** - A powerful tool that finance professionals use to make [Financial Data](../../Skills/Software%20Development/Financial%20Data.md) analysis more efficient is [SQL](../../Skills/Data%20Science/SQL.md), or S-Q-L, or Structured Query Language. SQL is the standard language used to access relational [Database Management](../../Topics/Database%20Management.md) systems, which are programs that allow users to create and manage [Relational Databases](../../Skills/Software%20Development/Relational%20Databases.md). These are types of [Databases](../../Skills/Software%20Development/Databases.md) that are structured in a way where data can be identified and accessed in relation to another piece of data in the database. Some common relational database management systems you may hear about or work with are [Microsoft SQL Server](../../Skills/Software%20Development/Microsoft%20SQL%20Server.md), Oracle DB, [MySQL](../../Skills/Software%20Development/MySQL.md), and [PostgreSQL](../../Skills/Software%20Development/PostgreSQL.md). All of these systems use their own flavor or dialect of the SQL language. Common SQL dialects include T-SQL, PL/SQL, MySQL, and PL/pgSQL, respectively. However, all of these languages share the core features of standard SQL, which we'll learn about in the [rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) of this chapter.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [SQL](../../Skills/Data%20Science/SQL.md) (7), [Database Management](../../Topics/Database%20Management.md) (2), [MySQL](../../Skills/Software%20Development/MySQL.md) (2), [Financial Data](../../Skills/Software%20Development/Financial%20Data.md) (1), [Relational Databases](../../Skills/Software%20Development/Relational%20Databases.md) (1)
> **Env Vars:** sql (8)
...
>
> **[2:12](https://www.linkedin.com/learning/sql-for-finance-professionals/queries-the-basic-building-blocks-of-sql-23451293?u=76281980&t=132)** FROM the Orders table WHERE the CustomerID is equal to seven. What we are asking from the Orders table is to give us the OrderID and date of the order that the customer with an ID of seven has placed. The result is as follows. Next, what if we want to see all the columns in the table to get a bigger picture of these same orders? Then instead of selecting specific columns in the SELECT clause, you can just use SELECT *, which will return the [rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) of the details about this person's orders available to us in the orders table. The result is as follows. Now that we know how to use the basic building blocks of SQL, we can move on to functions, which will allow us to ask more advanced questions about our data.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [SQL](../../Skills/Data%20Science/SQL.md) (6), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [SQL](../../Skills/Data%20Science/SQL.md) (3), [Statistics](../../Skills/Data%20Science/Statistics.md) (1), [Word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/sql-for-finance-professionals/sql-in-the-finance-field-23454232?u=76281980&t=0)** - [SQL](../../Skills/Data%20Science/SQL.md) can be a very powerful tool in a financial analyst's toolkit. It's great for [business intelligence](../../Skills/Data%20Science/Business%20Intelligence%20(BI).md), [Forecasting](../../Skills/Data%20Science/Forecasting.md), and [Financial Modeling](../../Skills/Data%20Science/Financial%20Modeling.md). Let's talk about why SQL is such an effective tool to use in finance. Knowing how to manipulate and analyze [Financial Data](../../Skills/Software%20Development/Financial%20Data.md) and records is at the heart of [Financial Analysis](../../Skills/Data%20Science/Financial%20Analysis.md). Financial analysts often deal with large volumes of data to be able to create their financial models. Two common concepts used by financial analysts are [Pivot Tables](../../Skills/Data%20Science/Pivot%20Tables.md) and V-lookups. These are spreadsheet concepts we will learn more about later, but for now, be aware that they are widely used for building reporting that financial analysts are responsible for. Both pivot tables and V-lookups have direct translations in the world of SQL and can make the analyst's job much easier and faster. Another reason analysts in the field greatly benefit from using SQL in their day-to-day is that they often may need to get their own data rather than depending on engineers to extract it for them. Often, being able to write simple queries in SQL is all they need to access data that may not be readily available to use for their analyses. It's important to acknowledge that some finance professionals won't need to use SQL. Many of the most common analyses, such as financial statement, ratio, and variance analyses just don't require very much or very complex data, and thus can be easily handled by spreadsheets or other reporting systems. However, when the analyst needs to perform deep dive investigations or complex forecasts or they need to work with engineers to acquire the data,
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [SQL](../../Skills/Data%20Science/SQL.md) (7), [Pivot Tables](../../Skills/Data%20Science/Pivot%20Tables.md) (2), [Business intelligence](../../Skills/Data%20Science/Business%20Intelligence%20(BI).md) (1), [Forecasting](../../Skills/Data%20Science/Forecasting.md) (1), [Financial Modeling](../../Skills/Data%20Science/Financial%20Modeling.md) (1)
> **Env Vars:** sql (7)
> **CLI Commands:** make (1)
> **Definitions:** is a  (1)
> **Analogies:** such as (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/sql-for-finance-professionals/excel-vs-sql-in-finance-23455225?u=76281980&t=0)** - [Instructor] [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) is perhaps the main tool used by financial analysts in the field. Much of the data these analysts have to work with come in the form of spreadsheets that are exported from various reporting systems. This means that when they have to manipulate and analyze that data, doing so directly in those spreadsheets rather than going to outside tools is often easier. Beyond its ease of use, spreadsheet tools like Excel are very widely used by finance professionals because of the formatting and calculation functions readily available in the tool. The formatting functionality in Excel allows users to easily communicate findings and reports in [Dashboards](../../Skills/Data%20Science/Dashboards.md), but in addition to that, conditional formatting is another extremely helpful tool that helps in reducing errors in the data. The variety of financial functions available in Excel allow you to perform the most popular calculations that are required for building [Financial Statements](../../Skills/Data%20Science/Financial%20Statements.md), financial models, [Forecasting](../../Skills/Data%20Science/Forecasting.md), budgeting, and account reconciliations. [SQL](../../Skills/Data%20Science/SQL.md), on the other hand, is a tool that is a lot less native in the field of finance. This is because oftentimes, many finance teams just don't deal with large enough volumes of data to need to use [Databases](../../Skills/Software%20Development/Databases.md) and thus SQL. But where more complex, frequent, or cross-functional analyses are involved, these teams are more likely to need SQL so that they can readily access the data they need without relying on engineers to get it. For example, if a global bank needs to pull data on the hundreds of thousands of transactions its customers have over the course of a fiscal year, a spreadsheet tool like Excel just would not have
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Excel](../../Skills/Data%20Science/Microsoft%20Excel.md) (7), [SQL](../../Skills/Data%20Science/SQL.md) (4), [Dashboards](../../Skills/Data%20Science/Dashboards.md) (1), [Financial Statements](../../Skills/Data%20Science/Financial%20Statements.md) (1), [Forecasting](../../Skills/Data%20Science/Forecasting.md) (1)
> **Env Vars:** sql (4)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [SQL](../../Skills/Data%20Science/SQL.md) (4), [Financial Statements](../../Skills/Data%20Science/Financial%20Statements.md) (2), [Databases](../../Skills/Software%20Development/Databases.md) (2)
> **Env Vars:** sql (4)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/sql-for-finance-professionals/developing-predictive-models-using-sql-and-python-r?u=76281980&t=0)** - [Instructor] How are these predictive models developed and deployed in the real world? In finance and in other industries that use these models to maximize revenue, reduce expenses, and mitigate risks, [SQL](../../Skills/Data%20Science/SQL.md) is not the only tool used. SQL is often combined with other coding languages like [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) and R to create these models. While SQL is great for querying vast amounts of data that are needed to train the models, the actual cleaning and selecting of important features of the data, then training and testing a model can only be done outside of SQL. This is because languages like Python and R vast libraries and functionalities specifically made for the purpose of data analysis and predictive programming. Let's take a look at what the entire predictive model building process would look like from beginning to end in the context of SQL, Python, and/or R. The process of building a predictive model generally is composed of five steps. One, gathering and storing the data, two, [Data Cleaning](../../Skills/Data%20Science/Data%20Cleaning.md), three, feature selection, four, building and evaluating the model, and five, deploying the model. The first step of gathering and storing the raw data needed for the model starts with either [Data Pipelines](../../Skills/Data%20Science/Data%20Pipelines.md) that data engineers have built to automatically extract and load information from data sources, or manual steps to scrape, download, or import that data. Regardless of whether that data is gathered automatically or manually, it has to be stored in [Databases](../../Skills/Software%20Development/Databases.md), especially if the volume of that data is significant. The next step of data cleaning is critical
>
...
>
> **[3:08](https://www.linkedin.com/learning/sql-for-finance-professionals/developing-predictive-models-using-sql-and-python-r?u=76281980&t=188)** is to ensure your model gets practice predicting as accurately as possible when it's presented with unfamiliar data in the future. Lastly, the model that has been optimized over several rounds of iterative review is deployed so that the model's predictions are consumed by an application that directly affects business decisions. This operationalization is often done using scalable [REST](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) API endpoints for the model. These endpoints store your model and its [Metadata](../../Skills/Web%20Development/Metadata.md) and allow you to exchange that information with developers who can use the model in mobile and web applications. Next, let's take a look at what we've learned about the role of SQL and [Predictive Modeling](../../Skills/Data%20Science/Predictive%20Modeling.md) to build our own fraud detection model.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [SQL](../../Skills/Data%20Science/SQL.md) (8), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (6), [Data Cleaning](../../Skills/Data%20Science/Data%20Cleaning.md) (2), [Data Pipelines](../../Skills/Data%20Science/Data%20Pipelines.md) (1), [Databases](../../Skills/Software%20Development/Databases.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [SQL](../../Skills/Data%20Science/SQL.md) (7), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (3), [Statistics](../../Skills/Data%20Science/Statistics.md) (2), [Predictive Modeling](../../Skills/Data%20Science/Predictive%20Modeling.md) (1), [Data Pipelines](../../Skills/Data%20Science/Data%20Pipelines.md) (1)
...
- [Megan Lieu](../../Instructors/Data%20Science/Megan%20Lieu.md)
...
← [Financial Forecasting with Analytics Essential Training](Financial%20Forecasting%20with%20Analytics%20Essential%20Training.md) | **4 of 7** | [Getting Started with Python for Finance](Getting%20Started%20with%20Python%20for%20Finance.md) →
...
← [The Data Science Of Economics Banking And Finance](The%20Data%20Science%20Of%20Economics%20Banking%20And%20Finance.md) | **2 of 4** | [From Excel to SQL](From%20Excel%20to%20SQL.md) →
