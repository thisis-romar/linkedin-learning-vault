...
>
> **[3:08](https://www.linkedin.com/learning/advanced-data-visualizations-12-uncommon-plot-types-and-how-to-use-them/ridgeline-plots?u=76281980&t=188)** you'll need specialized software. If you're using R you can use the GG Ridges function. In Stats, you can use the user written command joyplot. And in [[Python (Programming Language)|Python]], you can use the joypi function. Ridgeline plots are a great way to visualize several densities in one single graph. Consider using them if you're faced with complex distributional comparisons over multiple groups.
