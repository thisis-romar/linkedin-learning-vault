...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/power-bi-quick-tips-24532183/add-people-or-groups-to-a-shared-workspace-25205180?u=76281980&t=0)** Once you create a shared workspace, you'll likely want to add people or groups to kick off collaboration on the content that's being crafted and analyzed within the workspace. With the workspace in view, select Manage Access, then select Add People or Groups. A information message appears describing what each type provides access to. Admins, members, and contributors have edit and view access, while viewers only have view access. In the field provided, enter the name or the email address for the person or the group that you want to add. As you type a name, a drop-down list will display showing all of the matches for fellow colleagues that you can choose. Make a selection and then choose the type that you want to assign to this person or group. Then select Add. A notification appears that that has been added. Continue to repeat the same steps for each person or group that you want to add. Once done, select the X in the upper right corner to close this pane. And that is how you can add people or groups to your shared workspace.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/power-bi-quick-tips-24532183/share-a-semantic-model-25206000?u=76281980&t=0)** A semantic model can be shared with other people in your organization. Start with the workspace and view that contains the semantic model that you want to share, then select Share Semantic Model. Enter the name or the email address for the colleague that you want to share this with. As they start to enter the name "Jenny," name appears in the list, and then select it. There are three settings that you can customize: allow recipients to share the semantic model, allow recipients to build content with the data associated with the semantic model, and to send an email notification. All three are checked by default. Make any customizations needed. As well, you can include an optional message to provide context for why you're sharing this model.
>
> **[0:55](https://www.linkedin.com/learning/power-bi-quick-tips-24532183/share-a-semantic-model-25206000?u=76281980&t=55)** Then select Grant Access. A notification appears in the upper right corner when the access has been granted. Let's close that notification. And that is how you can share a semantic model with colleagues, helping them build reports based on that data.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/power-bi-quick-tips-24532183/sharing-a-power-bi-dashboard-or-report-25000943?u=76281980&t=0)** A dashboard or report can be shared with someone else. Start by locating the dashboard or the report, and then hover over and select Share. Within the Send Link area, enter the name or the email address of the person you would like to share this with. By entering the name, you can then select the name from the list. You can also include an optional message. And before sending, notice at the top it's set to specific people can view or share. By selecting this, you may have other choices that you can make, if you want to make it available to people in your organization or people that already have access. In the Settings area, you can choose if you want the recipients to share this report, or if you would like the recipients to be able to build content with the data associated with this report. Make the appropriate checks in the boxes for the settings you would like to apply and then select Apply. Once you're ready to send it, go ahead and select Send. A notification appears letting you know that this send link notification has been emailed. And that's how you can share a dashboard or a report.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/power-bi-quick-tips-24532183/create-a-paginated-report-from-a-data-set-25202755?u=76281980&t=0)** A paginated report is a highly formatted page layout report optimized for printing and exporting in a different file format. Here's how to create a paginated report. Start with a workspace in view and then select a semantic model. Select the downward-facing arrow next to "Explore this data," and then select Create a Paginated Report. A blank report area loads here. Next, select the fields that you would like to include in this report. We'll select Accounts and Owners. You can also filter based on what is included along with these fields. Let's expand Owner. Uncheck Select All and then check one of the employees listed here. Next, let's save this report. We'll go to the top toolbar and select Save. We'll keep it saved in the same workspace and give it a name here,
>
> **[1:17](https://www.linkedin.com/learning/power-bi-quick-tips-24532183/create-a-paginated-report-from-a-data-set-25202755?u=76281980&t=77)** and then select Save. Let's close the notifications in the upper right corner, and that is how you can create a paginated report.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/power-bi-quick-tips-24532183/creating-a-page-in-a-report-24998999?u=76281980&t=0)** While a dashboard and a report may look similar in both formatting and layout, a dashboard is one page of data visualizations, and a report can have multiple pages of data visualizations. While we're here in this report, let's go ahead and create a new page. To the right of the existing pages, that's the tabs down here at the bottom, select New Page. This is the new page that has now been created within this report. To rename this page, right-click over the Page tab, then select Rename and modify the existing name, and then press Enter.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/power-bi-quick-tips-24532183/pin-a-visualization-to-a-dashboard-25205183?u=76281980&t=0)** A visualization created within a report can be pinned to a new dashboard. Here's how. Hover the mouse pointer over the tile, select Pin Visual. For the question, "Where would you like to pin to?" select New Dashboard. In the dashboard name box, enter a name for the dashboard. Then select Pin. A notification displays that you can go to the dashboard. Let's select this. And here is the new dashboard with the pinned tile in view. And that's how you can create a new dashboard and pin a visual quickly.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/power-bi-quick-tips-24532183/creating-a-big-number-tile-25201875?u=76281980&t=0)** You can ask a question about numerical data and have a big number tile displayed on a report page. To get started with a report page in view, such as the empty page you see here, select Edit from the toolbar above. Now within edit mode, go to the same toolbar at the top and select Ask a Question. This adds the Ask a Question tile to the page. You can ask a question by working with one of the suggested pre-built questions here, or in the box provided at the top, you can type your own question, and that's what we're going to do.
>
> **[0:49](https://www.linkedin.com/learning/power-bi-quick-tips-24532183/creating-a-big-number-tile-25201875?u=76281980&t=49)** So we're going to ask what the average temperature was for the past year and then select Submit. And here is the big number answer. Now to save this big number tile in this report page, just to the right of the box where we asked the question, we need to select "Turn this Q&A result into a standard visual." And now we have essentially pinned this to the report page. Let's go ahead and save the changes that we made to this report by selecting File and then Save. We can close the report save notification in the upper right corner. And that's how you can create a big number tile.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/power-bi-quick-tips-24532183/creating-a-table-tile-25203578?u=76281980&t=0)** A table of related data can be created for use within a report or a dashboard. With this report page in view, let's go over here to the Data pane and select fields that we want to populate within a table tile. First, let's expand the Datetimes area and then check the field date. And notice over here, our table tile has started to be created. Let's come back over here and expand Weather and then check sky conditions. Now there may be some adjustments to the size of this tile, and we'll get to that later in the course, but this visualization is now ready to be pinned if you want to pin that elsewhere. And it's here to work within the page of this report. Before we do anything else, let's go ahead and save the changes to this report by going to File and then selecting Save. And that's how you can create a table tile.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/power-bi-quick-tips-24532183/create-a-slicer-25202748?u=76281980&t=0)** A slicer can be added to quickly filter all related data within a report page or within a dashboard. To create a slicer, let's go to the Visualizations pane and then locate and select Slicer. It inserts the slicer tile here, and it's going to be the next empty space within the page of your report or within the dashboard that you're working with. But we don't have anything to filter yet within this tile. And just as the instruction says here at the top, you can either drag the fields from the Data pane here, or you can go and select them, check them within that Data area. So we're going to go over here to Data, and we're going to expand the Stations category. We want to filter based on the station IDs, so we're going to check this box. And remember you could also left-click and drag and drop into the tile here if you want as well. So this is a listing of all of the different airports in the Southern California area. And now if we want to filter all of the related data, so everything that has a relationship with this station ID on the page of this report, we can go ahead and check one of these airport codes, like LAX, which is Los Angeles. Now notice when I check that, every tile on this report page dynamically updated to only show the corresponding data for that station ID, LAX. Now if I go ahead and select another one, notice how it changes to just that station ID only.
>
> **[1:34](https://www.linkedin.com/learning/power-bi-quick-tips-24532183/create-a-slicer-25202748?u=76281980&t=94)** In the upper right corner, you can also clear the selections by selecting this eraser. And that's how you can set up a slicer to quickly filter a report page or a dashboard.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/power-bi-quick-tips-24532183/rearrange-and-resize-tiles-24999953?u=76281980&t=0)** A tile within a report page or a dashboard can be resized or moved. With this report page in view, let's go ahead and select Edit from the toolbar at the top. And now let's go ahead and place the mouse [[Cursor]] directly over a tile that we want to change the size of. We'll give this tile a click and that provides these handles around the perimeter. Now if I place my mouse cursor over the corner area here and I left-click and drag, I am resizing this tile both vertically and horizontally, making it smaller or larger. If I grab this handle, left-click, and drag, I'm making the tile wider. Same thing with this handle. I can make it taller or shorter. If you want to reposition a tile, place the mouse cursor over the middle of the tile, left-click, hold, and drag. As you're doing that, you may notice these red dashed lines that appear. This is letting you know how it is aligning with adjacent tiles on the page. So as I bring it over here and I get closer to the middle, you'll notice that it's aligned. And if I come down just a bit, we can get it aligned horizontally and vertically. Now let's go to the other page of this report and show you something else that can be useful. When you're discussing a key point on a report page, you may want to spotlight that tile. To do this, go ahead and hover over the tile. What we're looking for is in the upper right corner, so you may have to click the tile.
>
> **[1:34](https://www.linkedin.com/learning/power-bi-quick-tips-24532183/rearrange-and-resize-tiles-24999953?u=76281980&t=94)** We're looking for more options. Let's select this and then select Spotlight. Notice that everything else on this page is washed out, except for this tile that we put a spotlight on. This is a great way to have everyone focus on just this data. And that's how you can resize tiles, rearrange tiles, and flash a spotlight on a tile.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/power-bi-quick-tips-24532183/filter-data-25202751?u=76281980&t=0)** Data visualizations in a report can be filtered to answer specific questions. With a report in view, select the arrow to expand the Filters pane. The filter fields that have been set up for this report are listed in this pane. Select the criteria that you want to filter for within each field. As selections are made, the report dynamically updates based on the data that matches the criteria that you chose. To reset this back to all data for a field, select Clear Filter in the upper right corner. And that's how you can filter a report.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/power-bi-quick-tips-24532183/setup-an-alert-25206001?u=76281980&t=0)** A visual tile can have an alert set up to notify when a specific threshold is met. Go to the tile you want to set this up for and select More Options. From the menu, select Manage Alerts. From the Manage Alerts pane, select Add Alert Rule. The alert title includes the name of the tile. Update this as needed. Select a condition above or below and then update the threshold as needed. Select the maximum notification frequency at most every 24 hours or at most once an hour. You can also have email notifications sent. This is turned on by default. Then select Save and Close. That's how you set up an alert to stay in the know about dashboard data.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/power-bi-quick-tips-24532183/bookmark-a-report-25201872?u=76281980&t=0)** A bookmark can be created for a report. This captures the report's current state or a filtered view that you choose for your personal use. With the report in view, select Bookmarks, then select Add a Personal Bookmark. Update the bookmark name, and check the box if you want to make this the default view. Then select Save. Here's the bookmark within the bookmarks list. If I click outside of this, we'll go back to bookmarks. And this is how you can access the bookmark. To manage this bookmark, select More Options and then make a selection from the list. And that's how you can create a report bookmark for quick retrieval in the future.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/power-bi-quick-tips-24532183/export-to-pdf-24999955?u=76281980&t=0)** There are several different file formats you can export a report to, including a PDF. To export as a PDF, select Export from the toolbar and then select PDF. Next, choose the settings for this export. You can export with the current values or with the default values. If there are hidden report tabs included with this report, you can check this box to exclude them. If the box looks like the outline is grayed out, so a lighter version of gray as you see it here, it means that there are no hidden report tabs to exclude. If you only want to export the current page in view, check this box. Once the settings have been changed, go ahead and select Export. You'll have a notification in the upper right corner that the export is in progress. Once the export is complete, you'll see it listed here in the downloads listing. You can open the file to view it in your PDF viewer. And that's how you can export a report as a PDF.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/power-bi-quick-tips-24532183/generate-a-qr-code-25202750?u=76281980&t=0)** You can generate a QR code for colleagues with permission to a report to access it from their mobile devices. Here's how. With the report in view, select File from the toolbar and then select Generate a QR Code. A notification appears that the QR code is ready. Select Download and the QR code is downloaded in a JPEG format, just as you see here in the downloads list. Let's go ahead and close this notification. And that's how you can generate a QR code for sharing elsewhere.
...
>
> **[0:43](https://www.linkedin.com/learning/power-bi-quick-tips-24532183/sharing-a-power-bi-report-to-teams-chat-or-channel-post-25201876?u=76281980&t=43)** Then select Share. A notification appears that the link has been shared. And that's how you can share a Power BI report in teams for collaboration.
...
>
> **[0:57](https://www.linkedin.com/learning/power-bi-quick-tips-24532183/asking-copilot-to-suggest-content-for-a-power-bi-report-25204315?u=76281980&t=57)** Copilot does some quick analysis and it returns this answer: here's a suggested outline. We have weather trends. And notice the button here to create a page based on this content. We can expand the other suggestions like population analysis and temperature variations as well as rainfall patterns. Let's go ahead and select Rainfall Patterns. We'll select Create. We have a notification that it's working on it. And here is the newly created page based on Copilot's suggestion. That is how you can ask Copilot to suggest content to build pages of your report.
