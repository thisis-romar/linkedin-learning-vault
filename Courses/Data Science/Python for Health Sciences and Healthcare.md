...
>
> **[3:10](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/what-is-programming?u=76281980&t=190)** So kindly be a good programmer that documents. Programming is only one of the tasks involved in software engineering. Not everyone who can write the program has the skills necessary to manage complex software systems. And not everyone who can manage software systems is an excellent coder. Understanding your strengths is critical to any software work you'll be doing.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/modules-libraries-packages-and-systems?u=76281980&t=0)** - [Instructor] One of the most important things in programming is code organization. Being organized enables reusability. A simplified sequence of code organization is from modules to libraries, to packages, then systems. To help you understand this, think of the progression of the cell, tissue, organ, and system progression in biological systems. We start with the cells, that evolves into tissues. Those tissues form into organs, and those organs power vital bodily functions. Think of your code in the same way. Code is a set of instructions for your computer system. So let's look at how you can organize those instructions. Module is a set of code for related functionalities. For example, a module to have different data types to a collection of patient data. A library is a collection of related modules and code. For example, a library for arithmetic operations. A package is a bundle of libraries, modules, and code for related purpose. For example, a packet that can carry out arithmetic and logical operations. Finally, the software system is an integration of different packages, libraries, modules, and code that can all work together to power a real world system. For example, your interaction
>
> **[1:35](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/modules-libraries-packages-and-systems?u=76281980&t=95)** with the electronic health record is a software system in action. Keeping your code organized is the key to a well-functioning system, and that's imperative when it comes to industries that deals with a lot of sensitive data and code.
...
>
> **[1:43](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/python-keywords?u=76281980&t=103)** Some are related to true or false. True and false itself. There are other keywords like none, with, assert, global, lambda, async, delete. There are tons of keywords, but don't worry. That might seem overwhelming now, but you will learn which keywords to use quickly. When you do, you will be able to code better and faster.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/write-python-file?u=76281980&t=0)** - [Instructor] Let's say you want to add content to created .py file like demo_python_file.py here. You double click on the filename and the text editor opens and type in something like def welcome print
>
...
>
> **[0:48](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/read-python-file?u=76281980&t=48)** Print file dot read. We have our output as string. If you prefer they are printed in separate thread lines and not the single string, Then repeat the same code, but with thread lines.
>
> **[1:19](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/read-python-file?u=76281980&t=79)** The output is each sentence separated by the next line characters. If you want to practice Drake, research how to remove the next line character from your outputs. See if you can do it on your own.
...
>
> **[2:07](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/numeric-data?u=76281980&t=127)** The output is float, so consider numbers with decimal points as float. Assign 5.0 to a variable called sample float. Print out the value and data type as a single cell run.
>
> **[2:34](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/numeric-data?u=76281980&t=154)** It's possible to convert data types, for example, converting floats to integer and vice versa. So, let's convert 5.60 to an integer by calling the int method on it. The output is five, which is the closest integer value to 5.60. While both types of data are common, integers are commonly used for all numbers, and floats are used when higher precision, such as decimals are needed.
...
>
> **[2:10](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/string-data?u=76281980&t=130)** It's still a string. What about multiple sentences with punctuations?
>
...
>
> **[2:40](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/string-data?u=76281980&t=160)** Well done, by now you should have an intuition on writing strings in Python. Something to note here, Python strings are immutable, meaning that ones the string is created, it cannot be modified. However, you can assign a new value to the same variable name. So practice writing strings and assigning different variables to those strings.
...
>
> **[2:09](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/boolean?u=76281980&t=129)** Again, when it comes to Booleans, this is only for datasets that have two factors like true or false, on and off. In a healthcare setting, this could be something like continue or discontinue prescription. So make sure if you have a dataset with other variables, you're using another type of data like numeric or string.
...
>
> **[1:31](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/lists?u=76281980&t=91)** You can also remove a specific item using the remove method. So let's remove diclofenac.
>
> **[1:46](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/lists?u=76281980&t=106)** Now let's talk about indexing. Indexing allows you to assess the position of characters and strings or items in data structures like list. In Python, you count from position 0. So in a list, paracetamol is in position 0, and can be assessed by indexing the list. So when you run sample_list[0], the output is the first item in the list, which is paracetamol in our case. This is a short list, so you can see tramadol in position five as the last item. But imagine it's a very long list. You can assess the last item by sample_list[-1].
>
> **[2:36](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/lists?u=76281980&t=156)** So remember indexing when you're working with very large list. Another useful method is insert. You can use the insert method to place an item in a particular position. Let's place diclofenac after piroxicam, in position five. You can see diclofenac in position five right after piroxicam. Let's say you'd like to duplicate the list and save it to a different variable. You can use the copy method. Now we have a duplicate in a new variable called sample_list_copy. To reverse the order of items on your list, use the reverse method, sample_list_copy.reverse.
>
> **[3:40](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/lists?u=76281980&t=220)** Now we have tramadol, which was in the last position, in the first position. A list can be sorted using the sort method. If your list is strings, you can sort alphabetically, sample_list_copy.sort.
>
> **[4:04](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/lists?u=76281980&t=244)** sample_list_copy is now sorted alphabetically from aspirin to diclofenac, and tramadol is now the last item on the sorted list. If your list is numeric, you can sort an ascending order of magnitude. Let's make a list of numbers called sample_list_numeric, and then sort it. The list contains 1, 12, 23, 34, 90, 80, 70, and 67.
>
> **[4:49](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/lists?u=76281980&t=289)** Let's sort the list of numbers. You can see the output is ordered from the smallest one to the biggest, which is 90 in this example. Another method you can also use is pop. This will remove the last item in the list, so let's practice it on the numbers list, sample_list_numeric.pop.
>
> **[5:21](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/lists?u=76281980&t=321)** The last item in our list is 90, and as you can see, it's been removed. As you can see, list are incredibly useful for most data structures. Practice making lists of different lengths and of numeric and string data. Try applying these different methods for modifying your list.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/tuples?u=76281980&t=0)** - [Instructor] Tuples are ordered sequence like list, but they are immutable, meaning they cannot be modified. So tuples are a suitable data structure when you want permanence. Let's practice implementing the tuple data structure. In the code cell, type in paracetamol as a string, a comma, and then 500, 500 indicates 500 milligram, a common prescription strength for paracetamol. The output automatically puts them in parentheses which is right. You can create tuples with or without brackets. Let's check the data type of the output. Voila, it's tuple. Now let's create another example of all string values of common analgesics. Now let's create another example of all string values of common analgesics, paracetamol, ibuprofen, aspirin, and saving to a variable called sample_tuple_string. And check the type. It's still a tuple. Create a new tuple with numeric values only. We'll use 500, 200, and 325. These are common dosage strengths for the value in the string variable. sample_tuple_numeric,
>
> **[1:40](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/tuples?u=76281980&t=100)** it's still a tuple. You can assess values in tuples by index. Let's assess the third value in position two of the sample numeric, sample_tuple_numeric square bracket two. The output is 325, which is expected. You can get the same value by negative indexing, so I say sample_tuple_numeric square bracket minus one.
>
> **[2:12](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/tuples?u=76281980&t=132)** So let's check for the immutability. Let's say you want to change the medication names to their common brand. For example, change paracetamol to Tylenol. Paracetamol is in position zero, so we index sample_tuple_string square bracket zero and assign Tylenol to position zero like this. When we run the code, we get the type error. Tuple objects does not support item assignments. In plain terms, this is not allowed for this data type. Now let's attempt to append the new value of 400 to the sample_tuple_numeric. Okay, we get an attribute error. Tuple object does not have an attribute appended. Again, you cannot modify a tuple. That's the key feature of this data structure. There's a workaround though. Even though you can add to an existing tuple, you can add two tuples together. When you do this, you create the new tuple. Let's add sample_tuple_string and sample_tuple_numeric.
>
> **[3:39](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/tuples?u=76281980&t=219)** As you can see, the two tuples have been added together. Tuples are a great data structure when you don't want the function to change. So practice using list in tuples and see which data structure works best for your desired outcome.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/sets?u=76281980&t=0)** - [Instructor] Sets are immutable collection of unique elements. While immutable, they're unordered. So, specific positions are not assigned to each item. Let's practice implementing a set and making modification. Let's go ahead and create a set and save into a variable code sample set. We'll put in some names of medications called proton pump inhibitors. Like, omeprazole, rabeprazole, pantoprazole, rabeprazole again, and lansoprazole, making it five values. But when we run the sample set variable, we have an output with four values, and they are also being reordered. So what we said at the beginning about sets not being ordered is true. It returned the values in alphabetical orders. It did not permit to duplicate. In our case, the duplicate rabeprazole was removed.
>
> **[1:13](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/sets?u=76281980&t=73)** The type method confirms that we have a set. Data types can be combined in a set. For example, a patient's name, age, unique ID, and nationality, saved in the variable sample_patient_set.
>
> **[1:38](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/sets?u=76281980&t=98)** By the way, this is still considered to be a set despite it being the mix of strings and numerics. (indistinct) omeprazole is a member of the sample set. It says true. What if we ask if esomeprazole is part of the sample set? The answer is false. Can we update the set with esomeprazole using the add method?
>
> **[2:19](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/sets?u=76281980&t=139)** Yes, we can. Esomeprazole is now part of our set. We can go ahead and remove esomeprazole and be back to the original list. If you apply the pop method, it'll remove a random item. So let's see what it removes from sample set. Okay, it removed omeprazole this time. Let's see if it changes if we run it again. It removed lansoprazole on the second try. Two sets can be joined using the union method. Let's try it with sample_set and sample_patient_set. Okay, that worked fine. Practice creating sets with strings, numerics, and a mix of both. Try to put in duplicate, and see if your method scrub the duplicates, and what order your set appears.
...
>
> **[1:59](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/dictionaries?u=76281980&t=119)** Let's confirm the type. Type, sample_dictionary_antihypertensives. Yes, we have a proper dictionary. If you're following Kinley, you'll notice none of the previous data structures can hold data like this. A dictionary can hold multiple data sets within its structure. If you would like to get the list of beta blockers alone, type sample_dictionary_antihypertensives, square bracket, betablockers. Okay. We have a list of beta blockers. Atenolol, propranolol and metoprolol. What if you'd like to assess just the second value in the list? Remember that the value here, it's a list, so you can access it directly by specifying position two, index one, and gets propranolol.
>
> **[3:10](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/dictionaries?u=76281980&t=190)** If you'd like to print out the keys, which in this case, are the classes of antihypertensives, you can do that by calling the keys method on the dictionary. This returns the expected dictionary keys of diuretics, beta blockers and ACEI. You can extend the Python dictionary using the updates method. So, let's add a new class of antihypertensives, calcium channel blockers, to a dictionary. Sample_dictionary_antihypertensives.update, calcium channel blockers, amlodipine, nifedipine and verapamil.
>
> **[4:07](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/dictionaries?u=76281980&t=247)** If we check again, here we go, our dictionary has a new class. You can also create a dictionary using the dict method in Python. Let's say, a patient's information dictionary code, patient_info_dictionary. Dict method, name is a girl's name, kuki. Age, 20. Nationality, kukiland. Patient_info_dictionary. If you notice the output, the dict method has converted it to a dictionary with the curled brackets and semicolon. Now that you know how to make list, topples, sets, practice using those within the dictionary structure. What immutable keys would you associate with these values?
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/solution-create-a-set-from-a-list?u=76281980&t=0)** - [Instructor] To return a set of unique elements from the list of antihistamines, we will use the inbuilt set function. Let's run our code. That's right. The code returned a set of unique items from a list of antihistamine.
...
>
> **[1:27](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/arithmetic-operations?u=76281980&t=87)** 500, 200, and 50. Analgesics plus dosage strength in milligram.
>
> **[1:43](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/arithmetic-operations?u=76281980&t=103)** Okay, now we have a single list with all the elements in the two lists combined. You can work with integers as well. Let's declare a variable called value one and assign 100 to it. Another one named value two and assign 20 to it. Subtract value two from value one. The output is 80 as expected. Let's try the other way. The output is minus 80 as expected. Can we subtract string values from each other? Let's see. 500 milligram minus 200 milligram. Oops. We can't. We have a type error. Unsupported operand type for string and string. What if it's a list of numbers like this? 100, 200, 300 minus another list of 20, 40, 60.
>
> **[3:13](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/arithmetic-operations?u=76281980&t=193)** Another error message. So there's a way to do this, but not just directly. For multiplication, the asterisk operator is used. So 5 multiplied by 5 gives 25.
>
> **[3:32](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/arithmetic-operations?u=76281980&t=212)** We can multiply values stored in variables too. Let's assign 4.5 and 3.124 to variables float one and float two. Let's multiply float one and two and save to a new variable called float combined.
>
> **[4:01](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/arithmetic-operations?u=76281980&t=241)** Can we multiply strings by numbers to repeat values? Omeprazole multiply by three.
>
> **[4:13](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/arithmetic-operations?u=76281980&t=253)** Okay. It returns the string repeated three times. If you want this to have space between, you need to add it right beside omeprazole. Now we have omeprazole three times with space in between. Can we use a list of analgesics again and multiply it by three?
>
> **[4:50](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/arithmetic-operations?u=76281980&t=290)** Yes. It returns the new list with all the elements in three places. Let's try the same with a list of numbers like dosage strength in milligram.
>
> **[5:12](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/arithmetic-operations?u=76281980&t=312)** Multiply by three. It works too. It's returned all the elements three times. To raise the numeric expression to the power of another, you use the double asterisk. So 5 raised to power 4 is 625.
>
> **[5:39](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/arithmetic-operations?u=76281980&t=339)** Numeric values saved in variables can also be raised. So let's save 5 into a variable called power number and then raise it to power 4. We have 625, which is the same as above.
>
> **[6:05](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/arithmetic-operations?u=76281980&t=365)** Floats can also be exponentiated. So 5.4 raised to a power of 5
>
...
>
> **[6:24](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/arithmetic-operations?u=76281980&t=384)** You can even divide numeric values by the forward slash character. So 100 divided by 5 is 20.
>
> **[6:39](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/arithmetic-operations?u=76281980&t=399)** Numeric values stored in variables can also be divided. From previous defined variables, value one divided by value two is 5. And for floats, 1.5 divided by 2 is 0.75. 100.5 divided by 2.5 is 40.2. I'll imagine values like these when (indistinct) in the lab. As the name suggests, arithmetic operations are common math operations but apply to a variety of data types. This kind of programming can be incredible when you're dealing with very small or big values, or you're looking for very precise information. Familiarize yourself with Python arithmetic functions, and you'll be amazed at how much you can do.
...
>
> **[1:03](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/comparison-operations?u=76281980&t=63)** The output is true. No error messages, so it works. Let's try the same examples, but with not equal sign. The sign for that is a shebang and one equal sign.
>
> **[1:26](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/comparison-operations?u=76281980&t=86)** 5 not equal to 5.0. The output is false because they are equal. What about 500 milligram not equal to 500 milligram? The output is false again because they're equal. Let's try the same with lists, analgesic not equal analgesic is also false. Let's check if one million is greater 100,000. True. Is one million greater than or equal to 100,000?
>
> **[2:22](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/comparison-operations?u=76281980&t=142)** True. Is one microgram less than one milligram?
>
> **[2:37](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/comparison-operations?u=76281980&t=157)** True. Is one microgram less than or equal to nine microgram? Okay, true. It's lesser. Go ahead and try different combinations of these operators and see for yourself how they work.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/logical-operations?u=76281980&t=0)** - [Instructor] Logical operators are also called Boolean operators, and their main use is to check typical conditions for your program allows it to run. The three major operators are AND for conjunction, OR for disjunction, and NOT for negation. Let's create some Boolean expressions. Starts with five is equal to 5.0. The output is true. Five is less than hundred divided by 20. The output is false. Hundred divided by 20 is equal to five. Let's combine this expression with the AND operator. (no audio)
>
> **[0:56](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/logical-operations?u=76281980&t=56)** The output is false because only one of the expression is true. What if we compare them with the OR operant? The output is true because only one of the expressions has to be true in this scenario. Finally, what will the output be with the AND NOT operant?
>
> **[1:26](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/logical-operations?u=76281980&t=86)** True, this gives the inverse of the expression when NOT was not included, as expected. You can go ahead and try different combinations of the logical operators.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/solution-repeat-string-by-integer-multiplication?u=76281980&t=0)** - [Instructor] To repeat our string of interest, "Be Cautious in the Lab", by integer multiplication three times. Let's write caution multiplied by three.
>
> **[0:21](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/solution-repeat-string-by-integer-multiplication?u=76281980&t=21)** We can go ahead and run this. Great work. You got the right answer. Be Cautious in the Lab. Be Cautious in the Lab. Be Cautious in the Lab.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/solution-integer-floor-division?u=76281980&t=0)** - [Instructor] An eight-hour dose means three times per day. So let's apply that to our code. Maximum_daily_dose_in_mg, integer floor divider, by three. Marvelous work. Our code return 66, which is the correct answer. If you tried just the normal division, now you know how to do floor division.
...
>
> **[1:43](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/functions?u=76281980&t=103)** Now, we type return, another expression and then results. When we run the cell, we have successfully created a function called addition, that takes in two values and return their sum. Now, let's test if these works, by calling addition to add 200 and 100. The output is 300, so its works. Let's apply it to larger numbers, maybe 1 million and a hundred thousand, 1.1 million and a hundred thousand. Will those function work on strings? Let's add hydro and chlorothiazide. Addition hydro. Okay, that worked too. You can also define the function to print the sentence, every time it is called, without the return expression and parameters. Let's write a function called bienvenue. That's print. "Welcome to our Laboratory". If we call bienvenue, its prints, "Welcome to our Laboratory". So, it works. Creating function is coding.
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/conditional-statements?u=76281980&t=0)** - Imagine you want to specify the flow of a code snippet, that's when conditional statements come in. The three expressions for conditional statements are if, else, and elif. For example, you have written a prescription for omeprazole, a proton pump inhibitor, but the pharmacy is out. You like to substitute with esomeprazole, another medication in that class. How to write this program? We'll define a variable called quantity of omeprazole and assign a generic quantity of say 60. Now we'll write the conditional statement that if the quantity of omeprazole, is greater than 40, there is enough omeprazole to dispense.
>
> **[0:57](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/conditional-statements?u=76281980&t=57)** And let's write another conditional statement, using else, that if there's less than 40 omeprazole. it should present an alternative called esomeprazole. So else, print.
>
> **[1:26](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/conditional-statements?u=76281980&t=86)** Okay, so we've written the statement because the quantity of omeprazole here is 60, there is enough omeprazole to dispense. Now let's try the same code, but with 39.
>
> **[1:51](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/conditional-statements?u=76281980&t=111)** The output this time is another statement, that there is less than 40 omeprazole in the dispensary. Would you like to dispense esomeprazole? We can combine two conditions in the same code using elif, this simply means else if, and the elif statement only works if the first statement is not true. Let's try with the same code about omeprazole and esomeprazole.
>
> **[2:34](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/conditional-statements?u=76281980&t=154)** If the quantity is 60, there is enough omeprazole to dispense. If it's 20 in the same code, there is less than 40 omeprazole in the dispensary. Would you like to dispense esomeprazole? This example is simple because there will probably be more than one alternative in real time but the goal is to see how this conditional statement work.
...
>
> **[2:21](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/for-loops?u=76281980&t=141)** If item is equal to 60, continue, then print item. The output here excludes 60. Let's see what happens when you iterate over a string like omeprazole saved in a variable called string_value. String_value omeprazole,
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/solution-define-a-function?u=76281980&t=0)** - [Instructor] To solve this exercise successfully, we'll be converting data types. The value provided here is a numeric but the expected output is a string. So let's convert the numeric to string first. String value. And now, let's append milligram which is also a string. Time to test our code. Great work. The code returned 10 milligram. If you look at the test code, the value provided is just ten, and our function that we completed here has successfully appended milligram to it, and it's a string.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/solution-iterate-over-a-list-with-for-loop?u=76281980&t=0)** - [Instructor] Since there are 24 hours in a day, and this has been taken eight hourly, we'll be iterating to multiply each element by three. So for i in quantity of medication per dose. (no audio)
>
> **[0:31](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/solution-iterate-over-a-list-with-for-loop?u=76281980&t=31)** Now, let's run our code after the iteration. Okay, our code output is three, six, and nine, that means that this is the quantity of medication per dose 1, 2, 3, and then we iterated over it that we want the total quantity that this person will need per day. So this is the first thing you do, 24 divided by eight to get this three.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/minimum-and-maximum-function?u=76281980&t=0)** - [Instructor] The numbers beside medication names typically indicates the content of active ingredients in that particular presentation. So the same medication can have different strengths. This is where the minimum and maximum function can be incredibly useful. For example, let's make a least code ibuprofen strengths in milligram. To decide the one with minimum strength, we simply call the minimum function on ibuprofen strength in milligram. That returns 200, as expected. We can call the max function to return the highest value on the same list, and it returns 800. This doesn't look like a big deal on small list, but imagine if there are thousands of elements in the list of sequence. I would like you to apply minimum and maximum to other data types like strings, and see what happens. Think of the ways this function could be useful for operations in places like laboratories, pharmacies, or even emergency rooms.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/range-and-sum-function?u=76281980&t=0)** - [Instructor] In your lab experiment, let's say you want the list showing the number of oscillations of a pendulum. How can you get that information quickly? This is where the range function comes in. Create the variable called number_of_oscillations, which list the numbers between the range of zero and 11.
>
> **[0:27](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/range-and-sum-function?u=76281980&t=27)** The output is a list showing numbers zero to 10. That means the range includes the first number but excludes the last, which is 11 in our case. Can you have a range not starting from zero? Yes, you can use the range functions alone, say, range 500 to 511.
>
> **[0:57](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/range-and-sum-function?u=76281980&t=57)** The output is the same as written. You can assess the values using the for loop, as I'm doing here. (no audio)
>
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/split-and-join-function?u=76281980&t=0)** - [Instructor] If you create a variable called laboratory_apparatus containing a sentence about, "Some of the apparatus found in the laboratory are test tube, beaker, pipette, glass funnel, and petri dish." If you would like to split them into individual wards, that's where the split function comes in, so laboratory_apparatus.split. If nothing is specified in the split as the splitter, it simply splits the statement with white spaces. You can specify the split parameter. For example, if you separate by comma, you can have a different output as seen here. What if you have a list of lab apparatus and you would like them to be a single phrase? List_of_lab_apparatus, test tube, beaker, pipette, and burette. That's why you have the join function. So let's join this. We can tweak the code with a space. Now we have space in between the words. If you want the comma between them, we can tweak them further by adding a comma in the preceding string sign. Practice place and join functions on your list dataset and try this with both numeric and string data. Do you prefer using one kind over the other?
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/zip-function?u=76281980&t=0)** - [Instructor] Let's say you have two lists, a list of analgesics, containing generic name of analgesics, and then list of dosage strength in milligram, containing the common dose presentation. So pair each analgesic with their strength. In Zuko, we can simply use the zip function. This returns a zip object. Let's call the list function, so that we can see each pair. Great, we now have a list of tuples of each medication and their presentation strength.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/map-function?u=76281980&t=0)** - [Instructor] The built-in map function is there to apply the same procedure to every item in an iterable data structure, like list, strings, tuples, and sets, to name a few. If you would like to apply a function to a list or any iterable without writing a for loop, you can use the map function. For example, you are calculating the body mass index of kids, and you have a list containing the height of some of the children in meters. To calculate the square of each value, you will use the map function, height of children in meters. We can go ahead and write a simple function called square that takes a number and raises it to the power of two. We then create a variable. We then create a variable square of height of children in meters that maps the square function to the numbers in the height of children in meters list.
>
> **[1:07](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/map-function?u=76281980&t=67)** Another approach is to use the lambda expression rather than the square function first. To do that, you list, map, lambda x, x raised to power two, height of children in meters. Voila, you have the same output. You now know how to use the map function.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/solution-return-maximum-value-from-a-tuple?u=76281980&t=0)** - [Instructor] This is another instance where you can use built-in methods. To find the largest number in this tuple, let's use max_dosage_strength. Let's run the code. We have the right output. This is the largest number in this tuple.
...
>
> **[0:13](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/solution-print-elements-in-a-list-in-lowercase?u=76281980&t=13)** Let's test our code. This is also correct. All the items in the ancestor main list are in lowercase.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/solution-get-an-element-from-a-list-using-negative-indexing?u=76281980&t=0)** - [Instructor] To get the correct answer here, it's important that you apply negative indexing only. So antihistamines, square bracket, minus one, square bracket, let's see if it works. It's solved. The code return the last item in this list and we used negative indexing. There are other types of indexing, but only negative indexing will be right in this instance.
...
>
> **[1:24](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/comments?u=76281980&t=84)** because it'll be considered an improperly written string. You can also use the triple code string for multi-line command. total_quantity_dispensed is a equal to six multiplied by seven in the comment. Total quantity of medication taking two tablets twice daily for one week use. Remember, a week is seven days. The dosage of this tablet is 500 milligram each. Don't be afraid to leave comment on your code. Documentation is the key to good collaboration, so letting others know what you intended is very helpful.
...
>
> **[1:47](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/docstring?u=76281980&t=107)** This function calculates the total quantity of medication dispensed. And the arguments are: total daily quantity, an integer, an integer that contains total daily quantity of medication, and number of days, also an integer. Number of days to take medication. This function returns an integer. Total quantity of medication dispensed. Okay, let's complete the function. Return total daily quantity, multiply by number of days. Okay, there we have our function. Let's try out our total quantity dispensed function. Six. Seven. Okay, it returns 42 tablets. It works. Let's do help total quantity dispensed. It works. It shares the detailed comments
>
> **[3:19](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/docstring?u=76281980&t=199)** that we already embedded in our function. Let's see if we apply the dunder function. Total quantity dispensed double underscore dot double underscore. What about the doc dunder? It works too. It returns the documentation. So you've written your first docstring and it's accessible by help in doc dunder. Practice writing your own docstrings in your workspace. Then show it to your colleague and see if they understand what your comments mean.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/error-messages?u=76281980&t=0)** - [Instructor] To successfully debug your code understanding error messages and how to resolve them is an important skill. The simplest technique is to actually read the message. For example, if you write omeprazole and run it it returns a NameError, and goes on to suggest that it is because omeprazole is not defined because it is not in the string quotes. When you rewrite it with quotes it runs fine. Omeprazole has 10 characters. That means it's in index zero to nine. If we attempt to get the tenth index we have an IndexError: string index out of range. The same code assessing the ninth index returns a value and runs fine. What if we decide to add an integer like zero to omeprazole? We get a TypeError: can only concatenate string, not integer, to string. If we add a string E-S to omeprazole
>
> **[1:27](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/error-messages?u=76281980&t=87)** we have a new string called esomeprazole. This is another medication in the same class. If we declare function with def and place the next line on the same alignment as def we have an IndentationError: expected an indented block after function definition on line one. When we fix this, it runs.
>
> **[2:02](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/error-messages?u=76281980&t=122)** What if we try to print without parentheses? We have a SyntaxError: Missing parentheses in call to print. Did you mean to print? If you follow the prompt, it could run successfully. So if you're getting a bunch of error messages don't just ignore them. Read them. They are there to help you fix your code.
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/python-for-health-sciences-and-healthcare/next-steps?u=76281980&t=0)** - [Wuraola] If you made it to the end of this course, you're truly committed to becoming great at this, and it's an honor to be your guide. What are the next steps? Practice, build new things, and implement your new skills to optimize your workflow. Remember to rate this course, share all about your new skills, and if you have questions, you can write them in the community Q and A.
