...
>
> **[0:00](https://www.linkedin.com/learning/practical-database-design-implementing-responsible-data-solutions-with-sql-querying/designing-and-implementing-a-data-model?u=76281980&t=0)** - Have you ever been given a data set only to realize that you can't turn it into a dashboard? You need to understand the relationship between categories, fill in contextual gaps, and prioritize building a data model. Having conversations with your clients is key to meeting their data insight expectations. In this course, I'll teach you the fundamentals of designing and implementing a data model. Using [MySQL](../../Skills/Software%20Development/MySQL.md) Workbench, we'll walk through the full arc of any database project including business rules, data generation, and [SQL](../../Skills/Data%20Science/SQL.md) querying. Hi, I'm Brandeis Marshall, a former college professor turned data learning entrepreneur. And [Data Modeling](../../Skills/Data%20Science/Data%20Modeling.md) is my tech jam. So let me be your personal coach as we build this project together. Let's get started.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [MySQL](../../Skills/Software%20Development/MySQL.md) (1), [SQL](../../Skills/Data%20Science/SQL.md) (1), [Data Modeling](../../Skills/Data%20Science/Data%20Modeling.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/practical-database-design-implementing-responsible-data-solutions-with-sql-querying/what-you-should-know?u=76281980&t=0)** - [Instructor] I designed this course for beginner to intermediate data analyst and engineers who have a basic understanding of [Database Design](../../Skills/Software%20Development/Database%20Design.md) and [SQL](../../Skills/Data%20Science/SQL.md). You may currently be in a data role or work with a data team. There's a myriad of data terms and you don't need to know all of them for this course. I'll go over some of the most common ones to help make it easier. I will be using [MySQL](../../Skills/Software%20Development/MySQL.md) Workbench, which is a free, open source [Database Management](../../Topics/Database%20Management.md) systems tool. You can download it here. FYI, I'll be using my SQL Workbench 8.0.31 FYI, I'll be using my SQL Workbench 8.0.31 because it's the most stable version. You'll need to select Archives to choose the correct version. If you download a newer version, some of the features may not work correctly. You'll also need to download MySQL Community Server 8.0.36. MySQL Community Server 8.0.36. No need to go to the Archives. Just select the version on the home screen. Well, that should do it. Let's get started.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [SQL](../../Skills/Data%20Science/SQL.md) (3), [MySQL](../../Skills/Software%20Development/MySQL.md) (3), [Database Design](../../Skills/Software%20Development/Database%20Design.md) (1), [Database Management](../../Topics/Database%20Management.md) (1)
...
> [!transcript]- Transcript
>
> **[0:01](https://www.linkedin.com/learning/practical-database-design-implementing-responsible-data-solutions-with-sql-querying/how-databases-help-businesses?u=76281980&t=1)** - [Narrator] Whether you say database or database, you've had to interact with several of them as part of your position duties. There's a backend data structure that you must connect to that helps you complete your task. Behind every login screen, internal search bar and [Slack](../../Skills/Software%20Development/Slack.md) channel is a database. You rely on those [Databases](../../Skills/Software%20Development/Databases.md) to be up and running. You rely on them to contain the data that you're looking for. You rely on them to save and store your work [products](../../Skills/Software%20Development/Microsoft%20Products.md) and all the correspondence surrounding them. [Business Operations](../../Skills/Data%20Science/Business%20Operations.md) can't happen without databases. HR departments manage talent recruitment, acquisition and retention strategies. Product departments design, implement and maintain a suite of services and products. Marketing and sales departments execute [Lead Generation](../../Skills/Cloud%20Computing/Lead%20Generation.md) campaigns and cultivate client relationships, and IT departments coordinate the integration of systems, tools, and platforms. Data assets are created, manipulated, repurposed, and isolated within businesses to help fulfill business key performance indicators, goals, and objectives and key results.
>
> **[1:38](https://www.linkedin.com/learning/practical-database-design-implementing-responsible-data-solutions-with-sql-querying/how-databases-help-businesses?u=76281980&t=98)** These data assets come in various [Forms](../../Skills/Web%20Development/Forms.md). There's documents, spreadsheets, media, software, [Dashboards](../../Skills/Data%20Science/Dashboards.md), and so on. From the organization's CEO to their clients, data is added, updated, retrieved, and deleted daily from a collection of databases, whether you're aware of it or not. While everyone in the organization implicitly engages with databases, it takes an organization's commitment to [Data Stewardship](../../Skills/Data%20Science/Data%20Stewardship.md) to ensure their data assets are sufficiently protected. Now, data stewardship in a nutshell is concerns with standardizing data definitions, ensuring [Data Quality](../../Skills/Data%20Science/Data%20Quality.md) and managing [Data Lineage](../../Skills/Data%20Science/Data%20Lineage.md), and data stewardship calls on all levels of data professionals, including chief data officers, data administrators, database administrators, data scientists, data analysts, and data engineers. All these people evaluate the [Data Integrity](../../Skills/Cybersecurity/Data%20Integrity.md) for completeness and trustworthiness, along with securing the [Data Privacy](../../Skills/Data%20Science/Data%20Privacy.md) of their products and clients. It's you as the data analyst or data engineer who are crucial to help guide the [rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) of the organization in effective execution of data stewardship practices.
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Databases](../../Skills/Software%20Development/Databases.md) (6), [Data Stewardship](../../Skills/Data%20Science/Data%20Stewardship.md) (4), [Products](../../Skills/Software%20Development/Microsoft%20Products.md) (3), [Data Quality](../../Skills/Data%20Science/Data%20Quality.md) (2), [Slack](../../Skills/Software%20Development/Slack.md) (1)
> **Env Vars:** ceo (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Generative AI](../../Skills/Artificial%20Intelligence%20(AI)/Generative%20AI.md) (1), [Algorithms](../../Skills/Software%20Development/Algorithms.md) (1), [Products](../../Skills/Software%20Development/Microsoft%20Products.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Business Operations](../../Skills/Data%20Science/Business%20Operations.md) (2), [Database Management](../../Topics/Database%20Management.md) (2), [Products](../../Skills/Software%20Development/Microsoft%20Products.md) (1), [Data Modeling](../../Skills/Data%20Science/Data%20Modeling.md) (1), [Data Governance](../../Skills/Data%20Science/Data%20Governance.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/practical-database-design-implementing-responsible-data-solutions-with-sql-querying/a-business-rule-vs-a-business-policy?u=76281980&t=0)** - [Host] It may seem unnatural for business policies and business rules to be part of the same conversation, but in day-to-day data team activities, much of our work is guided by the organization's business policies. Business policies take on one of three [Forms](../../Skills/Web%20Development/Forms.md), facilitating regulatory or restrictive. Each type of business policy provides a blueprint for defining limits of how the organization's team members should be making decisions. Ideally, a business policy is clear, concise, simple, inclusive, and stable in practice however, conflicting business policies are unearthed as they can be developed in silos. [Data Governance](../../Skills/Data%20Science/Data%20Governance.md) committees are formed internally to help provide sufficient and regular checks and balances given specific compliance stipulations. For instance, let's revisit the business rule that checks the dimensions of an [Instagram](../../Glossary/Service/Instagram.md) post prior to posting to the profile's timeline. A business policy would require that the posts not contain explicit or inappropriate content. The data governance committee of data and legal experts would figure out what constitutes explicit and inappropriate content, as well as agree to how to algorithmically establish those parameters.
>
> **[1:37](https://www.linkedin.com/learning/practical-database-design-implementing-responsible-data-solutions-with-sql-querying/a-business-rule-vs-a-business-policy?u=76281980&t=97)** The [Banking](../../Skills/Software%20Development/Banking.md), insurance and healthcare industries contend with more comprehensive national oversight to help minimize [Data Privacy](../../Skills/Data%20Science/Data%20Privacy.md) breaches. In other industries, business policies concerning [Data Management](../../Skills/Software%20Development/Data%20Management.md) activities aren't common. The public release of [Generative AI](../../Skills/Artificial%20Intelligence%20(AI)/Generative%20AI.md) in March, 2023 has altered this landscape. Many organizations are looking and some are shaping [agile](../../Skills/DevOps/Agile%20Development.md) implementable AI policies to support better transparency, [Accountability](../../Skills/Data%20Science/Accountability.md), and governance. As you can see, business policies serve as an additional layer of protection for the organization. They also help support the effective implementation of business rules. The ultimate goals of business policies within the data management space remain constant to improve [Data Quality](../../Skills/Data%20Science/Data%20Quality.md), maintain a high standard of documentation, and keep data secure. There have been a lot of terms and scenarios shared so far. Next up, we are going to reinforce what you've learned. We'll see how well you're able to distinguish between a business rule, business operation, business practice, and business policy.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Data Governance](../../Skills/Data%20Science/Data%20Governance.md) (2), [Data Management](../../Skills/Software%20Development/Data%20Management.md) (2), [Forms](../../Skills/Web%20Development/Forms.md) (1), [Instagram](../../Glossary/Service/Instagram.md) (1), [Banking](../../Skills/Software%20Development/Banking.md) (1)
> **Analogies:** for instance (1)
> **Speakers:** - [host] (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Databases](../../Skills/Software%20Development/Databases.md) (4), [SQL](../../Skills/Data%20Science/SQL.md) (1), [Relational Databases](../../Skills/Software%20Development/Relational%20Databases.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Database Design](../../Skills/Software%20Development/Database%20Design.md) (5)
> **CLI Commands:** make (6)
> **Speakers:** - [narrator] (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Business Operations](../../Skills/Data%20Science/Business%20Operations.md) (2), [Software Development](../../Topics/Software%20Development.md) (2), [Data Validation](../../Skills/Software%20Development/Data%20Validation.md) (2), [Data Storage](../../Skills/Data%20Science/Data%20Storage.md) (2), [Database Management](../../Topics/Database%20Management.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Database Management](../../Topics/Database%20Management.md) (1)
> **Env Vars:** dbms (2)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Privacy](../../Skills/Data%20Science/Privacy.md) (2), [Sketching](../../Skills/Web%20Development/Sketching.md) (1)
> **Analogies:** imagine (2)
> **CLI Commands:** find (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Pandas](../../Skills/Software%20Development/Pandas%20(Software).md) (2), [Statistics](../../Skills/Data%20Science/Statistics.md) (2), [Python](../../Skills/Software%20Development/Python%20(Programming%20Language).md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/practical-database-design-implementing-responsible-data-solutions-with-sql-querying/the-data-you-re-creating-pros-and-cons?u=76281980&t=0)** - [Instructor] Some data environments elect to create synthetic data sets themselves or license them from other organizations. The [Banking](../../Skills/Software%20Development/Banking.md) and credit lending industry use synthetic [Financial Data](../../Skills/Software%20Development/Financial%20Data.md) to improve fraud detection. Manufacturing companies use synthetic data for better quality control testing and predictive maintenance processes. AI-powered companies use synthetic data to test the robustness of their facial feature recognition and [natural language processing](../../Skills/Artificial%20Intelligence%20(AI)/Natural%20Language%20Processing%20(NLP).md) systems. In doing so, there are expected pros and cons. Let's discuss the pros first. Top benefits include, number one, your ability to generate data sets that are diverse and realistic. You can mimic characteristics found in the real world and test different models or scenarios relatively easily. Number two, you have the opportunity to save costs. Once data generation is complete, an organization isn't spending a bunch of money repeatedly on real dataset licenses, and you're avoiding the real world [Data Collection](../../Skills/Data%20Science/Data%20Collection.md) process, which is notoriously very costly. And number three, you significantly reduce concerns around data ownership and [Privacy](../../Skills/Data%20Science/Privacy.md).
>
...
>
> **[3:11](https://www.linkedin.com/learning/practical-database-design-implementing-responsible-data-solutions-with-sql-querying/the-data-you-re-creating-pros-and-cons?u=76281980&t=191)** So there you have it. We have the pros of potentially generating diverse and realistic data, saving cost, and keeping sensitive data safe. We've shared several limitations of choosing an inadequate data generation model, dealing with a slew of [Data Integrity](../../Skills/Cybersecurity/Data%20Integrity.md) issues, and not being able to assess reliability. We'll finish up this chapter with important questions to ask if you're planning on developing your own synthetic data.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Banking](../../Skills/Software%20Development/Banking.md) (1), [Financial Data](../../Skills/Software%20Development/Financial%20Data.md) (1), [Natural language processing](../../Skills/Artificial%20Intelligence%20(AI)/Natural%20Language%20Processing%20(NLP).md) (1), [Data Collection](../../Skills/Data%20Science/Data%20Collection.md) (1), [Privacy](../../Skills/Data%20Science/Privacy.md) (1)
> **Speakers:** - [instructor] (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [MySQL](../../Skills/Software%20Development/MySQL.md) (8), [SQL](../../Skills/Data%20Science/SQL.md) (3), [Database Management](../../Topics/Database%20Management.md) (1), [Data Modeling](../../Skills/Data%20Science/Data%20Modeling.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [MySQL](../../Skills/Software%20Development/MySQL.md) (2), [Data Modeling](../../Skills/Data%20Science/Data%20Modeling.md) (1), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [MySQL](../../Skills/Software%20Development/MySQL.md) (2), [Database Design](../../Skills/Software%20Development/Database%20Design.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [MySQL](../../Skills/Software%20Development/MySQL.md) (5), [SQL](../../Skills/Data%20Science/SQL.md) (4), [Database Design](../../Skills/Software%20Development/Database%20Design.md) (1), [Word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/practical-database-design-implementing-responsible-data-solutions-with-sql-querying/overview-of-the-select-statement?u=76281980&t=0)** - [Instructor] Knowing [SQL](../../Skills/Data%20Science/SQL.md) has skyrocketed as a preferred skill for data analysts and engineers. Learning SQL has stayed relatively the same since the early 1970s. The emphasis is placed on learning the mechanics of structuring an SQL statement. However, we should also focus on understanding the [Decision-Making](../../Skills/Data%20Science/Decision-Making.md) implications of what an SQL query is retrieving. Let's discuss the mechanics first. The SQL select statement. The select clause is first, which contains the list of columns to be returned back to the user. Then comes the from clause. It holds the list of tables needed to perform the query. After from, we have options, depending on which database items we're trying to retrieve. Most times, we need a where clause. The where clause places conditions on which data elements will be selected and filtered out for each column. And sometimes, especially when we want to cluster or sort, we'll use the group by, having, and/or order by clauses. The group by clause does just that, groups data elements anchored on at least one column. For example, grouping your organization's customer list
>
...
>
> **[3:14](https://www.linkedin.com/learning/practical-database-design-implementing-responsible-data-solutions-with-sql-querying/overview-of-the-select-statement?u=76281980&t=194)** We end up with a selective list of columns and rows that meet the conditions of the SQL query. Now, we can't overlook how null entries can disqualify a row from appearing in a result set, and therefore, making a result sets incomplete. We also can't overlook how important both primary keys and foreign keys are to our [Database Design](../../Skills/Software%20Development/Database%20Design.md). Without solid primary keys and foreign keys, our SQL querying would return lackluster results. Pay close attention to the motivation, ethical, and legal impact of which queries are requested and how they are shared. Keeping the SQL processing order top of mind will help you figure out which clauses in the select statement are really needed.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [SQL](../../Skills/Data%20Science/SQL.md) (9), [Decision-Making](../../Skills/Data%20Science/Decision-Making.md) (1), [Database Design](../../Skills/Software%20Development/Database%20Design.md) (1)
> **Env Vars:** sql (9)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [SQL](../../Skills/Data%20Science/SQL.md) (11), [MySQL](../../Skills/Software%20Development/MySQL.md) (5), cursor (1), [Fetch](../../Skills/Web%20Development/Fetch.md) (1), [E-Commerce](../../Skills/Web%20Development/E-Commerce.md) (1)
> **Env Vars:** sql (11)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [SQL](../../Skills/Data%20Science/SQL.md) (11), [Windows](../../Glossary/Service/Windows.md) (1), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1), [Data Quality](../../Skills/Data%20Science/Data%20Quality.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [SQL](../../Skills/Data%20Science/SQL.md) (9), [Word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) (3), [Windows](../../Glossary/Service/Windows.md) (1)
...
> [!transcript]- Transcript
>
> **[0:00](https://www.linkedin.com/learning/practical-database-design-implementing-responsible-data-solutions-with-sql-querying/next-steps?u=76281980&t=0)** - Congratulations, give yourself a pat on the back. You've done it. It wasn't as overwhelming as you'd imagined, right? If you're interested in gaining more practice in [SQL](../../Skills/Data%20Science/SQL.md), check out Kedeisha Bryan's advanced SQL course, or to learn more about leading a [Responsible AI](../../Skills/Artificial%20Intelligence%20(AI)/Responsible%20AI.md) organization, Elizabeth M. Adams has a great course on this topic. Well, we've reached the end of our time together for now. Thanks for taking this course. For more conversations about [Data Ethics](../../Skills/Data%20Science/Data%20Ethics.md) and building more responsible data practices, follow me on [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) or visit my company website at [dataedx.com](https://dataedx.com). Thank you for watching.

> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [SQL](../../Skills/Data%20Science/SQL.md) (2), [Responsible AI](../../Skills/Artificial%20Intelligence%20(AI)/Responsible%20AI.md) (1), [Data Ethics](../../Skills/Data%20Science/Data%20Ethics.md) (1), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (1)
> **Env Vars:** sql (2)
...
← [SQL Server Fundamentals- Master Basic Query Techniques](SQL%20Server%20Fundamentals-%20Master%20Basic%20Query%20Techniques.md) | **7 of 11** | [Advanced SQL for Query Tuning and Performance Optimization](Advanced%20SQL%20for%20Query%20Tuning%20and%20Performance%20Optimization.md) →
...
- [Advanced SQL Project- Design and Manage a Database](Advanced%20SQL%20Project-%20Design%20and%20Manage%20a%20Database.md) — SQL, Database Design
