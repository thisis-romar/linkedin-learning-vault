...
>
> **[2:31](https://www.linkedin.com/learning/level-up-rust/calculate-the-median?u=76281980&t=151)** otherwise and I'll just return a placeholder for now. I can return zero. Ah-ha. One of them has passed. Okay, so the next step is to sort my list. So if I do this just with the sort method, I'll encounter a problem. I'll try and compile my tests and I get this error message saying that the trait odd is not implemented for F32. What this means, well, odd is short for ordinal and this indicates that [Rust](../../Skills/Software%20Development/Rust%20(Programming%20Language).md) doesn't know how to compare all values of F32, which is a floating point value, because some of them, such as not a number, cannot be compared to any other. So instead we have to provide our custom sort function and we'll do that by using what's a little bit sneaky
>
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Rust](../../Skills/Software%20Development/Rust%20(Programming%20Language).md) (4), [Word](../../Skills/Cloud%20Computing/Microsoft%20Word.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Rust](../../Skills/Software%20Development/Rust%20(Programming%20Language).md) (3), [Data Quality](../../Skills/Data%20Science/Data%20Quality.md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Rust](../../Skills/Software%20Development/Rust%20(Programming%20Language).md) (1), [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (1), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1)
> **CLI Commands:** find (3)
> **Non-Speech:** (retro video game sound effects) (1), (retro video game music) (1)
> **File Paths:** main.rs (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [LinkedIn](../../Skills/Web%20Development/LinkedIn.md) (3), [Rust](../../Skills/Software%20Development/Rust%20(Programming%20Language).md) (1)
...
> [!info]- Semantic Content
>
> **Frameworks & Libraries:** [Rust](../../Skills/Software%20Development/Rust%20(Programming%20Language).md) (4), [Rest](../../Skills/Web%20Development/Representational%20State%20Transfer%20(REST).md) (1)
...
- [Tim McNamara](../../Instructors/Data%20Science/Tim%20McNamara.md)
...
← [Rust for Data Engineering](Rust%20for%20Data%20Engineering.md) | **5 of 6** | [End-to-End Data Engineering Project](End-to-End%20Data%20Engineering%20Project.md) →
...
- [Rust Essential Training](Rust%20Essential%20Training.md) — Rust (Programming Language)
