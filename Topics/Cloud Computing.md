...
> <!-- lle:github-source --> [View this note on GitHub](https://github.com/thisis-romar/linkedin-learning-vault/blob/github-browse/Topics/Cloud%20Computing.md)

# Cloud Computing

> 65 learning paths | LinkedIn Official Topic
...
- [[Cloud Computing Understanding Core Concepts]] — 5 paths
- [[Microsoft Teams Essential Training]] — 4 paths
- [[Microsoft Entra ID Fundamentals]] — 4 paths
- [[Writing a Tech Resume]] — 4 paths
- [[Determining Your Cloud Strategy- Planning for Roadmap, Infrastructure, and Deployment]] — 3 paths
- [[Cloud Architecture- Core Concepts]] — 3 paths
